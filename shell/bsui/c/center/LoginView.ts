...
namespace shell {
    export namespace ui {
        export namespace c {
            ...
            /** 配置项目-启用验证码 */
            export const CONFIG_ITEM_ENABLE_VERIFICATION_CODE: string = "enableVerificationCode";
            /** 配置项目-空验证码地址 */
                    ...
                    return new sap.ui.layout.form.SimpleForm("", {
                        content: [
                            ...
                            new sap.m.Label("", {
                                ...
                                visible: ibas.config.get(CONFIG_ITEM_ENABLE_VERIFICATION_CODE, false)
                                    ...
                                    new sap.m.Button("", {
                                        ...
                                        press: function (): void {
                                            let user: {} = {
                                                ...
                                                verification: ibas.strings.format("{0}={1}", that.imgVerification.getAlt(), that.txtVerification.getValue()),
                                            };
