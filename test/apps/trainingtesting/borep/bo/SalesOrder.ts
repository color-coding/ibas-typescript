...
namespace trainingtesting {
    export namespace bo {
        ...
        export class SalesOrderItem extends ibas.BODocumentLine<SalesOrderItem> implements ISalesOrderItem {
            ...
            /** 映射的属性名称-销售订单-行-批次集合 */
            static PROPERTY_BATCHITEMS_NAME: string = "BatchItems";
            /** 获取-销售订单-行-批次集合 */
            get batchItems(): BatchItems {
                return this.getProperty<BatchItems>(SalesOrderItem.PROPERTY_BATCHITEMS_NAME);
            }
            /** 设置-销售订单-行-批次集合 */
            set batchItems(value: BatchItems) {
                this.setProperty(SalesOrderItem.PROPERTY_BATCHITEMS_NAME, value);
            }

            /** 初始化数据 */
            protected init(): void {
                this.batchItems = new BatchItems(this);
            }
        }

        /** 销售订单-行-批次 集合 */
        export class BatchItems extends ibas.BusinessObjects<BatchItem, SalesOrderItem> implements IBatchItems {
            /** 创建并添加子项 */
            create(): BatchItem {
                let item: BatchItem = new BatchItem();
                this.add(item);
                return item;
            }
        }
        /** 销售订单-行-批次 */
        export class BatchItem extends ibas.BODocumentLine<BatchItem> implements IBatchItem {
            /** 构造函数 */
            constructor() {
                super();
            }
            ...
            /** 获取-编码 */
            get docEntry(): number {
                return this.getProperty<number>(BatchItem.PROPERTY_DOCENTRY_NAME);
            }
            /** 设置-编码 */
            set docEntry(value: number) {
                this.setProperty(BatchItem.PROPERTY_DOCENTRY_NAME, value);
            }
            ...
            /** 获取-行号 */
            get lineId(): number {
                return this.getProperty<number>(BatchItem.PROPERTY_LINEID_NAME);
            }
            /** 设置-行号 */
            set lineId(value: number) {
                this.setProperty(BatchItem.PROPERTY_LINEID_NAME, value);
            }
            ...
            /** 获取-显示顺序 */
            get visOrder(): number {
                return this.getProperty<number>(BatchItem.PROPERTY_VISORDER_NAME);
            }
            /** 设置-显示顺序 */
            set visOrder(value: number) {
                this.setProperty(BatchItem.PROPERTY_VISORDER_NAME, value);
            }
            ...
            /** 获取-类型 */
            get objectCode(): string {
                return this.getProperty<string>(BatchItem.PROPERTY_OBJECTCODE_NAME);
            }
            /** 设置-类型 */
            set objectCode(value: string) {
                this.setProperty(BatchItem.PROPERTY_OBJECTCODE_NAME, value);
            }
            ...
            /** 获取-数据源 */
            get dataSource(): string {
                return this.getProperty<string>(BatchItem.PROPERTY_DATASOURCE_NAME);
            }
            /** 设置-数据源 */
            set dataSource(value: string) {
                this.setProperty(BatchItem.PROPERTY_DATASOURCE_NAME, value);
            }
            ...
            /** 获取-实例号（版本） */
            get logInst(): number {
                return this.getProperty<number>(BatchItem.PROPERTY_LOGINST_NAME);
            }
            /** 设置-实例号（版本） */
            set logInst(value: number) {
                this.setProperty(BatchItem.PROPERTY_LOGINST_NAME, value);
            }
            ...
            /** 获取-已引用 */
            get referenced(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(BatchItem.PROPERTY_REFERENCED_NAME);
            }
            /** 设置-已引用 */
            set referenced(value: ibas.emYesNo) {
                this.setProperty(BatchItem.PROPERTY_REFERENCED_NAME, value);
            }
            ...
            /** 获取-取消 */
            get canceled(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(BatchItem.PROPERTY_CANCELED_NAME);
            }
            /** 设置-取消 */
            set canceled(value: ibas.emYesNo) {
                this.setProperty(BatchItem.PROPERTY_CANCELED_NAME, value);
            }
            ...
            /** 获取-状态 */
            get status(): ibas.emBOStatus {
                return this.getProperty<ibas.emBOStatus>(BatchItem.PROPERTY_STATUS_NAME);
            }
            /** 设置-状态 */
            set status(value: ibas.emBOStatus) {
                this.setProperty(BatchItem.PROPERTY_STATUS_NAME, value);
            }
            ...
            /** 获取-单据状态 */
            get lineStatus(): ibas.emDocumentStatus {
                return this.getProperty<ibas.emDocumentStatus>(BatchItem.PROPERTY_LINESTATUS_NAME);
            }
            /** 设置-单据状态 */
            set lineStatus(value: ibas.emDocumentStatus) {
                this.setProperty(BatchItem.PROPERTY_LINESTATUS_NAME, value);
            }
            ...
            /** 获取-创建日期 */
            get createDate(): Date {
                return this.getProperty<Date>(BatchItem.PROPERTY_CREATEDATE_NAME);
            }
            /** 设置-创建日期 */
            set createDate(value: Date) {
                this.setProperty(BatchItem.PROPERTY_CREATEDATE_NAME, value);
            }
            ...
            /** 获取-创建时间 */
            get createTime(): number {
                return this.getProperty<number>(BatchItem.PROPERTY_CREATETIME_NAME);
            }
            /** 设置-创建时间 */
            set createTime(value: number) {
                this.setProperty(BatchItem.PROPERTY_CREATETIME_NAME, value);
            }
            ...
            /** 获取-修改日期 */
            get updateDate(): Date {
                return this.getProperty<Date>(BatchItem.PROPERTY_UPDATEDATE_NAME);
            }
            /** 设置-修改日期 */
            set updateDate(value: Date) {
                this.setProperty(BatchItem.PROPERTY_UPDATEDATE_NAME, value);
            }
            ...
            /** 获取-修改时间 */
            get updateTime(): number {
                return this.getProperty<number>(BatchItem.PROPERTY_UPDATETIME_NAME);
            }
            /** 设置-修改时间 */
            set updateTime(value: number) {
                this.setProperty(BatchItem.PROPERTY_UPDATETIME_NAME, value);
            }
            ...
            /** 获取-创建用户 */
            get createUserSign(): number {
                return this.getProperty<number>(BatchItem.PROPERTY_CREATEUSERSIGN_NAME);
            }
            /** 设置-创建用户 */
            set createUserSign(value: number) {
                this.setProperty(BatchItem.PROPERTY_CREATEUSERSIGN_NAME, value);
            }
            ...
            /** 获取-修改用户 */
            get updateUserSign(): number {
                return this.getProperty<number>(BatchItem.PROPERTY_UPDATEUSERSIGN_NAME);
            }
            /** 设置-修改用户 */
            set updateUserSign(value: number) {
                this.setProperty(BatchItem.PROPERTY_UPDATEUSERSIGN_NAME, value);
            }
            ...
            /** 获取-创建动作标识 */
            get createActionId(): string {
                return this.getProperty<string>(BatchItem.PROPERTY_CREATEACTIONID_NAME);
            }
            /** 设置-创建动作标识 */
            set createActionId(value: string) {
                this.setProperty(BatchItem.PROPERTY_CREATEACTIONID_NAME, value);
            }
            ...
            /** 获取-更新动作标识 */
            get updateActionId(): string {
                return this.getProperty<string>(BatchItem.PROPERTY_UPDATEACTIONID_NAME);
            }
            /** 设置-更新动作标识 */
            set updateActionId(value: string) {
                this.setProperty(BatchItem.PROPERTY_UPDATEACTIONID_NAME, value);
            }
            ...
            get batchCode(): string {
                return this.getProperty<string>(BatchItem.PROPERTY_BATCHCODE_NAME);
            }
            /** 设置-批次编号 */
            set batchCode(value: string) {
                this.setProperty(BatchItem.PROPERTY_BATCHCODE_NAME, value);
            }
            ...
            /** 获取-数量 */
            get quantity(): number {
                return this.getProperty<number>(BatchItem.PROPERTY_QUANTITY_NAME);
            }
            /** 设置-数量 */
            set quantity(value: number) {
                this.setProperty(BatchItem.PROPERTY_QUANTITY_NAME, value);
            }
