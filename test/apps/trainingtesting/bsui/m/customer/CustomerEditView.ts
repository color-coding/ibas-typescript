    ...
    export namespace ui {
        export namespace m {
            ...
            export class CustomerEditView extends ibas.BOEditView implements app.ICustomerEditView {
                ...
                draw(): any {
                    let that: this = this;
                    this.pageCustomer = new sap.m.Page("", {
                        showHeader: false,
                        showfooter: false,
                        content: [
                    ...
                    this.toPage(this.pageCustomer);
                    return this.page;
                }

                private page: sap.m.Page;
                private pageCustomer: sap.m.Page;
                ...
                private toPage(page: sap.m.Page, leftToRight?: boolean): void {
                    switch (page) {
                        case this.pageCustomer:
                            this.navButton.setVisible(true);
                            this.currentPage = this.pageCustomer;
                            break;
                        default:
                            break;
                    }
                ...
                private changeViewStatus(data: bo.Customer): void {
                    ...
                    if (data.approvalStatus === ibas.emApprovalStatus.APPROVED) {
                        ...
                        openui5.utils.changeFormEditable(this.pageCustomer, false);
                    }
                }

                /** 显示数据 */
                showCustomer(data: bo.Customer): void {
                    this.pageCustomer.setModel(new sap.ui.model.json.JSONModel(data));
                    this.pageCustomer.bindObject("/");
                    // 监听属性改变，并更新控件
                    openui5.utils.refreshModelChanged(this.pageCustomer, data);
                    // 改变视图状态
