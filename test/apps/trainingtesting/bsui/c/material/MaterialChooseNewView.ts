...
import { IMaterialChooseNewView } from "../../../bsapp/material/index";

/**
 * 视图-Material
 */
export class MaterialChooseNewView extends ibas.BOChooseView implements IMaterialChooseNewView {
    /** 返回查询的对象 */
    get queryTarget(): any {
        return bo.Material;
    }
            ...
            columns: [
                new sap.m.Column("", {
                    ...
                    header: new sap.m.Label("", {
                        width: "12em",
                        text: ibas.i18n.prop("bo_material_code")
                    })
                }),
                new sap.m.Column("", {
                    demandPopin: true,
                    minScreenWidth: "Tablet",
                    header: new sap.m.Label("", {
                        text: ibas.i18n.prop("bo_material_name")
                    })
                })
            ],
