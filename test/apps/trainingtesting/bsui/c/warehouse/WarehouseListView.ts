...
export class WarehouseListView extends ibas.BOListView implements IWarehouseListView {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.viewDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.Warehouse>(that.table).firstOrDefault()
                            );
                        }
                    }),
                    new sap.m.Button("", {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.deleteDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.Warehouse>(that.table)
                            );
                        }
                    }),
                ],
    ...
    getSelecteds(): bo.Warehouse[] {
        return utils.getTableSelecteds<bo.Warehouse>(this.table);
    }
}
