...
/** 应用-销售订单 */
export class SalesOrderEditNewApp extends ibas.BOEditApplication<ISalesOrderEditNewView, bo.SalesOrder> {

    /** 应用标识 */
    static APPLICATION_ID: string = "37f1fce3-ee1a-4c55-bb0d-98e8af355e57";
    /** 应用名称 */
    ...
    chooseSalesOrderCustomer(): void {
        ...
        ibas.servicesManager.runChooseService<bo.Customer>({
            chooseType:emChooseType.single,
...
/** 视图-销售订单 */
export interface ISalesOrderEditNewView extends ibas.IBOEditView {
    /** 显示数据 */
