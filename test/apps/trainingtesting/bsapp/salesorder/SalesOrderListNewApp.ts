...
import { SalesOrderEditNewApp } from "./SalesOrderEditNewApp";

/** 列表应用-销售订单 */
export class SalesOrderListNewApp extends ibas.BOListApplication<ISalesOrderListNewView, bo.SalesOrder> {

    /** 应用标识 */
    static APPLICATION_ID: string = "4a9d00c4-674e-42e7-b868-13802be571c2";
    /** 应用名称 */
    ...
    constructor() {
        super();
        this.id = SalesOrderListNewApp.APPLICATION_ID;
        this.name = SalesOrderListNewApp.APPLICATION_NAME;
        this.boCode = SalesOrderListNewApp.BUSINESS_OBJECT_CODE;
    ...
    protected newData(): void {
        let app: SalesOrderEditNewApp = new SalesOrderEditNewApp();
    ...
    protected viewData(data: bo.SalesOrder): void {
        ...
        let app: SalesOrderViewApp = new SalesOrderViewApp();
        app.navigation = this.navigation;
        app.viewShower = this.viewShower;
        app.run(data);
...
/** 视图-销售订单 */
export interface ISalesOrderListNewView extends ibas.IBOListView {
    /** 编辑数据事件，参数：编辑对象 */
