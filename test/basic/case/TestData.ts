    ...
    export namespace test {
        export class TestData extends ibas.TestCase {
            ...
            testEnum(): void {
                ...
                ibas.asserts.equals("converter parsingEnums faild.", ibas.emYesNo.YES, eValue);
                eValue = ibas.enums.valueOf(ibas.emConditionOperation, "NOT_EQUAL");
                ibas.asserts.equals("converter parsingEnums faild.", ibas.emConditionOperation.NOT_EQUAL, eValue);
            }
            // 测试日期类型
            testDate(): void {
                let dValue: Date = ibas.dates.valueOf("2017-03-14'T'23:59:59");
                ibas.asserts.equals("converter parsingDate faild.", dValue, new Date(2017, 2, 14, 23, 59, 59));
                dValue = ibas.dates.valueOf("2017/3/14'T'23:59:59");
                ibas.asserts.equals("converter parsingDate faild.", dValue, new Date(2017, 2, 14, 23, 59, 59));
                dValue = ibas.dates.valueOf("2017/3/14");
                ibas.asserts.equals("converter parsingDate faild.", dValue, new Date(2017, 2, 14));
                dValue = ibas.dates.valueOf("2017-3-14");
                ibas.asserts.equals("converter parsingDate faild.", dValue, new Date(2017, 2, 14));
                let sValue: string = ibas.dates.toString(new Date(2017, 2, 14, 23, 59, 59));
                ibas.asserts.equals("converter convertDate faild.", sValue, "2017-03-14T23:59:59");
            ...
            testString(): void {
                ...
                ibas.asserts.equals("string.count faild.", ibas.strings.count("I'm niuren.zhu.", "zhu"), 1);
                ibas.asserts.equals("string.count faild.", ibas.strings.count("I'm niuren.zhu.", "."), 2);
            }
            // 测试字符串构造器
            ...
            testUrl(): void {
                // 测试地址处理
                ibas.asserts.equals("string.count faild.", ibas.urls.normalize(".../test/util/.././../index.html"), document.location.href + "index.html");
            }
