...
/// <reference path="./extensions/components/Buttons.d.ts" />
/// <reference path="./extensions/components/Buttons.ts" />
...
/// <reference path="./extensions/components/ObjectListItem.d.ts" />
