	...
	namespace ui {
		...
		namespace layout {
			...
			export class BlockLayout extends sap.ui.core.Control {
				...
				/**
				 * <p>Adds some content to the aggregation <a target="_self" href="api/sap.ui.layout.BlockLayout#methods/getContent">content</a>.</p>
				 ...
				 */
				addContent(oContent: sap.ui.layout.BlockLayoutRow): this;
				/**
				 * <p>Destroys all the content in the aggregation <a target="_self" href="api/sap.ui.layout.BlockLayout#methods/getContent">content</a>.</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				destroyContent(): this;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.BlockLayout#methods/getBackground">background</a>.</p><p>Determines the background used for the Layout</p><p>Default value is <code>"Default"</code>.</p>
				...
				/**
				 * <p>Checks for the provided <code>sap.ui.layout.BlockLayoutRow</code> in the aggregation <a target="_self" href="api/sap.ui.layout.BlockLayout#methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
				...
				/**
				 * <p>Inserts a content into the aggregation <a target="_self" href="api/sap.ui.layout.BlockLayout#methods/getContent">content</a>.</p>
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				insertContent(oContent: sap.ui.layout.BlockLayoutRow, iIndex: number): this;
				/**
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setBackground(sBackground?: sap.ui.layout.BlockBackgroundType): this;
				/**
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setKeepFontSize(bKeepFontSize?: boolean): this;
			}
			/**
			...
			export class BlockLayoutCell extends sap.ui.core.Control {
				...
				constructor(sId?: string, mSettings?: any);
				/**
				 * <p>Adds some content to the aggregation <a target="_self" href="api/sap.ui.layout.BlockLayoutCell#methods/getContent">content</a>.</p>
				...
				/**
				 * <p>Destroys all the content in the aggregation <a target="_self" href="api/sap.ui.layout.BlockLayoutCell#methods/getContent">content</a>.</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				destroyContent(): this;
				/**
				 * <p>Destroys the titleLink in the aggregation <a target="_self" href="api/sap.ui.layout.BlockLayoutCell#methods/getTitleLink">titleLink</a>.</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				destroyTitleLink(): this;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.BlockLayoutCell#methods/getBackgroundColorSet">backgroundColorSet</a>.</p><p>The Background color set from which the background color will be selected. <b>Note:</b> backgroundColorSet should be used only in combination with backgroundColorShade.</p>
				...
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.BlockLayoutCell#methods/getBackgroundColorShade">backgroundColorShade</a>.</p><p>The index of the background color in the color set from which the color will be selected. <b>Note:</b> backgroundColorShade should be used only in combination with backgroundColorSet.</p>
				...
				getTitle(): string;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.BlockLayoutCell#methods/getTitleAlignment">titleAlignment</a>.</p><p>Defines the alignment of the cell title</p><p>Default value is <code>"Begin"</code>.</p>
				...
				/**
				 * <p>Gets content of aggregation <a target="_self" href="api/sap.ui.layout.BlockLayoutCell#methods/getTitleLink">titleLink</a>.</p><p>The link that will replace the title of the cell. <b>Note:</b> The only possible value is the <code>sap.m.Link</code> control.</p>
				 * @returns sap.ui.core.Control 
				 */
				...
				getWidth(): number;
				/**
				 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" href="api/sap.ui.layout.BlockLayoutCell#methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
				...
				/**
				 * <p>Inserts a content into the aggregation <a target="_self" href="api/sap.ui.layout.BlockLayoutCell#methods/getContent">content</a>.</p>
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setBackgroundColorSet(sBackgroundColorSet: sap.ui.layout.BlockLayoutCellColorSet): this;
				/**
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setBackgroundColorShade(sBackgroundColorShade: sap.ui.layout.BlockLayoutCellColorShade): this;
				/**
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setTitleAlignment(sTitleAlignment?: sap.ui.core.HorizontalAlign): this;
				/**
				...
				/**
				 * <p>Sets the aggregated <a target="_self" href="api/sap.ui.layout.BlockLayoutCell#methods/getTitleLink">titleLink</a>.</p>
				 * @param {sap.ui.core.Control} oTitleLink <p>The titleLink to set</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setTitleLink(oTitleLink: sap.ui.core.Control): this;
				/**
				 * <p>Sets the Width.</p>
				 * @param {number} iWidth <p>value.</p>
				 * @returns this <p>this BlockLayoutCell reference for chaining.</p>
				 */
			...
			export enum BlockLayoutCellColorShade {
				...
				ShadeD = "ShadeD",
				/**
				 * <p>Shade E - available only for SAP Quartz and Horizon themes</p>
				 */
				ShadeE = "ShadeE",
				/**
				 * <p>Shade F - available only for SAP Quartz and Horizon themes</p>
				 */
				ShadeF = "ShadeF",
			}
			/**
			...
			export class BlockLayoutCellData extends sap.ui.core.LayoutData {
				...
				constructor(sId?: string, mSettings?: any);
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.BlockLayoutCellData#methods/getLSize">lSize</a>.</p><p>Sets the width of the cell for L size of the BlockLayout.</p><p>Default value is <code>1</code>.</p>
				 * @returns number <p>Value of property <code>lSize</code></p>
				 */
				getLSize(): number;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.BlockLayoutCellData#methods/getMSize">mSize</a>.</p><p>Sets the width of the cell for M size of the BlockLayout.</p><p>Default value is <code>1</code>.</p>
				 * @returns number <p>Value of property <code>mSize</code></p>
				 */
				getMSize(): number;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.BlockLayoutCellData#methods/getSSize">sSize</a>.</p><p>Sets the width of the cell for S size of the BlockLayout.</p><p>Default value is <code>1</code>.</p>
				 * @returns number <p>Value of property <code>sSize</code></p>
				 */
				getSSize(): number;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.BlockLayoutCellData#methods/getXlSize">xlSize</a>.</p><p>Sets the width of the cell for XL size of the BlockLayout.</p><p>Default value is <code>1</code>.</p>
			...
			export class BlockLayoutRow extends sap.ui.core.Control {
				...
				constructor(sId?: string, mSettings?: any);
				/**
				 * <p>Adds some accentCell into the association <a target="_self" href="api/sap.ui.layout.BlockLayoutRow#methods/getAccentCells">accentCells</a>.</p>
				 * @param {sap.ui.core.ID | sap.ui.layout.BlockLayoutCell} vAccentCell <p>The accentCells to add; if empty, nothing is inserted</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				addAccentCell(vAccentCell: sap.ui.core.ID | sap.ui.layout.BlockLayoutCell): this;
				/**
				 * <p>Adds some content to the aggregation <a target="_self" href="api/sap.ui.layout.BlockLayoutRow#methods/getContent">content</a>.</p>
				 * @param {sap.ui.layout.BlockLayoutCell} oContent <p>The content to add; if empty, nothing is inserted</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				addContent(oContent: sap.ui.layout.BlockLayoutCell): this;
				/**
				 * <p>Destroys all the content in the aggregation <a target="_self" href="api/sap.ui.layout.BlockLayoutRow#methods/getContent">content</a>.</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				destroyContent(): this;
				/**
				...
				/**
				 * <p>Checks for the provided <code>sap.ui.layout.BlockLayoutCell</code> in the aggregation <a target="_self" href="api/sap.ui.layout.BlockLayoutRow#methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
				...
				/**
				 * <p>Inserts a content into the aggregation <a target="_self" href="api/sap.ui.layout.BlockLayoutRow#methods/getContent">content</a>.</p>
				 * @param {sap.ui.layout.BlockLayoutCell} oContent <p>The content to insert; if empty, nothing is inserted</p>
				 * @param {number} iIndex <p>The <code>0</code>-based index the content should be inserted at; for a negative value of <code>iIndex</code>, the content is inserted at position 0; for a value greater than the current size of the aggregation, the content is inserted at the last position</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				insertContent(oContent: sap.ui.layout.BlockLayoutCell, iIndex: number): this;
				/**
			...
			export class DynamicSideContent extends sap.ui.core.Control {
				...
				/**
				 * <p>Destroys all the sideContent in the aggregation <a target="_self" href="api/sap.ui.layout.DynamicSideContent#methods/getSideContent">sideContent</a>.</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				...
				/**
				 * <p>Returns the breakpoint for the current state of the control.</p><p>If the control is not rendered yet, this method will return <code>undefined</code>, as current break point calculation is based on the parent container width.</p>
				...
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.DynamicSideContent#methods/getSideContentPosition">sideContentPosition</a>.</p><p>Determines whether the side content is on the left or on the right side of the main content.</p><p>Default value is <code>End</code>.</p>
				...
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.DynamicSideContent#methods/getSideContentVisibility">sideContentVisibility</a>.</p><p>Determines on which breakpoints the side content is visible.</p><p>Default value is <code>ShowAboveS</code>.</p>
				...
				/**
				 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" href="api/sap.ui.layout.DynamicSideContent#methods/getSideContent">sideContent</a>. and returns its index if found or -1 otherwise.</p>
				...
				/**
				 * <p>Inserts a mainContent into the aggregation <a target="_self" href="api/sap.ui.layout.DynamicSideContent#methods/getMainContent">mainContent</a>.</p>
				...
				/**
				 * <p>Inserts a sideContent into the aggregation <a target="_self" href="api/sap.ui.layout.DynamicSideContent#methods/getSideContent">sideContent</a>.</p>
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setSideContentFallDown(sSideContentFallDown?: sap.ui.layout.SideContentFallDown): this;
				/**
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setSideContentPosition(sSideContentPosition?: sap.ui.layout.SideContentPosition): this;
				/**
			...
			export class FixFlex extends sap.ui.core.Control {
				...
				constructor(sId?: string, mSettings?: any);
				/**
				 * <p>Adds some fixContent to the aggregation <a target="_self" href="api/sap.ui.layout.FixFlex#methods/getFixContent">fixContent</a>.</p>
				 * @param {sap.ui.core.Control} oFixContent <p>The fixContent to add; if empty, nothing is inserted</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				addFixContent(oFixContent: sap.ui.core.Control): this;
				/**
				 * <p>Destroys all the fixContent in the aggregation <a target="_self" href="api/sap.ui.layout.FixFlex#methods/getFixContent">fixContent</a>.</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				destroyFixContent(): this;
				/**
				 * <p>Destroys the flexContent in the aggregation <a target="_self" href="api/sap.ui.layout.FixFlex#methods/getFlexContent">flexContent</a>.</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				...
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.FixFlex#methods/getFixFirst">fixFirst</a>.</p><p>Determines whether the fixed-size area should be on the beginning/top ( if the value is "true") or end/bottom ( if the value is "false").</p><p>Default value is <code>true</code>.</p>
				 * @returns boolean <p>Value of property <code>fixFirst</code></p>
				 */
				getFixFirst(): boolean;
				/**
				 * <p>Gets content of aggregation <a target="_self" href="api/sap.ui.layout.FixFlex#methods/getFlexContent">flexContent</a>.</p><p>Control in the stretching part of the layout.</p>
				 * @returns sap.ui.core.Control 
				 */
				...
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.FixFlex#methods/getVertical">vertical</a>.</p><p>Determines the direction of the layout of child elements. True for vertical and false for horizontal layout.</p><p>Default value is <code>true</code>.</p>
				 * @returns boolean <p>Value of property <code>vertical</code></p>
				 */
				getVertical(): boolean;
				/**
				 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" href="api/sap.ui.layout.FixFlex#methods/getFixContent">fixContent</a>. and returns its index if found or -1 otherwise.</p>
				...
				/**
				 * <p>Inserts a fixContent into the aggregation <a target="_self" href="api/sap.ui.layout.FixFlex#methods/getFixContent">fixContent</a>.</p>
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				insertFixContent(oFixContent: sap.ui.core.Control, iIndex: number): this;
				/**
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setFixContentSize(sFixContentSize?: sap.ui.core.CSSSize): this;
				/**
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setFixFirst(bFixFirst?: boolean): this;
				/**
				 * <p>Sets the aggregated <a target="_self" href="api/sap.ui.layout.FixFlex#methods/getFlexContent">flexContent</a>.</p>
				 * @param {sap.ui.core.Control} oFlexContent <p>The flexContent to set</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setFlexContent(oFlexContent: sap.ui.core.Control): this;
				/**
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setMinFlexSize(iMinFlexSize?: number): this;
				/**
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setVertical(bVertical?: boolean): this;
			}
			/**
			...
			export class Grid extends sap.ui.core.Control {
				...
				constructor(sId?: string, mSettings?: any);
				/**
				 * <p>Adds some ariaLabelledBy into the association <a target="_self" href="api/sap.ui.layout.Grid#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
				...
				/**
				 * <p>Adds some content to the aggregation <a target="_self" href="api/sap.ui.layout.Grid#methods/getContent">content</a>.</p>
				 * @param {sap.ui.core.Control} oContent <p>The content to add; if empty, nothing is inserted</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				addContent(oContent: sap.ui.core.Control): this;
				/**
				 * <p>Destroys all the content in the aggregation <a target="_self" href="api/sap.ui.layout.Grid#methods/getContent">content</a>.</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				destroyContent(): this;
				/**
				...
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.Grid#methods/getHSpacing">hSpacing</a>.</p><p>Optional. Defines the horizontal spacing between the content in the <code>Grid</code>. In rem, allowed values are 0, 0.5 , 1 or 2.</p><p>Default value is <code>1</code>.</p>
				 * @returns number <p>Value of property <code>hSpacing</code></p>
				 */
				getHSpacing(): number;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.Grid#methods/getPosition">position</a>.</p><p>Optional. Defines the position of the <code>Grid</code> in the window or surrounding container.</p><p>Default value is <code>"Left"</code>.</p>
				 * @returns sap.ui.layout.GridPosition <p>Value of property <code>position</code></p>
				 */
				getPosition(): sap.ui.layout.GridPosition;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.Grid#methods/getVSpacing">vSpacing</a>.</p><p>Optional. Defines the vertical spacing between the rows in the <code>Grid</code>. In rem, allowed values are 0, 0.5, 1 and 2.</p><p>Default value is <code>1</code>.</p>
				 * @returns number <p>Value of property <code>vSpacing</code></p>
				 */
				getVSpacing(): number;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.Grid#methods/getWidth">width</a>.</p><p>Optional. Defines the width of the <code>Grid</code>. If not specified, then 100%.</p><p>Default value is <code>'100%'</code>.</p>
				 * @returns sap.ui.core.CSSSize <p>Value of property <code>width</code></p>
				 */
				getWidth(): sap.ui.core.CSSSize;
				/**
				 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" href="api/sap.ui.layout.Grid#methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
				 * @param {sap.ui.core.Control} oContent <p>The content whose index is looked for</p>
				 * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
				 */
				indexOfContent(oContent: sap.ui.core.Control): number;
				/**
				 * <p>Inserts a content into the aggregation <a target="_self" href="api/sap.ui.layout.Grid#methods/getContent">content</a>.</p>
				 * @param {sap.ui.core.Control} oContent <p>The content to insert; if empty, nothing is inserted</p>
				 * @param {number} iIndex <p>The <code>0</code>-based index the content should be inserted at; for a negative value of <code>iIndex</code>, the content is inserted at position 0; for a value greater than the current size of the aggregation, the content is inserted at the last position</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setDefaultSpan(sDefaultSpan?: sap.ui.layout.GridSpan): this;
				/**
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setHSpacing(fHSpacing?: number): this;
				/**
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setPosition(sPosition?: sap.ui.layout.GridPosition): this;
				/**
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setVSpacing(fVSpacing?: number): this;
				/**
			...
			export class GridData extends sap.ui.core.LayoutData {
				...
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.GridData#methods/getIndentL">indentL</a>.</p><p>Optional. Defines an indent value for large screens. This value overwrites the value for large screens defined in the <code>indent</code> property.</p>
				 * @returns number <p>Value of property <code>indentL</code></p>
				 */
				getIndentL(): number;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.GridData#methods/getIndentM">indentM</a>.</p><p>Optional. Defines an indent value for medium size screens. This value overwrites the value for medium screens defined in the <code>indent</code> property.</p>
				 * @returns number <p>Value of property <code>indentM</code></p>
				 */
				getIndentM(): number;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.GridData#methods/getIndentS">indentS</a>.</p><p>Optional. Defines an indent value for small screens. This value overwrites the value for small screens defined in the <code>indent</code> property.</p>
				 * @returns number <p>Value of property <code>indentS</code></p>
				 */
				getIndentS(): number;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.GridData#methods/getIndentXL">indentXL</a>.</p><p>Optional. Defines an indent value for extra large screens. This value overwrites the value for extra large screens defined in the <code>indent</code> property.</p>
				...
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.GridData#methods/getMoveBackwards">moveBackwards</a>.</p><p>Optional. Moves a cell backwards with as many columns as specified.</p>
				 * @returns sap.ui.layout.GridIndent <p>Value of property <code>moveBackwards</code></p>
				 */
				getMoveBackwards(): sap.ui.layout.GridIndent;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.GridData#methods/getMoveForward">moveForward</a>.</p><p>Optional. Moves a cell forwards with as many columns as specified.</p>
				...
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.GridData#methods/getSpanL">spanL</a>.</p><p>Optional. Defines a span value for large screens. This value overwrites the value for large screens defined in the <code>span</code> property.</p>
				 * @returns number <p>Value of property <code>spanL</code></p>
				 */
				getSpanL(): number;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.GridData#methods/getSpanM">spanM</a>.</p><p>Optional. Defines a span value for medium size screens. This value overwrites the value for medium screens defined in the <code>span</code> property.</p>
				 * @returns number <p>Value of property <code>spanM</code></p>
				 */
				getSpanM(): number;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.GridData#methods/getSpanS">spanS</a>.</p><p>Optional. Defines a span value for small screens. This value overwrites the value for small screens defined in the <code>span</code> property.</p>
				 * @returns number <p>Value of property <code>spanS</code></p>
				 */
				getSpanS(): number;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.GridData#methods/getSpanXL">spanXL</a>.</p><p>Optional. Defines a span value for extra large screens. This value overwrites the value for extra large screens defined in the <code>span</code> property.</p>
				 * @returns number <p>Value of property <code>spanXL</code></p>
				 */
				getSpanXL(): number;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.GridData#methods/getVisibleL">visibleL</a>.</p><p>Defines if this control is visible on large screens.</p><p>Default value is <code>true</code>.</p>
				 * @returns boolean <p>Value of property <code>visibleL</code></p>
				 */
				getVisibleL(): boolean;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.GridData#methods/getVisibleM">visibleM</a>.</p><p>Defines if this control is visible on medium screens.</p><p>Default value is <code>true</code>.</p>
				 * @returns boolean <p>Value of property <code>visibleM</code></p>
				 */
				getVisibleM(): boolean;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.GridData#methods/getVisibleS">visibleS</a>.</p><p>Defines if this control is visible on small screens.</p><p>Default value is <code>true</code>.</p>
				 * @returns boolean <p>Value of property <code>visibleS</code></p>
				 */
				getVisibleS(): boolean;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.GridData#methods/getVisibleXL">visibleXL</a>.</p><p>Defines if this control is visible on extra Large screens.</p><p>Default value is <code>true</code>.</p>
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setIndent(sIndent?: sap.ui.layout.GridIndent): this;
				/**
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setIndentL(iIndentL?: number): this;
				/**
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setIndentM(iIndentM?: number): this;
				/**
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setIndentS(iIndentS?: number): this;
				/**
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setIndentXL(iIndentXL?: number): this;
				/**
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setMoveBackwards(sMoveBackwards?: sap.ui.layout.GridIndent): this;
				/**
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setSpan(sSpan?: sap.ui.layout.GridSpan): this;
				/**
			...
			export class HorizontalLayout extends sap.ui.core.Control {
				...
				constructor(sId?: string, mSettings?: any);
				/**
				 * <p>Adds some content to the aggregation <a target="_self" href="api/sap.ui.layout.HorizontalLayout#methods/getContent">content</a>.</p>
				 * @param {sap.ui.core.Control} oContent <p>The content to add; if empty, nothing is inserted</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				addContent(oContent: sap.ui.core.Control): this;
				/**
				 * <p>Destroys all the content in the aggregation <a target="_self" href="api/sap.ui.layout.HorizontalLayout#methods/getContent">content</a>.</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				destroyContent(): this;
				/**
				...
				indexOfContent(oContent: sap.ui.core.Control): number;
				/**
				 * <p>Inserts a content into the aggregation <a target="_self" href="api/sap.ui.layout.HorizontalLayout#methods/getContent">content</a>.</p>
				 * @param {sap.ui.core.Control} oContent <p>The content to insert; if empty, nothing is inserted</p>
				 * @param {number} iIndex <p>The <code>0</code>-based index the content should be inserted at; for a negative value of <code>iIndex</code>, the content is inserted at position 0; for a value greater than the current size of the aggregation, the content is inserted at the last position</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setAllowWrapping(bAllowWrapping?: boolean): this;
			}
			/**
			...
			export class PaneContainer extends sap.ui.core.Element {
				...
				constructor(sId?: string, mSettings?: any);
				/**
				 * <p>Adds some pane to the aggregation <a target="_self" href="api/sap.ui.layout.PaneContainer#methods/getPanes">panes</a>.</p>
				 * @param {sap.ui.core.Element} oPane <p>The pane to add; if empty, nothing is inserted</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				addPane(oPane: sap.ui.core.Element): this;
				/**
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				protected fireResize(mParameters?: any): this;
				/**
				 * <p>Getter for property layoutData.</p>
				 * @returns sap.ui.core.LayoutData <p>The LayoutData object.</p>
				 */
				getLayoutData(): sap.ui.core.LayoutData;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.PaneContainer#methods/getOrientation">orientation</a>.</p><p>The orientation of the Splitter</p><p>Default value is <code>Horizontal</code>.</p>
				 ...
				 * @returns this <p>this to allow method chaining.</p>
				 */
				setLayoutData(oLayoutData: sap.ui.core.LayoutData): this;
				/**
			...
			export class ResponsiveFlowLayout extends sap.ui.core.Control {
				...
				constructor(sId?: string, mSettings?: any);
				/**
				 * <p>Adds some ariaLabelledBy into the association <a target="_self" href="api/sap.ui.layout.ResponsiveFlowLayout#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
				 * @param {sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to add; if empty, nothing is inserted</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				addAriaLabelledBy(vAriaLabelledBy: sap.ui.core.ID | sap.ui.core.Control): this;
				...
				/**
				 * <p>Destroys all the content in the aggregation <a target="_self" href="api/sap.ui.layout.ResponsiveFlowLayout#methods/getContent">content</a>.</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				destroyContent(): this;
				/**
				...
				/**
				 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" href="api/sap.ui.layout.ResponsiveFlowLayout#methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
				 * @param {sap.ui.core.Control} oContent <p>The content whose index is looked for</p>
				 * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
				 */
				indexOfContent(oContent: sap.ui.core.Control): number;
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setResponsive(bResponsive?: boolean): this;
			}
			/**
			...
			export class ResponsiveFlowLayoutData extends sap.ui.core.LayoutData {
				...
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.ResponsiveFlowLayoutData#methods/getMargin">margin</a>.</p><p>Prevents any margin of the element if set to false.</p><p>Default value is <code>true</code>.</p>
				 * @returns boolean <p>Value of property <code>margin</code></p>
				 */
				getMargin(): boolean;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.ResponsiveFlowLayoutData#methods/getMinWidth">minWidth</a>.</p><p>Defines the minimal size in px of a ResponsiveFlowLayout element. The element will be shrunk down to this value.</p><p>Default value is <code>100</code>.</p>
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setLinebreakable(bLinebreakable?: boolean): this;
				/**
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setMargin(bMargin?: boolean): this;
				/**
			...
			export class ResponsiveSplitter extends sap.ui.core.Control {
				...
				constructor(sId?: string, mSettings?: any);
				/**
				 * <p>Destroys the rootPaneContainer in the aggregation <a target="_self" href="api/sap.ui.layout.ResponsiveSplitter#methods/getRootPaneContainer">rootPaneContainer</a>.</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				...
				/**
				 * <p>Gets content of aggregation <a target="_self" href="api/sap.ui.layout.ResponsiveSplitter#methods/getRootPaneContainer">rootPaneContainer</a>.</p><p>The root PaneContainer of the ResponsiveSplitter</p>
				 * @returns sap.ui.layout.PaneContainer 
				 */
				getRootPaneContainer(): sap.ui.layout.PaneContainer;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.ResponsiveSplitter#methods/getWidth">width</a>.</p><p>The width of the control</p><p>Default value is <code>'100%'</code>.</p>
				 * @returns sap.ui.core.CSSSize <p>Value of property <code>width</code></p>
				 */
				getWidth(): sap.ui.core.CSSSize;
				/**
				 * <p>Sets the associated <a target="_self" href="api/sap.ui.layout.ResponsiveSplitter#methods/getDefaultPane">defaultPane</a>.</p>
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setDefaultPane(oDefaultPane: sap.ui.core.ID | sap.ui.layout.SplitPane): this;
				/**
				...
				/**
				 * <p>Sets the aggregated <a target="_self" href="api/sap.ui.layout.ResponsiveSplitter#methods/getRootPaneContainer">rootPaneContainer</a>.</p>
				 * @param {sap.ui.layout.PaneContainer} oRootPaneContainer <p>The rootPaneContainer to set</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setRootPaneContainer(oRootPaneContainer: sap.ui.layout.PaneContainer): this;
				/**
				 * <p>Sets a new value for property <a target="_self" href="api/sap.ui.layout.ResponsiveSplitter#methods/getWidth">width</a>.</p><p>The width of the control</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>'100%'</code>.</p>
				 * @param {sap.ui.core.CSSSize} sWidth <p>New value for property <code>width</code></p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setWidth(sWidth?: sap.ui.core.CSSSize): this;
			...
			export class SplitPane extends sap.ui.core.Element {
				...
				constructor(sId?: string, mSettings?: any);
				/**
				 * <p>Destroys the content in the aggregation <a target="_self" href="api/sap.ui.layout.SplitPane#methods/getContent">content</a>.</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				destroyContent(): this;
				/**
				 * <p>Gets content of aggregation <a target="_self" href="api/sap.ui.layout.SplitPane#methods/getContent">content</a>.</p><p>Content of the SplitPane</p>
				 * @returns sap.ui.core.Control 
				 */
				getContent(): sap.ui.core.Control;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.SplitPane#methods/getDemandPane">demandPane</a>.</p><p>Determines whether the pane will be moved to the pagination</p><p>Default value is <code>true</code>.</p>
				 * @returns boolean <p>Value of property <code>demandPane</code></p>
				 */
				getDemandPane(): boolean;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.SplitPane#methods/getRequiredParentWidth">requiredParentWidth</a>.</p><p>Determines the minimum width of the ResponsiveSplitter(in pixels). When it is reached the pane will be hidden from the screen.</p><p>When you are calculating the required parent width to fit your panes, you should also include the width of all split bars between these panes.</p><p>Default value is <code>800</code>.</p>
				 * @returns number <p>Value of property <code>requiredParentWidth</code></p>
				 */
				getRequiredParentWidth(): number;
				/**
				 * <p>Sets the aggregated <a target="_self" href="api/sap.ui.layout.SplitPane#methods/getContent">content</a>.</p>
			...
			export class Splitter extends sap.ui.core.Control {
				...
				constructor(sId?: string, mSettings?: any);
				/**
				 * <p>Adds some contentArea to the aggregation <a target="_self" href="api/sap.ui.layout.Splitter#methods/getContentAreas">contentAreas</a>.</p>
				 * @param {sap.ui.core.Control} oContentArea <p>The contentArea to add; if empty, nothing is inserted</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				addContentArea(oContentArea: sap.ui.core.Control): this;
				/**
				...
				/**
				 * <p>Fires event <a target="_self" href="api/sap.ui.layout.Splitter#events/resize">resize</a> to attached listeners.</p>
				 * @param {any} mParameters <p>Parameters to pass along with the event</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				protected fireResize(mParameters?: any): this;
				...
				getHeight(): sap.ui.core.CSSSize;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.Splitter#methods/getOrientation">orientation</a>.</p><p>Whether to split the contents horizontally (default) or vertically.</p><p>Default value is <code>Horizontal</code>.</p>
				 * @returns sap.ui.core.Orientation <p>Value of property <code>orientation</code></p>
				 */
				getOrientation(): sap.ui.core.Orientation;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.Splitter#methods/getWidth">width</a>.</p><p>The width of the control</p><p>Default value is <code>'100%'</code>.</p>
				 * @returns sap.ui.core.CSSSize <p>Value of property <code>width</code></p>
				 */
				getWidth(): sap.ui.core.CSSSize;
				/**
				 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" href="api/sap.ui.layout.Splitter#methods/getContentAreas">contentAreas</a>. and returns its index if found or -1 otherwise.</p>
				...
				/**
				 * <p>Inserts a contentArea into the aggregation <a target="_self" href="api/sap.ui.layout.Splitter#methods/getContentAreas">contentAreas</a>.</p>
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				insertContentArea(oContentArea: sap.ui.core.Control, iIndex: number): this;
				/**
				...
				/**
				 * <p>Sets a new value for property <a target="_self" href="api/sap.ui.layout.Splitter#methods/getHeight">height</a>.</p><p>The height of the control</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>'100%'</code>.</p>
				 * @param {sap.ui.core.CSSSize} sHeight <p>New value for property <code>height</code></p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setHeight(sHeight?: sap.ui.core.CSSSize): this;
				...
				setOrientation(sOrientation?: sap.ui.core.Orientation): this;
				/**
				 * <p>Sets a new value for property <a target="_self" href="api/sap.ui.layout.Splitter#methods/getWidth">width</a>.</p><p>The width of the control</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>'100%'</code>.</p>
				 * @param {sap.ui.core.CSSSize} sWidth <p>New value for property <code>width</code></p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setWidth(sWidth?: sap.ui.core.CSSSize): this;
			...
			export class SplitterLayoutData extends sap.ui.core.LayoutData {
				...
				constructor(sId?: string, mSettings?: any);
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.SplitterLayoutData#methods/getMinSize">minSize</a>.</p><p>Sets the minimum size of the splitter content in px.</p><p>Default value is <code>0</code>.</p>
				 * @returns number <p>Value of property <code>minSize</code></p>
				 */
				getMinSize(): number;
				/**
				 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.SplitterLayoutData#methods/getResizable">resizable</a>.</p><p>Determines whether the control in the splitter can be resized or not.</p><p>Default value is <code>true</code>.</p>
				 ...
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				setMinSize(iMinSize?: number): this;
				/**
			...
			export class VerticalLayout extends sap.ui.core.Control {
				...
				constructor(sId?: string, mSettings?: any);
				/**
				 * <p>Adds some content to the aggregation <a target="_self" href="api/sap.ui.layout.VerticalLayout#methods/getContent">content</a>.</p>
				 * @param {sap.ui.core.Control} oContent <p>The content to add; if empty, nothing is inserted</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				addContent(oContent: sap.ui.core.Control): this;
				/**
				 * <p>Destroys all the content in the aggregation <a target="_self" href="api/sap.ui.layout.VerticalLayout#methods/getContent">content</a>.</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
				destroyContent(): this;
				/**
				...
				getWidth(): sap.ui.core.CSSSize;
				/**
				 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" href="api/sap.ui.layout.VerticalLayout#methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
				 * @param {sap.ui.core.Control} oContent <p>The content whose index is looked for</p>
				 * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
				 */
				indexOfContent(oContent: sap.ui.core.Control): number;
				/**
				 * <p>Inserts a content into the aggregation <a target="_self" href="api/sap.ui.layout.VerticalLayout#methods/getContent">content</a>.</p>
				 * @param {sap.ui.core.Control} oContent <p>The content to insert; if empty, nothing is inserted</p>
				 * @param {number} iIndex <p>The <code>0</code>-based index the content should be inserted at; for a negative value of <code>iIndex</code>, the content is inserted at position 0; for a value greater than the current size of the aggregation, the content is inserted at the last position</p>
				 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
				 */
...
declare namespace sap {
	namespace ui {
		namespace layout {
			namespace cssgrid {
				/**
				 * <p><p>A string type that represents a short hand CSS grid gap.</p><br><br>References: <ul><li><a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/CSS/gap">https://developer.mozilla.org/en-US/docs/Web/CSS/gap</a>
...
declare namespace sap {
	namespace ui {
		namespace layout {
			namespace cssgrid {
				/**
				 * <p><p>A string type that represents one or two grid lines. Used to define the position and size of a single grid item.</p><p>Valid values: <ul> <li>auto</li> <li>inherit</li> <li>1</li> <li>span 2</li> <li>span 2 / 5</li> <li>span 2 / -5</li> <li>5 / 7</li> <li>7 / span 5</li> <li>span 7 / span 5</li> </ul></p><br><br>References: <ul><li><a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Glossary/Grid_lines">MDN web docs: grid lines</a>
							<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
							title="Information published on non SAP site" class="sapUISDKExternalLink"/></li></ul></p>
				 */
...
declare namespace sap {
	namespace ui {
		namespace layout {
			namespace cssgrid {
				/**
				 * <p><p>A string type that represents a grid track (the space between two grid lines)</p><br><br>References: <ul><li><a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Glossary/Grid_tracks">https://developer.mozilla.org/en-US/docs/Glossary/Grid_tracks</a>
							<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
							title="Information published on non SAP site" class="sapUISDKExternalLink"/></li></ul></p>
				 */
		...
		namespace layout {
			...
			namespace cssgrid {
				...
				export class CSSGrid extends sap.ui.core.Control implements sap.ui.layout.cssgrid.IGridConfigurable {
					...
					constructor(sId?: string, mSettings?: any);
					/**
					 * <p>Adds some item to the aggregation <a target="_self" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getItems">items</a>.</p>
					 * @param {sap.ui.core.Control} oItem <p>The item to add; if empty, nothing is inserted</p>
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					addItem(oItem: sap.ui.core.Control): this;
					/**
					 * <p>Destroys the customLayout in the aggregation <a target="_self" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getCustomLayout">customLayout</a>.</p>
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					destroyCustomLayout(): this;
					/**
					 * <p>Destroys all the items in the aggregation <a target="_self" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getItems">items</a>.</p>
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					destroyItems(): this;
					/**
					 * <p>Gets content of aggregation <a target="_self" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getCustomLayout">customLayout</a>.</p><p>Defines a custom Grid layout for the control. If provided, it will override all of the grid properties.</p>
					 * @returns sap.ui.layout.cssgrid.GridLayoutBase 
					 */
					getCustomLayout(): sap.ui.layout.cssgrid.GridLayoutBase;
					/**
					 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getGridAutoColumns">gridAutoColumns</a>.</p><p>Sets the value for the CSS display:grid property <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-auto-columns">MDN web docs: grid-auto-columns</a>
								<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
					...
					/**
					 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getGridAutoFlow">gridAutoFlow</a>.</p><p>Sets the value for the CSS display:grid property <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-auto-flow">MDN web docs: grid-auto-flow</a>
								<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
								title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p>Default value is <code>"Row"</code>.</p>
					...
					/**
					 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getGridAutoRows">gridAutoRows</a>.</p><p>Sets the value for the CSS display:grid property <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-auto-rows">MDN web docs: grid-auto-rows</a>
								<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
								title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p>Default value is <code>empty string</code>.</p>
					...
					/**
					 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getGridColumnGap">gridColumnGap</a>.</p><p>Sets the value for the CSS display:grid property <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-column-gap">MDN web docs: grid-column-gap</a>
								<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
								title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p>Default value is <code>empty string</code>.</p>
					 ...
					 */
					protected getGridLayoutConfiguration(): sap.ui.layout.cssgrid.GridBasicLayout;
					/**
					...
					/**
					 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getGridTemplateColumns">gridTemplateColumns</a>.</p><p>Sets the value for the CSS display:grid property <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-template-columns">MDN web docs: grid-template-columns</a>
								<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
								title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p>Default value is <code>empty string</code>.</p>
					...
					/**
					 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getGridTemplateRows">gridTemplateRows</a>.</p><p>Sets the value for the CSS display:grid property <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-template-rows">MDN web docs: grid-template-rows</a>
								<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
								title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p>Default value is <code>empty string</code>.</p>
					...
					getWidth(): sap.ui.core.CSSSize;
					/**
					 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getItems">items</a>. and returns its index if found or -1 otherwise.</p>
					 * @param {sap.ui.core.Control} oItem <p>The item whose index is looked for</p>
					 * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
					 */
					indexOfItem(oItem: sap.ui.core.Control): number;
					/**
					 * <p>Inserts a item into the aggregation <a target="_self" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getItems">items</a>.</p>
					...
					/**
					 * <p>Sets the aggregated <a target="_self" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getCustomLayout">customLayout</a>.</p>
					 ...
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					setGridAutoColumns(sGridAutoColumns?: sap.ui.layout.cssgrid.CSSGridTrack): this;
					/**
					 * <p>Sets a new value for property <a target="_self" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getGridAutoFlow">gridAutoFlow</a>.</p><p>Sets the value for the CSS display:grid property <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-auto-flow">MDN web docs: grid-auto-flow</a>
								<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
								title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>"Row"</code>.</p>
					 * @param {sap.ui.layout.cssgrid.CSSGridAutoFlow} sGridAutoFlow <p>New value for property <code>gridAutoFlow</code></p>
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					setGridAutoFlow(sGridAutoFlow?: sap.ui.layout.cssgrid.CSSGridAutoFlow): this;
					/**
					 * <p>Sets a new value for property <a target="_self" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getGridAutoRows">gridAutoRows</a>.</p><p>Sets the value for the CSS display:grid property <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-auto-rows">MDN web docs: grid-auto-rows</a>
								<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
								title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>empty string</code>.</p>
					 ...
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					setGridAutoRows(sGridAutoRows?: sap.ui.layout.cssgrid.CSSGridTrack): this;
					/**
					 * <p>Sets a new value for property <a target="_self" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getGridColumnGap">gridColumnGap</a>.</p><p>Sets the value for the CSS display:grid property <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-column-gap">MDN web docs: grid-column-gap</a>
								<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
								title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>empty string</code>.</p>
					 ...
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					setGridColumnGap(sGridColumnGap?: sap.ui.core.CSSSize): this;
					/**
					 ...
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					setGridRowGap(sGridRowGap?: sap.ui.core.CSSSize): this;
					/**
					 * <p>Sets a new value for property <a target="_self" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getGridTemplateColumns">gridTemplateColumns</a>.</p><p>Sets the value for the CSS display:grid property <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-template-columns">MDN web docs: grid-template-columns</a>
								<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
								title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>empty string</code>.</p>
					 ...
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					setGridTemplateColumns(sGridTemplateColumns?: sap.ui.layout.cssgrid.CSSGridTrack): this;
					/**
					 * <p>Sets a new value for property <a target="_self" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getGridTemplateRows">gridTemplateRows</a>.</p><p>Sets the value for the CSS display:grid property <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-template-rows">MDN web docs: grid-template-rows</a>
								<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
								title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>empty string</code>.</p>
					 ...
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					setGridTemplateRows(sGridTemplateRows?: sap.ui.layout.cssgrid.CSSGridTrack): this;
					/**
					 * <p>Sets a new value for property <a target="_self" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getWidth">width</a>.</p><p>The width of the control</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>"100%"</code>.</p>
					 * @param {sap.ui.core.CSSSize} sWidth <p>New value for property <code>width</code></p>
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					setWidth(sWidth?: sap.ui.core.CSSSize): this;
				...
				export class GridBoxLayout extends sap.ui.layout.cssgrid.GridLayoutBase {
					...
					/**
					 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.cssgrid.GridBoxLayout#methods/getBoxesPerRowConfig">boxesPerRowConfig</a>.</p><p>A string type that defines number of Boxes per row for extra large, large, medium and small screens</p><p><b>Note:</b> When the property <code>boxMinWidth</code> or <code>boxWidth</code> is set this property has no effect.</p><p>Default value is <code>"XL7 L6 M4 S2"</code>.</p>
					...
					/**
					 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.cssgrid.GridBoxLayout#methods/getBoxMinWidth">boxMinWidth</a>.</p><p>Defines the minimum width of the Boxes</p><p>Default value is <code>empty string</code>.</p>
					 * @returns sap.ui.core.CSSSize <p>Value of property <code>boxMinWidth</code></p>
					 */
					getBoxMinWidth(): sap.ui.core.CSSSize;
					/**
					 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.cssgrid.GridBoxLayout#methods/getBoxWidth">boxWidth</a>.</p><p>Defines the width of the Boxes</p><p>Default value is <code>empty string</code>.</p>
					...
					isResponsive(): boolean;
					/**
					 * <p>Sets a new value for property <a target="_self" href="api/sap.ui.layout.cssgrid.GridBoxLayout#methods/getBoxesPerRowConfig">boxesPerRowConfig</a>.</p><p>A string type that defines number of Boxes per row for extra large, large, medium and small screens</p><p><b>Note:</b> When the property <code>boxMinWidth</code> or <code>boxWidth</code> is set this property has no effect.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>"XL7 L6 M4 S2"</code>.</p>
					 * @param {sap.ui.layout.BoxesPerRowConfig} sBoxesPerRowConfig <p>New value for property <code>boxesPerRowConfig</code></p>
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					setBoxesPerRowConfig(sBoxesPerRowConfig?: sap.ui.layout.BoxesPerRowConfig): this;
					/**
					 ...
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					setBoxMinWidth(sBoxMinWidth?: sap.ui.core.CSSSize): this;
					/**
					 ...
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					setBoxWidth(sBoxWidth?: sap.ui.core.CSSSize): this;
				}
				/**
				 * <p>Holds layout data for a grid item.</p>
				 */
				export class GridItemLayoutData extends sap.ui.core.LayoutData implements sap.ui.layout.cssgrid.IGridItemLayoutData {
					/**
					...
					constructor(sId?: string, mSettings?: any);
					/**
					 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.cssgrid.GridItemLayoutData#methods/getGridColumn">gridColumn</a>.</p><p>Sets the value for the CSS display:grid item property grid-column <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-column">MDN web docs: grid-column</a>
								<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
								title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p>Default value is <code>empty string</code>.</p>
					...
					/**
					 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.cssgrid.GridItemLayoutData#methods/getGridColumnEnd">gridColumnEnd</a>.</p><p>Sets the value for the CSS display:grid item property grid-column-end <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-column-end">MDN web docs: grid-column-end</a>
								<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
								title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p>Default value is <code>empty string</code>.</p>
					...
					/**
					 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.cssgrid.GridItemLayoutData#methods/getGridColumnStart">gridColumnStart</a>.</p><p>Sets the value for the CSS display:grid item property grid-column-start <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-column-start">MDN web docs: grid-column-start</a>
								<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
								title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p>Default value is <code>empty string</code>.</p>
					...
					/**
					 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.cssgrid.GridItemLayoutData#methods/getGridRow">gridRow</a>.</p><p>Sets the value for the CSS display:grid item property grid-row <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-row">MDN web docs: grid-row</a>
								<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
								title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p>Default value is <code>empty string</code>.</p>
					...
					/**
					 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.cssgrid.GridItemLayoutData#methods/getGridRowEnd">gridRowEnd</a>.</p><p>Sets the value for the CSS display:grid item property grid-row-end <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-row-end">MDN web docs: grid-row-end</a>
								<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
								title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p>Default value is <code>empty string</code>.</p>
					...
					/**
					 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.cssgrid.GridItemLayoutData#methods/getGridRowStart">gridRowStart</a>.</p><p>Sets the value for the CSS display:grid item property grid-row-start <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-row-start">MDN web docs: grid-row-start</a>
								<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
								title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p>Default value is <code>empty string</code>.</p>
					 ...
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					setGridColumn(sGridColumn?: sap.ui.layout.cssgrid.CSSGridLine): this;
					/**
					 * <p>Sets a new value for property <a target="_self" href="api/sap.ui.layout.cssgrid.GridItemLayoutData#methods/getGridColumnEnd">gridColumnEnd</a>.</p><p>Sets the value for the CSS display:grid item property grid-column-end <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-column-end">MDN web docs: grid-column-end</a>
								<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
								title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>empty string</code>.</p>
					 ...
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					setGridColumnEnd(sGridColumnEnd?: sap.ui.layout.cssgrid.CSSGridLine): this;
					/**
					 * <p>Sets a new value for property <a target="_self" href="api/sap.ui.layout.cssgrid.GridItemLayoutData#methods/getGridColumnStart">gridColumnStart</a>.</p><p>Sets the value for the CSS display:grid item property grid-column-start <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-column-start">MDN web docs: grid-column-start</a>
								<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
								title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>empty string</code>.</p>
					 ...
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					setGridColumnStart(sGridColumnStart?: sap.ui.layout.cssgrid.CSSGridLine): this;
					/**
					 * <p>Sets a new value for property <a target="_self" href="api/sap.ui.layout.cssgrid.GridItemLayoutData#methods/getGridRow">gridRow</a>.</p><p>Sets the value for the CSS display:grid item property grid-row <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-row">MDN web docs: grid-row</a>
								<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
								title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>empty string</code>.</p>
					 ...
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					setGridRow(sGridRow?: sap.ui.layout.cssgrid.CSSGridLine): this;
					/**
					 * <p>Sets a new value for property <a target="_self" href="api/sap.ui.layout.cssgrid.GridItemLayoutData#methods/getGridRowEnd">gridRowEnd</a>.</p><p>Sets the value for the CSS display:grid item property grid-row-end <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-row-end">MDN web docs: grid-row-end</a>
								<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
								title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>empty string</code>.</p>
					 ...
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					setGridRowEnd(sGridRowEnd?: sap.ui.layout.cssgrid.CSSGridLine): this;
					/**
					 * <p>Sets a new value for property <a target="_self" href="api/sap.ui.layout.cssgrid.GridItemLayoutData#methods/getGridRowStart">gridRowStart</a>.</p><p>Sets the value for the CSS display:grid item property grid-row-start <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-row-start">MDN web docs: grid-row-start</a>
								<img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
								title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>empty string</code>.</p>
					 ...
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					setGridRowStart(sGridRowStart?: sap.ui.layout.cssgrid.CSSGridLine): this;
				}
				/**
				 * <p>Applies a sap.ui.layout.cssgrid.GridSettings to a provided DOM element or Control.</p>
				 */
				export abstract class GridLayoutBase extends sap.ui.base.ManagedObject {
					...
					isResponsive(): boolean;
					/**
					 * <p>Hook function for the Grid's onAfterRendering</p>
					 * @param {sap.ui.layout.cssgrid.IGridConfigurable} oGrid <p>The grid</p>
					 */
					protected onGridAfterRendering(oGrid: sap.ui.layout.cssgrid.IGridConfigurable): void;
					/**
					 * <p>Hook function for the Grid's resize. Will be called if the grid layout is responsive.</p>
					 * @param {any} oEvent <p>The event passed by the resize handler</p>
					 */
					protected onGridResize(oEvent: any): void;
				}
				/**
				...
				export class GridResponsiveLayout extends sap.ui.layout.cssgrid.GridLayoutBase {
					...
					destroyLayout(): this;
					/**
					 * <p>Destroys the layoutL in the aggregation <a target="_self" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutL">layoutL</a>.</p>
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					destroyLayoutL(): this;
					/**
					 * <p>Destroys the layoutM in the aggregation <a target="_self" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutM">layoutM</a>.</p>
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					destroyLayoutM(): this;
					/**
					 * <p>Destroys the layoutS in the aggregation <a target="_self" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutS">layoutS</a>.</p>
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					destroyLayoutS(): this;
					/**
					 * <p>Destroys the layoutXL in the aggregation <a target="_self" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutXL">layoutXL</a>.</p>
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					...
					getContainerQuery(): boolean;
					/**
					 * <p>Gets content of aggregation <a target="_self" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayout">layout</a>.</p><p>The sap.ui.layout.cssgrid.GridSettings applied if no settings are provided for a specific size</p>
					 * @returns sap.ui.layout.cssgrid.GridSettings 
					 */
					getLayout(): sap.ui.layout.cssgrid.GridSettings;
					/**
					 * <p>Gets content of aggregation <a target="_self" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutL">layoutL</a>.</p><p>The sap.ui.layout.cssgrid.GridSettings applied for size "L"</p>
					 * @returns sap.ui.layout.cssgrid.GridSettings 
					 */
					getLayoutL(): sap.ui.layout.cssgrid.GridSettings;
					/**
					 * <p>Gets content of aggregation <a target="_self" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutM">layoutM</a>.</p><p>The sap.ui.layout.cssgrid.GridSettings applied for size "M"</p>
					 * @returns sap.ui.layout.cssgrid.GridSettings 
					 */
					getLayoutM(): sap.ui.layout.cssgrid.GridSettings;
					/**
					 * <p>Gets content of aggregation <a target="_self" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutS">layoutS</a>.</p><p>The sap.ui.layout.cssgrid.GridSettings applied for size "S"</p>
					 * @returns sap.ui.layout.cssgrid.GridSettings 
					 */
					getLayoutS(): sap.ui.layout.cssgrid.GridSettings;
					/**
					 * <p>Gets content of aggregation <a target="_self" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutXL">layoutXL</a>.</p><p>The sap.ui.layout.cssgrid.GridSettings applied for size "XL"</p>
					 * @returns sap.ui.layout.cssgrid.GridSettings 
					 */
					...
					setContainerQuery(bContainerQuery?: boolean): this;
					/**
					 * <p>Sets the aggregated <a target="_self" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayout">layout</a>.</p>
					 * @param {sap.ui.layout.cssgrid.GridSettings} oLayout <p>The layout to set</p>
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					setLayout(oLayout: sap.ui.layout.cssgrid.GridSettings): this;
					/**
					 * <p>Sets the aggregated <a target="_self" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutL">layoutL</a>.</p>
					 * @param {sap.ui.layout.cssgrid.GridSettings} oLayoutL <p>The layoutL to set</p>
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					setLayoutL(oLayoutL: sap.ui.layout.cssgrid.GridSettings): this;
					/**
					 * <p>Sets the aggregated <a target="_self" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutM">layoutM</a>.</p>
					 * @param {sap.ui.layout.cssgrid.GridSettings} oLayoutM <p>The layoutM to set</p>
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					setLayoutM(oLayoutM: sap.ui.layout.cssgrid.GridSettings): this;
					/**
					 * <p>Sets the aggregated <a target="_self" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutS">layoutS</a>.</p>
					 * @param {sap.ui.layout.cssgrid.GridSettings} oLayoutS <p>The layoutS to set</p>
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					setLayoutS(oLayoutS: sap.ui.layout.cssgrid.GridSettings): this;
					/**
					 * <p>Sets the aggregated <a target="_self" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutXL">layoutXL</a>.</p>
					 * @param {sap.ui.layout.cssgrid.GridSettings} oLayoutXL <p>The layoutXL to set</p>
					 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
					 */
					setLayoutXL(oLayoutXL: sap.ui.layout.cssgrid.GridSettings): this;
				}
				/**
				...
				/**
				 * <p><p>LayoutData for grid items</p></p>
				 */
				...
				export class ResponsiveColumnItemLayoutData extends sap.ui.core.LayoutData {
					...
					constructor(sId?: string, mSettings?: any);
					/**
					 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.cssgrid.ResponsiveColumnItemLayoutData#methods/getColumns">columns</a>.</p><p>Specifies the number of columns, which the item should take.</p><p>Default value is <code>1</code>.</p>
					 * @returns number <p>Value of property <code>columns</code></p>
					 */
					getColumns(): number;
					/**
					 * <p>Gets current value of property <a target="_self" href="api/sap.ui.layout.cssgrid.ResponsiveColumnItemLayoutData#methods/getRows">rows</a>.</p><p>Specifies the number of rows, which the item should take.</p><p>Default value is <code>1</code>.</p>
