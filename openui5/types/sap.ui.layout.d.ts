...
declare namespace sap {
    namespace ui {
        /**
         * <p><p>SAPUI5 library with layout controls.</p></p>
         */
        namespace layout {
            /**
            ...
            export class BlockLayout extends sap.ui.core.Control {
                ...
                /**
                 * <p>Adds some content to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.BlockLayout#methods/getContent">content</a>.</p>
                ...
                /**
                 * <p>Destroys all the content in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.BlockLayout#methods/getContent">content</a>.</p>
                 * @returns sap.ui.layout.BlockLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.BlockLayout#methods/getContent">content</a>.</p><p>The Rows to be included in the content of the control</p>
                 * @returns sap.ui.layout.BlockLayoutRow[] 
                 */
                getContent(): sap.ui.layout.BlockLayoutRow[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getKeepFontSize" href="api/sap.ui.layout.BlockLayout#methods/getKeepFontSize">keepFontSize</a>.</p><p>Keeps the font-size of the contents as is, independent from the screen size.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>keepFontSize</code></p>
                 */
                getKeepFontSize(): boolean;
                /**
                 * <p>Checks for the provided <code>sap.ui.layout.BlockLayoutRow</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.BlockLayout#methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Inserts a content into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.BlockLayout#methods/getContent">content</a>.</p>
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.BlockLayout#methods/getContent">content</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                ...
                /**
                 * <p>Removes a content from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.BlockLayout#methods/getContent">content</a>.</p>
            ...
            export class BlockLayoutCell extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some content to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.BlockLayoutCell#methods/getContent">content</a>.</p>
                ...
                /**
                 * <p>Destroys all the content in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.BlockLayoutCell#methods/getContent">content</a>.</p>
                 * @returns sap.ui.layout.BlockLayoutCell <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyContent(): sap.ui.layout.BlockLayoutCell;
                /**
                 * <p>Destroys the titleLink in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getTitleLink" href="api/sap.ui.layout.BlockLayoutCell#methods/getTitleLink">titleLink</a>.</p>
                 * @returns sap.ui.layout.BlockLayoutCell <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyTitleLink(): sap.ui.layout.BlockLayoutCell;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getBackgroundColorSet" href="api/sap.ui.layout.BlockLayoutCell#methods/getBackgroundColorSet">backgroundColorSet</a>.</p><p>The Background color set from which the background color will be selected. By using background colors from the predefined sets your colors could later be customized from the Theme Designer. <b>Note:</b> backgroundColorSet should be used only in combination with backgroundColorShade.</p>
                ...
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getBackgroundColorShade" href="api/sap.ui.layout.BlockLayoutCell#methods/getBackgroundColorShade">backgroundColorShade</a>.</p><p>The index of the background color in the color set from which the color will be selected. By using background colors from the predefined sets your colors could later be customized from the Theme Designer. <b>Note:</b> backgroundColorShade should be used only in combination with backgroundColorSet.</p>
                ...
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.BlockLayoutCell#methods/getContent">content</a>.</p><p>The content to be included inside the cell</p>
                 * @returns sap.ui.core.Control[] 
                 */
                getContent(): sap.ui.core.Control[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getTitle" href="api/sap.ui.layout.BlockLayoutCell#methods/getTitle">title</a>.</p><p>Defines the title of the cell. <b>Note:</b> When the <code>titleLink</code> aggregation is provided, the title of the cell will be replaced with the text from the <code>titleLink</code>.</p>
                ...
                /**
                 * <p>Inserts a content into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.BlockLayoutCell#methods/getContent">content</a>.</p>
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.BlockLayoutCell#methods/getContent">content</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllContent(): sap.ui.core.Control[];
                /**
                 * <p>Removes a content from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.BlockLayoutCell#methods/getContent">content</a>.</p>
                ...
                /**
                 * <p>Sets the Width.</p>
                 * @param {number} iWidth <p>value.</p>
                 * @returns sap.ui.layout.BlockLayoutCell <p>this BlockLayoutCell reference for chaining.</p>
                 */
            ...
            export enum BlockLayoutCellColorShade {
                ...
                ShadeD = "ShadeD",
                /**
                 * <p>Shade E - available only for Fiori 3 theme</p>
                 */
                ShadeE = "ShadeE",
                /**
                 * <p>Shade F - available only for Fiori 3 theme</p>
                 */
                ShadeF = "ShadeF",
            }
            /**
            ...
            export class BlockLayoutCellData extends sap.ui.core.LayoutData {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getLSize" href="api/sap.ui.layout.BlockLayoutCellData#methods/getLSize">lSize</a>.</p><p>Sets the width of the cell for L size of the BlockLayout.</p><p>Default value is <code>1</code>.</p>
                 * @returns number <p>Value of property <code>lSize</code></p>
                 */
                getLSize(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMSize" href="api/sap.ui.layout.BlockLayoutCellData#methods/getMSize">mSize</a>.</p><p>Sets the width of the cell for M size of the BlockLayout.</p><p>Default value is <code>1</code>.</p>
                 * @returns number <p>Value of property <code>mSize</code></p>
                 */
                getMSize(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSSize" href="api/sap.ui.layout.BlockLayoutCellData#methods/getSSize">sSize</a>.</p><p>Sets the width of the cell for S size of the BlockLayout.</p><p>Default value is <code>1</code>.</p>
                 * @returns number <p>Value of property <code>sSize</code></p>
                 */
                getSSize(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getXlSize" href="api/sap.ui.layout.BlockLayoutCellData#methods/getXlSize">xlSize</a>.</p><p>Sets the width of the cell for XL size of the BlockLayout.</p><p>Default value is <code>1</code>.</p>
                 * @returns number <p>Value of property <code>xlSize</code></p>
                 */
                getXlSize(): number;
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getLSize" href="api/sap.ui.layout.BlockLayoutCellData#methods/getLSize">lSize</a>.</p><p>Sets the width of the cell for L size of the BlockLayout.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>1</code>.</p>
            ...
            export class BlockLayoutRow extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some accentCell into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAccentCells" href="api/sap.ui.layout.BlockLayoutRow#methods/getAccentCells">accentCells</a>.</p>
                ...
                /**
                 * <p>Adds some content to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.BlockLayoutRow#methods/getContent">content</a>.</p>
                ...
                /**
                 * <p>Destroys all the content in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.BlockLayoutRow#methods/getContent">content</a>.</p>
                 * @returns sap.ui.layout.BlockLayoutRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyContent(): sap.ui.layout.BlockLayoutRow;
                /**
                 * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAccentCells" href="api/sap.ui.layout.BlockLayoutRow#methods/getAccentCells">accentCells</a>.</p>
                 * @returns sap.ui.core.ID[] 
                 */
                getAccentCells(): sap.ui.core.ID[];
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.BlockLayoutRow#methods/getContent">content</a>.</p><p>The content cells to be included in the row.</p>
                 * @returns sap.ui.layout.BlockLayoutCell[] 
                 */
                getContent(): sap.ui.layout.BlockLayoutCell[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getRowColorSet" href="api/sap.ui.layout.BlockLayoutRow#methods/getRowColorSet">rowColorSet</a>.</p><p>Defines background type for that row. There might be several rows with the same type</p>
                ...
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getScrollable" href="api/sap.ui.layout.BlockLayoutRow#methods/getScrollable">scrollable</a>.</p><p>Sets the rendering mode of the BlockLayoutRow to scrollable. In scrollable mode, the cells get aligned side by side, with horizontal scroll bar for the row.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>scrollable</code></p>
                 */
                getScrollable(): boolean;
                /**
                 * <p>Checks for the provided <code>sap.ui.layout.BlockLayoutCell</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.BlockLayoutRow#methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Inserts a content into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.BlockLayoutRow#methods/getContent">content</a>.</p>
                ...
                /**
                 * <p>Removes an accentCell from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAccentCells" href="api/sap.ui.layout.BlockLayoutRow#methods/getAccentCells">accentCells</a>.</p>
                ...
                /**
                 * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAccentCells" href="api/sap.ui.layout.BlockLayoutRow#methods/getAccentCells">accentCells</a>.</p>
                 * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllAccentCells(): sap.ui.core.ID[];
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.BlockLayoutRow#methods/getContent">content</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                ...
                /**
                 * <p>Removes a content from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.BlockLayoutRow#methods/getContent">content</a>.</p>
            ...
            export class DynamicSideContent extends sap.ui.core.Control {
                ...
                /**
                 * <p>Destroys all the mainContent in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getMainContent" href="api/sap.ui.layout.DynamicSideContent#methods/getMainContent">mainContent</a>.</p>
                 * @returns sap.ui.layout.DynamicSideContent <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyMainContent(): sap.ui.layout.DynamicSideContent;
                /**
                 * <p>Destroys all the sideContent in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSideContent" href="api/sap.ui.layout.DynamicSideContent#methods/getSideContent">sideContent</a>.</p>
                 * @returns sap.ui.layout.DynamicSideContent <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroySideContent(): sap.ui.layout.DynamicSideContent;
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="breakpointChanged" href="api/sap.ui.layout.DynamicSideContent#events/breakpointChanged">breakpointChanged</a> event of this <code>sap.ui.layout.DynamicSideContent</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                ...
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="breakpointChanged" href="api/sap.ui.layout.DynamicSideContent#events/breakpointChanged">breakpointChanged</a> to attached listeners.</p>
                ...
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowSideContent" href="api/sap.ui.layout.DynamicSideContent#methods/getShowSideContent">showSideContent</a>.</p><p>Determines whether the side content is visible or hidden.</p><p><b>Note:</b> If both <code>showSideContent</code> and <code>showMainContent</code> properties are set to <code>true</code>, use the <code>toggle</code> method for showing the side content on phone.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>showSideContent</code></p>
                 */
                getShowSideContent(): boolean;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSideContent" href="api/sap.ui.layout.DynamicSideContent#methods/getSideContent">sideContent</a>.</p><p>Side content controls.</p>
                 * @returns sap.ui.core.Control[] 
                 */
                getSideContent(): sap.ui.core.Control[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSideContentFallDown" href="api/sap.ui.layout.DynamicSideContent#methods/getSideContentFallDown">sideContentFallDown</a>.</p><p>Determines on which breakpoints the side content falls down below the main content.</p><p>Default value is <code>OnMinimumWidth</code>.</p>
                ...
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSideContentVisibility" href="api/sap.ui.layout.DynamicSideContent#methods/getSideContentVisibility">sideContentVisibility</a>.</p><p>Determines on which breakpoints the side content is visible.</p><p>Default value is <code>ShowAboveS</code>.</p>
                ...
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getMainContent" href="api/sap.ui.layout.DynamicSideContent#methods/getMainContent">mainContent</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSideContent" href="api/sap.ui.layout.DynamicSideContent#methods/getSideContent">sideContent</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Inserts a mainContent into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getMainContent" href="api/sap.ui.layout.DynamicSideContent#methods/getMainContent">mainContent</a>.</p>
                ...
                /**
                 * <p>Inserts a sideContent into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSideContent" href="api/sap.ui.layout.DynamicSideContent#methods/getSideContent">sideContent</a>.</p>
                ...
                /**
                 * <p>Checks if the main content is visible.</p>
                 * @returns boolean <p>Main content visibility state</p>
                 */
                isMainContentVisible(): boolean;
                /**
                 * <p>Checks if the side content is visible.</p>
                 * @returns boolean <p>Side content visibility state</p>
                 */
                isSideContentVisible(): boolean;
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getMainContent" href="api/sap.ui.layout.DynamicSideContent#methods/getMainContent">mainContent</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllMainContent(): sap.ui.core.Control[];
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSideContent" href="api/sap.ui.layout.DynamicSideContent#methods/getSideContent">sideContent</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllSideContent(): sap.ui.core.Control[];
                /**
                 * <p>Removes a mainContent from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getMainContent" href="api/sap.ui.layout.DynamicSideContent#methods/getMainContent">mainContent</a>.</p>
                ...
                /**
                 * <p>Removes a sideContent from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSideContent" href="api/sap.ui.layout.DynamicSideContent#methods/getSideContent">sideContent</a>.</p>
                ...
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSideContentFallDown" href="api/sap.ui.layout.DynamicSideContent#methods/getSideContentFallDown">sideContentFallDown</a>.</p><p>Determines on which breakpoints the side content falls down below the main content.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>OnMinimumWidth</code>.</p>
            ...
            export class FixFlex extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some fixContent to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFixContent" href="api/sap.ui.layout.FixFlex#methods/getFixContent">fixContent</a>.</p>
                ...
                /**
                 * <p>Destroys all the fixContent in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFixContent" href="api/sap.ui.layout.FixFlex#methods/getFixContent">fixContent</a>.</p>
                 * @returns sap.ui.layout.FixFlex <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyFixContent(): sap.ui.layout.FixFlex;
                /**
                 * <p>Destroys the flexContent in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFlexContent" href="api/sap.ui.layout.FixFlex#methods/getFlexContent">flexContent</a>.</p>
                 * @returns sap.ui.layout.FixFlex <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyFlexContent(): sap.ui.layout.FixFlex;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFixContent" href="api/sap.ui.layout.FixFlex#methods/getFixContent">fixContent</a>.</p><p>Controls in the fixed part of the layout.</p>
                 * @returns sap.ui.core.Control[] 
                 */
                ...
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getFixFirst" href="api/sap.ui.layout.FixFlex#methods/getFixFirst">fixFirst</a>.</p><p>Determines whether the fixed-size area should be on the beginning/top ( if the value is "true") or end/bottom ( if the value is "false").</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>fixFirst</code></p>
                 */
                getFixFirst(): boolean;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFlexContent" href="api/sap.ui.layout.FixFlex#methods/getFlexContent">flexContent</a>.</p><p>Control in the stretching part of the layout.</p>
                 * @returns sap.ui.core.Control 
                 */
                getFlexContent(): sap.ui.core.Control;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMinFlexSize" href="api/sap.ui.layout.FixFlex#methods/getMinFlexSize">minFlexSize</a>.</p><p>Enables scrolling inside the flexible part. The given size is calculated in "px". If the child control in the flexible part is larger than the available flexible size on the screen and if the available size for the flexible part is smaller or equal to the minFlexSize value, the scroll will be for the entire FixFlex control.</p><p>Default value is <code>0</code>.</p>
                 * @returns number <p>Value of property <code>minFlexSize</code></p>
                 */
                getMinFlexSize(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getVertical" href="api/sap.ui.layout.FixFlex#methods/getVertical">vertical</a>.</p><p>Determines the direction of the layout of child elements. True for vertical and false for horizontal layout.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>vertical</code></p>
                 */
                getVertical(): boolean;
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFixContent" href="api/sap.ui.layout.FixFlex#methods/getFixContent">fixContent</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Inserts a fixContent into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFixContent" href="api/sap.ui.layout.FixFlex#methods/getFixContent">fixContent</a>.</p>
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFixContent" href="api/sap.ui.layout.FixFlex#methods/getFixContent">fixContent</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllFixContent(): sap.ui.core.Control[];
                /**
                 * <p>Removes a fixContent from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFixContent" href="api/sap.ui.layout.FixFlex#methods/getFixContent">fixContent</a>.</p>
            ...
            export class Grid extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.layout.Grid#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                ...
                /**
                 * <p>Adds some content to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.Grid#methods/getContent">content</a>.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content to add; if empty, nothing is inserted</p>
                 * @returns sap.ui.layout.Grid <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                addContent(oContent: sap.ui.core.Control): sap.ui.layout.Grid;
                /**
                 * <p>Destroys all the content in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.Grid#methods/getContent">content</a>.</p>
                 * @returns sap.ui.layout.Grid <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.layout.Grid#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] 
                 */
                ...
                getContainerQuery(): boolean;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.Grid#methods/getContent">content</a>.</p><p>Controls that are placed into Grid layout.</p>
                 * @returns sap.ui.core.Control[] 
                 */
                getContent(): sap.ui.core.Control[];
                /**
                ...
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.Grid#methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content whose index is looked for</p>
                 * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                 */
                indexOfContent(oContent: sap.ui.core.Control): number;
                /**
                 * <p>Inserts a content into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.Grid#methods/getContent">content</a>.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content to insert; if empty, nothing is inserted</p>
                 * @param {number} iIndex <p>The <code>0</code>-based index the content should be inserted at; for a negative value of <code>iIndex</code>, the content is inserted at position 0; for a value greater than the current size of the aggregation, the content is inserted at the last position</p>
                 * @returns sap.ui.layout.Grid <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.layout.Grid#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.Grid#methods/getContent">content</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllContent(): sap.ui.core.Control[];
                /**
                 * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.layout.Grid#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                ...
                /**
                 * <p>Removes a content from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.Grid#methods/getContent">content</a>.</p>
                 * @param {number | string | sap.ui.core.Control} vContent <p>The content to remove or its index or id</p>
                 * @returns sap.ui.core.Control <p>The removed content or <code>null</code></p>
                 */
                removeContent(vContent: number | string | sap.ui.core.Control): sap.ui.core.Control;
            ...
            export class GridData extends sap.ui.core.LayoutData {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIndent" href="api/sap.ui.layout.GridData#methods/getIndent">indent</a>.</p><p>A string type that represents the indent values of the <code>Grid</code> for large, medium and small screens.</p><p>Allowed values are separated by space Letters L, M or S followed by number of columns from 1 to 11 that the container has to take, for example, <code>L2 M4 S6</code>, <code>M11</code>, <code>s10</code> or <code>l4 m4</code>.</p><p><b>Note:</b> The parameters must be provided in the order <large medium small>.</p>
                 * @returns sap.ui.layout.GridIndent <p>Value of property <code>indent</code></p>
                 */
                getIndent(): sap.ui.layout.GridIndent;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIndentL" href="api/sap.ui.layout.GridData#methods/getIndentL">indentL</a>.</p><p>Optional. Defines an indent value for large screens. This value overwrites the value for large screens defined in the <code>indent</code> property.</p>
                 * @returns number <p>Value of property <code>indentL</code></p>
                 */
                getIndentL(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIndentM" href="api/sap.ui.layout.GridData#methods/getIndentM">indentM</a>.</p><p>Optional. Defines an indent value for medium size screens. This value overwrites the value for medium screens defined in the <code>indent</code> property.</p>
                 * @returns number <p>Value of property <code>indentM</code></p>
                 */
                getIndentM(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIndentS" href="api/sap.ui.layout.GridData#methods/getIndentS">indentS</a>.</p><p>Optional. Defines an indent value for small screens. This value overwrites the value for small screens defined in the <code>indent</code> property.</p>
                 * @returns number <p>Value of property <code>indentS</code></p>
                 */
                getIndentS(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIndentXL" href="api/sap.ui.layout.GridData#methods/getIndentXL">indentXL</a>.</p><p>Optional. Defines an indent value for extra large screens. This value overwrites the value for extra large screens defined in the <code>indent</code> property.</p>
                 * @returns number <p>Value of property <code>indentXL</code></p>
                 */
                getIndentXL(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getLinebreak" href="api/sap.ui.layout.GridData#methods/getLinebreak">linebreak</a>.</p><p>Optional. If set to <code>true</code>, the control causes a line break on all-size screens within the <code>Grid</code> and becomes the first within the next line.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>linebreak</code></p>
                 */
                getLinebreak(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getLinebreakL" href="api/sap.ui.layout.GridData#methods/getLinebreakL">linebreakL</a>.</p><p>Optional. If set to <code>true</code>, the control causes a line break on large screens within the <code>Grid</code> and becomes the first within the next line.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>linebreakL</code></p>
                 */
                getLinebreakL(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getLinebreakM" href="api/sap.ui.layout.GridData#methods/getLinebreakM">linebreakM</a>.</p><p>Optional. If set to <code>true</code>, the control causes a line break on medium screens within the <code>Grid</code> and becomes the first within the next line.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>linebreakM</code></p>
                 */
                getLinebreakM(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getLinebreakS" href="api/sap.ui.layout.GridData#methods/getLinebreakS">linebreakS</a>.</p><p>Optional. If set to <code>true</code>, the control causes a line break on small screens within the <code>Grid</code> and becomes the first within the next line.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>linebreakS</code></p>
                 */
                getLinebreakS(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getLinebreakXL" href="api/sap.ui.layout.GridData#methods/getLinebreakXL">linebreakXL</a>.</p><p>Optional. If set to <code>true</code>, the control causes a line break on extra large screens within the <code>Grid</code> and becomes the first within the next line.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>linebreakXL</code></p>
                 */
                getLinebreakXL(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMoveBackwards" href="api/sap.ui.layout.GridData#methods/getMoveBackwards">moveBackwards</a>.</p><p>Optional. Moves a cell backwards with as many columns as specified.</p>
                 * @returns sap.ui.layout.GridIndent <p>Value of property <code>moveBackwards</code></p>
                 */
                getMoveBackwards(): sap.ui.layout.GridIndent;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMoveForward" href="api/sap.ui.layout.GridData#methods/getMoveForward">moveForward</a>.</p><p>Optional. Moves a cell forwards with as many columns as specified.</p>
                 * @returns sap.ui.layout.GridIndent <p>Value of property <code>moveForward</code></p>
                 */
                getMoveForward(): sap.ui.layout.GridIndent;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpan" href="api/sap.ui.layout.GridData#methods/getSpan">span</a>.</p><p>A string type that represents the span values of the <code>Grid</code> for large, medium and small screens.</p><p>Allowed values are separated by space Letters L, M or S followed by number of columns from 1 to 12 that the container has to take, for example: <code>L2 M4 S6</code>, <code>M12</code>, <code>s10</code> or <code>l4 m4</code>.</p><p><b>Note:</b> The parameters must be provided in the order <large medium small>.</p>
                 * @returns sap.ui.layout.GridSpan <p>Value of property <code>span</code></p>
                 */
                getSpan(): sap.ui.layout.GridSpan;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpanL" href="api/sap.ui.layout.GridData#methods/getSpanL">spanL</a>.</p><p>Optional. Defines a span value for large screens. This value overwrites the value for large screens defined in the <code>span</code> property.</p>
                 * @returns number <p>Value of property <code>spanL</code></p>
                 */
                getSpanL(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpanM" href="api/sap.ui.layout.GridData#methods/getSpanM">spanM</a>.</p><p>Optional. Defines a span value for medium size screens. This value overwrites the value for medium screens defined in the <code>span</code> property.</p>
                 * @returns number <p>Value of property <code>spanM</code></p>
                 */
                getSpanM(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpanS" href="api/sap.ui.layout.GridData#methods/getSpanS">spanS</a>.</p><p>Optional. Defines a span value for small screens. This value overwrites the value for small screens defined in the <code>span</code> property.</p>
                 * @returns number <p>Value of property <code>spanS</code></p>
                 */
                getSpanS(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpanXL" href="api/sap.ui.layout.GridData#methods/getSpanXL">spanXL</a>.</p><p>Optional. Defines a span value for extra large screens. This value overwrites the value for extra large screens defined in the <code>span</code> property.</p>
                 * @returns number <p>Value of property <code>spanXL</code></p>
                 */
                getSpanXL(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getVisibleL" href="api/sap.ui.layout.GridData#methods/getVisibleL">visibleL</a>.</p><p>Defines if this control is visible on large screens.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>visibleL</code></p>
                 */
                getVisibleL(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getVisibleM" href="api/sap.ui.layout.GridData#methods/getVisibleM">visibleM</a>.</p><p>Defines if this control is visible on medium screens.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>visibleM</code></p>
                 */
                getVisibleM(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getVisibleS" href="api/sap.ui.layout.GridData#methods/getVisibleS">visibleS</a>.</p><p>Defines if this control is visible on small screens.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>visibleS</code></p>
                 */
                getVisibleS(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getVisibleXL" href="api/sap.ui.layout.GridData#methods/getVisibleXL">visibleXL</a>.</p><p>Defines if this control is visible on extra Large screens.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>visibleXL</code></p>
                 */
                getVisibleXL(): boolean;
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIndent" href="api/sap.ui.layout.GridData#methods/getIndent">indent</a>.</p><p>A string type that represents the indent values of the <code>Grid</code> for large, medium and small screens.</p><p>Allowed values are separated by space Letters L, M or S followed by number of columns from 1 to 11 that the container has to take, for example, <code>L2 M4 S6</code>, <code>M11</code>, <code>s10</code> or <code>l4 m4</code>.</p><p><b>Note:</b> The parameters must be provided in the order <large medium small>.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
            ...
            export class HorizontalLayout extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some content to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.HorizontalLayout#methods/getContent">content</a>.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content to add; if empty, nothing is inserted</p>
                ...
                /**
                 * <p>Destroys all the content in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.HorizontalLayout#methods/getContent">content</a>.</p>
                 * @returns sap.ui.layout.HorizontalLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                protected getAccessibilityInfo(): any;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getAllowWrapping" href="api/sap.ui.layout.HorizontalLayout#methods/getAllowWrapping">allowWrapping</a>.</p><p>Specifies whether the content inside the Layout shall be line-wrapped in the case that there is less horizontal space available than required.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>allowWrapping</code></p>
                 */
                getAllowWrapping(): boolean;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.HorizontalLayout#methods/getContent">content</a>.</p><p>The controls inside this layout</p>
                 * @returns sap.ui.core.Control[] 
                 */
                getContent(): sap.ui.core.Control[];
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.HorizontalLayout#methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content whose index is looked for</p>
                 * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                 */
                indexOfContent(oContent: sap.ui.core.Control): number;
                /**
                 * <p>Inserts a content into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.HorizontalLayout#methods/getContent">content</a>.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content to insert; if empty, nothing is inserted</p>
                 * @param {number} iIndex <p>The <code>0</code>-based index the content should be inserted at; for a negative value of <code>iIndex</code>, the content is inserted at position 0; for a value greater than the current size of the aggregation, the content is inserted at the last position</p>
                 * @returns sap.ui.layout.HorizontalLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.HorizontalLayout#methods/getContent">content</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllContent(): sap.ui.core.Control[];
                /**
                 * <p>Removes a content from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.HorizontalLayout#methods/getContent">content</a>.</p>
                 * @param {number | string | sap.ui.core.Control} vContent <p>The content to remove or its index or id</p>
                 * @returns sap.ui.core.Control <p>The removed content or <code>null</code></p>
                 */
                removeContent(vContent: number | string | sap.ui.core.Control): sap.ui.core.Control;
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getAllowWrapping" href="api/sap.ui.layout.HorizontalLayout#methods/getAllowWrapping">allowWrapping</a>.</p><p>Specifies whether the content inside the Layout shall be line-wrapped in the case that there is less horizontal space available than required.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
            ...
            export class PaneContainer extends sap.ui.core.Element {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some pane to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getPanes" href="api/sap.ui.layout.PaneContainer#methods/getPanes">panes</a>.</p>
                ...
                /**
                 * <p>Destroys all the panes in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getPanes" href="api/sap.ui.layout.PaneContainer#methods/getPanes">panes</a>.</p>
                 * @returns sap.ui.layout.PaneContainer <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyPanes(): sap.ui.layout.PaneContainer;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getOrientation" href="api/sap.ui.layout.PaneContainer#methods/getOrientation">orientation</a>.</p><p>The orientation of the Splitter</p><p>Default value is <code>Horizontal</code>.</p>
                ...
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Element</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getPanes" href="api/sap.ui.layout.PaneContainer#methods/getPanes">panes</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getPanes" href="api/sap.ui.layout.PaneContainer#methods/getPanes">panes</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
            ...
            export class ResponsiveFlowLayout extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.layout.ResponsiveFlowLayout#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to add; if empty, nothing is inserted</p>
                ...
                /**
                 * <p>Destroys all the content in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.ResponsiveFlowLayout#methods/getContent">content</a>.</p>
                 * @returns sap.ui.layout.ResponsiveFlowLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyContent(): sap.ui.layout.ResponsiveFlowLayout;
                /**
                 * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.layout.ResponsiveFlowLayout#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] 
                 */
                getAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.ResponsiveFlowLayout#methods/getContent">content</a>.</p><p>Added content that should be positioned. Every content item should have a ResponsiveFlowLayoutData attached, or otherwise, the default values are used.</p>
                 * @returns sap.ui.core.Control[] 
                 */
                getContent(): sap.ui.core.Control[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getResponsive" href="api/sap.ui.layout.ResponsiveFlowLayout#methods/getResponsive">responsive</a>.</p><p>If set to false, all added controls will keep their width, or otherwise, the controls will be stretched to the possible width of a row.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>responsive</code></p>
                 */
                getResponsive(): boolean;
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.ResponsiveFlowLayout#methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content whose index is looked for</p>
                 * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                 */
                indexOfContent(oContent: sap.ui.core.Control): number;
                ...
                /**
                 * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.layout.ResponsiveFlowLayout#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.ResponsiveFlowLayout#methods/getContent">content</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllContent(): sap.ui.core.Control[];
                /**
                 * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.layout.ResponsiveFlowLayout#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {number | sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to be removed or its index or ID</p>
                 * @returns sap.ui.core.ID <p>The removed ariaLabelledBy or <code>null</code></p>
                 */
                removeAriaLabelledBy(vAriaLabelledBy: number | sap.ui.core.ID | sap.ui.core.Control): sap.ui.core.ID;
            ...
            export class ResponsiveFlowLayoutData extends sap.ui.core.LayoutData {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getLinebreak" href="api/sap.ui.layout.ResponsiveFlowLayoutData#methods/getLinebreak">linebreak</a>.</p><p>If this property is set, the control in which the LayoutData is added, will always cause a line break within the ResponsiveFlowLayout.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>linebreak</code></p>
                 */
                getLinebreak(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getLinebreakable" href="api/sap.ui.layout.ResponsiveFlowLayoutData#methods/getLinebreakable">linebreakable</a>.</p><p>Shows if an element can be wrapped into a new row. If this value is set to false, the min-width will be set to 0 and the wrapping is up to the previous element.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>linebreakable</code></p>
                 */
                getLinebreakable(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMargin" href="api/sap.ui.layout.ResponsiveFlowLayoutData#methods/getMargin">margin</a>.</p><p>Prevents any margin of the element if set to false.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>margin</code></p>
                 */
                getMargin(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMinWidth" href="api/sap.ui.layout.ResponsiveFlowLayoutData#methods/getMinWidth">minWidth</a>.</p><p>Defines the minimal size in px of a ResponsiveFlowLayout element. The element will be shrunk down to this value.</p><p>Default value is <code>100</code>.</p>
                 * @returns number <p>Value of property <code>minWidth</code></p>
                 */
                getMinWidth(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getWeight" href="api/sap.ui.layout.ResponsiveFlowLayoutData#methods/getWeight">weight</a>.</p><p>Defines the weight of the element, that influences the resulting width. If there are several elements within a row of the ResponsiveFlowLayout, each element could have another weight. The bigger the weight of a single element, the wider it will be stretched, i.e. a bigger weight results in a larger width.</p><p>Default value is <code>1</code>.</p>
            ...
            export class ResponsiveSplitter extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Destroys the rootPaneContainer in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getRootPaneContainer" href="api/sap.ui.layout.ResponsiveSplitter#methods/getRootPaneContainer">rootPaneContainer</a>.</p>
                ...
                /**
                 * <p>ID of the element which is the current target of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getDefaultPane" href="api/sap.ui.layout.ResponsiveSplitter#methods/getDefaultPane">defaultPane</a>, or <code>null</code>.</p>
                 * @returns sap.ui.core.ID 
                 */
                ...
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getRootPaneContainer" href="api/sap.ui.layout.ResponsiveSplitter#methods/getRootPaneContainer">rootPaneContainer</a>.</p><p>The root PaneContainer of the ResponsiveSplitter</p>
                ...
                getWidth(): sap.ui.core.CSSSize;
                /**
                 * <p>Sets the associated <a target="_self" class="jsdoclink scrollToMethod" data-target="getDefaultPane" href="api/sap.ui.layout.ResponsiveSplitter#methods/getDefaultPane">defaultPane</a>.</p>
            ...
            export class SplitPane extends sap.ui.core.Element {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Destroys the content in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.SplitPane#methods/getContent">content</a>.</p>
                ...
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.SplitPane#methods/getContent">content</a>.</p><p>Content of the SplitPane</p>
                 * @returns sap.ui.core.Control 
                 */
                getContent(): sap.ui.core.Control;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getDemandPane" href="api/sap.ui.layout.SplitPane#methods/getDemandPane">demandPane</a>.</p><p>Determines whether the pane will be moved to the pagination</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>demandPane</code></p>
                 */
                getDemandPane(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getRequiredParentWidth" href="api/sap.ui.layout.SplitPane#methods/getRequiredParentWidth">requiredParentWidth</a>.</p><p>Determines the minimum width of the ResponsiveSplitter(in pixels). When it is reached the pane will be hidden from the screen.</p><p>Default value is <code>800</code>.</p>
                 * @returns number <p>Value of property <code>requiredParentWidth</code></p>
                 */
                getRequiredParentWidth(): number;
                /**
                 * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.SplitPane#methods/getContent">content</a>.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content to set</p>
                 * @returns sap.ui.layout.SplitPane <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                setContent(oContent: sap.ui.core.Control): sap.ui.layout.SplitPane;
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getDemandPane" href="api/sap.ui.layout.SplitPane#methods/getDemandPane">demandPane</a>.</p><p>Determines whether the pane will be moved to the pagination</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>true</code>.</p>
            ...
            export class Splitter extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some contentArea to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContentAreas" href="api/sap.ui.layout.Splitter#methods/getContentAreas">contentAreas</a>.</p>
                ...
                /**
                 * <p>Destroys all the contentAreas in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContentAreas" href="api/sap.ui.layout.Splitter#methods/getContentAreas">contentAreas</a>.</p>
                 * @returns sap.ui.layout.Splitter <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyContentAreas(): sap.ui.layout.Splitter;
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="resize" href="api/sap.ui.layout.Splitter#events/resize">resize</a> event of this <code>sap.ui.layout.Splitter</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.layout.Splitter <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="resize" href="api/sap.ui.layout.Splitter#events/resize">resize</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.layout.Splitter <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireResize(mParameters?: any): sap.ui.layout.Splitter;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContentAreas" href="api/sap.ui.layout.Splitter#methods/getContentAreas">contentAreas</a>.</p><p>The content areas to be split. The control will show n-1 splitter bars between n controls in this aggregation.</p>
                 * @returns sap.ui.core.Control[] 
                 */
                ...
                getHeight(): sap.ui.core.CSSSize;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getOrientation" href="api/sap.ui.layout.Splitter#methods/getOrientation">orientation</a>.</p><p>Whether to split the contents horizontally (default) or vertically.</p><p>Default value is <code>Horizontal</code>.</p>
                 * @returns sap.ui.core.Orientation <p>Value of property <code>orientation</code></p>
                 */
                getOrientation(): sap.ui.core.Orientation;
                /**
                ...
                getWidth(): sap.ui.core.CSSSize;
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContentAreas" href="api/sap.ui.layout.Splitter#methods/getContentAreas">contentAreas</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Inserts a contentArea into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContentAreas" href="api/sap.ui.layout.Splitter#methods/getContentAreas">contentAreas</a>.</p>
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContentAreas" href="api/sap.ui.layout.Splitter#methods/getContentAreas">contentAreas</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllContentAreas(): sap.ui.core.Control[];
                /**
                 * <p>Removes a contentArea from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContentAreas" href="api/sap.ui.layout.Splitter#methods/getContentAreas">contentAreas</a>.</p>
            ...
            export class SplitterLayoutData extends sap.ui.core.LayoutData {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMinSize" href="api/sap.ui.layout.SplitterLayoutData#methods/getMinSize">minSize</a>.</p><p>Sets the minimum size of the splitter content in px.</p><p>Default value is <code>0</code>.</p>
                 * @returns number <p>Value of property <code>minSize</code></p>
                 */
                getMinSize(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getResizable" href="api/sap.ui.layout.SplitterLayoutData#methods/getResizable">resizable</a>.</p><p>Determines whether the control in the splitter can be resized or not.</p><p>Default value is <code>true</code>.</p>
            ...
            export class VerticalLayout extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some content to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.VerticalLayout#methods/getContent">content</a>.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content to add; if empty, nothing is inserted</p>
                ...
                /**
                 * <p>Destroys all the content in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.VerticalLayout#methods/getContent">content</a>.</p>
                 * @returns sap.ui.layout.VerticalLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                protected getAccessibilityInfo(): any;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.VerticalLayout#methods/getContent">content</a>.</p><p>Content controls within the layout.</p>
                 * @returns sap.ui.core.Control[] 
                 */
                getContent(): sap.ui.core.Control[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getEnabled" href="api/sap.ui.layout.VerticalLayout#methods/getEnabled">enabled</a>.</p><p>If not enabled, all controls inside are not enabled automatically.</p><p>Default value is <code>true</code>.</p>
                ...
                getWidth(): sap.ui.core.CSSSize;
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.VerticalLayout#methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content whose index is looked for</p>
                 * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                 */
                indexOfContent(oContent: sap.ui.core.Control): number;
                /**
                 * <p>Inserts a content into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.VerticalLayout#methods/getContent">content</a>.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content to insert; if empty, nothing is inserted</p>
                 * @param {number} iIndex <p>The <code>0</code>-based index the content should be inserted at; for a negative value of <code>iIndex</code>, the content is inserted at position 0; for a value greater than the current size of the aggregation, the content is inserted at the last position</p>
                 * @returns sap.ui.layout.VerticalLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.VerticalLayout#methods/getContent">content</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllContent(): sap.ui.core.Control[];
                /**
                 * <p>Removes a content from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.VerticalLayout#methods/getContent">content</a>.</p>
                 * @param {number | string | sap.ui.core.Control} vContent <p>The content to remove or its index or id</p>
                 * @returns sap.ui.core.Control <p>The removed content or <code>null</code></p>
                 */
                removeContent(vContent: number | string | sap.ui.core.Control): sap.ui.core.Control;
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getEnabled" href="api/sap.ui.layout.VerticalLayout#methods/getEnabled">enabled</a>.</p><p>If not enabled, all controls inside are not enabled automatically.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>true</code>.</p>
...
declare namespace sap {
    namespace ui {
        namespace layout {
            /**
             * <p><p>A string type that represents how many boxes per row should be displayed for each screen size. The breakpoints are for extra large (XL), large (L), medium (M) and small (S) screen sizes.</p><p><b>Note:</b> The parameters must be provided in the order <XL L M S>.</p></p>
             */
...
declare namespace sap {
    namespace ui {
        namespace layout {
            namespace cssgrid {
                /**
                 * <p><p>A string type that represents a short hand CSS grid gap.</p><br><br>References: <ul><li><a target="_blank" rel="noopener" href="https://developer.mozilla.org/en-US/docs/Web/CSS/gap">https://developer.mozilla.org/en-US/docs/Web/CSS/gap</a>
...
declare namespace sap {
    namespace ui {
        namespace layout {
            namespace cssgrid {
                /**
                 * <p><p>A string type that represents one or two grid lines. Used to define the position and size of a single grid item.</p><p>Valid values: <ul> <li>auto</li> <li>inherit</li> <li>1</li> <li>span 2</li> <li>span 2 / 5</li> <li>span 2 / -5</li> <li>5 / 7</li> <li>7 / span 5</li> <li>span 7 / span 5</li> </ul></p><br><br>References: <ul><li><a target="_blank" rel="noopener" href="https://developer.mozilla.org/en-US/docs/Glossary/Grid_lines">MDN web docs: grid lines</a>
                <img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
                title="Information published on non SAP site" class="sapUISDKExternalLink"/></li></ul></p>
                 */
...
declare namespace sap {
    namespace ui {
        namespace layout {
            namespace cssgrid {
                /**
                 * <p><p>A string type that represents a grid track (the space between two grid lines)</p><br><br>References: <ul><li><a target="_blank" rel="noopener" href="https://developer.mozilla.org/en-US/docs/Glossary/Grid_tracks">https://developer.mozilla.org/en-US/docs/Glossary/Grid_tracks</a>
                <img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
                title="Information published on non SAP site" class="sapUISDKExternalLink"/></li></ul></p>
                 */
...
declare namespace sap {
    namespace ui {
        namespace layout {
            namespace form {
                /**
                 * <p><p>An <code>int</code> type that defines how many cells a control inside of a column of a <code>Form</code> control using the <code>ColumnLayout</code> control as layout can use.</p><p>Allowed values are numbers from 1 to 12.</p></p>
                 */
...
declare namespace sap {
    namespace ui {
        namespace layout {
            namespace form {
                /**
                 * <p><p>An <code>int</code> type that defines how many columns a <code>Form</code> control using the <code>ColumnLayout</code> as layout can have if it has extra-large size</p><p>Allowed values are numbers from 1 to 4.</p></p>
                 */
        ...
        namespace layout {
            ...
            namespace cssgrid {
                ...
                export class CSSGrid extends sap.ui.core.Control implements sap.ui.layout.cssgrid.IGridConfigurable {
                    ...
                    constructor(sId?: string, mSettings?: any);
                    /**
                     * <p>Adds some item to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getItems" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getItems">items</a>.</p>
                    ...
                    /**
                     * <p>Destroys the customLayout in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getCustomLayout" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getCustomLayout">customLayout</a>.</p>
                     * @returns sap.ui.layout.cssgrid.CSSGrid <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyCustomLayout(): sap.ui.layout.cssgrid.CSSGrid;
                    /**
                     * <p>Destroys all the items in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getItems" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getItems">items</a>.</p>
                     * @returns sap.ui.layout.cssgrid.CSSGrid <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyItems(): sap.ui.layout.cssgrid.CSSGrid;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getCustomLayout" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getCustomLayout">customLayout</a>.</p><p>Defines a custom Grid layout for the control. If provided, it will override all of the grid properties.</p>
                     * @returns sap.ui.layout.cssgrid.GridLayoutBase 
                     */
                    getCustomLayout(): sap.ui.layout.cssgrid.GridLayoutBase;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getGridAutoColumns" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getGridAutoColumns">gridAutoColumns</a>.</p><p>Sets the value for the CSS display:grid property <a target="_blank" rel="noopener" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-auto-columns">MDN web docs: grid-auto-columns</a>
                    <img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
                    ...
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getItems" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getItems">items</a>.</p><p>The items contained by the control.</p>
                     * @returns sap.ui.core.Control[] 
                     */
                    ...
                    getWidth(): sap.ui.core.CSSSize;
                    /**
                     * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getItems" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getItems">items</a>. and returns its index if found or -1 otherwise.</p>
                     * @param {sap.ui.core.Control} oItem <p>The item whose index is looked for</p>
                     * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                     */
                    indexOfItem(oItem: sap.ui.core.Control): number;
                    /**
                     * <p>Inserts a item into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getItems" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getItems">items</a>.</p>
                    ...
                    /**
                     * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getItems" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getItems">items</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                     * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllItems(): sap.ui.core.Control[];
                    /**
                     * <p>Removes a item from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getItems" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getItems">items</a>.</p>
                    ...
                    /**
                     * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-target="getCustomLayout" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getCustomLayout">customLayout</a>.</p>
                    ...
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getGridAutoColumns" href="api/sap.ui.layout.cssgrid.CSSGrid#methods/getGridAutoColumns">gridAutoColumns</a>.</p><p>Sets the value for the CSS display:grid property <a target="_blank" rel="noopener" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-auto-columns">MDN web docs: grid-auto-columns</a>
                    <img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
                 ...
                 */
                export class GridBasicLayout extends sap.ui.layout.cssgrid.GridLayoutBase {
                    /**
                     * <p>Constructor for a new GridBasicLayout.</p><p>Accepts an object literal <code>mSettings</code> that defines initial property values, aggregated and associated objects as well as event handlers. See <a target="_self" class="jsdoclink" href="api/sap.ui.base.ManagedObject#constructor">sap.ui.base.ManagedObject#constructor</a> for a general description of the syntax of the settings object.</p>
                     * @param {string} sId <p>ID for the new control, generated automatically if no ID is given</p>
                     * @param {any} mSettings <p>Initial settings for the new control</p>
                     */
                    constructor(sId?: string, mSettings?: any);
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getGridAutoColumns" href="api/sap.ui.layout.cssgrid.GridBasicLayout#methods/getGridAutoColumns">gridAutoColumns</a>.</p><p>Sets the value for the CSS display:grid property <a target="_blank" rel="noopener" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-auto-columns">MDN web docs: grid-auto-columns</a>
                    <img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
                    title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p><b>Note:</b> Not supported in IE11, Edge 15.</p><p>Default value is <code>empty string</code>.</p>
                     * @returns sap.ui.layout.cssgrid.CSSGridTrack <p>Value of property <code>gridAutoColumns</code></p>
                     */
                 ...
                 * <p>Applies a sap.ui.layout.cssgrid.GridSettings to a provided DOM element or Control.</p>
                 */
                export class GridBoxLayout extends sap.ui.layout.cssgrid.GridLayoutBase {
                    /**
                    ...
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getBoxMinWidth" href="api/sap.ui.layout.cssgrid.GridBoxLayout#methods/getBoxMinWidth">boxMinWidth</a>.</p><p>Defines the minimum width of the Boxes</p><p>Default value is <code>empty string</code>.</p>
                     * @returns sap.ui.core.CSSSize <p>Value of property <code>boxMinWidth</code></p>
                     */
                    getBoxMinWidth(): sap.ui.core.CSSSize;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getBoxWidth" href="api/sap.ui.layout.cssgrid.GridBoxLayout#methods/getBoxWidth">boxWidth</a>.</p><p>Defines the width of the Boxes</p><p>Default value is <code>empty string</code>.</p>
                ...
                export class GridItemLayoutData extends sap.ui.core.LayoutData {
                    ...
                    constructor(sId?: string, mSettings?: any);
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getGridColumn" href="api/sap.ui.layout.cssgrid.GridItemLayoutData#methods/getGridColumn">gridColumn</a>.</p><p>Sets the value for the CSS display:grid item property grid-column <a target="_blank" rel="noopener" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-column">MDN web docs: grid-column</a>
                    <img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
                    ...
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getGridColumn" href="api/sap.ui.layout.cssgrid.GridItemLayoutData#methods/getGridColumn">gridColumn</a>.</p><p>Sets the value for the CSS display:grid item property grid-column <a target="_blank" rel="noopener" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-column">MDN web docs: grid-column</a>
                    <img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
                ...
                export class GridResponsiveLayout extends sap.ui.layout.cssgrid.GridLayoutBase {
                    ...
                    /**
                     * <p>Destroys the layout in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getLayout" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayout">layout</a>.</p>
                     * @returns sap.ui.layout.cssgrid.GridResponsiveLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyLayout(): sap.ui.layout.cssgrid.GridResponsiveLayout;
                    /**
                     * <p>Destroys the layoutL in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getLayoutL" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutL">layoutL</a>.</p>
                     * @returns sap.ui.layout.cssgrid.GridResponsiveLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyLayoutL(): sap.ui.layout.cssgrid.GridResponsiveLayout;
                    /**
                     * <p>Destroys the layoutM in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getLayoutM" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutM">layoutM</a>.</p>
                     * @returns sap.ui.layout.cssgrid.GridResponsiveLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyLayoutM(): sap.ui.layout.cssgrid.GridResponsiveLayout;
                    /**
                     * <p>Destroys the layoutS in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getLayoutS" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutS">layoutS</a>.</p>
                     * @returns sap.ui.layout.cssgrid.GridResponsiveLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyLayoutS(): sap.ui.layout.cssgrid.GridResponsiveLayout;
                    /**
                     * <p>Destroys the layoutXL in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getLayoutXL" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutXL">layoutXL</a>.</p>
                     * @returns sap.ui.layout.cssgrid.GridResponsiveLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="layoutChange" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#events/layoutChange">layoutChange</a> to attached listeners.</p>
                     * @param {any} mParameters <p>Parameters to pass along with the event</p>
                     * @returns sap.ui.layout.cssgrid.GridResponsiveLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    protected fireLayoutChange(mParameters?: any): sap.ui.layout.cssgrid.GridResponsiveLayout;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getContainerQuery" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getContainerQuery">containerQuery</a>.</p><p>If set to <code>true</code>, the current range (large, medium or small) is defined by the size of the container surrounding the <code>CSSGrid</code> instead of the device screen size (media Query).</p><p>Default value is <code>false</code>.</p>
                     * @returns boolean <p>Value of property <code>containerQuery</code></p>
                     */
                    getContainerQuery(): boolean;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getLayout" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayout">layout</a>.</p><p>The sap.ui.layout.cssgrid.GridSettings applied if no settings are provided for a specific size</p>
                     * @returns sap.ui.layout.cssgrid.GridSettings 
                     */
                    getLayout(): sap.ui.layout.cssgrid.GridSettings;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getLayoutL" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutL">layoutL</a>.</p><p>The sap.ui.layout.cssgrid.GridSettings applied for size "L"</p>
                     * @returns sap.ui.layout.cssgrid.GridSettings 
                     */
                    getLayoutL(): sap.ui.layout.cssgrid.GridSettings;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getLayoutM" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutM">layoutM</a>.</p><p>The sap.ui.layout.cssgrid.GridSettings applied for size "M"</p>
                     * @returns sap.ui.layout.cssgrid.GridSettings 
                     */
                    getLayoutM(): sap.ui.layout.cssgrid.GridSettings;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getLayoutS" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutS">layoutS</a>.</p><p>The sap.ui.layout.cssgrid.GridSettings applied for size "S"</p>
                     * @returns sap.ui.layout.cssgrid.GridSettings 
                     */
                    getLayoutS(): sap.ui.layout.cssgrid.GridSettings;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getLayoutXL" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutXL">layoutXL</a>.</p><p>The sap.ui.layout.cssgrid.GridSettings applied for size "XL"</p>
                     * @returns sap.ui.layout.cssgrid.GridSettings 
                     */
                    getLayoutXL(): sap.ui.layout.cssgrid.GridSettings;
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getContainerQuery" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getContainerQuery">containerQuery</a>.</p><p>If set to <code>true</code>, the current range (large, medium or small) is defined by the size of the container surrounding the <code>CSSGrid</code> instead of the device screen size (media Query).</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
                     * @param {boolean} bContainerQuery <p>New value for property <code>containerQuery</code></p>
                     * @returns sap.ui.layout.cssgrid.GridResponsiveLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-target="getLayoutL" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutL">layoutL</a>.</p>
                    ...
                    /**
                     * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-target="getLayoutM" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutM">layoutM</a>.</p>
                    ...
                    /**
                     * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-target="getLayoutS" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutS">layoutS</a>.</p>
                    ...
                    /**
                     * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-target="getLayoutXL" href="api/sap.ui.layout.cssgrid.GridResponsiveLayout#methods/getLayoutXL">layoutXL</a>.</p>
                ...
                export class GridSettings extends sap.ui.base.ManagedObject {
                    ...
                    constructor(sId?: string, mSettings?: any);
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getGridAutoColumns" href="api/sap.ui.layout.cssgrid.GridSettings#methods/getGridAutoColumns">gridAutoColumns</a>.</p><p>Sets the value for the CSS display:grid property <a target="_blank" rel="noopener" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-auto-columns">MDN web docs: grid-auto-columns</a>
                    <img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
                    title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p><b>Note:</b> Not supported in IE11, Edge 15.</p><p>Default value is <code>empty string</code>.</p>
                     * @returns sap.ui.layout.cssgrid.CSSGridTrack <p>Value of property <code>gridAutoColumns</code></p>
                     */
                ...
                export class ResponsiveColumnItemLayoutData extends sap.ui.core.LayoutData {
                    ...
                    constructor(sId?: string, mSettings?: any);
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getColumns" href="api/sap.ui.layout.cssgrid.ResponsiveColumnItemLayoutData#methods/getColumns">columns</a>.</p><p>Specifies the number of columns, which the item should take.</p><p>Default value is <code>1</code>.</p>
                     * @returns number <p>Value of property <code>columns</code></p>
                     */
                    getColumns(): number;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getRows" href="api/sap.ui.layout.cssgrid.ResponsiveColumnItemLayoutData#methods/getRows">rows</a>.</p><p>Specifies the number of rows, which the item should take.</p><p>Default value is <code>1</code>.</p>
                     * @returns number <p>Value of property <code>rows</code></p>
                     */
                    getRows(): number;
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getColumns" href="api/sap.ui.layout.cssgrid.ResponsiveColumnItemLayoutData#methods/getColumns">columns</a>.</p><p>Specifies the number of columns, which the item should take.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>1</code>.</p>
                ...
                export class ResponsiveColumnLayout extends sap.ui.layout.cssgrid.GridLayoutBase {
                    ...
                    /**
                     * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="layoutChange" href="api/sap.ui.layout.cssgrid.ResponsiveColumnLayout#events/layoutChange">layoutChange</a> to attached listeners.</p>
                     * @param {any} mParameters <p>Parameters to pass along with the event</p>
                     * @returns sap.ui.layout.cssgrid.ResponsiveColumnLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
        ...
        namespace layout {
            ...
            namespace form {
                ...
                export class ColumnLayout extends sap.ui.layout.form.FormLayout {
                    ...
                    getColumnsL(): sap.ui.layout.form.ColumnsL;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getColumnsM" href="api/sap.ui.layout.form.ColumnLayout#methods/getColumnsM">columnsM</a>.</p><p>Number of columns for medium size.</p><p>Default value is <code>1</code>.</p>
                     * @returns sap.ui.layout.form.ColumnsM <p>Value of property <code>columnsM</code></p>
                     */
                    getColumnsM(): sap.ui.layout.form.ColumnsM;
                    /**
                    ...
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getLabelCellsLarge" href="api/sap.ui.layout.form.ColumnLayout#methods/getLabelCellsLarge">labelCellsLarge</a>.</p><p>Defines how many cells a label uses if the column is large.</p><p>Default value is <code>4</code>.</p>
                ...
                export class Form extends sap.ui.core.Control {
                    ...
                    constructor(sId?: string, mSettings?: any);
                    /**
                     * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.layout.form.Form#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @param {sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to add; if empty, nothing is inserted</p>
                    ...
                    /**
                     * <p>Adds some formContainer to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFormContainers" href="api/sap.ui.layout.form.Form#methods/getFormContainers">formContainers</a>.</p>
                    ...
                    /**
                     * <p>Destroys all the formContainers in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFormContainers" href="api/sap.ui.layout.form.Form#methods/getFormContainers">formContainers</a>.</p>
                     * @returns sap.ui.layout.form.Form <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyFormContainers(): sap.ui.layout.form.Form;
                    /**
                     * <p>Destroys the layout in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getLayout" href="api/sap.ui.layout.form.Form#methods/getLayout">layout</a>.</p>
                     * @returns sap.ui.layout.form.Form <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyLayout(): sap.ui.layout.form.Form;
                    /**
                     * <p>Destroys the title in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getTitle" href="api/sap.ui.layout.form.Form#methods/getTitle">title</a>.</p>
                     * @returns sap.ui.layout.form.Form <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyTitle(): sap.ui.layout.form.Form;
                    /**
                     * <p>Destroys the toolbar in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getToolbar" href="api/sap.ui.layout.form.Form#methods/getToolbar">toolbar</a>.</p>
                     * @returns sap.ui.layout.form.Form <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyToolbar(): sap.ui.layout.form.Form;
                    /**
                     * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.layout.form.Form#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @returns sap.ui.core.ID[] 
                     */
                    getAriaLabelledBy(): sap.ui.core.ID[];
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getEditable" href="api/sap.ui.layout.form.Form#methods/getEditable">editable</a>.</p><p>Applies a device-specific and theme-specific line height and label alignment to the form rows if the form has editable content. If set, all (not only the editable) rows of the form will get the line height of editable fields.</p><p>The labels inside the form will be rendered by default in the according mode.</p><p><b>Note:</b> The setting of this property does not change the content of the form. For example, <code>Input</code> controls in a form with <code>editable</code> set to false are still editable.</p><p><b>Warning:</b> If this property is wrongly set, this might lead to visual issues. The labels and fields might be misaligned, the labels might be rendered in the wrong mode, and the spacing between the single controls might be wrong. Also, controls that do not fit the mode might be rendered incorrectly.</p><p>Default value is <code>false</code>.</p>
                     * @returns boolean <p>Value of property <code>editable</code></p>
                     */
                    getEditable(): boolean;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFormContainers" href="api/sap.ui.layout.form.Form#methods/getFormContainers">formContainers</a>.</p><p>Containers with the content of the form. A <code>FormContainer</code> represents a group inside the <code>Form</code>.</p>
                     * @returns sap.ui.layout.form.FormContainer[] 
                     */
                    getFormContainers(): sap.ui.layout.form.FormContainer[];
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getLayout" href="api/sap.ui.layout.form.Form#methods/getLayout">layout</a>.</p><p>Layout of the <code>Form</code>. The assigned <code>Layout</code> renders the <code>Form</code>. We recommend using the <code>ResponsiveGridLayout</code> for rendering a <code>Form</code>, as its responsiveness allows the available space to be used in the best way possible.</p>
                     * @returns sap.ui.layout.form.FormLayout 
                     */
                    getLayout(): sap.ui.layout.form.FormLayout;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getTitle" href="api/sap.ui.layout.form.Form#methods/getTitle">title</a>.</p><p>Title of the <code>Form</code>. Can either be a <code>Title</code> element or a string. If a <code>Title</code> element it used, the style of the title can be set.</p><p><b>Note:</b> If a <code>Toolbar</code> is used, the <code>Title</code> is ignored.</p>
                     * @returns sap.ui.core.Title|string 
                     */
                    getTitle(): sap.ui.core.Title | string;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getToolbar" href="api/sap.ui.layout.form.Form#methods/getToolbar">toolbar</a>.</p><p>Toolbar of the <code>Form</code>.</p><p><b>Note:</b> If a <code>Toolbar</code> is used, the <code>Title</code> is ignored. If a title is needed inside the <code>Toolbar</code> it must be added at content to the <code>Toolbar</code>. In this case add the <code>Title</code> to the <code>ariaLabelledBy</code> association.</p>
                     * @returns sap.ui.core.Toolbar 
                     */
                    getToolbar(): sap.ui.core.Toolbar;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getWidth" href="api/sap.ui.layout.form.Form#methods/getWidth">width</a>.</p><p>Width of the <code>Form</code>.</p>
                     * @returns sap.ui.core.CSSSize <p>Value of property <code>width</code></p>
                     */
                    getWidth(): sap.ui.core.CSSSize;
                    /**
                     * <p>Checks for the provided <code>sap.ui.layout.form.FormContainer</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFormContainers" href="api/sap.ui.layout.form.Form#methods/getFormContainers">formContainers</a>. and returns its index if found or -1 otherwise.</p>
                    ...
                    /**
                     * <p>Inserts a formContainer into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFormContainers" href="api/sap.ui.layout.form.Form#methods/getFormContainers">formContainers</a>.</p>
                    ...
                    /**
                     * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.layout.form.Form#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllAriaLabelledBy(): sap.ui.core.ID[];
                    /**
                     * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFormContainers" href="api/sap.ui.layout.form.Form#methods/getFormContainers">formContainers</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                    ...
                    /**
                     * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.layout.form.Form#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @param {number | sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to be removed or its index or ID</p>
                     * @returns sap.ui.core.ID <p>The removed ariaLabelledBy or <code>null</code></p>
                     */
                    removeAriaLabelledBy(vAriaLabelledBy: number | sap.ui.core.ID | sap.ui.core.Control): sap.ui.core.ID;
                    /**
                     * <p>Removes a formContainer from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFormContainers" href="api/sap.ui.layout.form.Form#methods/getFormContainers">formContainers</a>.</p>
                    ...
                    /**
                     * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-target="getTitle" href="api/sap.ui.layout.form.Form#methods/getTitle">title</a>.</p>
                    ...
                    /**
                     * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-target="getToolbar" href="api/sap.ui.layout.form.Form#methods/getToolbar">toolbar</a>.</p>
                ...
                export class FormContainer extends sap.ui.core.Element {
                    ...
                    /**
                     * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.layout.form.FormContainer#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @param {sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to add; if empty, nothing is inserted</p>
                    ...
                    /**
                     * <p>Adds some formElement to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFormElements" href="api/sap.ui.layout.form.FormContainer#methods/getFormElements">formElements</a>.</p>
                    ...
                    /**
                     * <p>Destroys all the formElements in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFormElements" href="api/sap.ui.layout.form.FormContainer#methods/getFormElements">formElements</a>.</p>
                     * @returns sap.ui.layout.form.FormContainer <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyFormElements(): sap.ui.layout.form.FormContainer;
                    /**
                     * <p>Destroys the title in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getTitle" href="api/sap.ui.layout.form.FormContainer#methods/getTitle">title</a>.</p>
                     * @returns sap.ui.layout.form.FormContainer <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyTitle(): sap.ui.layout.form.FormContainer;
                    /**
                     * <p>Destroys the toolbar in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getToolbar" href="api/sap.ui.layout.form.FormContainer#methods/getToolbar">toolbar</a>.</p>
                     * @returns sap.ui.layout.form.FormContainer <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyToolbar(): sap.ui.layout.form.FormContainer;
                    /**
                     * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.layout.form.FormContainer#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @returns sap.ui.core.ID[] 
                     */
                    getAriaLabelledBy(): sap.ui.core.ID[];
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getExpandable" href="api/sap.ui.layout.form.FormContainer#methods/getExpandable">expandable</a>.</p><p>Defines if the <code>FormContainer</code> is expandable.</p><p><b>Note:</b> The expander icon will only be shown if a <code>title</code> is set for the <code>FormContainer</code>.</p><p>Default value is <code>false</code>.</p>
                     * @returns boolean <p>Value of property <code>expandable</code></p>
                     */
                    getExpandable(): boolean;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getExpanded" href="api/sap.ui.layout.form.FormContainer#methods/getExpanded">expanded</a>.</p><p>Container is expanded.</p><p><b>Note:</b> This property only works if <code>expandable</code> is set to <code>true</code>.</p><p>Default value is <code>true</code>.</p>
                     * @returns boolean <p>Value of property <code>expanded</code></p>
                     */
                    getExpanded(): boolean;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFormElements" href="api/sap.ui.layout.form.FormContainer#methods/getFormElements">formElements</a>.</p><p>The <code>FormElements</code> contain the content (labels and fields) of the <code>FormContainers</code>.</p>
                     * @returns sap.ui.layout.form.FormElement[] 
                     */
                    getFormElements(): sap.ui.layout.form.FormElement[];
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getTitle" href="api/sap.ui.layout.form.FormContainer#methods/getTitle">title</a>.</p><p>Title of the <code>FormContainer</code>. Can either be a <code>Title</code> element or a string. If a <code>Title</code> element is used, the style of the title can be set.</p><p><b>Note:</b> If a <code>Toolbar</code> is used, the <code>Title</code> is ignored.</p>
                     * @returns sap.ui.core.Title|string 
                     */
                    getTitle(): sap.ui.core.Title | string;
                    /**
                    ...
                    getToolbar(): sap.ui.core.Toolbar;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getVisible" href="api/sap.ui.layout.form.FormContainer#methods/getVisible">visible</a>.</p><p>If set to <code>false</code>, the <code>FormContainer</code> is not rendered.</p><p>Default value is <code>true</code>.</p>
                     * @returns boolean <p>Value of property <code>visible</code></p>
                     */
                    getVisible(): boolean;
                    /**
                     * <p>Checks for the provided <code>sap.ui.layout.form.FormElement</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFormElements" href="api/sap.ui.layout.form.FormContainer#methods/getFormElements">formElements</a>. and returns its index if found or -1 otherwise.</p>
                    ...
                    /**
                     * <p>Inserts a formElement into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFormElements" href="api/sap.ui.layout.form.FormContainer#methods/getFormElements">formElements</a>.</p>
                    ...
                    isVisible(): boolean;
                    /**
                     * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.layout.form.FormContainer#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllAriaLabelledBy(): sap.ui.core.ID[];
                    /**
                     * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFormElements" href="api/sap.ui.layout.form.FormContainer#methods/getFormElements">formElements</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                    ...
                    /**
                     * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.layout.form.FormContainer#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @param {number | sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to be removed or its index or ID</p>
                     * @returns sap.ui.core.ID <p>The removed ariaLabelledBy or <code>null</code></p>
                     */
                    removeAriaLabelledBy(vAriaLabelledBy: number | sap.ui.core.ID | sap.ui.core.Control): sap.ui.core.ID;
                    /**
                     * <p>Removes a formElement from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFormElements" href="api/sap.ui.layout.form.FormContainer#methods/getFormElements">formElements</a>.</p>
                ...
                export class FormElement extends sap.ui.core.Element {
                    ...
                    protected _setEditable(bEditable: boolean): void;
                    /**
                     * <p>Adds some field to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFields" href="api/sap.ui.layout.form.FormElement#methods/getFields">fields</a>.</p>
                    ...
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getVisible" href="api/sap.ui.layout.form.FormElement#methods/getVisible">visible</a>.</p><p>If set to <code>false</code>, the <code>FormElement</code> is not rendered.</p><p>Default value is <code>true</code>.</p>
                     * @returns boolean <p>Value of property <code>visible</code></p>
                     */
                    getVisible(): boolean;
                    /**
                     * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFields" href="api/sap.ui.layout.form.FormElement#methods/getFields">fields</a>. and returns its index if found or -1 otherwise.</p>
                     * @param {sap.ui.core.Control} oField <p>The field whose index is looked for</p>
                     * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                     */
                    indexOfField(oField: sap.ui.core.Control): number;
                    /**
                     * <p>Inserts a field into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFields" href="api/sap.ui.layout.form.FormElement#methods/getFields">fields</a>.</p>
                    ...
                    isVisible(): boolean;
                    /**
                     * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFields" href="api/sap.ui.layout.form.FormElement#methods/getFields">fields</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                     * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllFields(): sap.ui.core.Control[];
                    /**
                     * <p>Removes a field from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFields" href="api/sap.ui.layout.form.FormElement#methods/getFields">fields</a>.</p>
                    ...
                    /**
                     * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-target="getLabel" href="api/sap.ui.layout.form.FormElement#methods/getLabel">label</a>.</p>
                ...
                export class GridElementData extends sap.ui.core.LayoutData {
                    ...
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getVCells" href="api/sap.ui.layout.form.GridElementData#methods/getVCells">vCells</a>.</p><p>Number of cells in vertical direction.</p><p><b>Note:</b> This property has no effect on labels.</p><p>Default value is <code>1</code>.</p>
                ...
                export class ResponsiveGridLayout extends sap.ui.layout.form.FormLayout {
                    ...
                    getColumnsL(): number;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getColumnsM" href="api/sap.ui.layout.form.ResponsiveGridLayout#methods/getColumnsM">columnsM</a>.</p><p>Number of columns for medium size.</p><p>Default value is <code>1</code>.</p>
                ...
                /**
                 * <p>The <code>SimpleForm</code> control provides an easy-to-use API to create simple forms. Inside a <code>SimpleForm</code> control, a <code><a target="_self" class="jsdoclink" href="api/sap.ui.layout.form.Form">Form</a></code> control is created along with its <code><a target="_self" class="jsdoclink" href="api/sap.ui.layout.form.FormContainer">FormContainer</a></code> elements and <code><a target="_self" class="jsdoclink" href="api/sap.ui.layout.form.FormElement">FormElement</a></code> elements, but the complexity in the API is not exposed to the user. <ul> <li>A new <code>sap.ui.core.Title</code> element or <code>Toolbar</code> control starts a new group (<code><a target="_self" class="jsdoclink" href="api/sap.ui.layout.form.FormContainer">FormContainer</a></code>) in the form.</li> <li>A new <code>Label</code> control starts a new row (<code><a target="_self" class="jsdoclink" href="api/sap.ui.layout.form.FormElement">FormElement</a></code>) in the form.</li> <li>All other controls will be assigned to the row (<code><a target="_self" class="jsdoclink" href="api/sap.ui.layout.form.FormElement">FormElement</a></code>) that started with the last label.</li> </ul> Use <code>LayoutData</code> to influence the layout for special cases in the Input/Display controls.</p><p><b>Note:</b> If a more complex form is needed, use the <code><a target="_self" class="jsdoclink" href="api/sap.ui.layout.form.Form">Form</a></code> control instead.</p>
                 */
                export class SimpleForm extends sap.ui.core.Control {
                    ...
                    constructor(sId?: string, mSettings?: any);
                    /**
                     * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.layout.form.SimpleForm#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @param {sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to add; if empty, nothing is inserted</p>
                    ...
                    /**
                     * <p>Adds some content to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.form.SimpleForm#methods/getContent">content</a>.</p>
                    ...
                    /**
                     * <p>Destroys all the content in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.form.SimpleForm#methods/getContent">content</a>.</p>
                     * @returns sap.ui.layout.form.SimpleForm <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyContent(): sap.ui.layout.form.SimpleForm;
                    /**
                     * <p>Destroys the title in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getTitle" href="api/sap.ui.layout.form.SimpleForm#methods/getTitle">title</a>.</p>
                     * @returns sap.ui.layout.form.SimpleForm <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyTitle(): sap.ui.layout.form.SimpleForm;
                    /**
                     * <p>Destroys the toolbar in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getToolbar" href="api/sap.ui.layout.form.SimpleForm#methods/getToolbar">toolbar</a>.</p>
                     * @returns sap.ui.layout.form.SimpleForm <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    getAdjustLabelSpan(): boolean;
                    /**
                     * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.layout.form.SimpleForm#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @returns sap.ui.core.ID[] 
                     */
                    getAriaLabelledBy(): sap.ui.core.ID[];
                    /**
                    ...
                    getSingleContainerFullSize(): boolean;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getTitle" href="api/sap.ui.layout.form.SimpleForm#methods/getTitle">title</a>.</p><p>Title element of the <code>SimpleForm</code>. Can either be a <code>Title</code> element, or a string.</p>
                     * @returns sap.ui.core.Title|string 
                     */
                    getTitle(): sap.ui.core.Title | string;
                    /**
                    ...
                    getToolbar(): sap.ui.core.Toolbar;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getWidth" href="api/sap.ui.layout.form.SimpleForm#methods/getWidth">width</a>.</p><p>Width of the form.</p>
                     * @returns sap.ui.core.CSSSize <p>Value of property <code>width</code></p>
                     */
                    getWidth(): sap.ui.core.CSSSize;
                    /**
                     * <p>Checks for the provided <code>sap.ui.core.Element</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.form.SimpleForm#methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
                    ...
                    /**
                     * <p>Inserts a content into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.form.SimpleForm#methods/getContent">content</a>.</p>
                    ...
                    /**
                     * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.layout.form.SimpleForm#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllAriaLabelledBy(): sap.ui.core.ID[];
                    /**
                     * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.form.SimpleForm#methods/getContent">content</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                     * @returns sap.ui.core.Element[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllContent(): sap.ui.core.Element[];
                    /**
                     * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.layout.form.SimpleForm#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @param {number | sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to be removed or its index or ID</p>
                     * @returns sap.ui.core.ID <p>The removed ariaLabelledBy or <code>null</code></p>
                     */
                    removeAriaLabelledBy(vAriaLabelledBy: number | sap.ui.core.ID | sap.ui.core.Control): sap.ui.core.ID;
                    /**
                     * <p>Removes a content from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.layout.form.SimpleForm#methods/getContent">content</a>.</p>
                    ...
                    /**
                     * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-target="getToolbar" href="api/sap.ui.layout.form.SimpleForm#methods/getToolbar">toolbar</a>.</p>
                     * @param {sap.ui.core.Toolbar} oToolbar <p>The toolbar to set</p>
                     * @returns sap.ui.layout.form.SimpleForm <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    setToolbar(oToolbar: sap.ui.core.Toolbar): sap.ui.layout.form.SimpleForm;
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getWidth" href="api/sap.ui.layout.form.SimpleForm#methods/getWidth">width</a>.</p><p>Width of the form.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                     * @param {sap.ui.core.CSSSize} sWidth <p>New value for property <code>width</code></p>
                     * @returns sap.ui.layout.form.SimpleForm <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
