    ...
    namespace ui {
        ...
        namespace layout {
            ...
            export class BlockLayout extends sap.ui.core.Control {
                ...
                /**
                 * <p>Adds some content to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.BlockLayout/methods/getContent">content</a>.</p>
                ...
                /**
                 * <p>Destroys all the content in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.BlockLayout/methods/getContent">content</a>.</p>
                 * @returns sap.ui.layout.BlockLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyContent(): sap.ui.layout.BlockLayout;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getBackground" href="#/api/sap.ui.layout.BlockLayout/methods/getBackground">background</a>.</p><p>Determines the background used for the Layout</p><p>Default value is <code>Default</code>.</p>
                ...
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.BlockLayout/methods/getContent">content</a>.</p><p>The Rows to be included in the content of the control</p>
                 * @returns sap.ui.layout.BlockLayoutRow[] 
                 */
                getContent(): sap.ui.layout.BlockLayoutRow[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getKeepFontSize" href="#/api/sap.ui.layout.BlockLayout/methods/getKeepFontSize">keepFontSize</a>.</p><p>Keeps the font-size of the contents as is, independent from the screen size.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>keepFontSize</code></p>
                 */
                getKeepFontSize(): boolean;
                /**
                 * <p>Checks for the provided <code>sap.ui.layout.BlockLayoutRow</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.BlockLayout/methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Inserts a content into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.BlockLayout/methods/getContent">content</a>.</p>
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.BlockLayout/methods/getContent">content</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                ...
                /**
                 * <p>Removes a content from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.BlockLayout/methods/getContent">content</a>.</p>
            ...
            export class BlockLayoutCell extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some content to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.BlockLayoutCell/methods/getContent">content</a>.</p>
                ...
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.BlockLayoutCell/methods/getContent">content</a>.</p><p>The content to be included inside the cell</p>
                ...
                getTitle(): string;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getTitleAlignment" href="#/api/sap.ui.layout.BlockLayoutCell/methods/getTitleAlignment">titleAlignment</a>.</p><p>Defines the alignment of the cell title</p><p>Default value is <code>Begin</code>.</p>
                ...
                /**
                 * <p>Inserts a content into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.BlockLayoutCell/methods/getContent">content</a>.</p>
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.BlockLayoutCell/methods/getContent">content</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllContent(): sap.ui.core.Control[];
                /**
                 * <p>Removes a content from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.BlockLayoutCell/methods/getContent">content</a>.</p>
                ...
                /**
                 * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getTitleLink" href="#/api/sap.ui.layout.BlockLayoutCell/methods/getTitleLink">titleLink</a>.</p>
            ...
            export class BlockLayoutCellData extends sap.ui.core.LayoutData {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getLSize" href="#/api/sap.ui.layout.BlockLayoutCellData/methods/getLSize">lSize</a>.</p><p>Sets the width of the cell for L size of the BlockLayout.</p><p>Default value is <code>1</code>.</p>
                 * @returns number <p>Value of property <code>lSize</code></p>
                 */
                getLSize(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getMSize" href="#/api/sap.ui.layout.BlockLayoutCellData/methods/getMSize">mSize</a>.</p><p>Sets the width of the cell for M size of the BlockLayout.</p><p>Default value is <code>1</code>.</p>
                 * @returns number <p>Value of property <code>mSize</code></p>
                 */
                getMSize(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getSSize" href="#/api/sap.ui.layout.BlockLayoutCellData/methods/getSSize">sSize</a>.</p><p>Sets the width of the cell for S size of the BlockLayout.</p><p>Default value is <code>1</code>.</p>
                 * @returns number <p>Value of property <code>sSize</code></p>
                 */
                getSSize(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getXlSize" href="#/api/sap.ui.layout.BlockLayoutCellData/methods/getXlSize">xlSize</a>.</p><p>Sets the width of the cell for XL size of the BlockLayout.</p><p>Default value is <code>1</code>.</p>
                 * @returns number <p>Value of property <code>xlSize</code></p>
                 */
                getXlSize(): number;
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getLSize" href="#/api/sap.ui.layout.BlockLayoutCellData/methods/getLSize">lSize</a>.</p><p>Sets the width of the cell for L size of the BlockLayout.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>1</code>.</p>
            ...
            export class BlockLayoutRow extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some accentCell into the association <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAccentCells" href="#/api/sap.ui.layout.BlockLayoutRow/methods/getAccentCells">accentCells</a>.</p>
                ...
                /**
                 * <p>Adds some content to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.BlockLayoutRow/methods/getContent">content</a>.</p>
                ...
                /**
                 * <p>Destroys all the content in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.BlockLayoutRow/methods/getContent">content</a>.</p>
                 * @returns sap.ui.layout.BlockLayoutRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyContent(): sap.ui.layout.BlockLayoutRow;
                /**
                 * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAccentCells" href="#/api/sap.ui.layout.BlockLayoutRow/methods/getAccentCells">accentCells</a>.</p>
                 * @returns sap.ui.core.ID[] 
                 */
                getAccentCells(): sap.ui.core.ID[];
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.BlockLayoutRow/methods/getContent">content</a>.</p><p>The content cells to be included in the row.</p>
                 * @returns sap.ui.layout.BlockLayoutCell[] 
                 */
                getContent(): sap.ui.layout.BlockLayoutCell[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getRowColorSet" href="#/api/sap.ui.layout.BlockLayoutRow/methods/getRowColorSet">rowColorSet</a>.</p><p>Defines background type for that row. There might be several rows with the same type</p>
                ...
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getScrollable" href="#/api/sap.ui.layout.BlockLayoutRow/methods/getScrollable">scrollable</a>.</p><p>Sets the rendering mode of the BlockLayoutRow to scrollable. In scrollable mode, the cells get aligned side by side, with horizontal scroll bar for the row.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>scrollable</code></p>
                 */
                getScrollable(): boolean;
                /**
                 * <p>Checks for the provided <code>sap.ui.layout.BlockLayoutCell</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.BlockLayoutRow/methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Inserts a content into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.BlockLayoutRow/methods/getContent">content</a>.</p>
                ...
                /**
                 * <p>Removes an accentCell from the association named <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAccentCells" href="#/api/sap.ui.layout.BlockLayoutRow/methods/getAccentCells">accentCells</a>.</p>
                ...
                /**
                 * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAccentCells" href="#/api/sap.ui.layout.BlockLayoutRow/methods/getAccentCells">accentCells</a>.</p>
                 * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllAccentCells(): sap.ui.core.ID[];
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.BlockLayoutRow/methods/getContent">content</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                ...
                /**
                 * <p>Removes a content from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.BlockLayoutRow/methods/getContent">content</a>.</p>
            ...
            export class DynamicSideContent extends sap.ui.core.Control {
                ...
                /**
                 * <p>Destroys all the mainContent in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getMainContent" href="#/api/sap.ui.layout.DynamicSideContent/methods/getMainContent">mainContent</a>.</p>
                 * @returns sap.ui.layout.DynamicSideContent <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyMainContent(): sap.ui.layout.DynamicSideContent;
                /**
                 * <p>Destroys all the sideContent in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getSideContent" href="#/api/sap.ui.layout.DynamicSideContent/methods/getSideContent">sideContent</a>.</p>
                 * @returns sap.ui.layout.DynamicSideContent <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-sap-ui-target="breakpointChanged" href="#/api/sap.ui.layout.DynamicSideContent/events/breakpointChanged">breakpointChanged</a> to attached listeners.</p>
                ...
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getMainContent" href="#/api/sap.ui.layout.DynamicSideContent/methods/getMainContent">mainContent</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getSideContent" href="#/api/sap.ui.layout.DynamicSideContent/methods/getSideContent">sideContent</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Inserts a mainContent into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getMainContent" href="#/api/sap.ui.layout.DynamicSideContent/methods/getMainContent">mainContent</a>.</p>
                ...
                /**
                 * <p>Inserts a sideContent into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getSideContent" href="#/api/sap.ui.layout.DynamicSideContent/methods/getSideContent">sideContent</a>.</p>
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getMainContent" href="#/api/sap.ui.layout.DynamicSideContent/methods/getMainContent">mainContent</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllMainContent(): sap.ui.core.Control[];
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getSideContent" href="#/api/sap.ui.layout.DynamicSideContent/methods/getSideContent">sideContent</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllSideContent(): sap.ui.core.Control[];
                /**
                 * <p>Removes a mainContent from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getMainContent" href="#/api/sap.ui.layout.DynamicSideContent/methods/getMainContent">mainContent</a>.</p>
                ...
                /**
                 * <p>Removes a sideContent from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getSideContent" href="#/api/sap.ui.layout.DynamicSideContent/methods/getSideContent">sideContent</a>.</p>
            ...
            export class FixFlex extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some fixContent to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getFixContent" href="#/api/sap.ui.layout.FixFlex/methods/getFixContent">fixContent</a>.</p>
                ...
                /**
                 * <p>Inserts a fixContent into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getFixContent" href="#/api/sap.ui.layout.FixFlex/methods/getFixContent">fixContent</a>.</p>
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getFixContent" href="#/api/sap.ui.layout.FixFlex/methods/getFixContent">fixContent</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllFixContent(): sap.ui.core.Control[];
                /**
                 * <p>Removes a fixContent from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getFixContent" href="#/api/sap.ui.layout.FixFlex/methods/getFixContent">fixContent</a>.</p>
                ...
                /**
                 * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getFlexContent" href="#/api/sap.ui.layout.FixFlex/methods/getFlexContent">flexContent</a>.</p>
            ...
            export class Grid extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAriaLabelledBy" href="#/api/sap.ui.layout.Grid/methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                ...
                /**
                 * <p>Adds some content to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.Grid/methods/getContent">content</a>.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content to add; if empty, nothing is inserted</p>
                 * @returns sap.ui.layout.Grid <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                addContent(oContent: sap.ui.core.Control): sap.ui.layout.Grid;
                /**
                 * <p>Destroys all the content in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.Grid/methods/getContent">content</a>.</p>
                 * @returns sap.ui.layout.Grid <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAriaLabelledBy" href="#/api/sap.ui.layout.Grid/methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] 
                 */
                ...
                getContainerQuery(): boolean;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.Grid/methods/getContent">content</a>.</p><p>Controls that are placed into Grid layout.</p>
                 * @returns sap.ui.core.Control[] 
                 */
                getContent(): sap.ui.core.Control[];
                /**
                ...
                getHSpacing(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getPosition" href="#/api/sap.ui.layout.Grid/methods/getPosition">position</a>.</p><p>Optional. Defines the position of the <code>Grid</code> in the window or surrounding container.</p><p>Default value is <code>Left</code>.</p>
                 * @returns sap.ui.layout.GridPosition <p>Value of property <code>position</code></p>
                 */
                getPosition(): sap.ui.layout.GridPosition;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getVSpacing" href="#/api/sap.ui.layout.Grid/methods/getVSpacing">vSpacing</a>.</p><p>Optional. Defines the vertical spacing between the rows in the <code>Grid</code>. In rem, allowed values are 0, 0.5, 1 and 2.</p><p>Default value is <code>1</code>.</p>
                 * @returns number <p>Value of property <code>vSpacing</code></p>
                 */
                getVSpacing(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getWidth" href="#/api/sap.ui.layout.Grid/methods/getWidth">width</a>.</p><p>Optional. Defines the width of the <code>Grid</code>. If not specified, then 100%.</p><p>Default value is <code>100%</code>.</p>
                 * @returns sap.ui.core.CSSSize <p>Value of property <code>width</code></p>
                 */
                getWidth(): sap.ui.core.CSSSize;
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.Grid/methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content whose index is looked for</p>
                 * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                 */
                indexOfContent(oContent: sap.ui.core.Control): number;
                /**
                 * <p>Inserts a content into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.Grid/methods/getContent">content</a>.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content to insert; if empty, nothing is inserted</p>
                 * @param {number} iIndex <p>The <code>0</code>-based index the content should be inserted at; for a negative value of <code>iIndex</code>, the content is inserted at position 0; for a value greater than the current size of the aggregation, the content is inserted at the last position</p>
                 * @returns sap.ui.layout.Grid <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAriaLabelledBy" href="#/api/sap.ui.layout.Grid/methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.Grid/methods/getContent">content</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllContent(): sap.ui.core.Control[];
                /**
                 * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAriaLabelledBy" href="#/api/sap.ui.layout.Grid/methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                ...
                /**
                 * <p>Removes a content from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.Grid/methods/getContent">content</a>.</p>
                 * @param {number | string | sap.ui.core.Control} vContent <p>The content to remove or its index or id</p>
                 * @returns sap.ui.core.Control <p>The removed content or <code>null</code></p>
                 */
                removeContent(vContent: number | string | sap.ui.core.Control): sap.ui.core.Control;
            ...
            export class GridData extends sap.ui.core.LayoutData {
                ...
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getMoveBackwards" href="#/api/sap.ui.layout.GridData/methods/getMoveBackwards">moveBackwards</a>.</p><p>Optional. Moves a cell backwards with as many columns as specified.</p>
                 * @returns sap.ui.layout.GridIndent <p>Value of property <code>moveBackwards</code></p>
                 */
                getMoveBackwards(): sap.ui.layout.GridIndent;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getMoveForward" href="#/api/sap.ui.layout.GridData/methods/getMoveForward">moveForward</a>.</p><p>Optional. Moves a cell forwards with as many columns as specified.</p>
                 * @returns sap.ui.layout.GridIndent <p>Value of property <code>moveForward</code></p>
                 */
                getMoveForward(): sap.ui.layout.GridIndent;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getSpan" href="#/api/sap.ui.layout.GridData/methods/getSpan">span</a>.</p><p>A string type that represents the span values of the <code>Grid</code> for large, medium and small screens.</p><p>Allowed values are separated by space Letters L, M or S followed by number of columns from 1 to 12 that the container has to take, for example: <code>L2 M4 S6</code>, <code>M12</code>, <code>s10</code> or <code>l4 m4</code>.</p><p><b>Note:</b> The parameters must be provided in the order <large medium small>.</p>
                 * @returns sap.ui.layout.GridSpan <p>Value of property <code>span</code></p>
                 */
                getSpan(): sap.ui.layout.GridSpan;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getSpanL" href="#/api/sap.ui.layout.GridData/methods/getSpanL">spanL</a>.</p><p>Optional. Defines a span value for large screens. This value overwrites the value for large screens defined in the <code>span</code> property.</p>
                 * @returns number <p>Value of property <code>spanL</code></p>
                 */
                getSpanL(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getSpanM" href="#/api/sap.ui.layout.GridData/methods/getSpanM">spanM</a>.</p><p>Optional. Defines a span value for medium size screens. This value overwrites the value for medium screens defined in the <code>span</code> property.</p>
                 * @returns number <p>Value of property <code>spanM</code></p>
                 */
                getSpanM(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getSpanS" href="#/api/sap.ui.layout.GridData/methods/getSpanS">spanS</a>.</p><p>Optional. Defines a span value for small screens. This value overwrites the value for small screens defined in the <code>span</code> property.</p>
                 * @returns number <p>Value of property <code>spanS</code></p>
                 */
                getSpanS(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getSpanXL" href="#/api/sap.ui.layout.GridData/methods/getSpanXL">spanXL</a>.</p><p>Optional. Defines a span value for extra large screens. This value overwrites the value for extra large screens defined in the <code>span</code> property.</p>
                 * @returns number <p>Value of property <code>spanXL</code></p>
                 */
                getSpanXL(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getVisibleL" href="#/api/sap.ui.layout.GridData/methods/getVisibleL">visibleL</a>.</p><p>Defines if this control is visible on large screens.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>visibleL</code></p>
                 */
                getVisibleL(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getVisibleM" href="#/api/sap.ui.layout.GridData/methods/getVisibleM">visibleM</a>.</p><p>Defines if this control is visible on medium screens.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>visibleM</code></p>
                 */
                getVisibleM(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getVisibleS" href="#/api/sap.ui.layout.GridData/methods/getVisibleS">visibleS</a>.</p><p>Defines if this control is visible on small screens.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>visibleS</code></p>
                 */
                getVisibleS(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getVisibleXL" href="#/api/sap.ui.layout.GridData/methods/getVisibleXL">visibleXL</a>.</p><p>Defines if this control is visible on extra Large screens.</p><p>Default value is <code>true</code>.</p>
            ...
            export class HorizontalLayout extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some content to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.HorizontalLayout/methods/getContent">content</a>.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content to add; if empty, nothing is inserted</p>
                ...
                /**
                 * <p>Destroys all the content in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.HorizontalLayout/methods/getContent">content</a>.</p>
                 * @returns sap.ui.layout.HorizontalLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                protected getAccessibilityInfo(): any;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAllowWrapping" href="#/api/sap.ui.layout.HorizontalLayout/methods/getAllowWrapping">allowWrapping</a>.</p><p>Specifies whether the content inside the Layout shall be line-wrapped in the case that there is less horizontal space available than required.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>allowWrapping</code></p>
                 */
                getAllowWrapping(): boolean;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.HorizontalLayout/methods/getContent">content</a>.</p><p>The controls inside this layout</p>
                 * @returns sap.ui.core.Control[] 
                 */
                getContent(): sap.ui.core.Control[];
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.HorizontalLayout/methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content whose index is looked for</p>
                 * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                 */
                indexOfContent(oContent: sap.ui.core.Control): number;
                /**
                 * <p>Inserts a content into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.HorizontalLayout/methods/getContent">content</a>.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content to insert; if empty, nothing is inserted</p>
                 * @param {number} iIndex <p>The <code>0</code>-based index the content should be inserted at; for a negative value of <code>iIndex</code>, the content is inserted at position 0; for a value greater than the current size of the aggregation, the content is inserted at the last position</p>
                 * @returns sap.ui.layout.HorizontalLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.HorizontalLayout/methods/getContent">content</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllContent(): sap.ui.core.Control[];
                /**
                 * <p>Removes a content from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.HorizontalLayout/methods/getContent">content</a>.</p>
                 * @param {number | string | sap.ui.core.Control} vContent <p>The content to remove or its index or id</p>
                 * @returns sap.ui.core.Control <p>The removed content or <code>null</code></p>
                 */
                removeContent(vContent: number | string | sap.ui.core.Control): sap.ui.core.Control;
            ...
            export class PaneContainer extends sap.ui.core.Element {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some pane to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getPanes" href="#/api/sap.ui.layout.PaneContainer/methods/getPanes">panes</a>.</p>
                ...
                /**
                 * <p>Destroys all the panes in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getPanes" href="#/api/sap.ui.layout.PaneContainer/methods/getPanes">panes</a>.</p>
                 * @returns sap.ui.layout.PaneContainer <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyPanes(): sap.ui.layout.PaneContainer;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getOrientation" href="#/api/sap.ui.layout.PaneContainer/methods/getOrientation">orientation</a>.</p><p>The orientation of the Splitter</p><p>Default value is <code>Horizontal</code>.</p>
                 * @returns sap.ui.core.Orientation <p>Value of property <code>orientation</code></p>
                 */
                getOrientation(): sap.ui.core.Orientation;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getPanes" href="#/api/sap.ui.layout.PaneContainer/methods/getPanes">panes</a>.</p><p>The Pane that will be shown when there is no suitable pane for ResponsiveSplitter's current width.</p>
                 * @returns sap.ui.core.Element[] 
                 */
                getPanes(): sap.ui.core.Element[];
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Element</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getPanes" href="#/api/sap.ui.layout.PaneContainer/methods/getPanes">panes</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getPanes" href="#/api/sap.ui.layout.PaneContainer/methods/getPanes">panes</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
            ...
            export class ResponsiveFlowLayout extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAriaLabelledBy" href="#/api/sap.ui.layout.ResponsiveFlowLayout/methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to add; if empty, nothing is inserted</p>
                ...
                /**
                 * <p>Destroys all the content in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.ResponsiveFlowLayout/methods/getContent">content</a>.</p>
                 * @returns sap.ui.layout.ResponsiveFlowLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyContent(): sap.ui.layout.ResponsiveFlowLayout;
                /**
                 * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAriaLabelledBy" href="#/api/sap.ui.layout.ResponsiveFlowLayout/methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] 
                 */
                getAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.ResponsiveFlowLayout/methods/getContent">content</a>.</p><p>Added content that should be positioned. Every content item should have a ResponsiveFlowLayoutData attached, or otherwise, the default values are used.</p>
                 * @returns sap.ui.core.Control[] 
                 */
                getContent(): sap.ui.core.Control[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getResponsive" href="#/api/sap.ui.layout.ResponsiveFlowLayout/methods/getResponsive">responsive</a>.</p><p>If set to false, all added controls will keep their width, or otherwise, the controls will be stretched to the possible width of a row.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>responsive</code></p>
                 */
                getResponsive(): boolean;
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.ResponsiveFlowLayout/methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content whose index is looked for</p>
                 * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                 */
                indexOfContent(oContent: sap.ui.core.Control): number;
                ...
                /**
                 * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAriaLabelledBy" href="#/api/sap.ui.layout.ResponsiveFlowLayout/methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.ResponsiveFlowLayout/methods/getContent">content</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllContent(): sap.ui.core.Control[];
                /**
                 * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAriaLabelledBy" href="#/api/sap.ui.layout.ResponsiveFlowLayout/methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {number | sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to be removed or its index or ID</p>
                 * @returns sap.ui.core.ID <p>The removed ariaLabelledBy or <code>null</code></p>
                 */
                removeAriaLabelledBy(vAriaLabelledBy: number | sap.ui.core.ID | sap.ui.core.Control): sap.ui.core.ID;
            ...
            export class ResponsiveSplitter extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Destroys the rootPaneContainer in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getRootPaneContainer" href="#/api/sap.ui.layout.ResponsiveSplitter/methods/getRootPaneContainer">rootPaneContainer</a>.</p>
                ...
                /**
                 * <p>ID of the element which is the current target of the association <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getDefaultPane" href="#/api/sap.ui.layout.ResponsiveSplitter/methods/getDefaultPane">defaultPane</a>, or <code>null</code>.</p>
                 * @returns sap.ui.core.ID 
                 */
                getDefaultPane(): sap.ui.core.ID;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getHeight" href="#/api/sap.ui.layout.ResponsiveSplitter/methods/getHeight">height</a>.</p><p>The height of the control</p><p>Default value is <code>100%</code>.</p>
                 * @returns sap.ui.core.CSSSize <p>Value of property <code>height</code></p>
                 */
                getHeight(): sap.ui.core.CSSSize;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getRootPaneContainer" href="#/api/sap.ui.layout.ResponsiveSplitter/methods/getRootPaneContainer">rootPaneContainer</a>.</p><p>The root PaneContainer of the ResponsiveSplitter</p>
                 * @returns sap.ui.layout.PaneContainer 
                 */
                getRootPaneContainer(): sap.ui.layout.PaneContainer;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getWidth" href="#/api/sap.ui.layout.ResponsiveSplitter/methods/getWidth">width</a>.</p><p>The width of the control</p><p>Default value is <code>100%</code>.</p>
                 * @returns sap.ui.core.CSSSize <p>Value of property <code>width</code></p>
                 */
                getWidth(): sap.ui.core.CSSSize;
                /**
                 * <p>Sets the associated <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getDefaultPane" href="#/api/sap.ui.layout.ResponsiveSplitter/methods/getDefaultPane">defaultPane</a>.</p>
                ...
                /**
                 * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getRootPaneContainer" href="#/api/sap.ui.layout.ResponsiveSplitter/methods/getRootPaneContainer">rootPaneContainer</a>.</p>
            ...
            export class SplitPane extends sap.ui.core.Element {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Destroys the content in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.SplitPane/methods/getContent">content</a>.</p>
            ...
            export class Splitter extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some contentArea to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContentAreas" href="#/api/sap.ui.layout.Splitter/methods/getContentAreas">contentAreas</a>.</p>
                ...
                /**
                 * <p>Destroys all the contentAreas in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContentAreas" href="#/api/sap.ui.layout.Splitter/methods/getContentAreas">contentAreas</a>.</p>
                 * @returns sap.ui.layout.Splitter <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-sap-ui-target="resize" href="#/api/sap.ui.layout.Splitter/events/resize">resize</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.layout.Splitter <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireResize(mParameters?: any): sap.ui.layout.Splitter;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContentAreas" href="#/api/sap.ui.layout.Splitter/methods/getContentAreas">contentAreas</a>.</p><p>The content areas to be split. The control will show n-1 splitter bars between n controls in this aggregation.</p>
                 * @returns sap.ui.core.Control[] 
                 */
                getContentAreas(): sap.ui.core.Control[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getHeight" href="#/api/sap.ui.layout.Splitter/methods/getHeight">height</a>.</p><p>The height of the control</p><p>Default value is <code>100%</code>.</p>
                 * @returns sap.ui.core.CSSSize <p>Value of property <code>height</code></p>
                 */
                getHeight(): sap.ui.core.CSSSize;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getOrientation" href="#/api/sap.ui.layout.Splitter/methods/getOrientation">orientation</a>.</p><p>Whether to split the contents horizontally (default) or vertically.</p><p>Default value is <code>Horizontal</code>.</p>
                 * @returns sap.ui.core.Orientation <p>Value of property <code>orientation</code></p>
                 */
                getOrientation(): sap.ui.core.Orientation;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getWidth" href="#/api/sap.ui.layout.Splitter/methods/getWidth">width</a>.</p><p>The width of the control</p><p>Default value is <code>100%</code>.</p>
                 * @returns sap.ui.core.CSSSize <p>Value of property <code>width</code></p>
                 */
                getWidth(): sap.ui.core.CSSSize;
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContentAreas" href="#/api/sap.ui.layout.Splitter/methods/getContentAreas">contentAreas</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Inserts a contentArea into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContentAreas" href="#/api/sap.ui.layout.Splitter/methods/getContentAreas">contentAreas</a>.</p>
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContentAreas" href="#/api/sap.ui.layout.Splitter/methods/getContentAreas">contentAreas</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllContentAreas(): sap.ui.core.Control[];
                /**
                 * <p>Removes a contentArea from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContentAreas" href="#/api/sap.ui.layout.Splitter/methods/getContentAreas">contentAreas</a>.</p>
            ...
            export class SplitterLayoutData extends sap.ui.core.LayoutData {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getMinSize" href="#/api/sap.ui.layout.SplitterLayoutData/methods/getMinSize">minSize</a>.</p><p>Sets the minimum size of the splitter content in px.</p><p>Default value is <code>0</code>.</p>
                 * @returns number <p>Value of property <code>minSize</code></p>
                 */
                getMinSize(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getResizable" href="#/api/sap.ui.layout.SplitterLayoutData/methods/getResizable">resizable</a>.</p><p>Determines whether the control in the splitter can be resized or not.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>resizable</code></p>
                 */
                getResizable(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getSize" href="#/api/sap.ui.layout.SplitterLayoutData/methods/getSize">size</a>.</p><p>Sets the size of the splitter content.</p><p>Default value is <code>auto</code>.</p>
                 * @returns sap.ui.core.CSSSize <p>Value of property <code>size</code></p>
                 */
                getSize(): sap.ui.core.CSSSize;
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getMinSize" href="#/api/sap.ui.layout.SplitterLayoutData/methods/getMinSize">minSize</a>.</p><p>Sets the minimum size of the splitter content in px.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>0</code>.</p>
            ...
            export class VerticalLayout extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some content to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.VerticalLayout/methods/getContent">content</a>.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content to add; if empty, nothing is inserted</p>
                ...
                /**
                 * <p>Destroys all the content in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.VerticalLayout/methods/getContent">content</a>.</p>
                 * @returns sap.ui.layout.VerticalLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                protected getAccessibilityInfo(): any;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.VerticalLayout/methods/getContent">content</a>.</p><p>Content controls within the layout.</p>
                 * @returns sap.ui.core.Control[] 
                 */
                getContent(): sap.ui.core.Control[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getEnabled" href="#/api/sap.ui.layout.VerticalLayout/methods/getEnabled">enabled</a>.</p><p>If not enabled, all controls inside are not enabled automatically.</p><p>Default value is <code>true</code>.</p>
                ...
                getWidth(): sap.ui.core.CSSSize;
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.VerticalLayout/methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content whose index is looked for</p>
                 * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                 */
                indexOfContent(oContent: sap.ui.core.Control): number;
                /**
                 * <p>Inserts a content into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.VerticalLayout/methods/getContent">content</a>.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content to insert; if empty, nothing is inserted</p>
                 * @param {number} iIndex <p>The <code>0</code>-based index the content should be inserted at; for a negative value of <code>iIndex</code>, the content is inserted at position 0; for a value greater than the current size of the aggregation, the content is inserted at the last position</p>
                 * @returns sap.ui.layout.VerticalLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.VerticalLayout/methods/getContent">content</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllContent(): sap.ui.core.Control[];
                /**
                 * <p>Removes a content from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.VerticalLayout/methods/getContent">content</a>.</p>
                 * @param {number | string | sap.ui.core.Control} vContent <p>The content to remove or its index or id</p>
                 * @returns sap.ui.core.Control <p>The removed content or <code>null</code></p>
                 */
                removeContent(vContent: number | string | sap.ui.core.Control): sap.ui.core.Control;
...
declare namespace sap {
    namespace ui {
        namespace layout {
            namespace cssgrid {
                /**
                 * <p><p>A string type that represents a grid track (the space between two grid lines)</p><br><br>References: <ul><li><a target="_blank" href="https://developer.mozilla.org/en-US/docs/Glossary/Grid_tracks">https://developer.mozilla.org/en-US/docs/Glossary/Grid_tracks</a>
                <img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
                title="Information published on non SAP site" class="sapUISDKExternalLink"/></li></ul></p>
                 */
        ...
        namespace layout {
            ...
            namespace cssgrid {
                ...
                export class CSSGrid extends sap.ui.core.Control implements sap.ui.layout.cssgrid.IGridConfigurable {
                    ...
                    constructor(sId?: string, mSettings?: any);
                    /**
                     * <p>Adds some item to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getItems" href="#/api/sap.ui.layout.cssgrid.CSSGrid/methods/getItems">items</a>.</p>
                    ...
                    /**
                     * <p>Destroys the customLayout in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getCustomLayout" href="#/api/sap.ui.layout.cssgrid.CSSGrid/methods/getCustomLayout">customLayout</a>.</p>
                     * @returns sap.ui.layout.cssgrid.CSSGrid <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyCustomLayout(): sap.ui.layout.cssgrid.CSSGrid;
                    /**
                     * <p>Destroys all the items in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getItems" href="#/api/sap.ui.layout.cssgrid.CSSGrid/methods/getItems">items</a>.</p>
                     * @returns sap.ui.layout.cssgrid.CSSGrid <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyItems(): sap.ui.layout.cssgrid.CSSGrid;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getCustomLayout" href="#/api/sap.ui.layout.cssgrid.CSSGrid/methods/getCustomLayout">customLayout</a>.</p><p>Defines a custom Grid layout for the control. If provided, it will override all of the grid properties.</p>
                     * @returns sap.ui.layout.cssgrid.GridLayoutBase 
                     */
                    getCustomLayout(): sap.ui.layout.cssgrid.GridLayoutBase;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getGridAutoColumns" href="#/api/sap.ui.layout.cssgrid.CSSGrid/methods/getGridAutoColumns">gridAutoColumns</a>.</p><p>Sets the value for the CSS display:grid property <a target="_blank" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-auto-columns">MDN web docs: grid-auto-columns</a>
                    <img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
                    ...
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getGridAutoFlow" href="#/api/sap.ui.layout.cssgrid.CSSGrid/methods/getGridAutoFlow">gridAutoFlow</a>.</p><p>Sets the value for the CSS display:grid property <a target="_blank" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-auto-flow">MDN web docs: grid-auto-flow</a>
                    <img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
                    ...
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getGridAutoRows" href="#/api/sap.ui.layout.cssgrid.CSSGrid/methods/getGridAutoRows">gridAutoRows</a>.</p><p>Sets the value for the CSS display:grid property <a target="_blank" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-auto-rows">MDN web docs: grid-auto-rows</a>
                    <img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
                    title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p><b>Note:</b> Not supported in IE11, Edge 15.</p><p>Default value is <code>empty string</code>.</p>
                    ...
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getGridColumnGap" href="#/api/sap.ui.layout.cssgrid.CSSGrid/methods/getGridColumnGap">gridColumnGap</a>.</p><p>Sets the value for the CSS display:grid property <a target="_blank" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-column-gap">MDN web docs: grid-column-gap</a>
                    <img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
                    title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p><b>Note:</b> Not supported in IE11, Edge 15.</p><p>Default value is <code>empty string</code>.</p>
                    ...
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getGridGap" href="#/api/sap.ui.layout.cssgrid.CSSGrid/methods/getGridGap">gridGap</a>.</p><p>Sets the value for the CSS display:grid property <a target="_blank" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-gap">MDN web docs: grid-gap</a>
                    <img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
                    ...
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getGridRowGap" href="#/api/sap.ui.layout.cssgrid.CSSGrid/methods/getGridRowGap">gridRowGap</a>.</p><p>Sets the value for the CSS display:grid property <a target="_blank" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-row-gap">MDN web docs: grid-row-gap</a>
                    <img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
                    title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p><b>Note:</b> Not supported in IE11, Edge 15.</p><p>Default value is <code>empty string</code>.</p>
                    ...
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getGridTemplateColumns" href="#/api/sap.ui.layout.cssgrid.CSSGrid/methods/getGridTemplateColumns">gridTemplateColumns</a>.</p><p>Sets the value for the CSS display:grid property <a target="_blank" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-template-columns">MDN web docs: grid-template-columns</a>
                    <img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
                    title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p><b>Note:</b> Not supported in IE11, Edge 15.</p><p>Default value is <code>empty string</code>.</p>
                    ...
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getGridTemplateRows" href="#/api/sap.ui.layout.cssgrid.CSSGrid/methods/getGridTemplateRows">gridTemplateRows</a>.</p><p>Sets the value for the CSS display:grid property <a target="_blank" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-template-rows">MDN web docs: grid-template-rows</a>
                    <img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
                    title="Information published on non SAP site" class="sapUISDKExternalLink"/></p><p><b>Note:</b> Not supported in IE11, Edge 15.</p><p>Default value is <code>empty string</code>.</p>
                    ...
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getItems" href="#/api/sap.ui.layout.cssgrid.CSSGrid/methods/getItems">items</a>.</p><p>The items contained by the control.</p>
                     * @returns sap.ui.core.Control[] 
                     */
                    getItems(): sap.ui.core.Control[];
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getWidth" href="#/api/sap.ui.layout.cssgrid.CSSGrid/methods/getWidth">width</a>.</p><p>The width of the control</p><p>Default value is <code>100%</code>.</p>
                     * @returns sap.ui.core.CSSSize <p>Value of property <code>width</code></p>
                     */
                    getWidth(): sap.ui.core.CSSSize;
                    /**
                     * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getItems" href="#/api/sap.ui.layout.cssgrid.CSSGrid/methods/getItems">items</a>. and returns its index if found or -1 otherwise.</p>
                     * @param {sap.ui.core.Control} oItem <p>The item whose index is looked for</p>
                     * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                     */
                    indexOfItem(oItem: sap.ui.core.Control): number;
                    /**
                     * <p>Inserts a item into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getItems" href="#/api/sap.ui.layout.cssgrid.CSSGrid/methods/getItems">items</a>.</p>
                    ...
                    /**
                     * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getItems" href="#/api/sap.ui.layout.cssgrid.CSSGrid/methods/getItems">items</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                     * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllItems(): sap.ui.core.Control[];
                    /**
                     * <p>Removes a item from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getItems" href="#/api/sap.ui.layout.cssgrid.CSSGrid/methods/getItems">items</a>.</p>
                    ...
                    /**
                     * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getCustomLayout" href="#/api/sap.ui.layout.cssgrid.CSSGrid/methods/getCustomLayout">customLayout</a>.</p>
                ...
                /**
                 * <p><p>A string type that is used for CSS grid to control how the auto-placement algorithm works, specifying exactly how auto-placed items get flowed into the grid.</p><br><br>References: <ul><li><a target="_blank" href="https://developer.mozilla.org/en-US/docs/Web/CSS/grid-auto-flow">https://developer.mozilla.org/en-US/docs/Web/CSS/grid-auto-flow</a>
                <img src="./resources/sap/ui/documentation/sdk/images/link-external.png"
                title="Information published on non SAP site" class="sapUISDKExternalLink"/></li></ul></p>
                 */
                ...
                export class GridBoxLayout extends sap.ui.layout.cssgrid.GridLayoutBase {
                    ...
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getBoxMinWidth" href="#/api/sap.ui.layout.cssgrid.GridBoxLayout/methods/getBoxMinWidth">boxMinWidth</a>.</p><p>Defines the minimum width of the Boxes</p><p>Default value is <code>empty string</code>.</p>
                     * @returns sap.ui.core.CSSSize <p>Value of property <code>boxMinWidth</code></p>
                     */
                    getBoxMinWidth(): sap.ui.core.CSSSize;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getBoxWidth" href="#/api/sap.ui.layout.cssgrid.GridBoxLayout/methods/getBoxWidth">boxWidth</a>.</p><p>Defines the width of the Boxes</p><p>Default value is <code>empty string</code>.</p>
                ...
                export class GridResponsiveLayout extends sap.ui.layout.cssgrid.GridLayoutBase {
                    ...
                    /**
                     * <p>Destroys the layout in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getLayout" href="#/api/sap.ui.layout.cssgrid.GridResponsiveLayout/methods/getLayout">layout</a>.</p>
                     * @returns sap.ui.layout.cssgrid.GridResponsiveLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyLayout(): sap.ui.layout.cssgrid.GridResponsiveLayout;
                    /**
                     * <p>Destroys the layoutL in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getLayoutL" href="#/api/sap.ui.layout.cssgrid.GridResponsiveLayout/methods/getLayoutL">layoutL</a>.</p>
                     * @returns sap.ui.layout.cssgrid.GridResponsiveLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyLayoutL(): sap.ui.layout.cssgrid.GridResponsiveLayout;
                    /**
                     * <p>Destroys the layoutM in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getLayoutM" href="#/api/sap.ui.layout.cssgrid.GridResponsiveLayout/methods/getLayoutM">layoutM</a>.</p>
                     * @returns sap.ui.layout.cssgrid.GridResponsiveLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyLayoutM(): sap.ui.layout.cssgrid.GridResponsiveLayout;
                    /**
                     * <p>Destroys the layoutS in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getLayoutS" href="#/api/sap.ui.layout.cssgrid.GridResponsiveLayout/methods/getLayoutS">layoutS</a>.</p>
                     * @returns sap.ui.layout.cssgrid.GridResponsiveLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyLayoutS(): sap.ui.layout.cssgrid.GridResponsiveLayout;
                    /**
                     * <p>Destroys the layoutXL in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getLayoutXL" href="#/api/sap.ui.layout.cssgrid.GridResponsiveLayout/methods/getLayoutXL">layoutXL</a>.</p>
                     * @returns sap.ui.layout.cssgrid.GridResponsiveLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-sap-ui-target="layoutChange" href="#/api/sap.ui.layout.cssgrid.GridResponsiveLayout/events/layoutChange">layoutChange</a> to attached listeners.</p>
                     * @param {any} mParameters <p>Parameters to pass along with the event</p>
                     * @returns sap.ui.layout.cssgrid.GridResponsiveLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    getContainerQuery(): boolean;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getLayout" href="#/api/sap.ui.layout.cssgrid.GridResponsiveLayout/methods/getLayout">layout</a>.</p><p>The sap.ui.layout.cssgrid.GridSettings applied if no settings are provided for a specific size</p>
                     * @returns sap.ui.layout.cssgrid.GridSettings 
                     */
                    getLayout(): sap.ui.layout.cssgrid.GridSettings;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getLayoutL" href="#/api/sap.ui.layout.cssgrid.GridResponsiveLayout/methods/getLayoutL">layoutL</a>.</p><p>The sap.ui.layout.cssgrid.GridSettings applied for size "L"</p>
                     * @returns sap.ui.layout.cssgrid.GridSettings 
                     */
                    getLayoutL(): sap.ui.layout.cssgrid.GridSettings;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getLayoutM" href="#/api/sap.ui.layout.cssgrid.GridResponsiveLayout/methods/getLayoutM">layoutM</a>.</p><p>The sap.ui.layout.cssgrid.GridSettings applied for size "M"</p>
                     * @returns sap.ui.layout.cssgrid.GridSettings 
                     */
                    getLayoutM(): sap.ui.layout.cssgrid.GridSettings;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getLayoutS" href="#/api/sap.ui.layout.cssgrid.GridResponsiveLayout/methods/getLayoutS">layoutS</a>.</p><p>The sap.ui.layout.cssgrid.GridSettings applied for size "S"</p>
                     * @returns sap.ui.layout.cssgrid.GridSettings 
                     */
                    getLayoutS(): sap.ui.layout.cssgrid.GridSettings;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getLayoutXL" href="#/api/sap.ui.layout.cssgrid.GridResponsiveLayout/methods/getLayoutXL">layoutXL</a>.</p><p>The sap.ui.layout.cssgrid.GridSettings applied for size "XL"</p>
                     * @returns sap.ui.layout.cssgrid.GridSettings 
                     */
                    ...
                    /**
                     * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getLayout" href="#/api/sap.ui.layout.cssgrid.GridResponsiveLayout/methods/getLayout">layout</a>.</p>
                    ...
                    /**
                     * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getLayoutL" href="#/api/sap.ui.layout.cssgrid.GridResponsiveLayout/methods/getLayoutL">layoutL</a>.</p>
                    ...
                    /**
                     * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getLayoutM" href="#/api/sap.ui.layout.cssgrid.GridResponsiveLayout/methods/getLayoutM">layoutM</a>.</p>
                    ...
                    /**
                     * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getLayoutS" href="#/api/sap.ui.layout.cssgrid.GridResponsiveLayout/methods/getLayoutS">layoutS</a>.</p>
                    ...
                    /**
                     * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getLayoutXL" href="#/api/sap.ui.layout.cssgrid.GridResponsiveLayout/methods/getLayoutXL">layoutXL</a>.</p>
        ...
        namespace layout {
            ...
            namespace form {
                ...
                export class ColumnLayout extends sap.ui.layout.form.FormLayout {
                    ...
                    getColumnsL(): sap.ui.layout.form.ColumnsL;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getColumnsM" href="#/api/sap.ui.layout.form.ColumnLayout/methods/getColumnsM">columnsM</a>.</p><p>Number of columns for medium size.</p><p>Default value is <code>1</code>.</p>
                     * @returns sap.ui.layout.form.ColumnsM <p>Value of property <code>columnsM</code></p>
                     */
                    getColumnsM(): sap.ui.layout.form.ColumnsM;
                    /**
                    ...
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getLabelCellsLarge" href="#/api/sap.ui.layout.form.ColumnLayout/methods/getLabelCellsLarge">labelCellsLarge</a>.</p><p>Defines how many cells a label uses if the column is large.</p><p>Default value is <code>4</code>.</p>
                ...
                export class Form extends sap.ui.core.Control {
                    ...
                    constructor(sId?: string, mSettings?: any);
                    /**
                     * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAriaLabelledBy" href="#/api/sap.ui.layout.form.Form/methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @param {sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to add; if empty, nothing is inserted</p>
                    ...
                    /**
                     * <p>Adds some formContainer to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getFormContainers" href="#/api/sap.ui.layout.form.Form/methods/getFormContainers">formContainers</a>.</p>
                    ...
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getToolbar" href="#/api/sap.ui.layout.form.Form/methods/getToolbar">toolbar</a>.</p><p>Toolbar of the <code>Form</code>.</p><p><b>Note:</b> If a <code>Toolbar</code> is used, the <code>Title</code> is ignored. If a title is needed inside the <code>Toolbar</code> it must be added at content to the <code>Toolbar</code>. In this case add the <code>Title</code> to the <code>ariaLabelledBy</code> association.</p>
                     * @returns sap.ui.core.Toolbar 
                     */
                    getToolbar(): sap.ui.core.Toolbar;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getWidth" href="#/api/sap.ui.layout.form.Form/methods/getWidth">width</a>.</p><p>Width of the <code>Form</code>.</p>
                     * @returns sap.ui.core.CSSSize <p>Value of property <code>width</code></p>
                     */
                    getWidth(): sap.ui.core.CSSSize;
                    /**
                     * <p>Checks for the provided <code>sap.ui.layout.form.FormContainer</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getFormContainers" href="#/api/sap.ui.layout.form.Form/methods/getFormContainers">formContainers</a>. and returns its index if found or -1 otherwise.</p>
                    ...
                    /**
                     * <p>Inserts a formContainer into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getFormContainers" href="#/api/sap.ui.layout.form.Form/methods/getFormContainers">formContainers</a>.</p>
                    ...
                    /**
                     * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAriaLabelledBy" href="#/api/sap.ui.layout.form.Form/methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllAriaLabelledBy(): sap.ui.core.ID[];
                    /**
                     * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getFormContainers" href="#/api/sap.ui.layout.form.Form/methods/getFormContainers">formContainers</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                    ...
                    /**
                     * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAriaLabelledBy" href="#/api/sap.ui.layout.form.Form/methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @param {number | sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to be removed or its index or ID</p>
                     * @returns sap.ui.core.ID <p>The removed ariaLabelledBy or <code>null</code></p>
                     */
                    removeAriaLabelledBy(vAriaLabelledBy: number | sap.ui.core.ID | sap.ui.core.Control): sap.ui.core.ID;
                    /**
                     * <p>Removes a formContainer from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getFormContainers" href="#/api/sap.ui.layout.form.Form/methods/getFormContainers">formContainers</a>.</p>
                    ...
                    /**
                     * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getLayout" href="#/api/sap.ui.layout.form.Form/methods/getLayout">layout</a>.</p>
                    ...
                    /**
                     * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getTitle" href="#/api/sap.ui.layout.form.Form/methods/getTitle">title</a>.</p>
                    ...
                    /**
                     * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getToolbar" href="#/api/sap.ui.layout.form.Form/methods/getToolbar">toolbar</a>.</p>
                ...
                export class FormContainer extends sap.ui.core.Element {
                    ...
                    constructor(sId?: string, mSettings?: any);
                    /**
                     * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAriaLabelledBy" href="#/api/sap.ui.layout.form.FormContainer/methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @param {sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to add; if empty, nothing is inserted</p>
                    ...
                    /**
                     * <p>Adds some formElement to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getFormElements" href="#/api/sap.ui.layout.form.FormContainer/methods/getFormElements">formElements</a>.</p>
                    ...
                    /**
                     * <p>Destroys all the formElements in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getFormElements" href="#/api/sap.ui.layout.form.FormContainer/methods/getFormElements">formElements</a>.</p>
                     * @returns sap.ui.layout.form.FormContainer <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyFormElements(): sap.ui.layout.form.FormContainer;
                    /**
                     * <p>Destroys the title in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getTitle" href="#/api/sap.ui.layout.form.FormContainer/methods/getTitle">title</a>.</p>
                     * @returns sap.ui.layout.form.FormContainer <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyTitle(): sap.ui.layout.form.FormContainer;
                    /**
                     * <p>Destroys the toolbar in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getToolbar" href="#/api/sap.ui.layout.form.FormContainer/methods/getToolbar">toolbar</a>.</p>
                     * @returns sap.ui.layout.form.FormContainer <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyToolbar(): sap.ui.layout.form.FormContainer;
                    /**
                     * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAriaLabelledBy" href="#/api/sap.ui.layout.form.FormContainer/methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @returns sap.ui.core.ID[] 
                     */
                    getAriaLabelledBy(): sap.ui.core.ID[];
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getExpandable" href="#/api/sap.ui.layout.form.FormContainer/methods/getExpandable">expandable</a>.</p><p>Defines if the <code>FormContainer</code> is expandable.</p><p><b>Note:</b> The expander icon will only be shown if a <code>title</code> is set for the <code>FormContainer</code>.</p><p>Default value is <code>false</code>.</p>
                     * @returns boolean <p>Value of property <code>expandable</code></p>
                     */
                    getExpandable(): boolean;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getExpanded" href="#/api/sap.ui.layout.form.FormContainer/methods/getExpanded">expanded</a>.</p><p>Container is expanded.</p><p><b>Note:</b> This property only works if <code>expandable</code> is set to <code>true</code>.</p><p>Default value is <code>true</code>.</p>
                     * @returns boolean <p>Value of property <code>expanded</code></p>
                     */
                    getExpanded(): boolean;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getFormElements" href="#/api/sap.ui.layout.form.FormContainer/methods/getFormElements">formElements</a>.</p><p>The <code>FormElements</code> contain the content (labels and fields) of the <code>FormContainers</code>.</p>
                    ...
                    getToolbar(): sap.ui.core.Toolbar;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getVisible" href="#/api/sap.ui.layout.form.FormContainer/methods/getVisible">visible</a>.</p><p>If set to <code>false</code>, the <code>FormContainer</code> is not rendered.</p><p>Default value is <code>true</code>.</p>
                     * @returns boolean <p>Value of property <code>visible</code></p>
                     */
                    getVisible(): boolean;
                    /**
                     * <p>Checks for the provided <code>sap.ui.layout.form.FormElement</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getFormElements" href="#/api/sap.ui.layout.form.FormContainer/methods/getFormElements">formElements</a>. and returns its index if found or -1 otherwise.</p>
                    ...
                    /**
                     * <p>Inserts a formElement into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getFormElements" href="#/api/sap.ui.layout.form.FormContainer/methods/getFormElements">formElements</a>.</p>
                    ...
                    isVisible(): boolean;
                    /**
                     * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAriaLabelledBy" href="#/api/sap.ui.layout.form.FormContainer/methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllAriaLabelledBy(): sap.ui.core.ID[];
                    /**
                     * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getFormElements" href="#/api/sap.ui.layout.form.FormContainer/methods/getFormElements">formElements</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                    ...
                    /**
                     * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAriaLabelledBy" href="#/api/sap.ui.layout.form.FormContainer/methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @param {number | sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to be removed or its index or ID</p>
                     * @returns sap.ui.core.ID <p>The removed ariaLabelledBy or <code>null</code></p>
                     */
                    removeAriaLabelledBy(vAriaLabelledBy: number | sap.ui.core.ID | sap.ui.core.Control): sap.ui.core.ID;
                    /**
                     * <p>Removes a formElement from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getFormElements" href="#/api/sap.ui.layout.form.FormContainer/methods/getFormElements">formElements</a>.</p>
                ...
                export class FormElement extends sap.ui.core.Element {
                    ...
                    constructor(sId?: string, mSettings?: any);
                    /**
                     * <p>Adds some field to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getFields" href="#/api/sap.ui.layout.form.FormElement/methods/getFields">fields</a>.</p>
                    ...
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getVisible" href="#/api/sap.ui.layout.form.FormElement/methods/getVisible">visible</a>.</p><p>If set to <code>false</code>, the <code>FormElement</code> is not rendered.</p><p>Default value is <code>true</code>.</p>
                     * @returns boolean <p>Value of property <code>visible</code></p>
                     */
                    getVisible(): boolean;
                    /**
                     * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getFields" href="#/api/sap.ui.layout.form.FormElement/methods/getFields">fields</a>. and returns its index if found or -1 otherwise.</p>
                     * @param {sap.ui.core.Control} oField <p>The field whose index is looked for</p>
                     * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                     */
                    indexOfField(oField: sap.ui.core.Control): number;
                    /**
                     * <p>Inserts a field into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getFields" href="#/api/sap.ui.layout.form.FormElement/methods/getFields">fields</a>.</p>
                    ...
                    isVisible(): boolean;
                    /**
                     * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getFields" href="#/api/sap.ui.layout.form.FormElement/methods/getFields">fields</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                     * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllFields(): sap.ui.core.Control[];
                    /**
                     * <p>Removes a field from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getFields" href="#/api/sap.ui.layout.form.FormElement/methods/getFields">fields</a>.</p>
                    ...
                    /**
                     * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getLabel" href="#/api/sap.ui.layout.form.FormElement/methods/getLabel">label</a>.</p>
                ...
                export class ResponsiveGridLayout extends sap.ui.layout.form.FormLayout {
                    ...
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getBreakpointL" href="#/api/sap.ui.layout.form.ResponsiveGridLayout/methods/getBreakpointL">breakpointL</a>.</p><p>Breakpoint (in pixel) between Medium size and Large size.</p><p>Default value is <code>1024</code>.</p>
                     * @returns number <p>Value of property <code>breakpointL</code></p>
                     */
                    getBreakpointL(): number;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getBreakpointM" href="#/api/sap.ui.layout.form.ResponsiveGridLayout/methods/getBreakpointM">breakpointM</a>.</p><p>Breakpoint (in pixel) between Small size and Medium size.</p><p>Default value is <code>600</code>.</p>
                     * @returns number <p>Value of property <code>breakpointM</code></p>
                     */
                    getBreakpointM(): number;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getBreakpointXL" href="#/api/sap.ui.layout.form.ResponsiveGridLayout/methods/getBreakpointXL">breakpointXL</a>.</p><p>Breakpoint (in pixel) between large size and extra large (XL) size.</p><p>Default value is <code>1440</code>.</p>
                    ...
                    getColumnsL(): number;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getColumnsM" href="#/api/sap.ui.layout.form.ResponsiveGridLayout/methods/getColumnsM">columnsM</a>.</p><p>Number of columns for medium size.</p><p>Default value is <code>1</code>.</p>
                ...
                export class SimpleForm extends sap.ui.core.Control {
                    ...
                    constructor(sId?: string, mSettings?: any);
                    /**
                     * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAriaLabelledBy" href="#/api/sap.ui.layout.form.SimpleForm/methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @param {sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to add; if empty, nothing is inserted</p>
                    ...
                    /**
                     * <p>Adds some content to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.form.SimpleForm/methods/getContent">content</a>.</p>
                    ...
                    /**
                     * <p>Destroys all the content in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.form.SimpleForm/methods/getContent">content</a>.</p>
                     * @returns sap.ui.layout.form.SimpleForm <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyContent(): sap.ui.layout.form.SimpleForm;
                    /**
                     * <p>Destroys the title in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getTitle" href="#/api/sap.ui.layout.form.SimpleForm/methods/getTitle">title</a>.</p>
                     * @returns sap.ui.layout.form.SimpleForm <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyTitle(): sap.ui.layout.form.SimpleForm;
                    /**
                     * <p>Destroys the toolbar in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getToolbar" href="#/api/sap.ui.layout.form.SimpleForm/methods/getToolbar">toolbar</a>.</p>
                     * @returns sap.ui.layout.form.SimpleForm <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    getAdjustLabelSpan(): boolean;
                    /**
                     * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAriaLabelledBy" href="#/api/sap.ui.layout.form.SimpleForm/methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @returns sap.ui.core.ID[] 
                     */
                    getAriaLabelledBy(): sap.ui.core.ID[];
                    /**
                    ...
                    getSingleContainerFullSize(): boolean;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getTitle" href="#/api/sap.ui.layout.form.SimpleForm/methods/getTitle">title</a>.</p><p>Title element of the <code>SimpleForm</code>. Can either be a <code>Title</code> element, or a string.</p>
                     * @returns sap.ui.core.Title|string 
                     */
                    getTitle(): sap.ui.core.Title | string;
                    /**
                    ...
                    getToolbar(): sap.ui.core.Toolbar;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getWidth" href="#/api/sap.ui.layout.form.SimpleForm/methods/getWidth">width</a>.</p><p>Width of the form.</p>
                     * @returns sap.ui.core.CSSSize <p>Value of property <code>width</code></p>
                     */
                    getWidth(): sap.ui.core.CSSSize;
                    /**
                     * <p>Checks for the provided <code>sap.ui.core.Element</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.form.SimpleForm/methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
                    ...
                    /**
                     * <p>Inserts a content into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.form.SimpleForm/methods/getContent">content</a>.</p>
                    ...
                    /**
                     * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAriaLabelledBy" href="#/api/sap.ui.layout.form.SimpleForm/methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllAriaLabelledBy(): sap.ui.core.ID[];
                    /**
                     * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.form.SimpleForm/methods/getContent">content</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                     * @returns sap.ui.core.Element[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllContent(): sap.ui.core.Element[];
                    /**
                     * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getAriaLabelledBy" href="#/api/sap.ui.layout.form.SimpleForm/methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @param {number | sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to be removed or its index or ID</p>
                     * @returns sap.ui.core.ID <p>The removed ariaLabelledBy or <code>null</code></p>
                     */
                    removeAriaLabelledBy(vAriaLabelledBy: number | sap.ui.core.ID | sap.ui.core.Control): sap.ui.core.ID;
                    /**
                     * <p>Removes a content from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getContent" href="#/api/sap.ui.layout.form.SimpleForm/methods/getContent">content</a>.</p>
                    ...
                    /**
                     * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getTitle" href="#/api/sap.ui.layout.form.SimpleForm/methods/getTitle">title</a>.</p>
                     * @param {sap.ui.core.Title | string} vTitle <p>The title to set</p>
                     * @returns sap.ui.layout.form.SimpleForm <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    setTitle(vTitle: sap.ui.core.Title | string): sap.ui.layout.form.SimpleForm;
                    /**
                     * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getToolbar" href="#/api/sap.ui.layout.form.SimpleForm/methods/getToolbar">toolbar</a>.</p>
                     * @param {sap.ui.core.Toolbar} oToolbar <p>The toolbar to set</p>
                     * @returns sap.ui.layout.form.SimpleForm <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
