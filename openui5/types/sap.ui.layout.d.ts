...
declare namespace sap {
   namespace ui {
      ...
      namespace layout {
         ...
         /**
          * <p>The position of the <a target="_self" class="jsdoclink" href="#/api/sap.ui.layout.Grid">sap.ui.layout.Grid</a>. Can be <code>Left</code> (default), <code>Center</code> or <code>Right</code>.</p>
          */
