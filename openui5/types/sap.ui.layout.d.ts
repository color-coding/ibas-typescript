    ...
    namespace ui {
        namespace layout {
            ...
            namespace form {
                ...
                /**
                 * <p>The <code>SimpleForm</code> provides an easy-to-use API to create simple forms. Inside a <code>SimpleForm</code>, a <code><a target="_self" class="jsdoclink" href="#/api/sap.ui.layout.form.Form">Form</a></code> control is created along with its <code><a target="_self" class="jsdoclink" href="#/api/sap.ui.layout.form.FormContainer">FormContainers</a></code> and <code><a target="_self" class="jsdoclink" href="#/api/sap.ui.layout.form.FormElement">FormElements</a></code>, but the complexity in the API is not exposed to the user. <ul> <li>A new <code>Title</code> or <code>Toolbar</code> starts a new group (<code><a target="_self" class="jsdoclink" href="#/api/sap.ui.layout.form.FormContainer">FormContainer</a></code>) in the form.</li> <li>A new <code>Label</code> starts a new row (<code><a target="_self" class="jsdoclink" href="#/api/sap.ui.layout.form.FormElement">FormElement</a></code>) in the form.</li> <li>All other controls will be assigned to the row (<code><a target="_self" class="jsdoclink" href="#/api/sap.ui.layout.form.FormElement">FormElement</a></code>) that started with the last label.</li> </ul> Use <code>LayoutData</code> to influence the layout for special cases in the Input/Display controls.</p><p><b>Note:</b> If a more complex form is needed, use the <code><a target="_self" class="jsdoclink" href="#/api/sap.ui.layout.form.Form">Form</a></code> control instead.</p>
                 */
