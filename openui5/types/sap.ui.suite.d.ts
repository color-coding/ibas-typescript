    ...
    namespace ui {
        ...
        namespace suite {
            ...
            export class TaskCircle extends sap.ui.core.Control {
                ...
                /**
                 * <p>Adds some ariaDescribedBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaDescribedBy" href="api/sap.ui.suite.TaskCircle#methods/getAriaDescribedBy">ariaDescribedBy</a>.</p>
                ...
                /**
                 * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.suite.TaskCircle#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                ...
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="press" href="api/sap.ui.suite.TaskCircle#events/press">press</a> to attached listeners.</p>
                ...
                focus(): void;
                /**
                 * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaDescribedBy" href="api/sap.ui.suite.TaskCircle#methods/getAriaDescribedBy">ariaDescribedBy</a>.</p>
                 * @returns sap.ui.core.ID[] 
                 */
                getAriaDescribedBy(): sap.ui.core.ID[];
                /**
                 * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.suite.TaskCircle#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] 
                 */
                getAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getColor" href="api/sap.ui.suite.TaskCircle#methods/getColor">color</a>.</p><p>Color of the circle. The default color is red.</p><p>Default value is <code>Gray</code>.</p>
                 * @returns sap.ui.suite.TaskCircleColor <p>Value of property <code>color</code></p>
                 */
                getColor(): sap.ui.suite.TaskCircleColor;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMaxValue" href="api/sap.ui.suite.TaskCircle#methods/getMaxValue">maxValue</a>.</p><p>Upper limit of the displayed values. Default is 100.</p><p>Default value is <code>100</code>.</p>
                 * @returns number <p>Value of property <code>maxValue</code></p>
                 */
                getMaxValue(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMinValue" href="api/sap.ui.suite.TaskCircle#methods/getMinValue">minValue</a>.</p><p>Lower limit of the displayed values. Default is 0.</p><p>Default value is <code>0</code>.</p>
                 * @returns number <p>Value of property <code>minValue</code></p>
                 */
                getMinValue(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getValue" href="api/sap.ui.suite.TaskCircle#methods/getValue">value</a>.</p><p>Current value of the task circle to be displayed. In dependency of the parameters maxValue and minValue it controls the size of the circle.</p><p>Default value is <code>0</code>.</p>
                 * @returns number <p>Value of property <code>value</code></p>
                 */
                getValue(): number;
                /**
                 * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaDescribedBy" href="api/sap.ui.suite.TaskCircle#methods/getAriaDescribedBy">ariaDescribedBy</a>.</p>
                 * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllAriaDescribedBy(): sap.ui.core.ID[];
                /**
                 * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.suite.TaskCircle#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Removes an ariaDescribedBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaDescribedBy" href="api/sap.ui.suite.TaskCircle#methods/getAriaDescribedBy">ariaDescribedBy</a>.</p>
                ...
                /**
                 * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.suite.TaskCircle#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                ...
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getColor" href="api/sap.ui.suite.TaskCircle#methods/getColor">color</a>.</p><p>Color of the circle. The default color is red.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>Gray</code>.</p>
            ...
            export class VerticalProgressIndicator extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some ariaDescribedBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaDescribedBy" href="api/sap.ui.suite.VerticalProgressIndicator#methods/getAriaDescribedBy">ariaDescribedBy</a>.</p>
                 * @param {sap.ui.core.ID | sap.ui.core.Control} vAriaDescribedBy <p>The ariaDescribedBy to add; if empty, nothing is inserted</p>
                ...
                /**
                 * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.suite.VerticalProgressIndicator#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to add; if empty, nothing is inserted</p>
                 * @returns sap.ui.suite.VerticalProgressIndicator <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="press" href="api/sap.ui.suite.VerticalProgressIndicator#events/press">press</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.suite.VerticalProgressIndicator <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                focus(): void;
                /**
                 * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaDescribedBy" href="api/sap.ui.suite.VerticalProgressIndicator#methods/getAriaDescribedBy">ariaDescribedBy</a>.</p>
                 * @returns sap.ui.core.ID[] 
                 */
                getAriaDescribedBy(): sap.ui.core.ID[];
                /**
                 * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.suite.VerticalProgressIndicator#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] 
                 */
                getAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getPercentage" href="api/sap.ui.suite.VerticalProgressIndicator#methods/getPercentage">percentage</a>.</p><p>The numerical value between 0 and 100 which determines the height of the vertical bar. Values higher than 100 will be displayed as 100%, values lower than zero will be displayed as 0%.</p>
                 * @returns number <p>Value of property <code>percentage</code></p>
                 */
                getPercentage(): number;
                /**
                 * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaDescribedBy" href="api/sap.ui.suite.VerticalProgressIndicator#methods/getAriaDescribedBy">ariaDescribedBy</a>.</p>
                 * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllAriaDescribedBy(): sap.ui.core.ID[];
                /**
                 * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.suite.VerticalProgressIndicator#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Removes an ariaDescribedBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaDescribedBy" href="api/sap.ui.suite.VerticalProgressIndicator#methods/getAriaDescribedBy">ariaDescribedBy</a>.</p>
                 * @param {number | sap.ui.core.ID | sap.ui.core.Control} vAriaDescribedBy <p>The ariaDescribedBy to be removed or its index or ID</p>
                 * @returns sap.ui.core.ID <p>The removed ariaDescribedBy or <code>null</code></p>
                 */
                removeAriaDescribedBy(vAriaDescribedBy: number | sap.ui.core.ID | sap.ui.core.Control): sap.ui.core.ID;
                /**
                 * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.suite.VerticalProgressIndicator#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {number | sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to be removed or its index or ID</p>
                 * @returns sap.ui.core.ID <p>The removed ariaLabelledBy or <code>null</code></p>
                 */
                removeAriaLabelledBy(vAriaLabelledBy: number | sap.ui.core.ID | sap.ui.core.Control): sap.ui.core.ID;
