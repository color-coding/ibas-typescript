...
declare namespace sap {
    ...
    namespace uxap {
        /**
         * <p>Displays the titles of the sections and subsections in the <a target="_self" class="jsdoclink" href="api/sap.uxap.ObjectPageLayout">ObjectPageLayout</a> and allows the user to scroll to the respective content.</p><h3>Overview</h3><p>The <code>AnchorBar</code> is internally generated as a menu in the <code>ObjectPageLayout</code>. It displays the sections and subsections and allows the user to directly scroll to the respective content by selecting them, while it remains visible at the top of the page (below the page header).</p>
         */
        export class AnchorBar extends sap.m.Toolbar {
            ...
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getBackgroundDesign" href="api/sap.uxap.AnchorBar#methods/getBackgroundDesign">backgroundDesign</a>.</p><p>Determines the background color of the <code>AnchorBar</code>.</p><p><b>Note:</b> The default value of <code>backgroundDesign</code> property is null. If the property is not set, the color of the background is <code>@sapUiObjectHeaderBackground</code>, which depends on the specific theme.</p>
            ...
            /**
             * <p>ID of the element which is the current target of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedButton" href="api/sap.uxap.AnchorBar#methods/getSelectedButton">selectedButton</a>, or <code>null</code>.</p>
             * @returns sap.ui.core.ID 
             */
            getSelectedButton(): sap.ui.core.ID;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowPopover" href="api/sap.uxap.AnchorBar#methods/getShowPopover">showPopover</a>.</p><p>Determines whether to show a Popover with Subsection links when clicking on Section links in the Anchor bar.</p><p>Default value is <code>true</code>.</p>
             * @returns boolean <p>Value of property <code>showPopover</code></p>
             */
            getShowPopover(): boolean;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getUpperCase" href="api/sap.uxap.AnchorBar#methods/getUpperCase">upperCase</a>.</p><p>Determines whether the Anchor bar items are displayed in upper case.</p><p>Default value is <code>false</code>.</p>
            ...
            /**
             * <p>Sets the associated <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedButton" href="api/sap.uxap.AnchorBar#methods/getSelectedButton">selectedButton</a>.</p>
        ...
        export class BlockBase extends sap.ui.core.Control {
            ...
            constructor(sId?: string, mSettings?: any);
            /**
             * <p>Adds some mapping to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getMappings" href="api/sap.uxap.BlockBase#methods/getMappings">mappings</a>.</p>
            ...
            /**
             * <p>Destroys all the mappings in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getMappings" href="api/sap.uxap.BlockBase#methods/getMappings">mappings</a>.</p>
             * @returns sap.uxap.BlockBase <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            destroyMappings(): sap.uxap.BlockBase;
            /**
             * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="viewInit" href="api/sap.uxap.BlockBase#events/viewInit">viewInit</a> event of this <code>sap.uxap.BlockBase</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
             * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
            ...
            /**
             * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="viewInit" href="api/sap.uxap.BlockBase#events/viewInit">viewInit</a> to attached listeners.</p>
            ...
            /**
             * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getMappings" href="api/sap.uxap.BlockBase#methods/getMappings">mappings</a>.</p><p>Map external UI5 model and internal Block model</p>
             * @returns sap.uxap.ModelMapping[] 
             */
            getMappings(): sap.uxap.ModelMapping[];
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMode" href="api/sap.uxap.BlockBase#methods/getMode">mode</a>.</p><p>Determines the mode of the block. See <a target="_self" class="jsdoclink" href="api/sap.uxap.ObjectPageSubSectionMode">ObjectPageSubSectionMode</a>. When <code>BlockBase</code> is used inside an <code>ObjectPageLayout</code>, the <code>mode</code> property is inherited from the respective <a target="_self" class="jsdoclink" href="api/sap.uxap.ObjectPageSubSection">SubSection</a>. The <code>mode</code> property of <code>BlockBase</code> changes when the <code>mode</code> property of <code>ObjectPageSubSection</code> changes.</p>
             * @returns string <p>Value of property <code>mode</code></p>
             */
            getMode(): string;
            /**
             * <p>ID of the element which is the current target of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedView" href="api/sap.uxap.BlockBase#methods/getSelectedView">selectedView</a>, or <code>null</code>.</p>
             * @returns sap.ui.core.ID 
             */
            getSelectedView(): sap.ui.core.ID;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowSubSectionMore" href="api/sap.uxap.BlockBase#methods/getShowSubSectionMore">showSubSectionMore</a>.</p><p>Determines whether the show more button should be shown.</p><p><b>Note:</b> The property will take effect if the <code>BlockBase</code> is inside <code>ObjectPageSubSection</code> and would be ignored in case the <code>BlockBase</code> is nested inside another <code>BlockBase</code>.</p><p>Default value is <code>false</code>.</p>
             * @returns boolean <p>Value of property <code>showSubSectionMore</code></p>
             */
            getShowSubSectionMore(): boolean;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getVisible" href="api/sap.uxap.BlockBase#methods/getVisible">visible</a>.</p><p>Determines the visibility of the block.</p><p>Default value is <code>true</code>.</p>
             * @returns boolean <p>Value of property <code>visible</code></p>
             */
            getVisible(): boolean;
            /**
             * <p>Checks for the provided <code>sap.uxap.ModelMapping</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getMappings" href="api/sap.uxap.BlockBase#methods/getMappings">mappings</a>. and returns its index if found or -1 otherwise.</p>
            ...
            /**
             * <p>Inserts a mapping into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getMappings" href="api/sap.uxap.BlockBase#methods/getMappings">mappings</a>.</p>
            ...
            /**
             * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getMappings" href="api/sap.uxap.BlockBase#methods/getMappings">mappings</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
             * @returns sap.uxap.ModelMapping[] <p>An array of the removed elements (might be empty)</p>
             */
            removeAllMappings(): sap.uxap.ModelMapping[];
            /**
             * <p>Removes a mapping from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getMappings" href="api/sap.uxap.BlockBase#methods/getMappings">mappings</a>.</p>
            ...
            /**
             * <p>Set the column layout for this particular block.</p>
             * @param {string} sLayout <p>The column layout to apply to the control</p>
             */
            setColumnLayout(sLayout: string): void;
            /**
             * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getFormAdjustment" href="api/sap.uxap.BlockBase#methods/getFormAdjustment">formAdjustment</a>.</p><p>Determines if the block should automatically adjust its inner forms. Allowed values are "BlockColumns" and "OneColumn" and "None". If the value is "BlockColumns", then the inner form will have as many columns as the colspan of its parent block. If the value is "OneColumn", the inner form will have exactly one column, regardless the colspan of its parent block. If the value is "None", no automatic adjustment of inner forms will be made and the form will keep its original column count.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>BlockColumns</code>.</p>
            ...
            /**
             * <p>Sets the associated <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedView" href="api/sap.uxap.BlockBase#methods/getSelectedView">selectedView</a>.</p>
            ...
            /**
             * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowSubSectionMore" href="api/sap.uxap.BlockBase#methods/getShowSubSectionMore">showSubSectionMore</a>.</p><p>Determines whether the show more button should be shown.</p><p><b>Note:</b> The property will take effect if the <code>BlockBase</code> is inside <code>ObjectPageSubSection</code> and would be ignored in case the <code>BlockBase</code> is nested inside another <code>BlockBase</code>.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
        ...
        export class BreadCrumbs extends sap.ui.core.Control {
            ...
            constructor(sId?: string, mSettings?: any);
            /**
             * <p>Adds some link to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getLinks" href="api/sap.uxap.BreadCrumbs#methods/getLinks">links</a>.</p>
            ...
            /**
             * <p>Destroys the currentLocation in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getCurrentLocation" href="api/sap.uxap.BreadCrumbs#methods/getCurrentLocation">currentLocation</a>.</p>
             * @returns sap.uxap.BreadCrumbs <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            destroyCurrentLocation(): sap.uxap.BreadCrumbs;
            /**
             * <p>Destroys all the links in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getLinks" href="api/sap.uxap.BreadCrumbs#methods/getLinks">links</a>.</p>
             * @returns sap.uxap.BreadCrumbs <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            destroyLinks(): sap.uxap.BreadCrumbs;
            /**
             * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getCurrentLocation" href="api/sap.uxap.BreadCrumbs#methods/getCurrentLocation">currentLocation</a>.</p><p>The current/last element in the BreadCrumbs path.</p>
             * @returns sap.m.Text 
             */
            getCurrentLocation(): sap.m.Text;
            /**
             * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getLinks" href="api/sap.uxap.BreadCrumbs#methods/getLinks">links</a>.</p><p>A list of all the active link elements in the BreadCrumbs control.</p>
             * @returns sap.m.Link[] 
             */
            getLinks(): sap.m.Link[];
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowCurrentLocation" href="api/sap.uxap.BreadCrumbs#methods/getShowCurrentLocation">showCurrentLocation</a>.</p><p>Sets the visibility of the current/last element in the BreadCrumbs path.</p><p>Default value is <code>true</code>.</p>
             * @returns boolean <p>Value of property <code>showCurrentLocation</code></p>
             */
            getShowCurrentLocation(): boolean;
            /**
             * <p>Checks for the provided <code>sap.m.Link</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getLinks" href="api/sap.uxap.BreadCrumbs#methods/getLinks">links</a>. and returns its index if found or -1 otherwise.</p>
             * @param {sap.m.Link} oLink <p>The link whose index is looked for</p>
             * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
             */
            indexOfLink(oLink: sap.m.Link): number;
            /**
             * <p>Inserts a link into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getLinks" href="api/sap.uxap.BreadCrumbs#methods/getLinks">links</a>.</p>
            ...
            /**
             * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getLinks" href="api/sap.uxap.BreadCrumbs#methods/getLinks">links</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
             * @returns sap.m.Link[] <p>An array of the removed elements (might be empty)</p>
             */
            removeAllLinks(): sap.m.Link[];
            /**
             * <p>Removes a link from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getLinks" href="api/sap.uxap.BreadCrumbs#methods/getLinks">links</a>.</p>
            ...
            /**
             * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-target="getCurrentLocation" href="api/sap.uxap.BreadCrumbs#methods/getCurrentLocation">currentLocation</a>.</p>
        ...
        export class HierarchicalSelect extends sap.m.Select {
            ...
            constructor(sId?: string, mSettings?: any);
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getUpperCase" href="api/sap.uxap.HierarchicalSelect#methods/getUpperCase">upperCase</a>.</p><p>Determines whether the HierarchicalSelect items are displayed in upper case.</p><p>Default value is <code>false</code>.</p>
             * @returns boolean <p>Value of property <code>upperCase</code></p>
             */
            getUpperCase(): boolean;
            /**
             * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getUpperCase" href="api/sap.uxap.HierarchicalSelect#methods/getUpperCase">upperCase</a>.</p><p>Determines whether the HierarchicalSelect items are displayed in upper case.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
             * @param {boolean} bUpperCase <p>New value for property <code>upperCase</code></p>
        ...
        /**
         * <p><p>Interface for controls that are eligible for the <code>headerTitle</code> aggregation of the <code><a target="_self" class="jsdoclink" href="api/sap.uxap.ObjectPageLayout">sap.uxap.ObjectPageLayout</a></code>.</p><p>Controls that implement this interface: <ul> <li><code><a target="_self" class="jsdoclink" href="api/sap.uxap.ObjectPageHeader">sap.uxap.ObjectPageHeader</a></code> - <code>ObjectPageLayout</code>'s classic header</code></li> <li><code><a target="_self" class="jsdoclink" href="api/sap.uxap.ObjectPageDynamicHeaderTitle">sap.uxap.ObjectPageDynamicHeaderTitle</a></code> - <code>ObjectPageLayout</code>'s dynamic header</code></li> </ul></p><p>For more information on the types of header available for the <code><a target="_self" class="jsdoclink" href="api/sap.uxap.ObjectPageLayout">ObjectPageLayout</a></code>, see <a target="_self" href="topic/d2ef0099542d44dc868719d908e576d0">Object Page Headers</a>.</p><p>For details regarding the differences and similarities between the available headers, see <a target="_self" href="topic/9c9d94fd28284539a9a5a57e9caf82a8">Object Page Headers Comparison</a>.</p><br><br>References: <ul></ul></p>
         */
        ...
        /**
         * <p>Defines the entity that will be passed to the <a target="_self" class="jsdoclink" href="api/sap.uxap.ObjectPageLayout">sap.uxap.ObjectPageLayout</a>.</p>
         */
        export class ModelMapping extends sap.ui.core.Element {
            ...
            constructor(sId?: string, mSettings?: any);
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getExternalModelName" href="api/sap.uxap.ModelMapping#methods/getExternalModelName">externalModelName</a>.</p><p>Determines the external model name.</p>
             * @returns string <p>Value of property <code>externalModelName</code></p>
             */
            getExternalModelName(): string;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getExternalPath" href="api/sap.uxap.ModelMapping#methods/getExternalPath">externalPath</a>.</p><p>Determines the external path.</p>
            ...
            /**
             * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getExternalModelName" href="api/sap.uxap.ModelMapping#methods/getExternalModelName">externalModelName</a>.</p><p>Determines the external model name.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
        ...
        export class ObjectPageAccessibleLandmarkInfo extends sap.ui.core.Element {
            ...
            constructor(sId?: string, mSettings?: any);
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getContentLabel" href="api/sap.uxap.ObjectPageAccessibleLandmarkInfo#methods/getContentLabel">contentLabel</a>.</p><p>Texts which describe the landmark of the content container of the corresponding <code>sap.uxap.ObjectPageLayout</code> control.</p><p>If not set (and a landmark different than <code>sap.ui.core.AccessibleLandmarkRole.None</code> is defined), no label is set.</p>
            ...
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getNavigationLabel" href="api/sap.uxap.ObjectPageAccessibleLandmarkInfo#methods/getNavigationLabel">navigationLabel</a>.</p><p>Texts which describe the landmark of the navigation container of the corresponding <code>sap.uxap.ObjectPageLayout</code> control.</p><p>If not set (and a landmark different than <code>sap.ui.core.AccessibleLandmarkRole.None</code> is defined), no label is set.</p>
            ...
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getRootLabel" href="api/sap.uxap.ObjectPageAccessibleLandmarkInfo#methods/getRootLabel">rootLabel</a>.</p><p>Texts which describe the landmark of the root container of the corresponding <code>sap.uxap.ObjectPageLayout</code> control.</p><p>If not set (and a landmark different than <code>sap.ui.core.AccessibleLandmarkRole.None</code> is defined), no label is set.</p>
            ...
            /**
             * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getContentLabel" href="api/sap.uxap.ObjectPageAccessibleLandmarkInfo#methods/getContentLabel">contentLabel</a>.</p><p>Texts which describe the landmark of the content container of the corresponding <code>sap.uxap.ObjectPageLayout</code> control.</p><p>If not set (and a landmark different than <code>sap.ui.core.AccessibleLandmarkRole.None</code> is defined), no label is set.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
        ...
        /**
         * <p>Header content for the dynamic header of the <a target="_self" class="jsdoclink" href="api/sap.uxap.ObjectPageLayout">sap.uxap.ObjectPageLayout</a>.</p><h3>Overview</h3><p>The <code>ObjectPageDynamicHeaderContent</code> represents the movable part of the <code>ObjectPageLayout</code>'s dynamic header. It can contain any control and scrolls along with the content of the page until it disappears (collapsed header). When scrolled back to the top it becomes visible again (expanded header). It contains all the additional information of the object.</p><p>Documentation links: <ul> <li><a target="_self" href="topic/d2ef0099542d44dc868719d908e576d0">Object Page Headers</a></li> <li><a target="_self" href="topic/6e340c119ddd4c778b315f65a0432420">Object Page Dynamic Header</a></li> </ul></p>
         */
        export class ObjectPageDynamicHeaderContent extends sap.f.DynamicPageHeader {
            /**
        ...
        /**
         * <p>Represents the static part (header title) of the dynamic header of the <a target="_self" class="jsdoclink" href="api/sap.uxap.ObjectPageLayout">sap.uxap.ObjectPageLayout</a>.</p><h3>Overview</h3><p>The <code>ObjectPageDynamicHeaderTitle</code> is used to represent the most important details of the displayed business object, such as the object title and actions that the user can perform.</p><p><b>Note:</b> The <code>ObjectPageDynamicHeaderTitle</code> is meant to be used inside the <code>ObjectPageLayout</code> control. Any other usage is not supported and can lead to unexpected behavior.<br><br><span>Documentation links:</span><ul><li><a target="_self" href="topic/d2ef0099542d44dc868719d908e576d0">Object Page Headers</a></li><li><a target="_self" href="topic/9c9d94fd28284539a9a5a57e9caf82a8">Object Page Headers Comparison</a></li></ul></p>
         */
        export class ObjectPageDynamicHeaderTitle extends sap.f.DynamicPageTitle {
            /**
        ...
        /**
         * <p>Represents the static part (header title) of the classic header of the <a target="_self" class="jsdoclink" href="api/sap.uxap.ObjectPageLayout">sap.uxap.ObjectPageLayout</a>.</p><h3>Overview</h3><p>The <code>ObjectPageHeader</code> is used to display the basic information about a business object, such as title/description/picture, as well as a list of common actions.</p><p><b>Note:</b> The <code>ObjectPageHeader</code> is meant to be used inside the <code>ObjectPageLayout</code> control. Any other usage is not supported and can lead to unexpected behavior.<br><br><span>Documentation links:</span><ul><li><a target="_self" href="topic/d2ef0099542d44dc868719d908e576d0">Object Page Headers</a></li><li><a target="_self" href="topic/9c9d94fd28284539a9a5a57e9caf82a8">Object Page Headers Comparison</a></li><li><a target="_blank" rel="noopener" href="https://experience.sap.com/fiori-design-web/object-page">UX Guidelines: Object Page</a>
        ...
        export class ObjectPageHeader extends sap.ui.core.Control {
            ...
            constructor(sId?: string, mSettings?: any);
            /**
             * <p>Adds some action to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getActions" href="api/sap.uxap.ObjectPageHeader#methods/getActions">actions</a>.</p>
            ...
            /**
             * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="markChangesPress" href="api/sap.uxap.ObjectPageHeader#events/markChangesPress">markChangesPress</a> event of this <code>sap.uxap.ObjectPageHeader</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.uxap.ObjectPageHeader</code> itself.</p><p>The event is fired when the unsaved changes button is pressed</p>
             * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
             * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
            ...
            /**
             * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="titleSelectorPress" href="api/sap.uxap.ObjectPageHeader#events/titleSelectorPress">titleSelectorPress</a> event of this <code>sap.uxap.ObjectPageHeader</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.uxap.ObjectPageHeader</code> itself.</p><p>The event is fired when the objectPage header title selector (down-arrow) is pressed</p>
             * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
             * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
             * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.uxap.ObjectPageHeader</code> itself</p>
             * @returns sap.uxap.ObjectPageHeader <p>Reference to <code>this</code> in order to allow method chaining</p>
            ...
            /**
             * <p>Destroys all the actions in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getActions" href="api/sap.uxap.ObjectPageHeader#methods/getActions">actions</a>.</p>
             * @returns sap.uxap.ObjectPageHeader <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            destroyActions(): sap.uxap.ObjectPageHeader;
            /**
             * <p>Destroys the breadcrumbs in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getBreadcrumbs" href="api/sap.uxap.ObjectPageHeader#methods/getBreadcrumbs">breadcrumbs</a>.</p>
             * @returns sap.uxap.ObjectPageHeader <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            destroyBreadcrumbs(): sap.uxap.ObjectPageHeader;
            /**
             * <p>Destroys the navigationBar in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getNavigationBar" href="api/sap.uxap.ObjectPageHeader#methods/getNavigationBar">navigationBar</a>.</p>
             * @returns sap.uxap.ObjectPageHeader <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            destroyNavigationBar(): sap.uxap.ObjectPageHeader;
            /**
             * <p>Destroys the sideContentButton in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSideContentButton" href="api/sap.uxap.ObjectPageHeader#methods/getSideContentButton">sideContentButton</a>.</p>
             * @returns sap.uxap.ObjectPageHeader <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            destroySideContentButton(): sap.uxap.ObjectPageHeader;
            /**
             * <p>Destroys the titleSelectorTooltip in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getTitleSelectorTooltip" href="api/sap.uxap.ObjectPageHeader#methods/getTitleSelectorTooltip">titleSelectorTooltip</a>.</p>
             * @returns sap.uxap.ObjectPageHeader <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            destroyTitleSelectorTooltip(): sap.uxap.ObjectPageHeader;
            /**
             * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="markChangesPress" href="api/sap.uxap.ObjectPageHeader#events/markChangesPress">markChangesPress</a> event of this <code>sap.uxap.ObjectPageHeader</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
             * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
             * @param {any} oListener <p>Context object on which the given function had to be called</p>
             * @returns sap.uxap.ObjectPageHeader <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            ...
            /**
             * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="titleSelectorPress" href="api/sap.uxap.ObjectPageHeader#events/titleSelectorPress">titleSelectorPress</a> event of this <code>sap.uxap.ObjectPageHeader</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
             * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
             * @param {any} oListener <p>Context object on which the given function had to be called</p>
             * @returns sap.uxap.ObjectPageHeader <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            ...
            /**
             * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="markChangesPress" href="api/sap.uxap.ObjectPageHeader#events/markChangesPress">markChangesPress</a> to attached listeners.</p>
             * @param {any} mParameters <p>Parameters to pass along with the event</p>
             * @returns sap.uxap.ObjectPageHeader <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            protected fireMarkChangesPress(mParameters?: any): sap.uxap.ObjectPageHeader;
            /**
             * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="markLockedPress" href="api/sap.uxap.ObjectPageHeader#events/markLockedPress">markLockedPress</a> to attached listeners.</p>
             * @param {any} mParameters <p>Parameters to pass along with the event</p>
             * @returns sap.uxap.ObjectPageHeader <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            protected fireMarkLockedPress(mParameters?: any): sap.uxap.ObjectPageHeader;
            /**
             * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="titleSelectorPress" href="api/sap.uxap.ObjectPageHeader#events/titleSelectorPress">titleSelectorPress</a> to attached listeners.</p>
             * @param {any} mParameters <p>Parameters to pass along with the event</p>
             * @returns sap.uxap.ObjectPageHeader <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            ...
            /**
             * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getBreadcrumbs" href="api/sap.uxap.ObjectPageHeader#methods/getBreadcrumbs">breadcrumbs</a>.</p><p>The breadcrumbs displayed in the <code>ObjectPageHeader</code>. If this aggregation is set, the <code>breadCrumbsLinks</code> aggregation is omitted.</p>
             * @returns sap.m.Breadcrumbs 
             */
            getBreadcrumbs(): sap.m.Breadcrumbs;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIsActionAreaAlwaysVisible" href="api/sap.uxap.ObjectPageHeader#methods/getIsActionAreaAlwaysVisible">isActionAreaAlwaysVisible</a>.</p><p>Determines whether the action buttons should always be visible or visible only when the header is snapped.</p><p>Default value is <code>true</code>.</p>
             * @returns boolean <p>Value of property <code>isActionAreaAlwaysVisible</code></p>
             */
            getIsActionAreaAlwaysVisible(): boolean;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIsObjectIconAlwaysVisible" href="api/sap.uxap.ObjectPageHeader#methods/getIsObjectIconAlwaysVisible">isObjectIconAlwaysVisible</a>.</p><p>Determines whether the icon should always be visible or visible only when the header is snapped.</p><p>Default value is <code>false</code>.</p>
             * @returns boolean <p>Value of property <code>isObjectIconAlwaysVisible</code></p>
             */
            getIsObjectIconAlwaysVisible(): boolean;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIsObjectSubtitleAlwaysVisible" href="api/sap.uxap.ObjectPageHeader#methods/getIsObjectSubtitleAlwaysVisible">isObjectSubtitleAlwaysVisible</a>.</p><p>Determines whether the subtitle should always be visible or visible only when the header is snapped.</p><p>Default value is <code>true</code>.</p>
             * @returns boolean <p>Value of property <code>isObjectSubtitleAlwaysVisible</code></p>
             */
            getIsObjectSubtitleAlwaysVisible(): boolean;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIsObjectTitleAlwaysVisible" href="api/sap.uxap.ObjectPageHeader#methods/getIsObjectTitleAlwaysVisible">isObjectTitleAlwaysVisible</a>.</p><p>Determines whether the title should always be visible or visible only when the header is snapped.</p><p>Default value is <code>true</code>.</p>
             * @returns boolean <p>Value of property <code>isObjectTitleAlwaysVisible</code></p>
             */
            getIsObjectTitleAlwaysVisible(): boolean;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMarkChanges" href="api/sap.uxap.ObjectPageHeader#methods/getMarkChanges">markChanges</a>.</p><p>Marks that there are unsaved changes in the objectPageHeader. The markChanges state cannot be used together with the markLocked state. If both are set to true, only the locked state will be displayed.</p><p>Default value is <code>false</code>.</p>
             * @returns boolean <p>Value of property <code>markChanges</code></p>
             */
            getMarkChanges(): boolean;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMarkFavorite" href="api/sap.uxap.ObjectPageHeader#methods/getMarkFavorite">markFavorite</a>.</p><p>Set the favorite state to true or false. The showMarkers property must be true for this property to take effect.</p><p>Default value is <code>false</code>.</p>
             * @returns boolean <p>Value of property <code>markFavorite</code></p>
             */
            getMarkFavorite(): boolean;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMarkFlagged" href="api/sap.uxap.ObjectPageHeader#methods/getMarkFlagged">markFlagged</a>.</p><p>Set the flagged state to true or false. The showMarkers property must be true for this property to take effect.</p><p>Default value is <code>false</code>.</p>
             * @returns boolean <p>Value of property <code>markFlagged</code></p>
             */
            getMarkFlagged(): boolean;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMarkLocked" href="api/sap.uxap.ObjectPageHeader#methods/getMarkLocked">markLocked</a>.</p><p>Set the locked state of the objectPageHeader.</p><p>Default value is <code>false</code>.</p>
             * @returns boolean <p>Value of property <code>markLocked</code></p>
             */
            getMarkLocked(): boolean;
            /**
             * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getNavigationBar" href="api/sap.uxap.ObjectPageHeader#methods/getNavigationBar">navigationBar</a>.</p><p>An instance of sap.m.Bar to be embedded in the header</p>
             * @returns sap.m.Bar 
             */
            getNavigationBar(): sap.m.Bar;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getObjectImageAlt" href="api/sap.uxap.ObjectPageHeader#methods/getObjectImageAlt">objectImageAlt</a>.</p><p>The text to be used for the Alt and Tooltip attribute of the image, supplied via the objectImageURI property</p><p>Default value is <code>empty string</code>.</p>
             * @returns string <p>Value of property <code>objectImageAlt</code></p>
             */
            getObjectImageAlt(): string;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getObjectImageBackgroundColor" href="api/sap.uxap.ObjectPageHeader#methods/getObjectImageBackgroundColor">objectImageBackgroundColor</a>.</p><p>Determines the background color of the image placeholder or icon if valid icon URI is provided.</p><p>Default value is <code>Accent6</code>.</p>
             * @returns sap.m.AvatarColor <p>Value of property <code>objectImageBackgroundColor</code></p>
             */
            getObjectImageBackgroundColor(): sap.m.AvatarColor;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getObjectImageDensityAware" href="api/sap.uxap.ObjectPageHeader#methods/getObjectImageDensityAware">objectImageDensityAware</a>.</p><p>The value of densityAware for the image, supplied via the objectImageURI property. See sap.m.Image for more details on densityAware.</p><p>Default value is <code>false</code>.</p>
             * @returns boolean <p>Value of property <code>objectImageDensityAware</code></p>
             */
            getObjectImageDensityAware(): boolean;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getObjectImageShape" href="api/sap.uxap.ObjectPageHeader#methods/getObjectImageShape">objectImageShape</a>.</p><p>Determines whether the picture should be displayed in a square or with a circle-shaped mask.</p><p>Default value is <code>Square</code>.</p>
             * @returns sap.m.AvatarShape <p>Value of property <code>objectImageShape</code></p>
             */
            getObjectImageShape(): sap.m.AvatarShape;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getObjectImageURI" href="api/sap.uxap.ObjectPageHeader#methods/getObjectImageURI">objectImageURI</a>.</p><p>The URL of the image, representing the business object</p>
             * @returns string <p>Value of property <code>objectImageURI</code></p>
             */
            getObjectImageURI(): string;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getObjectSubtitle" href="api/sap.uxap.ObjectPageHeader#methods/getObjectSubtitle">objectSubtitle</a>.</p><p>The description of the object</p>
             * @returns string <p>Value of property <code>objectSubtitle</code></p>
             */
            getObjectSubtitle(): string;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getObjectTitle" href="api/sap.uxap.ObjectPageHeader#methods/getObjectTitle">objectTitle</a>.</p><p>The title of the object</p>
             * @returns string <p>Value of property <code>objectTitle</code></p>
             */
            getObjectTitle(): string;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowMarkers" href="api/sap.uxap.ObjectPageHeader#methods/getShowMarkers">showMarkers</a>.</p><p>Indicates if object page header title supports showing markers such as flagged and favorite.</p><p>Default value is <code>false</code>.</p>
             * @returns boolean <p>Value of property <code>showMarkers</code></p>
             */
            getShowMarkers(): boolean;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowPlaceholder" href="api/sap.uxap.ObjectPageHeader#methods/getShowPlaceholder">showPlaceholder</a>.</p><p>Enables support of a placeholder image in case no image is specified or the URL of the provided image is invalid.</p><p>Default value is <code>false</code>.</p>
             * @returns boolean <p>Value of property <code>showPlaceholder</code></p>
             */
            getShowPlaceholder(): boolean;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowTitleSelector" href="api/sap.uxap.ObjectPageHeader#methods/getShowTitleSelector">showTitleSelector</a>.</p><p>When set to true, the selector arrow icon/image is shown and can be pressed.</p><p>Default value is <code>false</code>.</p>
             * @returns boolean <p>Value of property <code>showTitleSelector</code></p>
             */
            getShowTitleSelector(): boolean;
            /**
             * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSideContentButton" href="api/sap.uxap.ObjectPageHeader#methods/getSideContentButton">sideContentButton</a>.</p><p>A button that is used for opening the side content of the page or some additional content.</p>
             * @returns sap.m.Button 
             */
            getSideContentButton(): sap.m.Button;
            /**
             * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getTitleSelectorTooltip" href="api/sap.uxap.ObjectPageHeader#methods/getTitleSelectorTooltip">titleSelectorTooltip</a>.</p><p>A custom tooltip for the title selector button.</p><p>The custom tooltip will be visible if the <code>showTitleSelector</code> property is set to <code>true</code>.</p><p><b>Note:</b> If the aggregation is destroyed or set to invalid value, the default tooltip will be set. The default tooltip text is "Related options".</p>
             * @returns sap.ui.core.TooltipBase|string 
             */
            getTitleSelectorTooltip(): sap.ui.core.TooltipBase | string;
            /**
             * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getActions" href="api/sap.uxap.ObjectPageHeader#methods/getActions">actions</a>. and returns its index if found or -1 otherwise.</p>
            ...
            /**
             * <p>Inserts a action into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getActions" href="api/sap.uxap.ObjectPageHeader#methods/getActions">actions</a>.</p>
            ...
            /**
             * <p>Removes a action from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getActions" href="api/sap.uxap.ObjectPageHeader#methods/getActions">actions</a>.</p>
            ...
            /**
             * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getActions" href="api/sap.uxap.ObjectPageHeader#methods/getActions">actions</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
             * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
             */
            removeAllActions(): sap.ui.core.Control[];
            /**
             * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-target="getBreadcrumbs" href="api/sap.uxap.ObjectPageHeader#methods/getBreadcrumbs">breadcrumbs</a>.</p>
            ...
            /**
             * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIsActionAreaAlwaysVisible" href="api/sap.uxap.ObjectPageHeader#methods/getIsActionAreaAlwaysVisible">isActionAreaAlwaysVisible</a>.</p><p>Determines whether the action buttons should always be visible or visible only when the header is snapped.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>true</code>.</p>
            ...
            /**
             * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getObjectImageAlt" href="api/sap.uxap.ObjectPageHeader#methods/getObjectImageAlt">objectImageAlt</a>.</p><p>The text to be used for the Alt and Tooltip attribute of the image, supplied via the objectImageURI property</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>empty string</code>.</p>
            ...
            /**
             * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-target="getTitleSelectorTooltip" href="api/sap.uxap.ObjectPageHeader#methods/getTitleSelectorTooltip">titleSelectorTooltip</a>.</p>
        ...
        /**
         * <p>A Button that is used in the <code>actions</code> aggregation of the <a target="_self" class="jsdoclink" href="api/sap.uxap.ObjectPageHeader">sap.uxap.ObjectPageHeader</a>.</p>
         */
        export class ObjectPageHeaderActionButton extends sap.m.Button {
            ...
            constructor(sId?: string, mSettings?: any);
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getHideIcon" href="api/sap.uxap.ObjectPageHeaderActionButton#methods/getHideIcon">hideIcon</a>.</p><p>Hide the button icon when rendered into the headerTitle part of the ObjectPageLayout. This is useful if you want to display texts only in the headerTitle part but still want to display text + icon in the actionSheet that appears when not enough space is available on the screen for displaying all actions.</p><p>Default value is <code>false</code>.</p>
             * @returns boolean <p>Value of property <code>hideIcon</code></p>
             */
            getHideIcon(): boolean;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getHideText" href="api/sap.uxap.ObjectPageHeaderActionButton#methods/getHideText">hideText</a>.</p><p>Hide the button text when rendered into the headerTitle part of the ObjectPageLayout. This is useful if you want to display icons only in the headerTitle part but still want to display text + icon in the actionSheet that appears when not enough space is available on the screen for displaying all actions.</p><p>Default value is <code>true</code>.</p>
             * @returns boolean <p>Value of property <code>hideText</code></p>
             */
            getHideText(): boolean;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getImportance" href="api/sap.uxap.ObjectPageHeaderActionButton#methods/getImportance">importance</a>.</p><p>Determines the order in which the button overflows.</p><p>Default value is <code>High</code>.</p>
             * @returns sap.uxap.Importance <p>Value of property <code>importance</code></p>
             */
            getImportance(): sap.uxap.Importance;
            /**
             * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getHideIcon" href="api/sap.uxap.ObjectPageHeaderActionButton#methods/getHideIcon">hideIcon</a>.</p><p>Hide the button icon when rendered into the headerTitle part of the ObjectPageLayout. This is useful if you want to display texts only in the headerTitle part but still want to display text + icon in the actionSheet that appears when not enough space is available on the screen for displaying all actions.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
        ...
        export class ObjectPageHeaderContent extends sap.ui.core.Control {
            ...
            constructor(sId?: string, mSettings?: any);
            /**
             * <p>Adds some content to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.uxap.ObjectPageHeaderContent#methods/getContent">content</a>.</p>
            ...
            /**
             * <p>Destroys all the content in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.uxap.ObjectPageHeaderContent#methods/getContent">content</a>.</p>
             * @returns sap.uxap.ObjectPageHeaderContent <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            destroyContent(): sap.uxap.ObjectPageHeaderContent;
            /**
             * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.uxap.ObjectPageHeaderContent#methods/getContent">content</a>.</p><p>The list of Objects of type sap.ui.core.Control.</p>
             * @returns sap.ui.core.Control[] 
             */
            getContent(): sap.ui.core.Control[];
            /**
             * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.uxap.ObjectPageHeaderContent#methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
            ...
            /**
             * <p>Inserts a content into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.uxap.ObjectPageHeaderContent#methods/getContent">content</a>.</p>
            ...
            /**
             * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.uxap.ObjectPageHeaderContent#methods/getContent">content</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
             * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
             */
            removeAllContent(): sap.ui.core.Control[];
            /**
             * <p>Removes a content from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.uxap.ObjectPageHeaderContent#methods/getContent">content</a>.</p>
        ...
        /**
         * <p>A <a target="_self" class="jsdoclink" href="api/sap.ui.core.LayoutData">sap.ui.core.LayoutData</a> element that can be added to controls used in the <code>headerContent</code> aggregation of the <code>ObjectPageLayout</code>.</p><p><b>Note:</b> This element is only taken into account when the <code>sap.uxap.ObjectPageLayout</code> control is used together with <code>sap.uxap.ObjectPageHeader</code> as value of <code>headerTitle</code>.</p>
         */
        export class ObjectPageHeaderLayoutData extends sap.ui.core.LayoutData {
            ...
            constructor(sId?: string, mSettings?: any);
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowSeparatorAfter" href="api/sap.uxap.ObjectPageHeaderLayoutData#methods/getShowSeparatorAfter">showSeparatorAfter</a>.</p><p>If this property is set the control will display a separator after it.</p><p>Default value is <code>false</code>.</p>
             * @returns boolean <p>Value of property <code>showSeparatorAfter</code></p>
             */
            getShowSeparatorAfter(): boolean;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowSeparatorBefore" href="api/sap.uxap.ObjectPageHeaderLayoutData#methods/getShowSeparatorBefore">showSeparatorBefore</a>.</p><p>If this property is set the control will display a separator before it.</p><p>Default value is <code>false</code>.</p>
             * @returns boolean <p>Value of property <code>showSeparatorBefore</code></p>
             */
            getShowSeparatorBefore(): boolean;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getVisibleL" href="api/sap.uxap.ObjectPageHeaderLayoutData#methods/getVisibleL">visibleL</a>.</p><p>If this property is set the control will be visible (or not) in a large sized layout.</p><p>Default value is <code>true</code>.</p>
             * @returns boolean <p>Value of property <code>visibleL</code></p>
             */
            getVisibleL(): boolean;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getVisibleM" href="api/sap.uxap.ObjectPageHeaderLayoutData#methods/getVisibleM">visibleM</a>.</p><p>If this property is set the control will be visible (or not) in a medium sized layout.</p><p>Default value is <code>true</code>.</p>
             * @returns boolean <p>Value of property <code>visibleM</code></p>
             */
            getVisibleM(): boolean;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getVisibleS" href="api/sap.uxap.ObjectPageHeaderLayoutData#methods/getVisibleS">visibleS</a>.</p><p>If this property is set the control will be visible (or not) in a small sized layout.</p><p>Default value is <code>true</code>.</p>
            ...
            /**
             * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowSeparatorAfter" href="api/sap.uxap.ObjectPageHeaderLayoutData#methods/getShowSeparatorAfter">showSeparatorAfter</a>.</p><p>If this property is set the control will display a separator after it.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
        ...
        export class ObjectPageLayout extends sap.ui.core.Control {
            ...
            constructor(sId?: string, mSettings?: any);
            /**
             * <p>Adds some headerContent to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeaderContent" href="api/sap.uxap.ObjectPageLayout#methods/getHeaderContent">headerContent</a>.</p>
            ...
            /**
             * <p>Adds some section to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSections" href="api/sap.uxap.ObjectPageLayout#methods/getSections">sections</a>.</p>
            ...
            /**
             * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="editHeaderButtonPress" href="api/sap.uxap.ObjectPageLayout#events/editHeaderButtonPress">editHeaderButtonPress</a> event of this <code>sap.uxap.ObjectPageLayout</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.uxap.ObjectPageLayout</code> itself.</p><p>The event is fired when the Edit Header button is pressed</p>
             * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
             * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
            ...
            /**
             * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="sectionChange" href="api/sap.uxap.ObjectPageLayout#events/sectionChange">sectionChange</a> event of this <code>sap.uxap.ObjectPageLayout</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.uxap.ObjectPageLayout</code> itself.</p><p>Fired when the current section is changed by scrolling.</p>
             * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
             * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
             * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.uxap.ObjectPageLayout</code> itself</p>
             * @returns sap.uxap.ObjectPageLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
            ...
            /**
             * <p>Destroys the footer in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFooter" href="api/sap.uxap.ObjectPageLayout#methods/getFooter">footer</a>.</p>
             * @returns sap.uxap.ObjectPageLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            destroyFooter(): sap.uxap.ObjectPageLayout;
            /**
             * <p>Destroys all the headerContent in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeaderContent" href="api/sap.uxap.ObjectPageLayout#methods/getHeaderContent">headerContent</a>.</p>
             * @returns sap.uxap.ObjectPageLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            destroyHeaderContent(): sap.uxap.ObjectPageLayout;
            /**
             * <p>Destroys the headerTitle in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeaderTitle" href="api/sap.uxap.ObjectPageLayout#methods/getHeaderTitle">headerTitle</a>.</p>
             * @returns sap.uxap.ObjectPageLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            destroyHeaderTitle(): sap.uxap.ObjectPageLayout;
            /**
             * <p>Destroys the landmarkInfo in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getLandmarkInfo" href="api/sap.uxap.ObjectPageLayout#methods/getLandmarkInfo">landmarkInfo</a>.</p>
             * @returns sap.uxap.ObjectPageLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            destroyLandmarkInfo(): sap.uxap.ObjectPageLayout;
            /**
             * <p>Destroys all the sections in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSections" href="api/sap.uxap.ObjectPageLayout#methods/getSections">sections</a>.</p>
             * @returns sap.uxap.ObjectPageLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            destroySections(): sap.uxap.ObjectPageLayout;
            /**
             * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="editHeaderButtonPress" href="api/sap.uxap.ObjectPageLayout#events/editHeaderButtonPress">editHeaderButtonPress</a> event of this <code>sap.uxap.ObjectPageLayout</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
             * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
             * @param {any} oListener <p>Context object on which the given function had to be called</p>
             * @returns sap.uxap.ObjectPageLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            ...
            /**
             * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="navigate" href="api/sap.uxap.ObjectPageLayout#events/navigate">navigate</a> event of this <code>sap.uxap.ObjectPageLayout</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
             * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
             * @param {any} oListener <p>Context object on which the given function had to be called</p>
             * @returns sap.uxap.ObjectPageLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            ...
            /**
             * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="sectionChange" href="api/sap.uxap.ObjectPageLayout#events/sectionChange">sectionChange</a> event of this <code>sap.uxap.ObjectPageLayout</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
             * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
             * @param {any} oListener <p>Context object on which the given function had to be called</p>
             * @returns sap.uxap.ObjectPageLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            ...
            /**
             * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="editHeaderButtonPress" href="api/sap.uxap.ObjectPageLayout#events/editHeaderButtonPress">editHeaderButtonPress</a> to attached listeners.</p>
             * @param {any} mParameters <p>Parameters to pass along with the event</p>
             * @returns sap.uxap.ObjectPageLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            protected fireEditHeaderButtonPress(mParameters?: any): sap.uxap.ObjectPageLayout;
            /**
             * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="navigate" href="api/sap.uxap.ObjectPageLayout#events/navigate">navigate</a> to attached listeners.</p>
             * @param {any} mParameters <p>Parameters to pass along with the event</p>
             * @returns sap.uxap.ObjectPageLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            protected fireNavigate(mParameters?: any): sap.uxap.ObjectPageLayout;
            /**
             * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="sectionChange" href="api/sap.uxap.ObjectPageLayout#events/sectionChange">sectionChange</a> to attached listeners.</p>
             * @param {any} mParameters <p>Parameters to pass along with the event</p>
             * @returns sap.uxap.ObjectPageLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            ...
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getEnableLazyLoading" href="api/sap.uxap.ObjectPageLayout#methods/getEnableLazyLoading">enableLazyLoading</a>.</p><p>Enable lazy loading for the Object page Subsections.</p><p>Default value is <code>false</code>.</p>
             * @returns boolean <p>Value of property <code>enableLazyLoading</code></p>
             */
            getEnableLazyLoading(): boolean;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getFlexEnabled" href="api/sap.uxap.ObjectPageLayout#methods/getFlexEnabled">flexEnabled</a>.</p><p>Specifies whether the object page enables flexibility features, such as hiding and adding sections.<br> For more information about SAPUI5 flexibility, refer to the Developer Guide.</p><p>Default value is <code>false</code>.</p>
             * @returns boolean <p>Value of property <code>flexEnabled</code></p>
             */
            getFlexEnabled(): boolean;
            /**
             * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getFooter" href="api/sap.uxap.ObjectPageLayout#methods/getFooter">footer</a>.</p><p>Object page floating footer.</p>
             * @returns sap.m.IBar 
             */
            getFooter(): sap.m.IBar;
            /**
             * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeaderContent" href="api/sap.uxap.ObjectPageLayout#methods/getHeaderContent">headerContent</a>.</p><p>Object page header content - the dynamic part of the Object page header.</p>
             * @returns sap.ui.core.Control[] 
             */
            getHeaderContent(): sap.ui.core.Control[];
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeaderContentPinnable" href="api/sap.uxap.ObjectPageLayout#methods/getHeaderContentPinnable">headerContentPinnable</a>.</p><p>Determines whether the Header Content area can be pinned.</p><p>When set to <code>true</code>, a pin button is displayed within the Header Content area. The pin button allows the user to make the Header Content always visible at the top of the page above any scrollable content.</p><p><b>Note:</b> This property is only taken into account if an instance of <code>sap.uxap.ObjectPageDynamicHeaderTitle</code> is used for the <code>headerTitle</code> aggregation.</p><p>Default value is <code>true</code>.</p>
             * @returns boolean <p>Value of property <code>headerContentPinnable</code></p>
             */
            getHeaderContentPinnable(): boolean;
            /**
             * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeaderTitle" href="api/sap.uxap.ObjectPageLayout#methods/getHeaderTitle">headerTitle</a>.</p><p>Object page header title - the upper, always static, part of the Object page header.</p>
            ...
            /**
             * <p>Checks for the provided <code>sap.uxap.ObjectPageSection</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSections" href="api/sap.uxap.ObjectPageLayout#methods/getSections">sections</a>. and returns its index if found or -1 otherwise.</p>
            ...
            /**
             * <p>Inserts a headerContent into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeaderContent" href="api/sap.uxap.ObjectPageLayout#methods/getHeaderContent">headerContent</a>.</p>
            ...
            /**
             * <p>Inserts a section into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSections" href="api/sap.uxap.ObjectPageLayout#methods/getSections">sections</a>.</p>
            ...
            /**
             * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeaderContent" href="api/sap.uxap.ObjectPageLayout#methods/getHeaderContent">headerContent</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
             * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
             */
            removeAllHeaderContent(): sap.ui.core.Control[];
            /**
             * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSections" href="api/sap.uxap.ObjectPageLayout#methods/getSections">sections</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
            ...
            /**
             * <p>Removes a headerContent from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeaderContent" href="api/sap.uxap.ObjectPageLayout#methods/getHeaderContent">headerContent</a>.</p>
            ...
            /**
             * <p>Removes a section from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSections" href="api/sap.uxap.ObjectPageLayout#methods/getSections">sections</a>.</p>
        ...
        export class ObjectPageLazyLoader extends sap.ui.core.Element {
            ...
            constructor(sId?: string, mSettings?: any);
            /**
             * <p>Adds some content to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.uxap.ObjectPageLazyLoader#methods/getContent">content</a>.</p>
             * @param {sap.ui.core.Control} oContent <p>The content to add; if empty, nothing is inserted</p>
            ...
            /**
             * <p>Destroys all the content in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.uxap.ObjectPageLazyLoader#methods/getContent">content</a>.</p>
             * @returns sap.uxap.ObjectPageLazyLoader <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            destroyContent(): sap.uxap.ObjectPageLazyLoader;
            /**
             * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.uxap.ObjectPageLazyLoader#methods/getContent">content</a>.</p><p>Controls to be displayed after this element is unstashed</p>
             * @returns sap.ui.core.Control[] 
             */
            getContent(): sap.ui.core.Control[];
            /**
             * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.uxap.ObjectPageLazyLoader#methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
             * @param {sap.ui.core.Control} oContent <p>The content whose index is looked for</p>
             * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
             */
            indexOfContent(oContent: sap.ui.core.Control): number;
            /**
             * <p>Inserts a content into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.uxap.ObjectPageLazyLoader#methods/getContent">content</a>.</p>
             * @param {sap.ui.core.Control} oContent <p>The content to insert; if empty, nothing is inserted</p>
             * @param {number} iIndex <p>The <code>0</code>-based index the content should be inserted at; for a negative value of <code>iIndex</code>, the content is inserted at position 0; for a value greater than the current size of the aggregation, the content is inserted at the last position</p>
             * @returns sap.uxap.ObjectPageLazyLoader <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            ...
            /**
             * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.uxap.ObjectPageLazyLoader#methods/getContent">content</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
             * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
             */
            removeAllContent(): sap.ui.core.Control[];
            /**
             * <p>Removes a content from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.uxap.ObjectPageLazyLoader#methods/getContent">content</a>.</p>
             * @param {number | string | sap.ui.core.Control} vContent <p>The content to remove or its index or id</p>
             * @returns sap.ui.core.Control <p>The removed content or <code>null</code></p>
             */
            removeContent(vContent: number | string | sap.ui.core.Control): sap.ui.core.Control;
        ...
        /**
         * <p>Top-level information container of an <a target="_self" class="jsdoclink" href="api/sap.uxap.ObjectPageLayout">sap.uxap.ObjectPageLayout</a>.</p><p>The <code>ObjectPageSection</code>'s purpose is to aggregate subsections.</p><p><b>Note:</b> This control is intended to be used only as part of the <code>ObjectPageLayout</code>.</p>
         */
        export class ObjectPageSection extends sap.uxap.ObjectPageSectionBase {
            ...
            constructor(sId?: string, mSettings?: any);
            /**
             * <p>Adds some subSection to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSubSections" href="api/sap.uxap.ObjectPageSection#methods/getSubSections">subSections</a>.</p>
            ...
            /**
             * <p>Destroys all the subSections in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSubSections" href="api/sap.uxap.ObjectPageSection#methods/getSubSections">subSections</a>.</p>
             * @returns sap.uxap.ObjectPageSection <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            destroySubSections(): sap.uxap.ObjectPageSection;
            /**
             * <p>ID of the element which is the current target of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedSubSection" href="api/sap.uxap.ObjectPageSection#methods/getSelectedSubSection">selectedSubSection</a>, or <code>null</code>.</p>
             * @returns sap.ui.core.ID 
             */
            getSelectedSubSection(): sap.ui.core.ID;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowTitle" href="api/sap.uxap.ObjectPageSection#methods/getShowTitle">showTitle</a>.</p><p>Determines whether to display the Section title or not.</p><p>Default value is <code>true</code>.</p>
             * @returns boolean <p>Value of property <code>showTitle</code></p>
             */
            getShowTitle(): boolean;
            /**
             * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSubSections" href="api/sap.uxap.ObjectPageSection#methods/getSubSections">subSections</a>.</p><p>The list of Subsections.</p>
             * @returns sap.uxap.ObjectPageSubSection[] 
             */
            getSubSections(): sap.uxap.ObjectPageSubSection[];
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getTitleUppercase" href="api/sap.uxap.ObjectPageSection#methods/getTitleUppercase">titleUppercase</a>.</p><p>Determines whether the Section title is displayed in upper case.</p><p>Default value is <code>true</code>.</p>
             * @returns boolean <p>Value of property <code>titleUppercase</code></p>
             */
            getTitleUppercase(): boolean;
            /**
             * <p>Checks for the provided <code>sap.uxap.ObjectPageSubSection</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSubSections" href="api/sap.uxap.ObjectPageSection#methods/getSubSections">subSections</a>. and returns its index if found or -1 otherwise.</p>
            ...
            /**
             * <p>Inserts a subSection into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSubSections" href="api/sap.uxap.ObjectPageSection#methods/getSubSections">subSections</a>.</p>
            ...
            /**
             * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSubSections" href="api/sap.uxap.ObjectPageSection#methods/getSubSections">subSections</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
            ...
            /**
             * <p>Removes a subSection from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSubSections" href="api/sap.uxap.ObjectPageSection#methods/getSubSections">subSections</a>.</p>
            ...
            /**
             * <p>Sets the associated <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedSubSection" href="api/sap.uxap.ObjectPageSection#methods/getSelectedSubSection">selectedSubSection</a>.</p>
            ...
            /**
             * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowTitle" href="api/sap.uxap.ObjectPageSection#methods/getShowTitle">showTitle</a>.</p><p>Determines whether to display the Section title or not.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>true</code>.</p>
        ...
        export abstract class ObjectPageSectionBase extends sap.ui.core.Control {
            ...
            /**
             * <p>Destroys the customAnchorBarButton in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getCustomAnchorBarButton" href="api/sap.uxap.ObjectPageSectionBase#methods/getCustomAnchorBarButton">customAnchorBarButton</a>.</p>
            ...
            /**
             * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getCustomAnchorBarButton" href="api/sap.uxap.ObjectPageSectionBase#methods/getCustomAnchorBarButton">customAnchorBarButton</a>.</p><p>The custom button that will provide a link to the section in the ObjectPageLayout anchor bar. This button will be used as a custom template to be into the ObjectPageLayout anchorBar area, therefore property changes happening on this button template after the first rendering won't affect the actual button copy used in the anchorBar.</p><p>If you want to change some of the button properties, you would need to bind them to a model.</p>
             * @returns sap.m.Button 
             */
            getCustomAnchorBarButton(): sap.m.Button;
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getImportance" href="api/sap.uxap.ObjectPageSectionBase#methods/getImportance">importance</a>.</p><p>Determines whether the section will be hidden on low resolutions.</p><p>Default value is <code>High</code>.</p>
             * @returns sap.uxap.Importance <p>Value of property <code>importance</code></p>
             */
            getImportance(): sap.uxap.Importance;
            /**
            ...
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getVisible" href="api/sap.uxap.ObjectPageSectionBase#methods/getVisible">visible</a>.</p><p>Invisible ObjectPageSectionBase are not rendered</p><p>Default value is <code>true</code>.</p>
             * @returns boolean <p>Value of property <code>visible</code></p>
             */
            getVisible(): boolean;
            /**
             * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-target="getCustomAnchorBarButton" href="api/sap.uxap.ObjectPageSectionBase#methods/getCustomAnchorBarButton">customAnchorBarButton</a>.</p>
            ...
            /**
             * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getImportance" href="api/sap.uxap.ObjectPageSectionBase#methods/getImportance">importance</a>.</p><p>Determines whether the section will be hidden on low resolutions.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>High</code>.</p>
             * @param {sap.uxap.Importance} sImportance <p>New value for property <code>importance</code></p>
             * @returns sap.uxap.ObjectPageSectionBase <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
        ...
        export class ObjectPageSubSection extends sap.uxap.ObjectPageSectionBase {
            ...
            constructor(sId?: string, mSettings?: any);
            /**
             * <p>Adds some action to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getActions" href="api/sap.uxap.ObjectPageSubSection#methods/getActions">actions</a>.</p>
             * @param {sap.ui.core.Control} oAction <p>The action to add; if empty, nothing is inserted</p>
            ...
            /**
             * <p>Adds some block to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getBlocks" href="api/sap.uxap.ObjectPageSubSection#methods/getBlocks">blocks</a>.</p>
            ...
            /**
             * <p>Adds some moreBlock to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getMoreBlocks" href="api/sap.uxap.ObjectPageSubSection#methods/getMoreBlocks">moreBlocks</a>.</p>
            ...
            /**
             * <p>Destroys all the actions in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getActions" href="api/sap.uxap.ObjectPageSubSection#methods/getActions">actions</a>.</p>
             * @returns sap.uxap.ObjectPageSubSection <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            destroyActions(): sap.uxap.ObjectPageSubSection;
            /**
             * <p>Destroys all the blocks in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getBlocks" href="api/sap.uxap.ObjectPageSubSection#methods/getBlocks">blocks</a>.</p>
             * @returns sap.uxap.ObjectPageSubSection <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            destroyBlocks(): sap.uxap.ObjectPageSubSection;
            /**
             * <p>Destroys all the moreBlocks in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getMoreBlocks" href="api/sap.uxap.ObjectPageSubSection#methods/getMoreBlocks">moreBlocks</a>.</p>
             * @returns sap.uxap.ObjectPageSubSection <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            ...
            /**
             * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMode" href="api/sap.uxap.ObjectPageSubSection#methods/getMode">mode</a>.</p><p>A mode property that will be passed to the controls in the blocks and moreBlocks aggregations. Only relevant if these aggregations use Object page blocks.</p><p>Default value is <code>Collapsed</code>.</p>
             * @returns sap.uxap.ObjectPageSubSectionMode <p>Value of property <code>mode</code></p>
             */
            getMode(): sap.uxap.ObjectPageSubSectionMode;
            /**
             * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getMoreBlocks" href="api/sap.uxap.ObjectPageSubSection#methods/getMoreBlocks">moreBlocks</a>.</p><p>Additional controls to display when the Show more / See all / (...) button is pressed</p>
             * @returns sap.ui.core.Control[] 
             */
            ...
            getTitleUppercase(): boolean;
            /**
             * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getActions" href="api/sap.uxap.ObjectPageSubSection#methods/getActions">actions</a>. and returns its index if found or -1 otherwise.</p>
             * @param {sap.ui.core.Control} oAction <p>The action whose index is looked for</p>
             * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
             */
            indexOfAction(oAction: sap.ui.core.Control): number;
            /**
             * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getBlocks" href="api/sap.uxap.ObjectPageSubSection#methods/getBlocks">blocks</a>. and returns its index if found or -1 otherwise.</p>
             * @param {sap.ui.core.Control} oBlock <p>The block whose index is looked for</p>
             * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
             */
            indexOfBlock(oBlock: sap.ui.core.Control): number;
            /**
             * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getMoreBlocks" href="api/sap.uxap.ObjectPageSubSection#methods/getMoreBlocks">moreBlocks</a>. and returns its index if found or -1 otherwise.</p>
            ...
            /**
             * <p>Inserts a action into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getActions" href="api/sap.uxap.ObjectPageSubSection#methods/getActions">actions</a>.</p>
             * @param {sap.ui.core.Control} oAction <p>The action to insert; if empty, nothing is inserted</p>
             * @param {number} iIndex <p>The <code>0</code>-based index the action should be inserted at; for a negative value of <code>iIndex</code>, the action is inserted at position 0; for a value greater than the current size of the aggregation, the action is inserted at the last position</p>
             * @returns sap.uxap.ObjectPageSubSection <p>Reference to <code>this</code> in order to allow method chaining</p>
             */
            ...
            /**
             * <p>Removes a action from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getActions" href="api/sap.uxap.ObjectPageSubSection#methods/getActions">actions</a>.</p>
             * @param {number | string | sap.ui.core.Control} vAction <p>The action to remove or its index or id</p>
             * @returns sap.ui.core.Control <p>The removed action or <code>null</code></p>
             */
            removeAction(vAction: number | string | sap.ui.core.Control): sap.ui.core.Control;
            /**
             * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getActions" href="api/sap.uxap.ObjectPageSubSection#methods/getActions">actions</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
             * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
             */
            removeAllActions(): sap.ui.core.Control[];
            /**
             * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getBlocks" href="api/sap.uxap.ObjectPageSubSection#methods/getBlocks">blocks</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
             * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
             */
            removeAllBlocks(): sap.ui.core.Control[];
            /**
             * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getMoreBlocks" href="api/sap.uxap.ObjectPageSubSection#methods/getMoreBlocks">moreBlocks</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
             * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
             */
            removeAllMoreBlocks(): sap.ui.core.Control[];
            /**
             * <p>Removes a block from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getBlocks" href="api/sap.uxap.ObjectPageSubSection#methods/getBlocks">blocks</a>.</p>
            ...
            /**
             * <p>Removes a moreBlock from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getMoreBlocks" href="api/sap.uxap.ObjectPageSubSection#methods/getMoreBlocks">moreBlocks</a>.</p>
...
declare namespace sap {
    namespace uxap {
        /**
         * <p><p>Used by the <code>BlockBase</code> control to define how many columns should it be assigned by the <code>objectPageSubSection</code>. The allowed values can be auto (subsection assigned a number of columns based on the parent objectPageLayout subsectionLayout property), 1, 2, 3 or 4 (This may not be a valid value for some <code>subSectionLayout</code>, for example, asking for 3 columns in a 2 column layout would raise warnings).</p></p>
         */
