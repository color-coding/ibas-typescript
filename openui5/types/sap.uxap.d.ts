...
declare namespace sap {
	...
	namespace uxap {
		/**
		 * <p>Displays the titles of the sections and subsections in the <a target="_self" href="api/sap.uxap.ObjectPageLayout">ObjectPageLayout</a> and allows the user to scroll to the respective content.</p><h3>Overview</h3><p>The <code>AnchorBar</code> is internally generated as a menu in the <code>ObjectPageLayout</code>. It displays the sections and subsections and allows the user to directly scroll to the respective content by selecting them, while it remains visible at the top of the page (below the page header).</p>
		 */
		export class AnchorBar extends sap.m.Toolbar {
			...
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.AnchorBar#methods/getBackgroundDesign">backgroundDesign</a>.</p><p>Determines the background color of the <code>AnchorBar</code>.</p><p><b>Note:</b> The default value of <code>backgroundDesign</code> property is null. If the property is not set, the color of the background is <code>@sapUiObjectHeaderBackground</code>, which depends on the specific theme.</p>
			...
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.AnchorBar#methods/getUpperCase">upperCase</a>.</p><p>Determines whether the Anchor bar items are displayed in upper case.</p><p>Default value is <code>false</code>.</p>
			 * @returns boolean <p>Value of property <code>upperCase</code></p>
			 */
			getUpperCase(): boolean;
			/**
			 * <p>Scrolls to the currently selected Section tab, when the header titles is snapped/unsnapped</p>
			 */
			...
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.AnchorBar#methods/getBackgroundDesign">backgroundDesign</a>.</p><p>Determines the background color of the <code>AnchorBar</code>.</p><p><b>Note:</b> The default value of <code>backgroundDesign</code> property is null. If the property is not set, the color of the background is <code>@sapUiObjectHeaderBackground</code>, which depends on the specific theme.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
			...
			/**
			 * <p>Sets the associated <a target="_self" href="api/sap.uxap.AnchorBar#methods/getSelectedButton">selectedButton</a>.</p>
		...
		export class BlockBase extends sap.ui.core.Control {
			...
			constructor(sId?: string, mSettings?: any);
			/**
			 * <p>Adds some mapping to the aggregation <a target="_self" href="api/sap.uxap.BlockBase#methods/getMappings">mappings</a>.</p>
			 * @param {sap.uxap.ModelMapping} oMapping <p>The mapping to add; if empty, nothing is inserted</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			addMapping(oMapping: sap.uxap.ModelMapping): this;
			/**
			...
			/**
			 * <p>Destroys all the mappings in the aggregation <a target="_self" href="api/sap.uxap.BlockBase#methods/getMappings">mappings</a>.</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			protected fireViewInit(mParameters?: any): this;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.BlockBase#methods/getColumnLayout">columnLayout</a>.</p><p>Determines on how many columns the layout will be rendered. Allowed values are integers from 1 to 4 and "auto".</p><p>Default value is <code>"auto"</code>.</p>
			...
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.BlockBase#methods/getVisible">visible</a>.</p><p>Determines the visibility of the block.</p><p>Default value is <code>true</code>.</p>
			 * @returns boolean <p>Value of property <code>visible</code></p>
			 */
			getVisible(): boolean;
			/**
			 * <p>Checks for the provided <code>sap.uxap.ModelMapping</code> in the aggregation <a target="_self" href="api/sap.uxap.BlockBase#methods/getMappings">mappings</a>. and returns its index if found or -1 otherwise.</p>
			...
			/**
			 * <p>Inserts a mapping into the aggregation <a target="_self" href="api/sap.uxap.BlockBase#methods/getMappings">mappings</a>.</p>
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			insertMapping(oMapping: sap.uxap.ModelMapping, iIndex: number): this;
			/**
			...
			/**
			 * <p>Sets the associated <a target="_self" href="api/sap.uxap.BlockBase#methods/getSelectedView">selectedView</a>.</p>
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setSelectedView(oSelectedView: sap.ui.core.ID | sap.ui.core.Control): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.BlockBase#methods/getShowSubSectionMore">showSubSectionMore</a>.</p><p>Determines whether the show more button should be shown.</p><p><b>Note:</b> The property will take effect if the <code>BlockBase</code> is inside <code>ObjectPageSubSection</code> and would be ignored in case the <code>BlockBase</code> is nested inside another <code>BlockBase</code>.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
			 * @param {boolean} bShowSubSectionMore <p>New value for property <code>showSubSectionMore</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setShowSubSectionMore(bShowSubSectionMore?: boolean): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.BlockBase#methods/getVisible">visible</a>.</p><p>Determines the visibility of the block.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>true</code>.</p>
		...
		export class BreadCrumbs extends sap.ui.core.Control {
			...
			constructor(sId?: string, mSettings?: any);
			/**
			 * <p>Adds some link to the aggregation <a target="_self" href="api/sap.uxap.BreadCrumbs#methods/getLinks">links</a>.</p>
			 * @param {sap.m.Link} oLink <p>The link to add; if empty, nothing is inserted</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			addLink(oLink: sap.m.Link): this;
			/**
			 * <p>Destroys the currentLocation in the aggregation <a target="_self" href="api/sap.uxap.BreadCrumbs#methods/getCurrentLocation">currentLocation</a>.</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			destroyCurrentLocation(): this;
			/**
			 * <p>Destroys all the links in the aggregation <a target="_self" href="api/sap.uxap.BreadCrumbs#methods/getLinks">links</a>.</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			destroyLinks(): this;
			/**
			 * <p>Gets content of aggregation <a target="_self" href="api/sap.uxap.BreadCrumbs#methods/getCurrentLocation">currentLocation</a>.</p><p>The current/last element in the BreadCrumbs path.</p>
			 * @returns sap.m.Text 
			 */
			...
			/**
			 * <p>Checks for the provided <code>sap.m.Link</code> in the aggregation <a target="_self" href="api/sap.uxap.BreadCrumbs#methods/getLinks">links</a>. and returns its index if found or -1 otherwise.</p>
			 * @param {sap.m.Link} oLink <p>The link whose index is looked for</p>
			 * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
			 */
			indexOfLink(oLink: sap.m.Link): number;
			/**
			 * <p>Inserts a link into the aggregation <a target="_self" href="api/sap.uxap.BreadCrumbs#methods/getLinks">links</a>.</p>
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			insertLink(oLink: sap.m.Link, iIndex: number): this;
			/**
		...
		export class HierarchicalSelect extends sap.m.Select {
			...
			constructor(sId?: string, mSettings?: any);
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.HierarchicalSelect#methods/getUpperCase">upperCase</a>.</p><p>Determines whether the HierarchicalSelect items are displayed in upper case.</p><p>Default value is <code>false</code>.</p>
			 * @returns boolean <p>Value of property <code>upperCase</code></p>
			 */
			getUpperCase(): boolean;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.HierarchicalSelect#methods/getUpperCase">upperCase</a>.</p><p>Determines whether the HierarchicalSelect items are displayed in upper case.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
			 * @param {boolean} bUpperCase <p>New value for property <code>upperCase</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setUpperCase(bUpperCase?: boolean): this;
		...
		/**
		 * <p><p>Interface for controls that are eligible for the <code>headerContent</code> aggregation of the <code><a target="_self" href="api/sap.uxap.ObjectPageLayout">sap.uxap.ObjectPageLayout</a></code>.</p><p>Controls that implement this interface: <ul> <li><code><a target="_self" href="api/sap.uxap.ObjectPageHeaderContent">sap.uxap.ObjectPageHeaderContent</a></code> - <code>ObjectPageLayout</code>'s classic header content</code></li> <li><code><a target="_self" href="api/sap.uxap.ObjectPageDynamicHeaderContent">sap.uxap.ObjectPageDynamicHeaderContent</a></code> - <code>ObjectPageLayout</code>'s dynamic header content</code></li> </ul></p><p>For more information on the types of header available for the <code><a target="_self" href="api/sap.uxap.ObjectPageLayout">ObjectPageLayout</a></code>, see <a target="_self" href="topic/d2ef0099542d44dc868719d908e576d0">Object Page Headers</a>.</p><p>For details regarding the differences and similarities between the available headers, see <a target="_self" href="topic/9c9d94fd28284539a9a5a57e9caf82a8">Object Page Headers Comparison</a>.</p><br><br>References: <ul></ul></p>
		 */
		export interface IHeaderContent {
		}
		/**
		 * <p><p>Interface for controls that are eligible for the <code>headerTitle</code> aggregation of the <code><a target="_self" href="api/sap.uxap.ObjectPageLayout">sap.uxap.ObjectPageLayout</a></code>.</p><p>Controls that implement this interface: <ul> <li><code><a target="_self" href="api/sap.uxap.ObjectPageHeader">sap.uxap.ObjectPageHeader</a></code> - <code>ObjectPageLayout</code>'s classic header</code></li> <li><code><a target="_self" href="api/sap.uxap.ObjectPageDynamicHeaderTitle">sap.uxap.ObjectPageDynamicHeaderTitle</a></code> - <code>ObjectPageLayout</code>'s dynamic header</code></li> </ul></p><p>For more information on the types of header available for the <code><a target="_self" href="api/sap.uxap.ObjectPageLayout">ObjectPageLayout</a></code>, see <a target="_self" href="topic/d2ef0099542d44dc868719d908e576d0">Object Page Headers</a>.</p><p>For details regarding the differences and similarities between the available headers, see <a target="_self" href="topic/9c9d94fd28284539a9a5a57e9caf82a8">Object Page Headers Comparison</a>.</p><br><br>References: <ul></ul></p>
		 */
		...
		/**
		 * <p>Defines the entity that will be passed to the <a target="_self" href="api/sap.uxap.ObjectPageLayout">sap.uxap.ObjectPageLayout</a>.</p>
		 */
		export class ModelMapping extends sap.ui.core.Element {
			...
			constructor(sId?: string, mSettings?: any);
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ModelMapping#methods/getExternalModelName">externalModelName</a>.</p><p>Determines the external model name.</p>
			 * @returns string <p>Value of property <code>externalModelName</code></p>
			 */
			getExternalModelName(): string;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ModelMapping#methods/getExternalPath">externalPath</a>.</p><p>Determines the external path.</p>
			 * @returns string <p>Value of property <code>externalPath</code></p>
			 */
			getExternalPath(): string;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ModelMapping#methods/getInternalModelName">internalModelName</a>.</p><p>Determines the internal model name.</p><p>Default value is <code>"Model"</code>.</p>
			 * @returns string <p>Value of property <code>internalModelName</code></p>
			 */
			getInternalModelName(): string;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ModelMapping#methods/getExternalModelName">externalModelName</a>.</p><p>Determines the external model name.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
			 * @param {string} sExternalModelName <p>New value for property <code>externalModelName</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setExternalModelName(sExternalModelName?: string): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ModelMapping#methods/getExternalPath">externalPath</a>.</p><p>Determines the external path.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
			 * @param {string} sExternalPath <p>New value for property <code>externalPath</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setExternalPath(sExternalPath?: string): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ModelMapping#methods/getInternalModelName">internalModelName</a>.</p><p>Determines the internal model name.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>"Model"</code>.</p>
			 * @param {string} sInternalModelName <p>New value for property <code>internalModelName</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setInternalModelName(sInternalModelName?: string): this;
		}
		/**
		...
		export class ObjectPageAccessibleLandmarkInfo extends sap.ui.core.Element {
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setNavigationLabel(sNavigationLabel?: string): this;
			/**
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setNavigationRole(sNavigationRole?: sap.ui.core.AccessibleLandmarkRole): this;
			/**
		...
		/**
		 * <p>Represents the static part (header title) of the classic header of the <a target="_self" href="api/sap.uxap.ObjectPageLayout">sap.uxap.ObjectPageLayout</a>.</p><h3>Overview</h3><p>The <code>ObjectPageHeader</code> is used to display the basic information about a business object, such as title/description/picture, as well as a list of common actions.</p><p><b>Note:</b> The <code>ObjectPageHeader</code> is meant to be used inside the <code>ObjectPageLayout</code> control. Any other usage is not supported and can lead to unexpected behavior.<br><br><span>Documentation links:</span><ul><li><a target="_self" href="topic/d2ef0099542d44dc868719d908e576d0">Object Page Headers</a></li><li><a target="_self" href="topic/9c9d94fd28284539a9a5a57e9caf82a8">Object Page Headers Comparison</a></li><li><a target="_blank" rel="noopener noreferrer" href="https://experience.sap.com/fiori-design-web/object-page">UX Guidelines: Object Page</a>
		...
		export class ObjectPageHeader extends sap.ui.core.Control {
			...
			constructor(sId?: string, mSettings?: any);
			/**
			 * <p>Adds some action to the aggregation <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getActions">actions</a>.</p>
			...
			destroyActions(): this;
			/**
			 * <p>Destroys the breadcrumbs in the aggregation <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getBreadcrumbs">breadcrumbs</a>.</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			destroyBreadcrumbs(): this;
			/**
			 * <p>Destroys the navigationBar in the aggregation <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getNavigationBar">navigationBar</a>.</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			destroyNavigationBar(): this;
			/**
			 * <p>Destroys the sideContentButton in the aggregation <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getSideContentButton">sideContentButton</a>.</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			destroySideContentButton(): this;
			/**
			 * <p>Destroys the titleSelectorTooltip in the aggregation <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getTitleSelectorTooltip">titleSelectorTooltip</a>.</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			protected fireMarkChangesPress(mParameters?: any): this;
			/**
			 * <p>Fires event <a target="_self" href="api/sap.uxap.ObjectPageHeader#events/markLockedPress">markLockedPress</a> to attached listeners.</p>
			 * @param {any} mParameters <p>Parameters to pass along with the event</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			protected fireMarkLockedPress(mParameters?: any): this;
			/**
			 * <p>Fires event <a target="_self" href="api/sap.uxap.ObjectPageHeader#events/titleSelectorPress">titleSelectorPress</a> to attached listeners.</p>
			 * @param {any} mParameters <p>Parameters to pass along with the event</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			protected fireTitleSelectorPress(mParameters?: any): this;
			/**
			...
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getIsActionAreaAlwaysVisible">isActionAreaAlwaysVisible</a>.</p><p>Determines whether the action buttons should always be visible or visible only when the header is snapped.</p><p>Default value is <code>true</code>.</p>
			 * @returns boolean <p>Value of property <code>isActionAreaAlwaysVisible</code></p>
			 */
			getIsActionAreaAlwaysVisible(): boolean;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getIsObjectIconAlwaysVisible">isObjectIconAlwaysVisible</a>.</p><p>Determines whether the icon should always be visible or visible only when the header is snapped.</p><p>Default value is <code>false</code>.</p>
			 * @returns boolean <p>Value of property <code>isObjectIconAlwaysVisible</code></p>
			 */
			getIsObjectIconAlwaysVisible(): boolean;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getIsObjectSubtitleAlwaysVisible">isObjectSubtitleAlwaysVisible</a>.</p><p>Determines whether the subtitle should always be visible or visible only when the header is snapped.</p><p>Default value is <code>true</code>.</p>
			 * @returns boolean <p>Value of property <code>isObjectSubtitleAlwaysVisible</code></p>
			 */
			getIsObjectSubtitleAlwaysVisible(): boolean;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getIsObjectTitleAlwaysVisible">isObjectTitleAlwaysVisible</a>.</p><p>Determines whether the title should always be visible or visible only when the header is snapped.</p><p>Default value is <code>true</code>.</p>
			 * @returns boolean <p>Value of property <code>isObjectTitleAlwaysVisible</code></p>
			 */
			getIsObjectTitleAlwaysVisible(): boolean;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getMarkChanges">markChanges</a>.</p><p>Marks that there are unsaved changes in the objectPageHeader. The markChanges state cannot be used together with the markLocked state. If both are set to true, only the locked state will be displayed.</p><p>Default value is <code>false</code>.</p>
			 * @returns boolean <p>Value of property <code>markChanges</code></p>
			 */
			getMarkChanges(): boolean;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getMarkFavorite">markFavorite</a>.</p><p>Set the favorite state to true or false. The showMarkers property must be true for this property to take effect.</p><p>Default value is <code>false</code>.</p>
			 * @returns boolean <p>Value of property <code>markFavorite</code></p>
			 */
			getMarkFavorite(): boolean;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getMarkFlagged">markFlagged</a>.</p><p>Set the flagged state to true or false. The showMarkers property must be true for this property to take effect.</p><p>Default value is <code>false</code>.</p>
			 * @returns boolean <p>Value of property <code>markFlagged</code></p>
			 */
			getMarkFlagged(): boolean;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getMarkLocked">markLocked</a>.</p><p>Set the locked state of the objectPageHeader.</p><p>Default value is <code>false</code>.</p>
			 * @returns boolean <p>Value of property <code>markLocked</code></p>
			 */
			getMarkLocked(): boolean;
			/**
			 * <p>Gets content of aggregation <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getNavigationBar">navigationBar</a>.</p><p>An instance of sap.m.Bar to be embedded in the header</p>
			 * @returns sap.m.Bar 
			 */
			getNavigationBar(): sap.m.Bar;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getObjectImageAlt">objectImageAlt</a>.</p><p>The text to be used for the Alt and Tooltip attribute of the image, supplied via the objectImageURI property</p><p>Default value is <code>empty string</code>.</p>
			 * @returns string <p>Value of property <code>objectImageAlt</code></p>
			 */
			getObjectImageAlt(): string;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getObjectImageBackgroundColor">objectImageBackgroundColor</a>.</p><p>Determines the background color of the image placeholder or icon if valid icon URI is provided.</p><p>Default value is <code>Accent6</code>.</p>
			...
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getObjectImageDensityAware">objectImageDensityAware</a>.</p><p>The value of densityAware for the image, supplied via the objectImageURI property. See sap.m.Image for more details on densityAware.</p><p>Default value is <code>false</code>.</p>
			 * @returns boolean <p>Value of property <code>objectImageDensityAware</code></p>
			 */
			getObjectImageDensityAware(): boolean;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getObjectImageShape">objectImageShape</a>.</p><p>Determines whether the picture should be displayed in a square or with a circle-shaped mask.</p><p>Default value is <code>Square</code>.</p>
			 * @returns sap.m.AvatarShape <p>Value of property <code>objectImageShape</code></p>
			 */
			getObjectImageShape(): sap.m.AvatarShape;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getObjectImageURI">objectImageURI</a>.</p><p>The URL of the image, representing the business object</p>
			 * @returns string <p>Value of property <code>objectImageURI</code></p>
			 */
			getObjectImageURI(): string;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getObjectSubtitle">objectSubtitle</a>.</p><p>The description of the object</p>
			 * @returns string <p>Value of property <code>objectSubtitle</code></p>
			 */
			getObjectSubtitle(): string;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getObjectTitle">objectTitle</a>.</p><p>The title of the object</p>
			 * @returns string <p>Value of property <code>objectTitle</code></p>
			 */
			getObjectTitle(): string;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getShowMarkers">showMarkers</a>.</p><p>Indicates if object page header title supports showing markers such as flagged and favorite.</p><p>Default value is <code>false</code>.</p>
			 * @returns boolean <p>Value of property <code>showMarkers</code></p>
			 */
			getShowMarkers(): boolean;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getShowPlaceholder">showPlaceholder</a>.</p><p>Enables support of a placeholder image in case no image is specified or the URL of the provided image is invalid.</p><p>Default value is <code>false</code>.</p>
			 * @returns boolean <p>Value of property <code>showPlaceholder</code></p>
			 */
			getShowPlaceholder(): boolean;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getShowTitleSelector">showTitleSelector</a>.</p><p>When set to true, the selector arrow icon/image is shown and can be pressed.</p><p>Default value is <code>false</code>.</p>
			 * @returns boolean <p>Value of property <code>showTitleSelector</code></p>
			 */
			getShowTitleSelector(): boolean;
			/**
			 * <p>Gets content of aggregation <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getSideContentButton">sideContentButton</a>.</p><p>A button that is used for opening the side content of the page or some additional content.</p>
			...
			/**
			 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getActions">actions</a>. and returns its index if found or -1 otherwise.</p>
			...
			/**
			 * <p>Inserts a action into the aggregation <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getActions">actions</a>.</p>
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setBreadcrumbs(oBreadcrumbs: sap.m.Breadcrumbs): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getIsActionAreaAlwaysVisible">isActionAreaAlwaysVisible</a>.</p><p>Determines whether the action buttons should always be visible or visible only when the header is snapped.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>true</code>.</p>
			 * @param {boolean} bIsActionAreaAlwaysVisible <p>New value for property <code>isActionAreaAlwaysVisible</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setIsActionAreaAlwaysVisible(bIsActionAreaAlwaysVisible?: boolean): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getIsObjectIconAlwaysVisible">isObjectIconAlwaysVisible</a>.</p><p>Determines whether the icon should always be visible or visible only when the header is snapped.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
			 * @param {boolean} bIsObjectIconAlwaysVisible <p>New value for property <code>isObjectIconAlwaysVisible</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setIsObjectIconAlwaysVisible(bIsObjectIconAlwaysVisible?: boolean): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getIsObjectSubtitleAlwaysVisible">isObjectSubtitleAlwaysVisible</a>.</p><p>Determines whether the subtitle should always be visible or visible only when the header is snapped.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>true</code>.</p>
			 * @param {boolean} bIsObjectSubtitleAlwaysVisible <p>New value for property <code>isObjectSubtitleAlwaysVisible</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setIsObjectSubtitleAlwaysVisible(bIsObjectSubtitleAlwaysVisible?: boolean): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getIsObjectTitleAlwaysVisible">isObjectTitleAlwaysVisible</a>.</p><p>Determines whether the title should always be visible or visible only when the header is snapped.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>true</code>.</p>
			 * @param {boolean} bIsObjectTitleAlwaysVisible <p>New value for property <code>isObjectTitleAlwaysVisible</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setIsObjectTitleAlwaysVisible(bIsObjectTitleAlwaysVisible?: boolean): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getMarkChanges">markChanges</a>.</p><p>Marks that there are unsaved changes in the objectPageHeader. The markChanges state cannot be used together with the markLocked state. If both are set to true, only the locked state will be displayed.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
			 * @param {boolean} bMarkChanges <p>New value for property <code>markChanges</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setMarkChanges(bMarkChanges?: boolean): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getMarkFavorite">markFavorite</a>.</p><p>Set the favorite state to true or false. The showMarkers property must be true for this property to take effect.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
			 * @param {boolean} bMarkFavorite <p>New value for property <code>markFavorite</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setMarkFavorite(bMarkFavorite?: boolean): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getMarkFlagged">markFlagged</a>.</p><p>Set the flagged state to true or false. The showMarkers property must be true for this property to take effect.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
			 * @param {boolean} bMarkFlagged <p>New value for property <code>markFlagged</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setMarkFlagged(bMarkFlagged?: boolean): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getMarkLocked">markLocked</a>.</p><p>Set the locked state of the objectPageHeader.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
			 * @param {boolean} bMarkLocked <p>New value for property <code>markLocked</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setMarkLocked(bMarkLocked?: boolean): this;
			/**
			 * <p>Sets the aggregated <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getNavigationBar">navigationBar</a>.</p>
			 * @param {sap.m.Bar} oNavigationBar <p>The navigationBar to set</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setNavigationBar(oNavigationBar: sap.m.Bar): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getObjectImageAlt">objectImageAlt</a>.</p><p>The text to be used for the Alt and Tooltip attribute of the image, supplied via the objectImageURI property</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>empty string</code>.</p>
			 * @param {string} sObjectImageAlt <p>New value for property <code>objectImageAlt</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setObjectImageAlt(sObjectImageAlt?: string): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getObjectImageBackgroundColor">objectImageBackgroundColor</a>.</p><p>Determines the background color of the image placeholder or icon if valid icon URI is provided.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>Accent6</code>.</p>
			 * @param {sap.m.AvatarColor} sObjectImageBackgroundColor <p>New value for property <code>objectImageBackgroundColor</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setObjectImageBackgroundColor(sObjectImageBackgroundColor?: sap.m.AvatarColor): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getObjectImageDensityAware">objectImageDensityAware</a>.</p><p>The value of densityAware for the image, supplied via the objectImageURI property. See sap.m.Image for more details on densityAware.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
			 * @param {boolean} bObjectImageDensityAware <p>New value for property <code>objectImageDensityAware</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setObjectImageDensityAware(bObjectImageDensityAware?: boolean): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getObjectImageShape">objectImageShape</a>.</p><p>Determines whether the picture should be displayed in a square or with a circle-shaped mask.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>Square</code>.</p>
			 * @param {sap.m.AvatarShape} sObjectImageShape <p>New value for property <code>objectImageShape</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setObjectImageShape(sObjectImageShape?: sap.m.AvatarShape): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getObjectImageURI">objectImageURI</a>.</p><p>The URL of the image, representing the business object</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
			 * @param {string} sObjectImageURI <p>New value for property <code>objectImageURI</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setObjectImageURI(sObjectImageURI?: string): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getObjectSubtitle">objectSubtitle</a>.</p><p>The description of the object</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
			 * @param {string} sObjectSubtitle <p>New value for property <code>objectSubtitle</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setObjectSubtitle(sObjectSubtitle?: string): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getObjectTitle">objectTitle</a>.</p><p>The title of the object</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
			 * @param {string} sObjectTitle <p>New value for property <code>objectTitle</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setObjectTitle(sObjectTitle?: string): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getShowMarkers">showMarkers</a>.</p><p>Indicates if object page header title supports showing markers such as flagged and favorite.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
			 * @param {boolean} bShowMarkers <p>New value for property <code>showMarkers</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setShowMarkers(bShowMarkers?: boolean): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getShowPlaceholder">showPlaceholder</a>.</p><p>Enables support of a placeholder image in case no image is specified or the URL of the provided image is invalid.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
			 * @param {boolean} bShowPlaceholder <p>New value for property <code>showPlaceholder</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setShowPlaceholder(bShowPlaceholder?: boolean): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getShowTitleSelector">showTitleSelector</a>.</p><p>When set to true, the selector arrow icon/image is shown and can be pressed.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
			 * @param {boolean} bShowTitleSelector <p>New value for property <code>showTitleSelector</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setShowTitleSelector(bShowTitleSelector?: boolean): this;
			/**
			 * <p>Sets the aggregated <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getSideContentButton">sideContentButton</a>.</p>
			 * @param {sap.m.Button} oSideContentButton <p>The sideContentButton to set</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setSideContentButton(oSideContentButton: sap.m.Button): this;
			/**
			 * <p>Sets the aggregated <a target="_self" href="api/sap.uxap.ObjectPageHeader#methods/getTitleSelectorTooltip">titleSelectorTooltip</a>.</p>
			 * @param {sap.ui.core.TooltipBase | string} vTitleSelectorTooltip <p>The titleSelectorTooltip to set</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setTitleSelectorTooltip(vTitleSelectorTooltip: sap.ui.core.TooltipBase | string): this;
		}
		/**
		 * <p>A Button that is used in the <code>actions</code> aggregation of the <a target="_self" href="api/sap.uxap.ObjectPageHeader">sap.uxap.ObjectPageHeader</a>.</p><p>The button is designed to be used with <a target="_self" href="api/sap.uxap.ObjectPageHeader">sap.uxap.ObjectPageHeader</a> and any usage outside the intended context is not recommended.</p>
		 */
		...
		/**
		 * <p>Header content for the classic header of the <a target="_self" href="api/sap.uxap.ObjectPageLayout">sap.uxap.ObjectPageLayout</a>.</p><h3>Overview</h3><p>The <code>ObjectPageHeaderContent</code> represents the movable part of the <code>ObjectPageLayout</code>'s classic header. It can contain any control and scrolls along with the content of the page until it disappears (collapsed header). When scrolled back to the top it becomes visible again (expanded header). It contains all the additional information of the object.</p><p>Documentation links: <ul> <li><a target="_self" href="topic/d2ef0099542d44dc868719d908e576d0">Object Page Headers</a></li> <li><a target="_self" href="topic/0fecbce45e39406aa939bd25e89823f4">Object Page Classic Header</a></li> <li><a target="_blank" rel="noopener noreferrer" href="https://experience.sap.com/fiori-design-web/object-page/">UX Guidelines: Object Page</a>
					<img src="./resources/sap/ui/documentation/sdk/images/link-sap.png"
					title="Information published on SAP site" class="sapUISDKExternalLink"/></li> </ul></p>
		 */
		export class ObjectPageHeaderContent extends sap.ui.core.Control {
			...
			constructor(sId?: string, mSettings?: any);
			/**
			 * <p>Adds some content to the aggregation <a target="_self" href="api/sap.uxap.ObjectPageHeaderContent#methods/getContent">content</a>.</p>
			...
			/**
			 * <p>Destroys all the content in the aggregation <a target="_self" href="api/sap.uxap.ObjectPageHeaderContent#methods/getContent">content</a>.</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			destroyContent(): this;
			/**
			...
			/**
			 * <p>Inserts a content into the aggregation <a target="_self" href="api/sap.uxap.ObjectPageHeaderContent#methods/getContent">content</a>.</p>
		...
		/**
		 * <p>A <a target="_self" href="api/sap.ui.core.LayoutData">sap.ui.core.LayoutData</a> element that can be added to controls used in the <code>headerContent</code> aggregation of the <code>ObjectPageLayout</code>.</p><p><b>Note:</b> This element is only taken into account when the <code>sap.uxap.ObjectPageLayout</code> control is used together with <code>sap.uxap.ObjectPageHeader</code> as value of <code>headerTitle</code>.</p>
		 */
		export class ObjectPageHeaderLayoutData extends sap.ui.core.LayoutData {
			...
			constructor(sId?: string, mSettings?: any);
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeaderLayoutData#methods/getShowSeparatorAfter">showSeparatorAfter</a>.</p><p>If this property is set the control will display a separator after it.</p><p>Default value is <code>false</code>.</p>
			 * @returns boolean <p>Value of property <code>showSeparatorAfter</code></p>
			 */
			getShowSeparatorAfter(): boolean;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeaderLayoutData#methods/getShowSeparatorBefore">showSeparatorBefore</a>.</p><p>If this property is set the control will display a separator before it.</p><p>Default value is <code>false</code>.</p>
			 * @returns boolean <p>Value of property <code>showSeparatorBefore</code></p>
			 */
			getShowSeparatorBefore(): boolean;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeaderLayoutData#methods/getVisibleL">visibleL</a>.</p><p>If this property is set the control will be visible (or not) in a large sized layout.</p><p>Default value is <code>true</code>.</p>
			 * @returns boolean <p>Value of property <code>visibleL</code></p>
			 */
			getVisibleL(): boolean;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeaderLayoutData#methods/getVisibleM">visibleM</a>.</p><p>If this property is set the control will be visible (or not) in a medium sized layout.</p><p>Default value is <code>true</code>.</p>
			 * @returns boolean <p>Value of property <code>visibleM</code></p>
			 */
			getVisibleM(): boolean;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeaderLayoutData#methods/getVisibleS">visibleS</a>.</p><p>If this property is set the control will be visible (or not) in a small sized layout.</p><p>Default value is <code>true</code>.</p>
			 * @returns boolean <p>Value of property <code>visibleS</code></p>
			 */
			getVisibleS(): boolean;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageHeaderLayoutData#methods/getWidth">width</a>.</p><p>If this property is set the control will take the provided size.</p><p>Default value is <code>'auto'</code>.</p>
			 * @returns sap.ui.core.CSSSize <p>Value of property <code>width</code></p>
			 */
			getWidth(): sap.ui.core.CSSSize;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageHeaderLayoutData#methods/getShowSeparatorAfter">showSeparatorAfter</a>.</p><p>If this property is set the control will display a separator after it.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
			 * @param {boolean} bShowSeparatorAfter <p>New value for property <code>showSeparatorAfter</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setShowSeparatorAfter(bShowSeparatorAfter?: boolean): this;
			/**
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setShowSeparatorBefore(bShowSeparatorBefore?: boolean): this;
			/**
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setVisibleL(bVisibleL?: boolean): this;
			/**
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setVisibleM(bVisibleM?: boolean): this;
			/**
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setVisibleS(bVisibleS?: boolean): this;
			/**
		...
		export class ObjectPageLayout extends sap.ui.core.Control {
			...
			constructor(sId?: string, mSettings?: any);
			/**
			 * <p>Adds some headerContent to the aggregation <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getHeaderContent">headerContent</a>.</p>
			...
			/**
			 * <p>Adds some section to the aggregation <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getSections">sections</a>.</p>
			...
			destroyFooter(): this;
			/**
			 * <p>Destroys all the headerContent in the aggregation <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getHeaderContent">headerContent</a>.</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			destroyHeaderContent(): this;
			/**
			 * <p>Destroys the headerTitle in the aggregation <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getHeaderTitle">headerTitle</a>.</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			destroyHeaderTitle(): this;
			/**
			 * <p>Destroys the landmarkInfo in the aggregation <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getLandmarkInfo">landmarkInfo</a>.</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			destroyLandmarkInfo(): this;
			/**
			 * <p>Destroys all the sections in the aggregation <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getSections">sections</a>.</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			protected fireEditHeaderButtonPress(mParameters?: any): this;
			/**
			 * <p>Fires event <a target="_self" href="api/sap.uxap.ObjectPageLayout#events/headerContentPinnedStateChange">headerContentPinnedStateChange</a> to attached listeners.</p>
			 * @param {any} mParameters <p>Parameters to pass along with the event</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			protected fireHeaderContentPinnedStateChange(mParameters?: any): this;
			/**
			 * <p>Fires event <a target="_self" href="api/sap.uxap.ObjectPageLayout#events/navigate">navigate</a> to attached listeners.</p>
			 * @param {any} mParameters <p>Parameters to pass along with the event</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			protected fireNavigate(mParameters?: any): this;
			/**
			 * <p>Fires event <a target="_self" href="api/sap.uxap.ObjectPageLayout#events/sectionChange">sectionChange</a> to attached listeners.</p>
			 * @param {any} mParameters <p>Parameters to pass along with the event</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			protected fireSectionChange(mParameters?: any): this;
			/**
			 * <p>Fires event <a target="_self" href="api/sap.uxap.ObjectPageLayout#events/subSectionVisibilityChange">subSectionVisibilityChange</a> to attached listeners.</p>
			 * @param {any} mParameters <p>Parameters to pass along with the event</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			protected fireSubSectionVisibilityChange(mParameters?: any): this;
			/**
			 * <p>Fires event <a target="_self" href="api/sap.uxap.ObjectPageLayout#events/toggleAnchorBar">toggleAnchorBar</a> to attached listeners.</p>
			 * @param {any} mParameters <p>Parameters to pass along with the event</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			protected fireToggleAnchorBar(mParameters?: any): this;
			/**
			...
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getEnableLazyLoading">enableLazyLoading</a>.</p><p>Enable lazy loading for the Object page Subsections.</p><p>Default value is <code>false</code>.</p>
			...
			/**
			 * <p>Gets content of aggregation <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getFooter">footer</a>.</p><p>Object page floating footer.</p>
			 * @returns sap.m.IBar 
			 */
			...
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getHeaderContentPinned">headerContentPinned</a>.</p><p>Determines whether the <code>sap.uxap.ObjectPageDynamicHeaderContent</code> is pinned.</p><p>The property can be changed explicitly with its setter or in the occurrence of the following user interactions: <ul> <li>Toggling the pin/unpin button of <code>sap.uxap.ObjectPageDynamicHeaderContent</code></li> <li>Snapping the <code>sap.uxap.ObjectPageDynamicHeaderContent</code> by explicitly clicking on the <code>sap.uxap.ObjectPageDynamicHeaderTitle</code></li> </ul></p><p><b>Note: </b> The property will only apply if the following rules are currently in use: <ul> <li>An instance of <code>sap.uxap.ObjectPageDynamicHeaderTitle</code> is used for the <code>headerTitle</code> aggregation.</li> <li>The <code>headerContentPinnable</code> property is <code>true</code></li> <li>The <code>sap.uxap.ObjectPageDynamicHeaderContent</code> is expanded</li> <li>The <code>preserveHeaderStateOnScroll</code> property or the rules for it to work are <code>false</code></li> </ul></p><p>Default value is <code>false</code>.</p>
			 * @returns boolean <p>Value of property <code>headerContentPinned</code></p>
			 */
			getHeaderContentPinned(): boolean;
			/**
			 * <p>Gets content of aggregation <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getHeaderTitle">headerTitle</a>.</p><p>Object page header title - the upper, always static, part of the Object page header.</p>
			 * @returns sap.uxap.IHeaderTitle 
			 */
			getHeaderTitle(): sap.uxap.IHeaderTitle;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getHeight">height</a>.</p><p>Determines the height of the ObjectPage.</p><p>Default value is <code>"100%"</code>.</p>
			...
			/**
			 * <p>Gets content of aggregation <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getLandmarkInfo">landmarkInfo</a>.</p><p>Accessible landmark settings to be applied on the containers of the <code>sap.uxap.ObjectPageLayout</code> control.</p><p>If not set, no landmarks will be written.</p>
			...
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getShowAnchorBarPopover">showAnchorBarPopover</a>.</p><p>Determines whether to show a Popover with Subsection links when clicking on Section links in the Anchor bar.</p><p>Default value is <code>true</code>.</p>
			...
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getShowFooter">showFooter</a>.</p><p>Determines whether the footer is visible.</p><p>Default value is <code>false</code>.</p>
			 * @returns boolean <p>Value of property <code>showFooter</code></p>
			 */
			getShowFooter(): boolean;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getShowHeaderContent">showHeaderContent</a>.</p><p>Determines the visibility of the Header content (headerContent aggregation).</p><p>Default value is <code>true</code>.</p>
			 * @returns boolean <p>Value of property <code>showHeaderContent</code></p>
			 */
			getShowHeaderContent(): boolean;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getShowOnlyHighImportance">showOnlyHighImportance</a>.</p><p>Determines whether sections and subsections with importance Low and Medium are hidden even on large screens.</p><p>Default value is <code>false</code>.</p>
			...
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getSubSectionLayout">subSectionLayout</a>.</p><p>Determines whether Subsection titles are displayed on top or to the left of the Subsection content.</p><p>Default value is <code>TitleOnTop</code>.</p>
			...
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getUpperCaseAnchorBar">upperCaseAnchorBar</a>.</p><p>Determines whether the Anchor bar items are displayed in upper case.</p><p>Default value is <code>true</code>.</p>
			...
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getUseTwoColumnsForLargeScreen">useTwoColumnsForLargeScreen</a>.</p><p>Determines whether the to use two column layout for the L screen size.</p><p>Default value is <code>false</code>.</p>
			 * @returns boolean <p>Value of property <code>useTwoColumnsForLargeScreen</code></p>
			 */
			getUseTwoColumnsForLargeScreen(): boolean;
			/**
			 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getHeaderContent">headerContent</a>. and returns its index if found or -1 otherwise.</p>
			...
			/**
			 * <p>Checks for the provided <code>sap.uxap.ObjectPageSection</code> in the aggregation <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getSections">sections</a>. and returns its index if found or -1 otherwise.</p>
			...
			/**
			 * <p>Inserts a headerContent into the aggregation <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getHeaderContent">headerContent</a>.</p>
			...
			/**
			 * <p>Inserts a section into the aggregation <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getSections">sections</a>.</p>
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			insertSection(oSection: sap.uxap.ObjectPageSection, iIndex: number): this;
			/**
			 ...
			 */
			setBackgroundDesignAnchorBar(sBackgroundDesignAnchorBar: sap.m.BackgroundDesign): this;
			/**
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setEnableLazyLoading(bEnableLazyLoading?: boolean): this;
			/**
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setFlexEnabled(bFlexEnabled?: boolean): this;
			/**
			 * <p>Sets the aggregated <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getFooter">footer</a>.</p>
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setHeaderContentPinnable(bHeaderContentPinnable?: boolean): this;
			/**
			 ...
			 * @param {boolean} bHeaderContentPinned <p>New value for property <code>headerContentPinned</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setHeaderContentPinned(bHeaderContentPinned?: boolean): this;
			/**
			 * <p>Sets the aggregated <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getHeaderTitle">headerTitle</a>.</p>
			 * @param {sap.uxap.IHeaderTitle} oHeaderTitle <p>The headerTitle to set</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setHeaderTitle(oHeaderTitle: sap.uxap.IHeaderTitle): this;
			/**
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setIsChildPage(bIsChildPage?: boolean): this;
			/**
			 * <p>Sets the aggregated <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getLandmarkInfo">landmarkInfo</a>.</p>
			 * @param {sap.uxap.ObjectPageAccessibleLandmarkInfo} oLandmarkInfo <p>The landmarkInfo to set</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setLandmarkInfo(oLandmarkInfo: sap.uxap.ObjectPageAccessibleLandmarkInfo): this;
			/**
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setSectionTitleLevel(sSectionTitleLevel?: sap.ui.core.TitleLevel): this;
			/**
			 * <p>Sets the section that should be selected.</p><p>The section can either be given by itself or by its id.</p><p>If left unspecified, then the page automatically sets the value to the first visible section before rendering. The value never remains empty because <code>sap.uxap.ObjectPageLayout</code> should always have one of its sections selected (unless it has 0 visible sections).</p><p><b>Note:</b> Updating the <code>selectedSection</code> with a value of <code>null</code> resets the <code>selectedSection</code> to the first visible section and scrolls the page to the top.</p>
			 * @param {string | sap.uxap.ObjectPageSection} sId <p>The ID or the section instance that should be selected Note that <code>undefined</code> is not a valid argument</p>
			 * @returns this <p>Returns <code>this</code> to allow method chaining</p>
			 */
			setSelectedSection(sId: string | sap.uxap.ObjectPageSection): this;
			/**
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setShowAnchorBar(bShowAnchorBar?: boolean): this;
			/**
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setShowAnchorBarPopover(bShowAnchorBarPopover?: boolean): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getShowEditHeaderButton">showEditHeaderButton</a>.</p><p>Determines whether an Edit button will be displayed in Header Content.</p><p><b>Note</b>: This property is only taken into account if an instance of <code>sap.uxap.ObjectPageHeader</code> is used for the <code>headerTitle</code> aggregation.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
			 * @param {boolean} bShowEditHeaderButton <p>New value for property <code>showEditHeaderButton</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setShowEditHeaderButton(bShowEditHeaderButton?: boolean): this;
			/**
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setShowHeaderContent(bShowHeaderContent?: boolean): this;
			/**
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setShowOnlyHighImportance(bShowOnlyHighImportance?: boolean): this;
			/**
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setShowTitleInHeaderContent(bShowTitleInHeaderContent?: boolean): this;
			/**
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setSubSectionLayout(sSubSectionLayout?: sap.uxap.ObjectPageSubSectionLayout): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageLayout#methods/getToggleHeaderOnTitleClick">toggleHeaderOnTitleClick</a>.</p><p>Determines whether the user can switch between the expanded/collapsed states of the <code>sap.uxap.ObjectPageDynamicHeaderContent</code> by clicking on the <code>sap.uxap.ObjectPageDynamicHeaderTitle</code>. If set to <code>false</code>, the <code>sap.uxap.ObjectPageDynamicHeaderTitle</code> is not clickable and the application must provide other means for expanding/collapsing the <code>sap.uxap.ObjectPageDynamicHeaderContent</code>, if necessary.</p><p><b>Note:</b> This property is only taken into account if an instance of <code>sap.uxap.ObjectPageDynamicHeaderTitle</code> is used for the <code>headerTitle</code> aggregation.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>true</code>.</p>
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setUpperCaseAnchorBar(bUpperCaseAnchorBar?: boolean): this;
			/**
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setUseIconTabBar(bUseIconTabBar?: boolean): this;
			/**
		...
		export class ObjectPageLazyLoader extends sap.ui.core.Element {
			...
			constructor(sId?: string, mSettings?: any);
			/**
			 * <p>Adds some content to the aggregation <a target="_self" href="api/sap.uxap.ObjectPageLazyLoader#methods/getContent">content</a>.</p>
			 * @param {sap.ui.core.Control} oContent <p>The content to add; if empty, nothing is inserted</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			addContent(oContent: sap.ui.core.Control): this;
			/**
			 * <p>Destroys all the content in the aggregation <a target="_self" href="api/sap.uxap.ObjectPageLazyLoader#methods/getContent">content</a>.</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			destroyContent(): this;
			/**
			...
			indexOfContent(oContent: sap.ui.core.Control): number;
			/**
			 * <p>Inserts a content into the aggregation <a target="_self" href="api/sap.uxap.ObjectPageLazyLoader#methods/getContent">content</a>.</p>
			 * @param {sap.ui.core.Control} oContent <p>The content to insert; if empty, nothing is inserted</p>
			 * @param {number} iIndex <p>The <code>0</code>-based index the content should be inserted at; for a negative value of <code>iIndex</code>, the content is inserted at position 0; for a value greater than the current size of the aggregation, the content is inserted at the last position</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
		...
		/**
		 * <p>Top-level information container of an <a target="_self" href="api/sap.uxap.ObjectPageLayout">sap.uxap.ObjectPageLayout</a>.</p><p>The <code>ObjectPageSection</code>'s purpose is to aggregate subsections.</p><p><b>Note:</b> This control is intended to be used only as part of the <code>ObjectPageLayout</code>.</p>
		 */
		export class ObjectPageSection extends sap.uxap.ObjectPageSectionBase {
			...
			constructor(sId?: string, mSettings?: any);
			/**
			 * <p>Adds some subSection to the aggregation <a target="_self" href="api/sap.uxap.ObjectPageSection#methods/getSubSections">subSections</a>.</p>
			 * @param {sap.uxap.ObjectPageSubSection} oSubSection <p>The subSection to add; if empty, nothing is inserted</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			addSubSection(oSubSection: sap.uxap.ObjectPageSubSection): this;
			/**
			 * <p>Destroys the heading in the aggregation <a target="_self" href="api/sap.uxap.ObjectPageSection#methods/getHeading">heading</a>.</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			destroyHeading(): this;
			/**
			 * <p>Destroys all the subSections in the aggregation <a target="_self" href="api/sap.uxap.ObjectPageSection#methods/getSubSections">subSections</a>.</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			...
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageSection#methods/getWrapTitle">wrapTitle</a>.</p><p>Determines whether the Section title wraps on multiple lines, when the available space is not enough.</p><p>Default value is <code>false</code>.</p>
			 * @returns boolean <p>Value of property <code>wrapTitle</code></p>
			 */
			getWrapTitle(): boolean;
			/**
			 * <p>Checks for the provided <code>sap.uxap.ObjectPageSubSection</code> in the aggregation <a target="_self" href="api/sap.uxap.ObjectPageSection#methods/getSubSections">subSections</a>. and returns its index if found or -1 otherwise.</p>
			...
			/**
			 * <p>Inserts a subSection into the aggregation <a target="_self" href="api/sap.uxap.ObjectPageSection#methods/getSubSections">subSections</a>.</p>
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			insertSubSection(oSubSection: sap.uxap.ObjectPageSubSection, iIndex: number): this;
			/**
			...
			/**
			 * <p>Sets the associated <a target="_self" href="api/sap.uxap.ObjectPageSection#methods/getSelectedSubSection">selectedSubSection</a>.</p>
			 ...
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setSelectedSubSection(oSelectedSubSection: sap.ui.core.ID | sap.uxap.ObjectPageSubSection): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageSection#methods/getShowTitle">showTitle</a>.</p><p>Determines whether to display the Section title or not.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>true</code>.</p>
			 * @param {boolean} bShowTitle <p>New value for property <code>showTitle</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setShowTitle(bShowTitle?: boolean): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageSection#methods/getTitleUppercase">titleUppercase</a>.</p><p>Determines whether the Section title is displayed in upper case.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>true</code>.</p>
			...
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageSection#methods/getWrapTitle">wrapTitle</a>.</p><p>Determines whether the Section title wraps on multiple lines, when the available space is not enough.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
			 * @param {boolean} bWrapTitle <p>New value for property <code>wrapTitle</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setWrapTitle(bWrapTitle?: boolean): this;
		}
		/**
		 * <p>An abstract container for sections and subsections in the <a target="_self" href="api/sap.uxap.ObjectPageLayout">sap.uxap.ObjectPageLayout</a>.</p>
		 */
		export abstract class ObjectPageSectionBase extends sap.ui.core.Control {
			...
			/**
			 * <p>Destroys the customAnchorBarButton in the aggregation <a target="_self" href="api/sap.uxap.ObjectPageSectionBase#methods/getCustomAnchorBarButton">customAnchorBarButton</a>.</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			destroyCustomAnchorBarButton(): this;
			/**
			 * <p>Gets content of aggregation <a target="_self" href="api/sap.uxap.ObjectPageSectionBase#methods/getCustomAnchorBarButton">customAnchorBarButton</a>.</p><p>The custom button that will provide a link to the section in the ObjectPageLayout anchor bar. This button will be used as a custom template to be into the ObjectPageLayout anchorBar area, therefore property changes happening on this button template after the first rendering won't affect the actual button copy used in the anchorBar.</p><p>If you want to change some of the button properties, you would need to bind them to a model.</p>
			 * @returns sap.m.Button 
			 */
			...
			getVisible(): boolean;
			/**
			 * <p>Sets the aggregated <a target="_self" href="api/sap.uxap.ObjectPageSectionBase#methods/getCustomAnchorBarButton">customAnchorBarButton</a>.</p>
			 * @param {sap.m.Button} oCustomAnchorBarButton <p>The customAnchorBarButton to set</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setCustomAnchorBarButton(oCustomAnchorBarButton: sap.m.Button): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageSectionBase#methods/getImportance">importance</a>.</p><p>Determines whether the section will be hidden on low resolutions.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>High</code>.</p>
			 * @param {sap.uxap.Importance} sImportance <p>New value for property <code>importance</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setImportance(sImportance?: sap.uxap.Importance): this;
		...
		export class ObjectPageSubSection extends sap.uxap.ObjectPageSectionBase {
			...
			constructor(sId?: string, mSettings?: any);
			/**
			 * <p>Adds some action to the aggregation <a target="_self" href="api/sap.uxap.ObjectPageSubSection#methods/getActions">actions</a>.</p>
			 * @param {sap.ui.core.Control} oAction <p>The action to add; if empty, nothing is inserted</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			addAction(oAction: sap.ui.core.Control): this;
			/**
			 * <p>Adds some block to the aggregation <a target="_self" href="api/sap.uxap.ObjectPageSubSection#methods/getBlocks">blocks</a>.</p>
			 * @param {sap.ui.core.Control} oBlock <p>The block to add; if empty, nothing is inserted</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			addBlock(oBlock: sap.ui.core.Control): this;
			/**
			 * <p>Adds some moreBlock to the aggregation <a target="_self" href="api/sap.uxap.ObjectPageSubSection#methods/getMoreBlocks">moreBlocks</a>.</p>
			 * @param {sap.ui.core.Control} oMoreBlock <p>The moreBlock to add; if empty, nothing is inserted</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			addMoreBlock(oMoreBlock: sap.ui.core.Control): this;
			/**
			 * <p>Destroys all the actions in the aggregation <a target="_self" href="api/sap.uxap.ObjectPageSubSection#methods/getActions">actions</a>.</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			destroyActions(): this;
			/**
			 * <p>Destroys all the blocks in the aggregation <a target="_self" href="api/sap.uxap.ObjectPageSubSection#methods/getBlocks">blocks</a>.</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			destroyBlocks(): this;
			/**
			 * <p>Destroys all the moreBlocks in the aggregation <a target="_self" href="api/sap.uxap.ObjectPageSubSection#methods/getMoreBlocks">moreBlocks</a>.</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			...
			getShowTitle(): boolean;
			/**
			 * <p>Gets current value of property <a target="_self" href="api/sap.uxap.ObjectPageSubSection#methods/getTitleUppercase">titleUppercase</a>.</p><p>Determines whether the Subsection title is displayed in upper case.</p><p>Default value is <code>false</code>.</p>
			 * @returns boolean <p>Value of property <code>titleUppercase</code></p>
			 */
			getTitleUppercase(): boolean;
			/**
			 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" href="api/sap.uxap.ObjectPageSubSection#methods/getActions">actions</a>. and returns its index if found or -1 otherwise.</p>
			 * @param {sap.ui.core.Control} oAction <p>The action whose index is looked for</p>
			 * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
			 */
			indexOfAction(oAction: sap.ui.core.Control): number;
			/**
			 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" href="api/sap.uxap.ObjectPageSubSection#methods/getBlocks">blocks</a>. and returns its index if found or -1 otherwise.</p>
			 * @param {sap.ui.core.Control} oBlock <p>The block whose index is looked for</p>
			 * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
			 */
			indexOfBlock(oBlock: sap.ui.core.Control): number;
			/**
			 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" href="api/sap.uxap.ObjectPageSubSection#methods/getMoreBlocks">moreBlocks</a>. and returns its index if found or -1 otherwise.</p>
			...
			/**
			 * <p>Inserts a action into the aggregation <a target="_self" href="api/sap.uxap.ObjectPageSubSection#methods/getActions">actions</a>.</p>
			 * @param {sap.ui.core.Control} oAction <p>The action to insert; if empty, nothing is inserted</p>
			 * @param {number} iIndex <p>The <code>0</code>-based index the action should be inserted at; for a negative value of <code>iIndex</code>, the action is inserted at position 0; for a value greater than the current size of the aggregation, the action is inserted at the last position</p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			 ...
			 * @returns this <p>The <code>sap.uxap.ObjectPageSubSection</code> instance</p>
			 */
			insertBlock(oObject: sap.uxap.BlockBase, iIndex: number): this;
			/**
			 ...
			 * @returns this <p>The <code>sap.uxap.ObjectPageSubSection</code> instance</p>
			 */
			insertMoreBlock(oObject: sap.uxap.BlockBase, iIndex: number): this;
			/**
			...
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageSubSection#methods/getMode">mode</a>.</p><p>A mode property that will be passed to the controls in the blocks and moreBlocks aggregations. Only relevant if these aggregations use Object page blocks.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>Collapsed</code>.</p>
			 * @param {sap.uxap.ObjectPageSubSectionMode} sMode <p>New value for property <code>mode</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setMode(sMode?: sap.uxap.ObjectPageSubSectionMode): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageSubSection#methods/getShowTitle">showTitle</a>.</p><p>Determines whether to display the <code>SubSection</code> title or not.</p><p><b>Note:</b> If a subsection is the only one (or the only one visible) within a section, its title is displayed instead of the section title even if this property is set to <code>false</code>. To hide the title of a subsection which is the only one (or the only one visible), you need to set the <code>showTitle</code> properties to <code>false</code> for both the section and its subsection.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>true</code>.</p>
			 * @param {boolean} bShowTitle <p>New value for property <code>showTitle</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setShowTitle(bShowTitle?: boolean): this;
			/**
			 * <p>Sets a new value for property <a target="_self" href="api/sap.uxap.ObjectPageSubSection#methods/getTitleUppercase">titleUppercase</a>.</p><p>Determines whether the Subsection title is displayed in upper case.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
			 * @param {boolean} bTitleUppercase <p>New value for property <code>titleUppercase</code></p>
			 * @returns this <p>Reference to <code>this</code> in order to allow method chaining</p>
			 */
			setTitleUppercase(bTitleUppercase?: boolean): this;
