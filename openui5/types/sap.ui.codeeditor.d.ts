    ...
    namespace ui {
        ...
        namespace codeeditor {
            ...
            export class CodeEditor extends sap.ui.core.Control {
                ...
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="liveChange" href="api/sap.ui.codeeditor.CodeEditor#events/liveChange">liveChange</a> event of this <code>sap.ui.codeeditor.CodeEditor</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.codeeditor.CodeEditor</code> itself.</p><p>Fired when the value is changed by user interaction - each keystroke, delete, paste, etc.</p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                 * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.codeeditor.CodeEditor</code> itself</p>
                 * @returns sap.ui.codeeditor.CodeEditor <p>Reference to <code>this</code> in order to allow method chaining</p>
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="change" href="api/sap.ui.codeeditor.CodeEditor#events/change">change</a> event of this <code>sap.ui.codeeditor.CodeEditor</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="liveChange" href="api/sap.ui.codeeditor.CodeEditor#events/liveChange">liveChange</a> event of this <code>sap.ui.codeeditor.CodeEditor</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.codeeditor.CodeEditor <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="change" href="api/sap.ui.codeeditor.CodeEditor#events/change">change</a> to attached listeners.</p>
                ...
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="liveChange" href="api/sap.ui.codeeditor.CodeEditor#events/liveChange">liveChange</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.codeeditor.CodeEditor <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getEditable" href="api/sap.ui.codeeditor.CodeEditor#methods/getEditable">editable</a>.</p><p>Sets whether the code in the editor can be changed by the user</p><p>Default value is <code>true</code>.</p>
                ...
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getLineNumbers" href="api/sap.ui.codeeditor.CodeEditor#methods/getLineNumbers">lineNumbers</a>.</p><p>Sets whether line numbers should be shown</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>lineNumbers</code></p>
                 */
                getLineNumbers(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMaxLines" href="api/sap.ui.codeeditor.CodeEditor#methods/getMaxLines">maxLines</a>.</p><p>Sets whether the editor height should auto expand to a maximum number of lines. After reaching the maximum number of lines specified, the content of the <code>CodeEditor</code> will become scrollable.</p><p><b>Note:</b> Keep in mind that the auto expand <code>CodeEditor</code> behavior requires the <code>height</code> property to be set to <code>auto</code>.</p><p>Default value is <code>0</code>.</p>
                 * @returns number <p>Value of property <code>maxLines</code></p>
                 */
                getMaxLines(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSyntaxHints" href="api/sap.ui.codeeditor.CodeEditor#methods/getSyntaxHints">syntaxHints</a>.</p><p>Sets whether to show syntax hints the editor. This flag is only available if line numbers are shown.</p><p>Default value is <code>true</code>.</p>
                ...
                getType(): string;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getValue" href="api/sap.ui.codeeditor.CodeEditor#methods/getValue">value</a>.</p><p>The value displayed in the code editor</p><p>Default value is <code>empty string</code>.</p>
                 * @returns string <p>Value of property <code>value</code></p>
                 */
                getValue(): string;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getValueSelection" href="api/sap.ui.codeeditor.CodeEditor#methods/getValueSelection">valueSelection</a>.</p><p>Sets whether the code is automatically selected if a value is set</p><p>Default value is <code>false</code>.</p>
