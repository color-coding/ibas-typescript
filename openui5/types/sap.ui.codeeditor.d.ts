    ...
    namespace ui {
        ...
        namespace codeeditor {
            ...
            export class CodeEditor extends sap.ui.core.Control {
                ...
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-sap-ui-target="liveChange" href="#/api/sap.ui.codeeditor.CodeEditor/events/liveChange">liveChange</a> event of this <code>sap.ui.codeeditor.CodeEditor</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.codeeditor.CodeEditor</code> itself.</p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                 * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.codeeditor.CodeEditor</code> itself</p>
                 * @returns sap.ui.codeeditor.CodeEditor <p>Reference to <code>this</code> in order to allow method chaining</p>
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-sap-ui-target="liveChange" href="#/api/sap.ui.codeeditor.CodeEditor/events/liveChange">liveChange</a> event of this <code>sap.ui.codeeditor.CodeEditor</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.codeeditor.CodeEditor <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-sap-ui-target="change" href="#/api/sap.ui.codeeditor.CodeEditor/events/change">change</a> to attached listeners.</p>
                ...
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-sap-ui-target="liveChange" href="#/api/sap.ui.codeeditor.CodeEditor/events/liveChange">liveChange</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.codeeditor.CodeEditor <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getEditable" href="#/api/sap.ui.codeeditor.CodeEditor/methods/getEditable">editable</a>.</p><p>Sets whether the code in the editor can be changed by the user</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>editable</code></p>
                 */
                getEditable(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getHeight" href="#/api/sap.ui.codeeditor.CodeEditor/methods/getHeight">height</a>.</p><p>The height of the code editor. A minimal height of 3rem will be applied in case the height is less than 20px.</p><p>Default value is <code>100%</code>.</p>
                 * @returns sap.ui.core.CSSSize <p>Value of property <code>height</code></p>
                 */
                getHeight(): sap.ui.core.CSSSize;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getLineNumbers" href="#/api/sap.ui.codeeditor.CodeEditor/methods/getLineNumbers">lineNumbers</a>.</p><p>Sets whether line numbers should be shown</p><p>Default value is <code>true</code>.</p>
                ...
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getHeight" href="#/api/sap.ui.codeeditor.CodeEditor/methods/getHeight">height</a>.</p><p>The height of the code editor. A minimal height of 3rem will be applied in case the height is less than 20px.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>100%</code>.</p>
                ...
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-sap-ui-target="getWidth" href="#/api/sap.ui.codeeditor.CodeEditor/methods/getWidth">width</a>.</p><p>The width of the code editor</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>100%</code>.</p>
