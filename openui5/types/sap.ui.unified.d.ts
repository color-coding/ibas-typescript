    ...
    namespace ui {
        ...
        namespace unified {
            ...
            export class Calendar extends sap.ui.core.Control {
                ...
                /**
                 * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.Calendar#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                ...
                /**
                 * <p>Adds some disabledDate to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getDisabledDates" href="api/sap.ui.unified.Calendar#methods/getDisabledDates">disabledDates</a>.</p>
                ...
                /**
                 * <p>Adds some selectedDate to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.Calendar#methods/getSelectedDates">selectedDates</a>.</p>
                ...
                /**
                 * <p>Adds some specialDate to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.Calendar#methods/getSpecialDates">specialDates</a>.</p>
                ...
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.Calendar#events/select">select</a> event of this <code>sap.ui.unified.Calendar</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.Calendar</code> itself.</p><p>Date selection changed</p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                 * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.Calendar</code> itself</p>
                 * @returns sap.ui.unified.Calendar <p>Reference to <code>this</code> in order to allow method chaining</p>
                ...
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="startDateChange" href="api/sap.ui.unified.Calendar#events/startDateChange">startDateChange</a> event of this <code>sap.ui.unified.Calendar</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.Calendar</code> itself.</p><p><code>startDate</code> was changed while navigation in <code>Calendar</code></p><p>Use <code>getStartDate</code> function to determine the current start date</p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                 * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.Calendar</code> itself</p>
                 * @returns sap.ui.unified.Calendar <p>Reference to <code>this</code> in order to allow method chaining</p>
                ...
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="weekNumberSelect" href="api/sap.ui.unified.Calendar#events/weekNumberSelect">weekNumberSelect</a> event of this <code>sap.ui.unified.Calendar</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.Calendar</code> itself.</p><p>Week number selection changed. By default, clicking on the week number will select the corresponding week. If the week has already been selected, clicking the week number will deselect it.</p><p>The default behavior can be prevented using the <code>preventDefault</code> method.</p><p><b>Note</b> Works for Gregorian calendars only and when <code>intervalSelection</code> is set to 'true'.</p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                 * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.Calendar</code> itself</p>
                 * @returns sap.ui.unified.Calendar <p>Reference to <code>this</code> in order to allow method chaining</p>
                ...
                /**
                 * <p>Destroys all the disabledDates in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getDisabledDates" href="api/sap.ui.unified.Calendar#methods/getDisabledDates">disabledDates</a>.</p>
                 * @returns sap.ui.unified.Calendar <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyDisabledDates(): sap.ui.unified.Calendar;
                /**
                 * <p>Destroys all the selectedDates in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.Calendar#methods/getSelectedDates">selectedDates</a>.</p>
                 * @returns sap.ui.unified.Calendar <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroySelectedDates(): sap.ui.unified.Calendar;
                /**
                 * <p>Destroys all the specialDates in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.Calendar#methods/getSpecialDates">specialDates</a>.</p>
                 * @returns sap.ui.unified.Calendar <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroySpecialDates(): sap.ui.unified.Calendar;
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="cancel" href="api/sap.ui.unified.Calendar#events/cancel">cancel</a> event of this <code>sap.ui.unified.Calendar</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.Calendar#events/select">select</a> event of this <code>sap.ui.unified.Calendar</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.Calendar <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="startDateChange" href="api/sap.ui.unified.Calendar#events/startDateChange">startDateChange</a> event of this <code>sap.ui.unified.Calendar</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.Calendar <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="weekNumberSelect" href="api/sap.ui.unified.Calendar#events/weekNumberSelect">weekNumberSelect</a> event of this <code>sap.ui.unified.Calendar</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.Calendar <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="cancel" href="api/sap.ui.unified.Calendar#events/cancel">cancel</a> to attached listeners.</p>
                ...
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.Calendar#events/select">select</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.Calendar <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireSelect(mParameters?: any): sap.ui.unified.Calendar;
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="startDateChange" href="api/sap.ui.unified.Calendar#events/startDateChange">startDateChange</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.Calendar <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.Calendar#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] 
                 */
                getAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getDisabledDates" href="api/sap.ui.unified.Calendar#methods/getDisabledDates">disabledDates</a>.</p><p>Dates or date ranges for disabled dates.</p><p>To set a single date (instead of a range), set only the <code>startDate</code> property of the <a target="_self" class="jsdoclink" href="api/sap.ui.unified.DateRange">sap.ui.unified.DateRange</a> class.</p>
                 * @returns sap.ui.unified.DateRange[] 
                 */
                getDisabledDates(): sap.ui.unified.DateRange[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getFirstDayOfWeek" href="api/sap.ui.unified.Calendar#methods/getFirstDayOfWeek">firstDayOfWeek</a>.</p><p>If set, the first day of the displayed week is this day. Valid values are 0 to 6. If not a valid value is set, the default of the used locale is used.</p><p>Default value is <code>-1</code>.</p>
                 * @returns number <p>Value of property <code>firstDayOfWeek</code></p>
                 */
                getFirstDayOfWeek(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervalSelection" href="api/sap.ui.unified.Calendar#methods/getIntervalSelection">intervalSelection</a>.</p><p>If set, interval selection is allowed</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>intervalSelection</code></p>
                 */
                getIntervalSelection(): boolean;
                /**
                 * <p>ID of the element which is the current target of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getLegend" href="api/sap.ui.unified.Calendar#methods/getLegend">legend</a>, or <code>null</code>.</p>
                 * @returns sap.ui.core.ID 
                 */
                getLegend(): sap.ui.core.ID;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMaxDate" href="api/sap.ui.unified.Calendar#methods/getMaxDate">maxDate</a>.</p><p>Maximum date that can be shown and selected in the Calendar. This must be a JavaScript date object.</p><p><b>Note:</b> if the date is inside of a month the complete month is displayed, but dates outside the valid range can not be selected.</p><p><b>Note:</b> If the <code>maxDate</code> is set to be before the <code>minDate</code>, the <code>minDate</code> is set to the begin of the month of the <code>maxDate</code>.</p>
                 * @returns any <p>Value of property <code>maxDate</code></p>
                 */
                getMaxDate(): any;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMinDate" href="api/sap.ui.unified.Calendar#methods/getMinDate">minDate</a>.</p><p>Minimum date that can be shown and selected in the Calendar. This must be a JavaScript date object.</p><p><b>Note:</b> if the date is inside of a month the complete month is displayed, but dates outside the valid range can not be selected.</p><p><b>Note:</b> If the <code>minDate</code> is set to be after the <code>maxDate</code>, the <code>maxDate</code> is set to the end of the month of the <code>minDate</code>.</p>
                 * @returns any <p>Value of property <code>minDate</code></p>
                 */
                getMinDate(): any;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMonths" href="api/sap.ui.unified.Calendar#methods/getMonths">months</a>.</p><p>Determines the number of months displayed.</p><p>As of version 1.50, the duplicated dates are not displayed if there are multiple months.</p><p><b>Note:</b> On phones, only one month is displayed.</p><p>Default value is <code>1</code>.</p>
                 * @returns number <p>Value of property <code>months</code></p>
                 */
                getMonths(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getNonWorkingDays" href="api/sap.ui.unified.Calendar#methods/getNonWorkingDays">nonWorkingDays</a>.</p><p>If set, the provided weekdays are displayed as non-working days. Valid values inside the array are 0 to 6. If not set, the weekend defined in the locale settings is displayed as non-working days.</p><p><b>Note:</b> Keep in mind that this property sets only weekly-recurring days as non-working. If you need specific dates or dates ranges, such as national holidays, use the <code>specialDates</code> aggregation to set them. Both the non-working days (from property) and dates (from aggregation) are visualized the same.</p>
                 * @returns number[] <p>Value of property <code>nonWorkingDays</code></p>
                 */
                getNonWorkingDays(): number[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getPrimaryCalendarType" href="api/sap.ui.unified.Calendar#methods/getPrimaryCalendarType">primaryCalendarType</a>.</p><p>If set, the calendar type is used for display. If not set, the calendar type of the global configuration is used.</p>
                ...
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSecondaryCalendarType" href="api/sap.ui.unified.Calendar#methods/getSecondaryCalendarType">secondaryCalendarType</a>.</p><p>If set, the days are also displayed in this calendar type If not set, the dates are only displayed in the primary calendar type</p>
                ...
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.Calendar#methods/getSelectedDates">selectedDates</a>.</p><p>Dates or date ranges for selected dates.</p><p>To set a single date (instead of a range), set only the <code>startDate</code> property of the <a target="_self" class="jsdoclink" href="api/sap.ui.unified.DateRange">sap.ui.unified.DateRange</a> class.</p>
                 * @returns sap.ui.unified.DateRange[] 
                 */
                getSelectedDates(): sap.ui.unified.DateRange[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowWeekNumbers" href="api/sap.ui.unified.Calendar#methods/getShowWeekNumbers">showWeekNumbers</a>.</p><p>Determines whether the week numbers in the months are displayed.</p><p><b>Note:</b> For Islamic calendars, the week numbers are not displayed regardless of what is set to this property.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>showWeekNumbers</code></p>
                 */
                getShowWeekNumbers(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSingleSelection" href="api/sap.ui.unified.Calendar#methods/getSingleSelection">singleSelection</a>.</p><p>If set, only a single date or interval, if intervalSelection is enabled, can be selected</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>singleSelection</code></p>
                 */
                getSingleSelection(): boolean;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.Calendar#methods/getSpecialDates">specialDates</a>.</p><p>Dates or date ranges with type, to visualize special days in the <code>Calendar</code>. If one day is assigned to more than one Type, only the first one will be used.</p><p>To set a single date (instead of a range), set only the <code>startDate</code> property of the <a target="_self" class="jsdoclink" href="api/sap.ui.unified.DateRange">sap.ui.unified.DateRange</a> class.</p><p><b>Note:</b> Keep in mind that the <code>NonWorking</code> type is for marking specific dates or date ranges as non-working, where if you need a weekly-reccuring non-working days (weekend), you should use the <code>nonWorkingDays</code> property. Both the non-working days (from property) and dates (from aggregation) are visualized the same.</p>
                ...
                getStartDate(): any;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getWidth" href="api/sap.ui.unified.Calendar#methods/getWidth">width</a>.</p><p>Width of Calendar</p><p><b>Note:</b> There is a theme depending minimum width, so the calendar can not be set smaller.</p>
                 * @returns sap.ui.core.CSSSize <p>Value of property <code>width</code></p>
                 */
                getWidth(): sap.ui.core.CSSSize;
                /**
                 * <p>Checks for the provided <code>sap.ui.unified.DateRange</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getDisabledDates" href="api/sap.ui.unified.Calendar#methods/getDisabledDates">disabledDates</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Checks for the provided <code>sap.ui.unified.DateRange</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.Calendar#methods/getSelectedDates">selectedDates</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Checks for the provided <code>sap.ui.unified.DateTypeRange</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.Calendar#methods/getSpecialDates">specialDates</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Inserts a disabledDate into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getDisabledDates" href="api/sap.ui.unified.Calendar#methods/getDisabledDates">disabledDates</a>.</p>
                ...
                /**
                 * <p>Inserts a selectedDate into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.Calendar#methods/getSelectedDates">selectedDates</a>.</p>
                ...
                /**
                 * <p>Inserts a specialDate into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.Calendar#methods/getSpecialDates">specialDates</a>.</p>
                ...
                /**
                 * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.Calendar#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getDisabledDates" href="api/sap.ui.unified.Calendar#methods/getDisabledDates">disabledDates</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.Calendar#methods/getSelectedDates">selectedDates</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.unified.DateRange[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllSelectedDates(): sap.ui.unified.DateRange[];
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.Calendar#methods/getSpecialDates">specialDates</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                ...
                /**
                 * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.Calendar#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                ...
                /**
                 * <p>Removes a disabledDate from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getDisabledDates" href="api/sap.ui.unified.Calendar#methods/getDisabledDates">disabledDates</a>.</p>
                ...
                /**
                 * <p>Removes a selectedDate from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.Calendar#methods/getSelectedDates">selectedDates</a>.</p>
                ...
                /**
                 * <p>Removes a specialDate from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.Calendar#methods/getSpecialDates">specialDates</a>.</p>
                ...
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMonths" href="api/sap.ui.unified.Calendar#methods/getMonths">months</a>.</p><p>Determines the number of months displayed.</p><p>As of version 1.50, the duplicated dates are not displayed if there are multiple months.</p><p><b>Note:</b> On phones, only one month is displayed.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>1</code>.</p>
            ...
            export class CalendarAppointment extends sap.ui.unified.DateTypeRange {
                ...
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getKey" href="api/sap.ui.unified.CalendarAppointment#methods/getKey">key</a>.</p><p>Can be used as identifier of the appointment</p>
                 * @returns string <p>Value of property <code>key</code></p>
                 */
                getKey(): string;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelected" href="api/sap.ui.unified.CalendarAppointment#methods/getSelected">selected</a>.</p><p>Indicates if the icon is selected.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>selected</code></p>
                 */
                getSelected(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getTentative" href="api/sap.ui.unified.CalendarAppointment#methods/getTentative">tentative</a>.</p><p>Indicates if the icon is tentative.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>tentative</code></p>
                 */
                getTentative(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getText" href="api/sap.ui.unified.CalendarAppointment#methods/getText">text</a>.</p><p>Text of the appointment.</p>
                 * @returns string <p>Value of property <code>text</code></p>
                 */
                getText(): string;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getTitle" href="api/sap.ui.unified.CalendarAppointment#methods/getTitle">title</a>.</p><p>Title of the appointment.</p>
                ...
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getTitle" href="api/sap.ui.unified.CalendarAppointment#methods/getTitle">title</a>.</p><p>Title of the appointment.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
            ...
            export class CalendarDateInterval extends sap.ui.unified.Calendar {
                ...
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getDays" href="api/sap.ui.unified.CalendarDateInterval#methods/getDays">days</a>.</p><p>number of days displayed on phones the maximum rendered number of days is 8.</p><p>Default value is <code>7</code>.</p>
                 * @returns number <p>Value of property <code>days</code></p>
                 */
                getDays(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getPickerPopup" href="api/sap.ui.unified.CalendarDateInterval#methods/getPickerPopup">pickerPopup</a>.</p><p>If set, the month- and yearPicker opens on a popup</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>pickerPopup</code></p>
                 */
                getPickerPopup(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowDayNamesLine" href="api/sap.ui.unified.CalendarDateInterval#methods/getShowDayNamesLine">showDayNamesLine</a>.</p><p>If set the day names are shown in a separate line. If not set the day names are shown inside the single days.</p><p>Default value is <code>true</code>.</p>
                ...
                getStartDate(): any;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getStartDate" href="api/sap.ui.unified.CalendarDateInterval#methods/getStartDate">startDate</a>.</p><p>Start date of the Interval</p>
                 * @returns any <p>Value of property <code>startDate</code></p>
                 */
                getStartDate(): any;
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getDays" href="api/sap.ui.unified.CalendarDateInterval#methods/getDays">days</a>.</p><p>number of days displayed on phones the maximum rendered number of days is 8.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>7</code>.</p>
            ...
            export class CalendarLegend extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some item to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getItems" href="api/sap.ui.unified.CalendarLegend#methods/getItems">items</a>.</p>
                ...
                /**
                 * <p>Destroys all the items in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getItems" href="api/sap.ui.unified.CalendarLegend#methods/getItems">items</a>.</p>
                 * @returns sap.ui.unified.CalendarLegend <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getItems" href="api/sap.ui.unified.CalendarLegend#methods/getItems">items</a>.</p><p>Items to be displayed.</p>
                ...
                /**
                 * <p>Checks for the provided <code>sap.ui.unified.CalendarLegendItem</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getItems" href="api/sap.ui.unified.CalendarLegend#methods/getItems">items</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Inserts a item into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getItems" href="api/sap.ui.unified.CalendarLegend#methods/getItems">items</a>.</p>
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getItems" href="api/sap.ui.unified.CalendarLegend#methods/getItems">items</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                ...
                /**
                 * <p>Removes a item from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getItems" href="api/sap.ui.unified.CalendarLegend#methods/getItems">items</a>.</p>
            ...
            export class CalendarLegendItem extends sap.ui.core.Element {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getColor" href="api/sap.ui.unified.CalendarLegendItem#methods/getColor">color</a>.</p><p>Overrides the color derived from the <code>type</code> property.</p>
                 * @returns sap.ui.core.CSSColor <p>Value of property <code>color</code></p>
                 */
                getColor(): sap.ui.core.CSSColor;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getText" href="api/sap.ui.unified.CalendarLegendItem#methods/getText">text</a>.</p><p>Text to be displayed for the item.</p>
                 * @returns string <p>Value of property <code>text</code></p>
                 */
                getText(): string;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getType" href="api/sap.ui.unified.CalendarLegendItem#methods/getType">type</a>.</p><p>Type of the item. If not set the type is automatically determined from the order of the items in the CalendarLegend.</p><p>Default value is <code>None</code>.</p>
                 * @returns sap.ui.unified.CalendarDayType <p>Value of property <code>type</code></p>
                 */
                getType(): sap.ui.unified.CalendarDayType;
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getColor" href="api/sap.ui.unified.CalendarLegendItem#methods/getColor">color</a>.</p><p>Overrides the color derived from the <code>type</code> property.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                 * @param {sap.ui.core.CSSColor} sColor <p>New value for property <code>color</code></p>
            ...
            export class CalendarMonthInterval extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.CalendarMonthInterval#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to add; if empty, nothing is inserted</p>
                ...
                /**
                 * <p>Adds some selectedDate to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.CalendarMonthInterval#methods/getSelectedDates">selectedDates</a>.</p>
                 * @param {sap.ui.unified.DateRange} oSelectedDate <p>The selectedDate to add; if empty, nothing is inserted</p>
                 * @returns sap.ui.unified.CalendarMonthInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                addSelectedDate(oSelectedDate: sap.ui.unified.DateRange): sap.ui.unified.CalendarMonthInterval;
                /**
                 * <p>Adds some specialDate to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.CalendarMonthInterval#methods/getSpecialDates">specialDates</a>.</p>
                 * @param {sap.ui.unified.DateTypeRange} oSpecialDate <p>The specialDate to add; if empty, nothing is inserted</p>
                 * @returns sap.ui.unified.CalendarMonthInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                addSpecialDate(oSpecialDate: sap.ui.unified.DateTypeRange): sap.ui.unified.CalendarMonthInterval;
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="cancel" href="api/sap.ui.unified.CalendarMonthInterval#events/cancel">cancel</a> event of this <code>sap.ui.unified.CalendarMonthInterval</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.CalendarMonthInterval</code> itself.</p><p>Month selection was cancelled</p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                ...
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.CalendarMonthInterval#events/select">select</a> event of this <code>sap.ui.unified.CalendarMonthInterval</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.CalendarMonthInterval</code> itself.</p><p>Month selection changed</p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                 * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.CalendarMonthInterval</code> itself</p>
                 * @returns sap.ui.unified.CalendarMonthInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                ...
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="startDateChange" href="api/sap.ui.unified.CalendarMonthInterval#events/startDateChange">startDateChange</a> event of this <code>sap.ui.unified.CalendarMonthInterval</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.CalendarMonthInterval</code> itself.</p><p><code>startDate</code> was changed while navigation in <code>CalendarMonthInterval</code></p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                 * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.CalendarMonthInterval</code> itself</p>
                 * @returns sap.ui.unified.CalendarMonthInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                ...
                /**
                 * <p>Destroys all the selectedDates in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.CalendarMonthInterval#methods/getSelectedDates">selectedDates</a>.</p>
                 * @returns sap.ui.unified.CalendarMonthInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroySelectedDates(): sap.ui.unified.CalendarMonthInterval;
                /**
                 * <p>Destroys all the specialDates in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.CalendarMonthInterval#methods/getSpecialDates">specialDates</a>.</p>
                 * @returns sap.ui.unified.CalendarMonthInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroySpecialDates(): sap.ui.unified.CalendarMonthInterval;
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="cancel" href="api/sap.ui.unified.CalendarMonthInterval#events/cancel">cancel</a> event of this <code>sap.ui.unified.CalendarMonthInterval</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.CalendarMonthInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.CalendarMonthInterval#events/select">select</a> event of this <code>sap.ui.unified.CalendarMonthInterval</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.CalendarMonthInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="startDateChange" href="api/sap.ui.unified.CalendarMonthInterval#events/startDateChange">startDateChange</a> event of this <code>sap.ui.unified.CalendarMonthInterval</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.CalendarMonthInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="cancel" href="api/sap.ui.unified.CalendarMonthInterval#events/cancel">cancel</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.CalendarMonthInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireCancel(mParameters?: any): sap.ui.unified.CalendarMonthInterval;
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.CalendarMonthInterval#events/select">select</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.CalendarMonthInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireSelect(mParameters?: any): sap.ui.unified.CalendarMonthInterval;
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="startDateChange" href="api/sap.ui.unified.CalendarMonthInterval#events/startDateChange">startDateChange</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.CalendarMonthInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.CalendarMonthInterval#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] 
                 */
                getAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervalSelection" href="api/sap.ui.unified.CalendarMonthInterval#methods/getIntervalSelection">intervalSelection</a>.</p><p>If set, interval selection is allowed</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>intervalSelection</code></p>
                 */
                getIntervalSelection(): boolean;
                /**
                 * <p>ID of the element which is the current target of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getLegend" href="api/sap.ui.unified.CalendarMonthInterval#methods/getLegend">legend</a>, or <code>null</code>.</p>
                 * @returns sap.ui.core.ID 
                 */
                getLegend(): sap.ui.core.ID;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMaxDate" href="api/sap.ui.unified.CalendarMonthInterval#methods/getMaxDate">maxDate</a>.</p><p>Maximum date that can be shown and selected in the Calendar. This must be a JavaScript date object.</p><p><b>Note:</b> If the <code>maxDate</code> is set to be before the <code>minDate</code>, the <code>minDate</code> is set to the begin of the month of the <code>maxDate</code>.</p>
                 * @returns any <p>Value of property <code>maxDate</code></p>
                 */
                getMaxDate(): any;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMinDate" href="api/sap.ui.unified.CalendarMonthInterval#methods/getMinDate">minDate</a>.</p><p>Minimum date that can be shown and selected in the Calendar. This must be a JavaScript date object.</p><p><b>Note:</b> If the <code>minDate</code> is set to be after the <code>maxDate</code>, the <code>maxDate</code> is set to the end of the month of the <code>minDate</code>.</p>
                 * @returns any <p>Value of property <code>minDate</code></p>
                 */
                getMinDate(): any;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMonths" href="api/sap.ui.unified.CalendarMonthInterval#methods/getMonths">months</a>.</p><p>Number of months displayed</p><p><b>Note:</b> On phones, the maximum number of months displayed in the row is always 6.</p><p>Default value is <code>12</code>.</p>
                 * @returns number <p>Value of property <code>months</code></p>
                 */
                getMonths(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getPickerPopup" href="api/sap.ui.unified.CalendarMonthInterval#methods/getPickerPopup">pickerPopup</a>.</p><p>If set, the yearPicker opens on a popup</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>pickerPopup</code></p>
                 */
                getPickerPopup(): boolean;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.CalendarMonthInterval#methods/getSelectedDates">selectedDates</a>.</p><p>Date ranges for selected dates of the <code>CalendarMonthInterval</code>.</p><p>If <code>singleSelection</code> is set, only the first entry is used.</p><p><b>Note:</b> Even if only one day is selected, the whole corresponding month is selected.</p>
                 * @returns sap.ui.unified.DateRange[] 
                 */
                getSelectedDates(): sap.ui.unified.DateRange[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSingleSelection" href="api/sap.ui.unified.CalendarMonthInterval#methods/getSingleSelection">singleSelection</a>.</p><p>If set, only a single date or interval, if <code>intervalSelection</code> is enabled, can be selected</p><p><b>Note:</b> Selection of multiple intervals is not supported in the current version.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>singleSelection</code></p>
                 */
                getSingleSelection(): boolean;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.CalendarMonthInterval#methods/getSpecialDates">specialDates</a>.</p><p>Date ranges with type to visualize special months in the <code>CalendarMonthInterval</code>. If one day is assigned to more than one type, only the first one will be used.</p><p><b>Note:</b> Even if only one day is set as a special day, the whole corresponding month is displayed in this way.</p>
                 * @returns sap.ui.unified.DateTypeRange[] 
                 */
                getSpecialDates(): sap.ui.unified.DateTypeRange[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getStartDate" href="api/sap.ui.unified.CalendarMonthInterval#methods/getStartDate">startDate</a>.</p><p>Start date of the Interval as JavaScript Date object. The month of this Date will be the first month in the displayed row.</p>
                 * @returns any <p>Value of property <code>startDate</code></p>
                 */
                getStartDate(): any;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getWidth" href="api/sap.ui.unified.CalendarMonthInterval#methods/getWidth">width</a>.</p><p>Width of the <code>CalendarMonthInterval</code>. The width of the single months depends on this width.</p>
                 * @returns sap.ui.core.CSSSize <p>Value of property <code>width</code></p>
                 */
                getWidth(): sap.ui.core.CSSSize;
                /**
                 * <p>Checks for the provided <code>sap.ui.unified.DateRange</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.CalendarMonthInterval#methods/getSelectedDates">selectedDates</a>. and returns its index if found or -1 otherwise.</p>
                 * @param {sap.ui.unified.DateRange} oSelectedDate <p>The selectedDate whose index is looked for</p>
                 * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                 */
                indexOfSelectedDate(oSelectedDate: sap.ui.unified.DateRange): number;
                /**
                 * <p>Checks for the provided <code>sap.ui.unified.DateTypeRange</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.CalendarMonthInterval#methods/getSpecialDates">specialDates</a>. and returns its index if found or -1 otherwise.</p>
                 * @param {sap.ui.unified.DateTypeRange} oSpecialDate <p>The specialDate whose index is looked for</p>
                 * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                 */
                indexOfSpecialDate(oSpecialDate: sap.ui.unified.DateTypeRange): number;
                /**
                 * <p>Inserts a selectedDate into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.CalendarMonthInterval#methods/getSelectedDates">selectedDates</a>.</p>
                 * @param {sap.ui.unified.DateRange} oSelectedDate <p>The selectedDate to insert; if empty, nothing is inserted</p>
                 * @param {number} iIndex <p>The <code>0</code>-based index the selectedDate should be inserted at; for a negative value of <code>iIndex</code>, the selectedDate is inserted at position 0; for a value greater than the current size of the aggregation, the selectedDate is inserted at the last position</p>
                 * @returns sap.ui.unified.CalendarMonthInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Inserts a specialDate into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.CalendarMonthInterval#methods/getSpecialDates">specialDates</a>.</p>
                 * @param {sap.ui.unified.DateTypeRange} oSpecialDate <p>The specialDate to insert; if empty, nothing is inserted</p>
                 * @param {number} iIndex <p>The <code>0</code>-based index the specialDate should be inserted at; for a negative value of <code>iIndex</code>, the specialDate is inserted at position 0; for a value greater than the current size of the aggregation, the specialDate is inserted at the last position</p>
                 * @returns sap.ui.unified.CalendarMonthInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.CalendarMonthInterval#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.CalendarMonthInterval#methods/getSelectedDates">selectedDates</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.unified.DateRange[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllSelectedDates(): sap.ui.unified.DateRange[];
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.CalendarMonthInterval#methods/getSpecialDates">specialDates</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.unified.DateTypeRange[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllSpecialDates(): sap.ui.unified.DateTypeRange[];
                /**
                 * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.CalendarMonthInterval#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {number | sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to be removed or its index or ID</p>
                 * @returns sap.ui.core.ID <p>The removed ariaLabelledBy or <code>null</code></p>
                 */
                removeAriaLabelledBy(vAriaLabelledBy: number | sap.ui.core.ID | sap.ui.core.Control): sap.ui.core.ID;
                /**
                 * <p>Removes a selectedDate from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.CalendarMonthInterval#methods/getSelectedDates">selectedDates</a>.</p>
                 * @param {number | string | sap.ui.unified.DateRange} vSelectedDate <p>The selectedDate to remove or its index or id</p>
                 * @returns sap.ui.unified.DateRange <p>The removed selectedDate or <code>null</code></p>
                 */
                removeSelectedDate(vSelectedDate: number | string | sap.ui.unified.DateRange): sap.ui.unified.DateRange;
                /**
                 * <p>Removes a specialDate from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.CalendarMonthInterval#methods/getSpecialDates">specialDates</a>.</p>
                 * @param {number | string | sap.ui.unified.DateTypeRange} vSpecialDate <p>The specialDate to remove or its index or id</p>
                 * @returns sap.ui.unified.DateTypeRange <p>The removed specialDate or <code>null</code></p>
                 */
                removeSpecialDate(vSpecialDate: number | string | sap.ui.unified.DateTypeRange): sap.ui.unified.DateTypeRange;
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervalSelection" href="api/sap.ui.unified.CalendarMonthInterval#methods/getIntervalSelection">intervalSelection</a>.</p><p>If set, interval selection is allowed</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
                 * @param {boolean} bIntervalSelection <p>New value for property <code>intervalSelection</code></p>
                 * @returns sap.ui.unified.CalendarMonthInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMaxDate" href="api/sap.ui.unified.CalendarMonthInterval#methods/getMaxDate">maxDate</a>.</p><p>Maximum date that can be shown and selected in the Calendar. This must be a JavaScript date object.</p><p><b>Note:</b> If the <code>maxDate</code> is set to be before the <code>minDate</code>, the <code>minDate</code> is set to the begin of the month of the <code>maxDate</code>.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                ...
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getWidth" href="api/sap.ui.unified.CalendarMonthInterval#methods/getWidth">width</a>.</p><p>Width of the <code>CalendarMonthInterval</code>. The width of the single months depends on this width.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                 * @param {sap.ui.core.CSSSize} sWidth <p>New value for property <code>width</code></p>
                 * @returns sap.ui.unified.CalendarMonthInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
            ...
            export class CalendarRow extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some appointment to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getAppointments" href="api/sap.ui.unified.CalendarRow#methods/getAppointments">appointments</a>.</p>
                ...
                /**
                 * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.CalendarRow#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to add; if empty, nothing is inserted</p>
                 * @returns sap.ui.unified.CalendarRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                addAriaLabelledBy(vAriaLabelledBy: sap.ui.core.ID | sap.ui.core.Control): sap.ui.unified.CalendarRow;
                /**
                 * <p>Adds some intervalHeader to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervalHeaders" href="api/sap.ui.unified.CalendarRow#methods/getIntervalHeaders">intervalHeaders</a>.</p>
                ...
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="leaveRow" href="api/sap.ui.unified.CalendarRow#events/leaveRow">leaveRow</a> event of this <code>sap.ui.unified.CalendarRow</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.CalendarRow</code> itself.</p><p>The <code>CalendarRow</code> should be left while navigating. (Arrow up or arrow down.) The caller should determine the next control to be focused</p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                 * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.CalendarRow</code> itself</p>
                 * @returns sap.ui.unified.CalendarRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                ...
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.CalendarRow#events/select">select</a> event of this <code>sap.ui.unified.CalendarRow</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.CalendarRow</code> itself.</p><p>Fired if an appointment was selected</p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                 * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.CalendarRow</code> itself</p>
                 * @returns sap.ui.unified.CalendarRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                ...
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="startDateChange" href="api/sap.ui.unified.CalendarRow#events/startDateChange">startDateChange</a> event of this <code>sap.ui.unified.CalendarRow</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.CalendarRow</code> itself.</p><p><code>startDate</code> was changed while navigating in <code>CalendarRow</code></p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                 * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.CalendarRow</code> itself</p>
                 * @returns sap.ui.unified.CalendarRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                ...
                /**
                 * <p>Destroys all the appointments in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getAppointments" href="api/sap.ui.unified.CalendarRow#methods/getAppointments">appointments</a>.</p>
                 * @returns sap.ui.unified.CalendarRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyAppointments(): sap.ui.unified.CalendarRow;
                /**
                 * <p>Destroys all the intervalHeaders in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervalHeaders" href="api/sap.ui.unified.CalendarRow#methods/getIntervalHeaders">intervalHeaders</a>.</p>
                 * @returns sap.ui.unified.CalendarRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyIntervalHeaders(): sap.ui.unified.CalendarRow;
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="intervalSelect" href="api/sap.ui.unified.CalendarRow#events/intervalSelect">intervalSelect</a> event of this <code>sap.ui.unified.CalendarRow</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.CalendarRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="leaveRow" href="api/sap.ui.unified.CalendarRow#events/leaveRow">leaveRow</a> event of this <code>sap.ui.unified.CalendarRow</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.CalendarRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.CalendarRow#events/select">select</a> event of this <code>sap.ui.unified.CalendarRow</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.CalendarRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="startDateChange" href="api/sap.ui.unified.CalendarRow#events/startDateChange">startDateChange</a> event of this <code>sap.ui.unified.CalendarRow</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.CalendarRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="intervalSelect" href="api/sap.ui.unified.CalendarRow#events/intervalSelect">intervalSelect</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.CalendarRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireIntervalSelect(mParameters?: any): sap.ui.unified.CalendarRow;
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="leaveRow" href="api/sap.ui.unified.CalendarRow#events/leaveRow">leaveRow</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.CalendarRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireLeaveRow(mParameters?: any): sap.ui.unified.CalendarRow;
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.CalendarRow#events/select">select</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.CalendarRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireSelect(mParameters?: any): sap.ui.unified.CalendarRow;
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="startDateChange" href="api/sap.ui.unified.CalendarRow#events/startDateChange">startDateChange</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.CalendarRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeight" href="api/sap.ui.unified.CalendarRow#methods/getHeight">height</a>.</p><p>Height of the row</p>
                 * @returns sap.ui.core.CSSSize <p>Value of property <code>height</code></p>
                 */
                getHeight(): sap.ui.core.CSSSize;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervalHeaders" href="api/sap.ui.unified.CalendarRow#methods/getIntervalHeaders">intervalHeaders</a>.</p><p>Appointments to be displayed in the top of the intervals. The <code>intervalHeaders</code> are used to visualize public holidays and similar things.</p><p>Appointments outside the visible time frame are not rendered.</p><p>The <code>intervalHeaders</code> always fill whole intervals. If they are shorter than one interval, they are not displayed.</p><p><b>Note:</b> For performance reasons, only appointments in the visible time range or nearby should be assigned.</p>
                 * @returns sap.ui.unified.CalendarAppointment[] 
                 */
                getIntervalHeaders(): sap.ui.unified.CalendarAppointment[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervals" href="api/sap.ui.unified.CalendarRow#methods/getIntervals">intervals</a>.</p><p>Number of displayed intervals. The size of the intervals is defined with <code>intervalType</code></p><p>Default value is <code>12</code>.</p>
                 * @returns number <p>Value of property <code>intervals</code></p>
                 */
                getIntervals(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervalType" href="api/sap.ui.unified.CalendarRow#methods/getIntervalType">intervalType</a>.</p><p>Type of the intervals of the row. The default is one hour.</p><p>Default value is <code>Hour</code>.</p>
                ...
                /**
                 * <p>ID of the element which is the current target of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getLegend" href="api/sap.ui.unified.CalendarRow#methods/getLegend">legend</a>, or <code>null</code>.</p>
                 * @returns sap.ui.core.ID 
                 */
                getLegend(): sap.ui.core.ID;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getNonWorkingDays" href="api/sap.ui.unified.CalendarRow#methods/getNonWorkingDays">nonWorkingDays</a>.</p><p>If set, the provided weekdays are displayed as non-working days. Valid values inside the array are 0 to 6. (Other values will just be ignored.)</p><p>If not set, the weekend defined in the locale settings is displayed as non-working days.</p><p><b>Note:</b> The non working days are only visualized if <code>intervalType</code> is set to day.</p>
                 * @returns number[] <p>Value of property <code>nonWorkingDays</code></p>
                 */
                getNonWorkingDays(): number[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getNonWorkingHours" href="api/sap.ui.unified.CalendarRow#methods/getNonWorkingHours">nonWorkingHours</a>.</p><p>If set, the provided hours are displayed as non-working hours. Valid values inside the array are 0 to 23. (Other values will just be ignored.)</p><p><b>Note:</b> The non working hours are only visualized if <code>intervalType</code> is set to hour.</p>
                 * @returns number[] <p>Value of property <code>nonWorkingHours</code></p>
                 */
                getNonWorkingHours(): number[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowEmptyIntervalHeaders" href="api/sap.ui.unified.CalendarRow#methods/getShowEmptyIntervalHeaders">showEmptyIntervalHeaders</a>.</p><p>If set, interval headers are shown even if no <code>intervalHeaders</code> are assigned to the visible time frame.</p><p>If not set, no interval headers are shown if no <code>intervalHeaders</code> are assigned.</p><p><b>Note:</b> This property is only used if <code>showIntervalHeaders</code> is set to true.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>showEmptyIntervalHeaders</code></p>
                 */
                getShowEmptyIntervalHeaders(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowIntervalHeaders" href="api/sap.ui.unified.CalendarRow#methods/getShowIntervalHeaders">showIntervalHeaders</a>.</p><p>If set, interval headers are shown like specified in <code>showEmptyIntervalHeaders</code>.</p><p>If not set, no interval headers are shown even if <code>intervalHeaders</code> are assigned.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>showIntervalHeaders</code></p>
                 */
                getShowIntervalHeaders(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowSubIntervals" href="api/sap.ui.unified.CalendarRow#methods/getShowSubIntervals">showSubIntervals</a>.</p><p>If set, subintervals are shown.</p><p>If the interval type is <code>Hour</code>, quarter hours are shown.</p><p>If the interval type is <code>Day</code>, hours are shown.</p><p>If the interval type is <code>Month</code>, days are shown.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>showSubIntervals</code></p>
                 */
                getShowSubIntervals(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getStartDate" href="api/sap.ui.unified.CalendarRow#methods/getStartDate">startDate</a>.</p><p>Start date, as JavaScript Date object, of the row. As default, the current date is used.</p>
                 * @returns any <p>Value of property <code>startDate</code></p>
                 */
                getStartDate(): any;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getUpdateCurrentTime" href="api/sap.ui.unified.CalendarRow#methods/getUpdateCurrentTime">updateCurrentTime</a>.</p><p>If set the <code>CalendarRow</code> triggers a periodic update to visualize the current time.</p><p>If a lot of <code>CalendarRow</code> controls are used in one container control (like <code>PlanningCalendar</code>) the periodic update should be triggered only by this container control. Then the container control should call <code>updateCurrentTimeVisualization</code> of the <code>CalendarRow</code> to update the visualization.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>updateCurrentTime</code></p>
                 */
                getUpdateCurrentTime(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getWidth" href="api/sap.ui.unified.CalendarRow#methods/getWidth">width</a>.</p><p>Width of the row</p>
                 * @returns sap.ui.core.CSSSize <p>Value of property <code>width</code></p>
                 */
                getWidth(): sap.ui.core.CSSSize;
                /**
                ...
                /**
                 * <p>Checks for the provided <code>sap.ui.unified.CalendarAppointment</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getAppointments" href="api/sap.ui.unified.CalendarRow#methods/getAppointments">appointments</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Checks for the provided <code>sap.ui.unified.CalendarAppointment</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervalHeaders" href="api/sap.ui.unified.CalendarRow#methods/getIntervalHeaders">intervalHeaders</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Inserts a appointment into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getAppointments" href="api/sap.ui.unified.CalendarRow#methods/getAppointments">appointments</a>.</p>
                ...
                /**
                 * <p>Inserts a intervalHeader into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervalHeaders" href="api/sap.ui.unified.CalendarRow#methods/getIntervalHeaders">intervalHeaders</a>.</p>
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getAppointments" href="api/sap.ui.unified.CalendarRow#methods/getAppointments">appointments</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                ...
                /**
                 * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.CalendarRow#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervalHeaders" href="api/sap.ui.unified.CalendarRow#methods/getIntervalHeaders">intervalHeaders</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.unified.CalendarAppointment[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllIntervalHeaders(): sap.ui.unified.CalendarAppointment[];
                /**
                 * <p>Removes a appointment from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getAppointments" href="api/sap.ui.unified.CalendarRow#methods/getAppointments">appointments</a>.</p>
                ...
                /**
                 * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.CalendarRow#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {number | sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to be removed or its index or ID</p>
                 * @returns sap.ui.core.ID <p>The removed ariaLabelledBy or <code>null</code></p>
                 */
                removeAriaLabelledBy(vAriaLabelledBy: number | sap.ui.core.ID | sap.ui.core.Control): sap.ui.core.ID;
                /**
                 * <p>Removes a intervalHeader from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervalHeaders" href="api/sap.ui.unified.CalendarRow#methods/getIntervalHeaders">intervalHeaders</a>.</p>
                ...
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getNonWorkingDays" href="api/sap.ui.unified.CalendarRow#methods/getNonWorkingDays">nonWorkingDays</a>.</p><p>If set, the provided weekdays are displayed as non-working days. Valid values inside the array are 0 to 6. (Other values will just be ignored.)</p><p>If not set, the weekend defined in the locale settings is displayed as non-working days.</p><p><b>Note:</b> The non working days are only visualized if <code>intervalType</code> is set to day.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                 * @param {number[]} sNonWorkingDays <p>New value for property <code>nonWorkingDays</code></p>
                 * @returns sap.ui.unified.CalendarRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getUpdateCurrentTime" href="api/sap.ui.unified.CalendarRow#methods/getUpdateCurrentTime">updateCurrentTime</a>.</p><p>If set the <code>CalendarRow</code> triggers a periodic update to visualize the current time.</p><p>If a lot of <code>CalendarRow</code> controls are used in one container control (like <code>PlanningCalendar</code>) the periodic update should be triggered only by this container control. Then the container control should call <code>updateCurrentTimeVisualization</code> of the <code>CalendarRow</code> to update the visualization.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>true</code>.</p>
            ...
            export class CalendarTimeInterval extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.CalendarTimeInterval#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to add; if empty, nothing is inserted</p>
                ...
                /**
                 * <p>Adds some selectedDate to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.CalendarTimeInterval#methods/getSelectedDates">selectedDates</a>.</p>
                 * @param {sap.ui.unified.DateRange} oSelectedDate <p>The selectedDate to add; if empty, nothing is inserted</p>
                 * @returns sap.ui.unified.CalendarTimeInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                addSelectedDate(oSelectedDate: sap.ui.unified.DateRange): sap.ui.unified.CalendarTimeInterval;
                /**
                 * <p>Adds some specialDate to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.CalendarTimeInterval#methods/getSpecialDates">specialDates</a>.</p>
                 * @param {sap.ui.unified.DateTypeRange} oSpecialDate <p>The specialDate to add; if empty, nothing is inserted</p>
                 * @returns sap.ui.unified.CalendarTimeInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                addSpecialDate(oSpecialDate: sap.ui.unified.DateTypeRange): sap.ui.unified.CalendarTimeInterval;
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="cancel" href="api/sap.ui.unified.CalendarTimeInterval#events/cancel">cancel</a> event of this <code>sap.ui.unified.CalendarTimeInterval</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.CalendarTimeInterval</code> itself.</p><p>Time selection was cancelled</p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                ...
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.CalendarTimeInterval#events/select">select</a> event of this <code>sap.ui.unified.CalendarTimeInterval</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.CalendarTimeInterval</code> itself.</p><p>Time selection changed</p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                 * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.CalendarTimeInterval</code> itself</p>
                 * @returns sap.ui.unified.CalendarTimeInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                ...
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="startDateChange" href="api/sap.ui.unified.CalendarTimeInterval#events/startDateChange">startDateChange</a> event of this <code>sap.ui.unified.CalendarTimeInterval</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.CalendarTimeInterval</code> itself.</p><p><code>startDate</code> was changed while navigation in <code>CalendarTimeInterval</code></p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                 * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.CalendarTimeInterval</code> itself</p>
                 * @returns sap.ui.unified.CalendarTimeInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                ...
                /**
                 * <p>Destroys all the selectedDates in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.CalendarTimeInterval#methods/getSelectedDates">selectedDates</a>.</p>
                 * @returns sap.ui.unified.CalendarTimeInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroySelectedDates(): sap.ui.unified.CalendarTimeInterval;
                /**
                 * <p>Destroys all the specialDates in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.CalendarTimeInterval#methods/getSpecialDates">specialDates</a>.</p>
                 * @returns sap.ui.unified.CalendarTimeInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroySpecialDates(): sap.ui.unified.CalendarTimeInterval;
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="cancel" href="api/sap.ui.unified.CalendarTimeInterval#events/cancel">cancel</a> event of this <code>sap.ui.unified.CalendarTimeInterval</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.CalendarTimeInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.CalendarTimeInterval#events/select">select</a> event of this <code>sap.ui.unified.CalendarTimeInterval</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.CalendarTimeInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="startDateChange" href="api/sap.ui.unified.CalendarTimeInterval#events/startDateChange">startDateChange</a> event of this <code>sap.ui.unified.CalendarTimeInterval</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.CalendarTimeInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                displayDate(oDate: any): sap.ui.unified.Calendar;
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="cancel" href="api/sap.ui.unified.CalendarTimeInterval#events/cancel">cancel</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.CalendarTimeInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireCancel(mParameters?: any): sap.ui.unified.CalendarTimeInterval;
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.CalendarTimeInterval#events/select">select</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.CalendarTimeInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireSelect(mParameters?: any): sap.ui.unified.CalendarTimeInterval;
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="startDateChange" href="api/sap.ui.unified.CalendarTimeInterval#events/startDateChange">startDateChange</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.CalendarTimeInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                focusDate(oDate: any): sap.ui.unified.Calendar;
                /**
                 * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.CalendarTimeInterval#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] 
                 */
                getAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervalMinutes" href="api/sap.ui.unified.CalendarTimeInterval#methods/getIntervalMinutes">intervalMinutes</a>.</p><p>Size of on time interval in minutes, default is 60 minutes.</p><p><b>Note:</b> the start of the interval calculation is always on the corresponding date at 00:00.</p><p>An interval longer than 720 minutes is not allowed. Please use the <code>CalendarDateInterval</code> instead.</p><p>A day must be divisible by this interval size. One interval must not include more than one day.</p><p>Default value is <code>60</code>.</p>
                 * @returns number <p>Value of property <code>intervalMinutes</code></p>
                 */
                getIntervalMinutes(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervalSelection" href="api/sap.ui.unified.CalendarTimeInterval#methods/getIntervalSelection">intervalSelection</a>.</p><p>If set, interval selection is allowed</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>intervalSelection</code></p>
                 */
                getIntervalSelection(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getItems" href="api/sap.ui.unified.CalendarTimeInterval#methods/getItems">items</a>.</p><p>Number of time items displayed. Default is 12.</p><p><b>Note:</b> On phones, the maximum number of items displayed in the row is always 6.</p><p>Default value is <code>12</code>.</p>
                 * @returns number <p>Value of property <code>items</code></p>
                 */
                getItems(): number;
                /**
                 * <p>ID of the element which is the current target of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getLegend" href="api/sap.ui.unified.CalendarTimeInterval#methods/getLegend">legend</a>, or <code>null</code>.</p>
                 * @returns sap.ui.core.ID 
                 */
                getLegend(): sap.ui.core.ID;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMaxDate" href="api/sap.ui.unified.CalendarTimeInterval#methods/getMaxDate">maxDate</a>.</p><p>Maximum date that can be shown and selected in the Calendar. This must be a JavaScript date object.</p><p><b>Note:</b> If the <code>maxDate</code> is set to be before the <code>minDate</code>, the <code>minDate</code> is set to the begin of the month of the <code>maxDate</code>.</p>
                 * @returns any <p>Value of property <code>maxDate</code></p>
                 */
                getMaxDate(): any;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMinDate" href="api/sap.ui.unified.CalendarTimeInterval#methods/getMinDate">minDate</a>.</p><p>Minimum date that can be shown and selected in the Calendar. This must be a JavaScript date object.</p><p><b>Note:</b> If the <code>minDate</code> is set to be after the <code>maxDate</code>, the <code>maxDate</code> is set to the end of the month of the <code>minDate</code>.</p>
                 * @returns any <p>Value of property <code>minDate</code></p>
                 */
                getMinDate(): any;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getPickerPopup" href="api/sap.ui.unified.CalendarTimeInterval#methods/getPickerPopup">pickerPopup</a>.</p><p>If set, the day-, month- and yearPicker opens on a popup</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>pickerPopup</code></p>
                 */
                getPickerPopup(): boolean;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.CalendarTimeInterval#methods/getSelectedDates">selectedDates</a>.</p><p>Date ranges for selected items of the <code>CalendarTimeInterval</code>.</p><p>If <code>singleSelection</code> is set, only the first entry is used.</p>
                 * @returns sap.ui.unified.DateRange[] 
                 */
                getSelectedDates(): sap.ui.unified.DateRange[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSingleSelection" href="api/sap.ui.unified.CalendarTimeInterval#methods/getSingleSelection">singleSelection</a>.</p><p>If set, only a single date or interval, if <code>intervalSelection</code> is enabled, can be selected</p><p><b>Note:</b> Selection of multiple intervals is not supported in the current version.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>singleSelection</code></p>
                 */
                getSingleSelection(): boolean;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.CalendarTimeInterval#methods/getSpecialDates">specialDates</a>.</p><p>Date ranges with type to visualize special items in the <code>CalendarTimeInterval</code>. If one interval is assigned to more than one type, only the first one will be used.</p>
                 * @returns sap.ui.unified.DateTypeRange[] 
                 */
                getSpecialDates(): sap.ui.unified.DateTypeRange[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getStartDate" href="api/sap.ui.unified.CalendarTimeInterval#methods/getStartDate">startDate</a>.</p><p>Start date of the Interval as JavaScript Date object. The time interval corresponding to this Date and <code>items</code> and <code>intervalMinutes</code> will be the first time in the displayed row.</p>
                 * @returns any <p>Value of property <code>startDate</code></p>
                 */
                getStartDate(): any;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getWidth" href="api/sap.ui.unified.CalendarTimeInterval#methods/getWidth">width</a>.</p><p>Width of the <code>CalendarTimeInterval</code>. The width of the single months depends on this width.</p>
                 * @returns sap.ui.core.CSSSize <p>Value of property <code>width</code></p>
                 */
                getWidth(): sap.ui.core.CSSSize;
                /**
                 * <p>Checks for the provided <code>sap.ui.unified.DateRange</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.CalendarTimeInterval#methods/getSelectedDates">selectedDates</a>. and returns its index if found or -1 otherwise.</p>
                 * @param {sap.ui.unified.DateRange} oSelectedDate <p>The selectedDate whose index is looked for</p>
                 * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                 */
                indexOfSelectedDate(oSelectedDate: sap.ui.unified.DateRange): number;
                /**
                 * <p>Checks for the provided <code>sap.ui.unified.DateTypeRange</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.CalendarTimeInterval#methods/getSpecialDates">specialDates</a>. and returns its index if found or -1 otherwise.</p>
                 * @param {sap.ui.unified.DateTypeRange} oSpecialDate <p>The specialDate whose index is looked for</p>
                 * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                 */
                indexOfSpecialDate(oSpecialDate: sap.ui.unified.DateTypeRange): number;
                /**
                 * <p>Inserts a selectedDate into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.CalendarTimeInterval#methods/getSelectedDates">selectedDates</a>.</p>
                 * @param {sap.ui.unified.DateRange} oSelectedDate <p>The selectedDate to insert; if empty, nothing is inserted</p>
                 * @param {number} iIndex <p>The <code>0</code>-based index the selectedDate should be inserted at; for a negative value of <code>iIndex</code>, the selectedDate is inserted at position 0; for a value greater than the current size of the aggregation, the selectedDate is inserted at the last position</p>
                 * @returns sap.ui.unified.CalendarTimeInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Inserts a specialDate into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.CalendarTimeInterval#methods/getSpecialDates">specialDates</a>.</p>
                 * @param {sap.ui.unified.DateTypeRange} oSpecialDate <p>The specialDate to insert; if empty, nothing is inserted</p>
                 * @param {number} iIndex <p>The <code>0</code>-based index the specialDate should be inserted at; for a negative value of <code>iIndex</code>, the specialDate is inserted at position 0; for a value greater than the current size of the aggregation, the specialDate is inserted at the last position</p>
                 * @returns sap.ui.unified.CalendarTimeInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.CalendarTimeInterval#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.CalendarTimeInterval#methods/getSelectedDates">selectedDates</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.unified.DateRange[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllSelectedDates(): sap.ui.unified.DateRange[];
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.CalendarTimeInterval#methods/getSpecialDates">specialDates</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.unified.DateTypeRange[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllSpecialDates(): sap.ui.unified.DateTypeRange[];
                /**
                 * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.CalendarTimeInterval#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {number | sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to be removed or its index or ID</p>
                 * @returns sap.ui.core.ID <p>The removed ariaLabelledBy or <code>null</code></p>
                 */
                removeAriaLabelledBy(vAriaLabelledBy: number | sap.ui.core.ID | sap.ui.core.Control): sap.ui.core.ID;
                /**
                 * <p>Removes a selectedDate from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.CalendarTimeInterval#methods/getSelectedDates">selectedDates</a>.</p>
                 * @param {number | string | sap.ui.unified.DateRange} vSelectedDate <p>The selectedDate to remove or its index or id</p>
                 * @returns sap.ui.unified.DateRange <p>The removed selectedDate or <code>null</code></p>
                 */
                removeSelectedDate(vSelectedDate: number | string | sap.ui.unified.DateRange): sap.ui.unified.DateRange;
                /**
                 * <p>Removes a specialDate from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.CalendarTimeInterval#methods/getSpecialDates">specialDates</a>.</p>
                 * @param {number | string | sap.ui.unified.DateTypeRange} vSpecialDate <p>The specialDate to remove or its index or id</p>
                 * @returns sap.ui.unified.DateTypeRange <p>The removed specialDate or <code>null</code></p>
                 */
                removeSpecialDate(vSpecialDate: number | string | sap.ui.unified.DateTypeRange): sap.ui.unified.DateTypeRange;
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervalMinutes" href="api/sap.ui.unified.CalendarTimeInterval#methods/getIntervalMinutes">intervalMinutes</a>.</p><p>Size of on time interval in minutes, default is 60 minutes.</p><p><b>Note:</b> the start of the interval calculation is always on the corresponding date at 00:00.</p><p>An interval longer than 720 minutes is not allowed. Please use the <code>CalendarDateInterval</code> instead.</p><p>A day must be divisible by this interval size. One interval must not include more than one day.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>60</code>.</p>
                ...
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMaxDate" href="api/sap.ui.unified.CalendarTimeInterval#methods/getMaxDate">maxDate</a>.</p><p>Maximum date that can be shown and selected in the Calendar. This must be a JavaScript date object.</p><p><b>Note:</b> If the <code>maxDate</code> is set to be before the <code>minDate</code>, the <code>minDate</code> is set to the begin of the month of the <code>maxDate</code>.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                 * @param {any} oMaxDate <p>New value for property <code>maxDate</code></p>
                 * @returns sap.ui.unified.CalendarTimeInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getWidth" href="api/sap.ui.unified.CalendarTimeInterval#methods/getWidth">width</a>.</p><p>Width of the <code>CalendarTimeInterval</code>. The width of the single months depends on this width.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                 * @param {sap.ui.core.CSSSize} sWidth <p>New value for property <code>width</code></p>
                 * @returns sap.ui.unified.CalendarTimeInterval <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
            ...
            export class ColorPicker extends sap.ui.core.Control {
                ...
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="liveChange" href="api/sap.ui.unified.ColorPicker#events/liveChange">liveChange</a> event of this <code>sap.ui.unified.ColorPicker</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.ColorPicker</code> itself.</p><p>Fired when the value is changed during the mouse move.</p><p><b>Note:</b> When the user action is mouse move, the <code>liveChange</code> event is fired during the mousedown event.</p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                 * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.ColorPicker</code> itself</p>
                 * @returns sap.ui.unified.ColorPicker <p>Reference to <code>this</code> in order to allow method chaining</p>
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="change" href="api/sap.ui.unified.ColorPicker#events/change">change</a> event of this <code>sap.ui.unified.ColorPicker</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.ColorPicker <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="liveChange" href="api/sap.ui.unified.ColorPicker#events/liveChange">liveChange</a> event of this <code>sap.ui.unified.ColorPicker</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.ColorPicker <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="change" href="api/sap.ui.unified.ColorPicker#events/change">change</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.ColorPicker <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireChange(mParameters?: any): sap.ui.unified.ColorPicker;
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="liveChange" href="api/sap.ui.unified.ColorPicker#events/liveChange">liveChange</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.ColorPicker <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireLiveChange(mParameters?: any): sap.ui.unified.ColorPicker;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getColorString" href="api/sap.ui.unified.ColorPicker#methods/getColorString">colorString</a>.</p><p>Determines the input parameter that can be a string of type HEX, RGB, HSV, or a CSS color name: <ul> <li>HEX - #FFFFFF</li> <li>RGB - rgb(255,255,255)</li> <li>HSV - hsv(360,100,100)</li> <li>CSS - red</li> </ul> <b>Note:</b> The output parameter is an RGB string of the current color.</p>
                 * @returns string <p>Value of property <code>colorString</code></p>
                 */
                getColorString(): string;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getDisplayMode" href="api/sap.ui.unified.ColorPicker#methods/getDisplayMode">displayMode</a>.</p><p>Determines the display mode of the <code>ColorPicker</code> among three types - Default, Large and Simplified</p><p>Default value is <code>Default</code>.</p>
                ...
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMode" href="api/sap.ui.unified.ColorPicker#methods/getMode">mode</a>.</p><p>Determines the color representation mode the ColorPicker works with - Hue, Saturation, and Value (HSV) or Hue, Saturation, and Lightness (HSL).</p><p><b>Note:</b> The <code>ColorPickerMode.HSV</code> is set by default. For color composing with alpha values, please set the mode to <code>ColorPickerMode.HSL</code></p><p>Default value is <code>HSV</code>.</p>
                ...
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getColorString" href="api/sap.ui.unified.ColorPicker#methods/getColorString">colorString</a>.</p><p>Determines the input parameter that can be a string of type HEX, RGB, HSV, or a CSS color name: <ul> <li>HEX - #FFFFFF</li> <li>RGB - rgb(255,255,255)</li> <li>HSV - hsv(360,100,100)</li> <li>CSS - red</li> </ul> <b>Note:</b> The output parameter is an RGB string of the current color.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
            ...
            /**
             * <p>A thin wrapper over <a target="_self" class="jsdoclink" href="api/sap.ui.unified.ColorPicker">sap.ui.unified.ColorPicker</a> allowing the latter to be used in a popover.</p>
             */
            export class ColorPickerPopover extends sap.ui.core.Control {
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="change" href="api/sap.ui.unified.ColorPickerPopover#events/change">change</a> event of this <code>sap.ui.unified.ColorPickerPopover</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.ColorPickerPopover <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="change" href="api/sap.ui.unified.ColorPickerPopover#events/change">change</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.ColorPickerPopover <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireChange(mParameters?: any): sap.ui.unified.ColorPickerPopover;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getColorString" href="api/sap.ui.unified.ColorPickerPopover#methods/getColorString">colorString</a>.</p><p>Determines the input parameter that can be a string of type HEX, RGB, HSV, or a CSS color name: <ul> <li>HEX - #FFFFFF</li> <li>RGB - rgb(255,255,255)</li> <li>HSV - hsv(360,100,100)</li> <li>CSS - red</li> </ul> <b>Note:</b> The output parameter is an RGB string of the current color.</p>
                 * @returns string <p>Value of property <code>colorString</code></p>
                 */
                getColorString(): string;
                /**
                ...
                getDisplayMode(): sap.ui.unified.ColorPickerDisplayMode;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMode" href="api/sap.ui.unified.ColorPickerPopover#methods/getMode">mode</a>.</p><p>Determines the color mode of the <code>ColorPicker</code>.</p><p>Default value is <code>HSV</code>.</p>
                 * @returns sap.ui.unified.ColorPickerMode <p>Value of property <code>mode</code></p>
                 */
                getMode(): sap.ui.unified.ColorPickerMode;
                /**
                ...
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getColorString" href="api/sap.ui.unified.ColorPickerPopover#methods/getColorString">colorString</a>.</p><p>Determines the input parameter that can be a string of type HEX, RGB, HSV, or a CSS color name: <ul> <li>HEX - #FFFFFF</li> <li>RGB - rgb(255,255,255)</li> <li>HSV - hsv(360,100,100)</li> <li>CSS - red</li> </ul> <b>Note:</b> The output parameter is an RGB string of the current color.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                 * @param {string} sColorString <p>New value for property <code>colorString</code></p>
                 * @returns sap.ui.unified.ColorPickerPopover <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
            ...
            export class ContentSwitcher extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some content1 to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent1" href="api/sap.ui.unified.ContentSwitcher#methods/getContent1">content1</a>.</p>
                ...
                /**
                 * <p>Adds some content2 to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent2" href="api/sap.ui.unified.ContentSwitcher#methods/getContent2">content2</a>.</p>
                ...
                /**
                 * <p>Destroys all the content1 in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent1" href="api/sap.ui.unified.ContentSwitcher#methods/getContent1">content1</a>.</p>
                 * @returns sap.ui.unified.ContentSwitcher <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyContent1(): sap.ui.unified.ContentSwitcher;
                /**
                 * <p>Destroys all the content2 in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent2" href="api/sap.ui.unified.ContentSwitcher#methods/getContent2">content2</a>.</p>
                 * @returns sap.ui.unified.ContentSwitcher <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyContent2(): sap.ui.unified.ContentSwitcher;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getActiveContent" href="api/sap.ui.unified.ContentSwitcher#methods/getActiveContent">activeContent</a>.</p><p>The number of the currently active content (1 or 2).</p><p>Default value is <code>1</code>.</p>
                ...
                getAnimation(): string;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent1" href="api/sap.ui.unified.ContentSwitcher#methods/getContent1">content1</a>.</p><p>The controls that should be shown in the first content</p>
                 * @returns sap.ui.core.Control[] 
                 */
                getContent1(): sap.ui.core.Control[];
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent2" href="api/sap.ui.unified.ContentSwitcher#methods/getContent2">content2</a>.</p><p>The controls that should be shown in the second content</p>
                 * @returns sap.ui.core.Control[] 
                 */
                getContent2(): sap.ui.core.Control[];
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent1" href="api/sap.ui.unified.ContentSwitcher#methods/getContent1">content1</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent2" href="api/sap.ui.unified.ContentSwitcher#methods/getContent2">content2</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Inserts a content1 into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent1" href="api/sap.ui.unified.ContentSwitcher#methods/getContent1">content1</a>.</p>
                ...
                /**
                 * <p>Inserts a content2 into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent2" href="api/sap.ui.unified.ContentSwitcher#methods/getContent2">content2</a>.</p>
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent1" href="api/sap.ui.unified.ContentSwitcher#methods/getContent1">content1</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllContent1(): sap.ui.core.Control[];
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent2" href="api/sap.ui.unified.ContentSwitcher#methods/getContent2">content2</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllContent2(): sap.ui.core.Control[];
                /**
                 * <p>Removes a content1 from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent1" href="api/sap.ui.unified.ContentSwitcher#methods/getContent1">content1</a>.</p>
                ...
                /**
                 * <p>Removes a content2 from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent2" href="api/sap.ui.unified.ContentSwitcher#methods/getContent2">content2</a>.</p>
            ...
            export class Currency extends sap.ui.core.Control {
                ...
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getCurrency" href="api/sap.ui.unified.Currency#methods/getCurrency">currency</a>.</p><p>Determines the displayed currency code (ISO 4217).</p><p><b>Note:</b> If a * character is set instead of currency code, only the character itself will be rendered, ignoring the <code>value</code> property.</p>
                ...
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMaxPrecision" href="api/sap.ui.unified.Currency#methods/getMaxPrecision">maxPrecision</a>.</p><p>Defines the space that is available for the precision of the various currencies.</p><p>Default value is <code>3</code>.</p>
                 * @returns number <p>Value of property <code>maxPrecision</code></p>
                 */
                getMaxPrecision(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getStringValue" href="api/sap.ui.unified.Currency#methods/getStringValue">stringValue</a>.</p><p>Determines the currency value as a string.</p><p>String value is useful if you want to store really big values. If there are more than 21 digits before the decimal point or if the number starts with “0.” followed by more than five zeros, it is represented in exponential form. In these cases use the <code>stringValue</code> property to keep the number in decimal format.</p><p><b>Note:</b> If set, it will take precedence over the <code>value</code> property.</p>
                 * @returns string <p>Value of property <code>stringValue</code></p>
                 */
                getStringValue(): string;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getUseSymbol" href="api/sap.ui.unified.Currency#methods/getUseSymbol">useSymbol</a>.</p><p>Displays the currency symbol instead of the ISO currency code.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>useSymbol</code></p>
                 */
                getUseSymbol(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getValue" href="api/sap.ui.unified.Currency#methods/getValue">value</a>.</p><p>Determines the currency value.</p><p>Default value is <code>0</code>.</p>
            ...
            export class DateRange extends sap.ui.core.Element {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getEndDate" href="api/sap.ui.unified.DateRange#methods/getEndDate">endDate</a>.</p><p>End date for a date range. If empty only a single date is presented by this DateRange element. This must be a JavaScript date object.</p>
                 * @returns any <p>Value of property <code>endDate</code></p>
                 */
                getEndDate(): any;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getStartDate" href="api/sap.ui.unified.DateRange#methods/getStartDate">startDate</a>.</p><p>Start date for a date range. This must be a JavaScript date object.</p>
                 * @returns any <p>Value of property <code>startDate</code></p>
                 */
                getStartDate(): any;
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getEndDate" href="api/sap.ui.unified.DateRange#methods/getEndDate">endDate</a>.</p><p>End date for a date range. If empty only a single date is presented by this DateRange element. This must be a JavaScript date object.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
            ...
            export class FileUploader extends sap.ui.core.Control implements sap.ui.unified.IProcessableBlobs {
                ...
                /**
                 * <p>Adds some ariaDescribedBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaDescribedBy" href="api/sap.ui.unified.FileUploader#methods/getAriaDescribedBy">ariaDescribedBy</a>.</p>
                ...
                /**
                 * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.FileUploader#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to add; if empty, nothing is inserted</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                addAriaLabelledBy(vAriaLabelledBy: sap.ui.core.ID | sap.ui.core.Control): sap.ui.unified.FileUploader;
                /**
                 * <p>Adds some headerParameter to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeaderParameters" href="api/sap.ui.unified.FileUploader#methods/getHeaderParameters">headerParameters</a>.</p>
                ...
                /**
                 * <p>Adds some parameter to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getParameters" href="api/sap.ui.unified.FileUploader#methods/getParameters">parameters</a>.</p>
                ...
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="fileAllowed" href="api/sap.ui.unified.FileUploader#events/fileAllowed">fileAllowed</a> event of this <code>sap.ui.unified.FileUploader</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.FileUploader</code> itself.</p><p>Event is fired when the file is allowed for upload on client side.</p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                 * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.FileUploader</code> itself</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                ...
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="fileEmpty" href="api/sap.ui.unified.FileUploader#events/fileEmpty">fileEmpty</a> event of this <code>sap.ui.unified.FileUploader</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.FileUploader</code> itself.</p><p>Event is fired when the size of the file is 0</p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                 * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.FileUploader</code> itself</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                ...
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="fileSizeExceed" href="api/sap.ui.unified.FileUploader#events/fileSizeExceed">fileSizeExceed</a> event of this <code>sap.ui.unified.FileUploader</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.FileUploader</code> itself.</p><p>Event is fired when the size of a file is above the <code>maximumFileSize</code> property. This event is not supported by Internet Explorer 9 (same restriction as for the property <code>maximumFileSize</code>).</p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                 * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.FileUploader</code> itself</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                ...
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="typeMissmatch" href="api/sap.ui.unified.FileUploader#events/typeMissmatch">typeMissmatch</a> event of this <code>sap.ui.unified.FileUploader</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.FileUploader</code> itself.</p><p>Event is fired when the type of a file does not match the <code>mimeType</code> or <code>fileType</code> property.</p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                 * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.FileUploader</code> itself</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                ...
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="uploadAborted" href="api/sap.ui.unified.FileUploader#events/uploadAborted">uploadAborted</a> event of this <code>sap.ui.unified.FileUploader</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.FileUploader</code> itself.</p><p>Event is fired after the current upload has been aborted.</p><p>This event is only supported with property <code>sendXHR</code> set to true, i.e. the event is not supported in Internet Explorer 9.</p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                 * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.FileUploader</code> itself</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                ...
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="uploadComplete" href="api/sap.ui.unified.FileUploader#events/uploadComplete">uploadComplete</a> event of this <code>sap.ui.unified.FileUploader</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.FileUploader</code> itself.</p><p>Event is fired as soon as the upload request is completed (either successful or unsuccessful).</p><p>To see if the upload request was successful, check the <code>status</code> parameter for a value 2xx. The actual progress of the upload can be monitored by listening to the <code>uploadProgress</code> event. However, this covers only the client side of the upload process and does not give any success status from the server.</p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                 * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.FileUploader</code> itself</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                ...
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="uploadStart" href="api/sap.ui.unified.FileUploader#events/uploadStart">uploadStart</a> event of this <code>sap.ui.unified.FileUploader</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.FileUploader</code> itself.</p><p>Event is fired before an upload is started.</p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                 * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.FileUploader</code> itself</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                ...
                /**
                 * <p>Destroys all the headerParameters in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeaderParameters" href="api/sap.ui.unified.FileUploader#methods/getHeaderParameters">headerParameters</a>.</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyHeaderParameters(): sap.ui.unified.FileUploader;
                /**
                 * <p>Destroys all the parameters in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getParameters" href="api/sap.ui.unified.FileUploader#methods/getParameters">parameters</a>.</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyParameters(): sap.ui.unified.FileUploader;
                /**
                 * <p>Destroys the xhrSettings in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getXhrSettings" href="api/sap.ui.unified.FileUploader#methods/getXhrSettings">xhrSettings</a>.</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyXhrSettings(): sap.ui.unified.FileUploader;
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="change" href="api/sap.ui.unified.FileUploader#events/change">change</a> event of this <code>sap.ui.unified.FileUploader</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="fileAllowed" href="api/sap.ui.unified.FileUploader#events/fileAllowed">fileAllowed</a> event of this <code>sap.ui.unified.FileUploader</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="fileEmpty" href="api/sap.ui.unified.FileUploader#events/fileEmpty">fileEmpty</a> event of this <code>sap.ui.unified.FileUploader</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="fileSizeExceed" href="api/sap.ui.unified.FileUploader#events/fileSizeExceed">fileSizeExceed</a> event of this <code>sap.ui.unified.FileUploader</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="typeMissmatch" href="api/sap.ui.unified.FileUploader#events/typeMissmatch">typeMissmatch</a> event of this <code>sap.ui.unified.FileUploader</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="uploadAborted" href="api/sap.ui.unified.FileUploader#events/uploadAborted">uploadAborted</a> event of this <code>sap.ui.unified.FileUploader</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="uploadComplete" href="api/sap.ui.unified.FileUploader#events/uploadComplete">uploadComplete</a> event of this <code>sap.ui.unified.FileUploader</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="uploadStart" href="api/sap.ui.unified.FileUploader#events/uploadStart">uploadStart</a> event of this <code>sap.ui.unified.FileUploader</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="change" href="api/sap.ui.unified.FileUploader#events/change">change</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireChange(mParameters?: any): sap.ui.unified.FileUploader;
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="fileAllowed" href="api/sap.ui.unified.FileUploader#events/fileAllowed">fileAllowed</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireFileAllowed(mParameters?: any): sap.ui.unified.FileUploader;
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="fileEmpty" href="api/sap.ui.unified.FileUploader#events/fileEmpty">fileEmpty</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireFileEmpty(mParameters?: any): sap.ui.unified.FileUploader;
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="filenameLengthExceed" href="api/sap.ui.unified.FileUploader#events/filenameLengthExceed">filenameLengthExceed</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireFilenameLengthExceed(mParameters?: any): sap.ui.unified.FileUploader;
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="fileSizeExceed" href="api/sap.ui.unified.FileUploader#events/fileSizeExceed">fileSizeExceed</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireFileSizeExceed(mParameters?: any): sap.ui.unified.FileUploader;
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="typeMissmatch" href="api/sap.ui.unified.FileUploader#events/typeMissmatch">typeMissmatch</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireTypeMissmatch(mParameters?: any): sap.ui.unified.FileUploader;
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="uploadAborted" href="api/sap.ui.unified.FileUploader#events/uploadAborted">uploadAborted</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireUploadAborted(mParameters?: any): sap.ui.unified.FileUploader;
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="uploadComplete" href="api/sap.ui.unified.FileUploader#events/uploadComplete">uploadComplete</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireUploadComplete(mParameters?: any): sap.ui.unified.FileUploader;
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="uploadProgress" href="api/sap.ui.unified.FileUploader#events/uploadProgress">uploadProgress</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireUploadProgress(mParameters?: any): sap.ui.unified.FileUploader;
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="uploadStart" href="api/sap.ui.unified.FileUploader#events/uploadStart">uploadStart</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.FileUploader <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireUploadStart(mParameters?: any): sap.ui.unified.FileUploader;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getAdditionalData" href="api/sap.ui.unified.FileUploader#methods/getAdditionalData">additionalData</a>.</p><p>Additional data that is sent to the back end service.</p><p>Data will be transmitted as value of a hidden input where the name is derived from the <code>name</code> property with suffix "-data".</p>
                 * @returns string <p>Value of property <code>additionalData</code></p>
                 */
                getAdditionalData(): string;
                /**
                 * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaDescribedBy" href="api/sap.ui.unified.FileUploader#methods/getAriaDescribedBy">ariaDescribedBy</a>.</p>
                 * @returns sap.ui.core.ID[] 
                 */
                getAriaDescribedBy(): sap.ui.core.ID[];
                /**
                 * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.FileUploader#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] 
                 */
                getAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getButtonOnly" href="api/sap.ui.unified.FileUploader#methods/getButtonOnly">buttonOnly</a>.</p><p>If set to "true", the <code>FileUploader</code> will be rendered as Button only, without showing the input field.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>buttonOnly</code></p>
                 */
                getButtonOnly(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getButtonText" href="api/sap.ui.unified.FileUploader#methods/getButtonText">buttonText</a>.</p><p>The button's text can be overwritten using this property.</p>
                 * @returns string <p>Value of property <code>buttonText</code></p>
                 */
                getButtonText(): string;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getEnabled" href="api/sap.ui.unified.FileUploader#methods/getEnabled">enabled</a>.</p><p>Disabled controls have different colors, depending on customer settings.</p><p>Default value is <code>true</code>.</p>
                ...
                getFileType(): string[];
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeaderParameters" href="api/sap.ui.unified.FileUploader#methods/getHeaderParameters">headerParameters</a>.</p><p>The header parameters for the <code>FileUploader</code> which are only submitted with XHR requests. Header parameters are not supported by Internet Explorer 9.</p>
                ...
                getIcon(): sap.ui.core.URI;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIconFirst" href="api/sap.ui.unified.FileUploader#methods/getIconFirst">iconFirst</a>.</p><p>If set to true (default), the display sequence is 1. icon 2. control text.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>iconFirst</code></p>
                 */
                getIconFirst(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIconHovered" href="api/sap.ui.unified.FileUploader#methods/getIconHovered">iconHovered</a>.</p><p>Icon to be displayed as graphical element within the button when it is hovered (only if also a base icon was specified).</p><p>If not specified, the base icon is used. If an icon font icon is used, this property is ignored.</p><p>Default value is <code>empty string</code>.</p>
                 * @returns sap.ui.core.URI <p>Value of property <code>iconHovered</code></p>
                 */
                getIconHovered(): sap.ui.core.URI;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIconOnly" href="api/sap.ui.unified.FileUploader#methods/getIconOnly">iconOnly</a>.</p><p>If set to true, the button is displayed without any text.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>iconOnly</code></p>
                 */
                getIconOnly(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIconSelected" href="api/sap.ui.unified.FileUploader#methods/getIconSelected">iconSelected</a>.</p><p>Icon to be displayed as graphical element within the button when it is selected (only if also a base icon was specified).</p><p>If not specified, the base or hovered icon is used. If an icon font icon is used, this property is ignored.</p><p>Default value is <code>empty string</code>.</p>
                 * @returns sap.ui.core.URI <p>Value of property <code>iconSelected</code></p>
                 */
                getIconSelected(): sap.ui.core.URI;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMaximumFilenameLength" href="api/sap.ui.unified.FileUploader#methods/getMaximumFilenameLength">maximumFilenameLength</a>.</p><p>The maximum length of a filename which the <code>FileUploader</code> will accept.</p><p>If the maximum filename length is exceeded, the corresponding event <code>filenameLengthExceed</code> is fired.</p>
                 * @returns number <p>Value of property <code>maximumFilenameLength</code></p>
                 */
                getMaximumFilenameLength(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMaximumFileSize" href="api/sap.ui.unified.FileUploader#methods/getMaximumFileSize">maximumFileSize</a>.</p><p>A file size limit in megabytes which prevents the upload if at least one file exceeds it.</p><p>This property is not supported by Internet Explorer 9.</p>
                ...
                getMimeType(): string[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMultiple" href="api/sap.ui.unified.FileUploader#methods/getMultiple">multiple</a>.</p><p>Allows multiple files to be chosen and uploaded from the same folder.</p><p>This property is not supported by Internet Explorer 9.</p><p><b>Note:</b> Keep in mind that the various operating systems for mobile devices can react differently to the property so that fewer upload functions may be available in some cases.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>multiple</code></p>
                 */
                getMultiple(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getName" href="api/sap.ui.unified.FileUploader#methods/getName">name</a>.</p><p>Unique control name for identification on the server side after sending data to the server.</p>
                 * @returns string <p>Value of property <code>name</code></p>
                 */
                getName(): string;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getParameters" href="api/sap.ui.unified.FileUploader#methods/getParameters">parameters</a>.</p><p>The parameters for the <code>FileUploader</code> which are rendered as a hidden input field.</p>
                 * @returns sap.ui.unified.FileUploaderParameter[] 
                 */
                getParameters(): sap.ui.unified.FileUploaderParameter[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getPlaceholder" href="api/sap.ui.unified.FileUploader#methods/getPlaceholder">placeholder</a>.</p><p>Placeholder for the text field.</p>
                ...
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSameFilenameAllowed" href="api/sap.ui.unified.FileUploader#methods/getSameFilenameAllowed">sameFilenameAllowed</a>.</p><p>If the FileUploader is configured to upload the file directly after the file is selected, it is not allowed to upload a file with the same name again. If a user should be allowed to upload a file with the same name again this parameter has to be "true".</p><p>A typical use case would be if the files have different paths.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>sameFilenameAllowed</code></p>
                 */
                getSameFilenameAllowed(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSendXHR" href="api/sap.ui.unified.FileUploader#methods/getSendXHR">sendXHR</a>.</p><p>If set to "true", the request will be sent as XHR request instead of a form submit.</p><p>This property is not supported by Internet Explorer 9.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>sendXHR</code></p>
                 */
                getSendXHR(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getStyle" href="api/sap.ui.unified.FileUploader#methods/getStyle">style</a>.</p><p>Style of the button.</p><p>Values "Transparent, "Accept", "Reject", or "Emphasized" are allowed.</p>
                 * @returns string <p>Value of property <code>style</code></p>
                 */
                getStyle(): string;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getUploadOnChange" href="api/sap.ui.unified.FileUploader#methods/getUploadOnChange">uploadOnChange</a>.</p><p>If set to "true", the upload immediately starts after file selection. With the default setting, the upload needs to be explicitly triggered.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>uploadOnChange</code></p>
                 */
                getUploadOnChange(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getUploadUrl" href="api/sap.ui.unified.FileUploader#methods/getUploadUrl">uploadUrl</a>.</p><p>Used when URL address is on a remote server.</p><p>Default value is <code>empty string</code>.</p>
                 * @returns sap.ui.core.URI <p>Value of property <code>uploadUrl</code></p>
                 */
                getUploadUrl(): sap.ui.core.URI;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getUseMultipart" href="api/sap.ui.unified.FileUploader#methods/getUseMultipart">useMultipart</a>.</p><p>If set to "false", the request will be sent as file only request instead of a multipart/form-data request.</p><p>Only one file could be uploaded using this type of request. Required for sending such a request is to set the property <code>sendXHR</code> to "true". This property is not supported by Internet Explorer 9.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>useMultipart</code></p>
                 */
                getUseMultipart(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getValue" href="api/sap.ui.unified.FileUploader#methods/getValue">value</a>.</p><p>Value of the path for file upload.</p><p>Default value is <code>empty string</code>.</p>
                 * @returns string <p>Value of property <code>value</code></p>
                 */
                getValue(): string;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getValueState" href="api/sap.ui.unified.FileUploader#methods/getValueState">valueState</a>.</p><p>Visualizes warnings or errors related to the text field.</p><p>Possible values: Warning, Error, Success, None.</p><p>Default value is <code>None</code>.</p>
                 * @returns sap.ui.core.ValueState <p>Value of property <code>valueState</code></p>
                 */
                getValueState(): sap.ui.core.ValueState;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getValueStateText" href="api/sap.ui.unified.FileUploader#methods/getValueStateText">valueStateText</a>.</p><p>Custom text for the value state message pop-up.</p><p><b>Note:</b> If not specified, a default text, based on the value state type, will be used instead.</p>
                 * @returns string <p>Value of property <code>valueStateText</code></p>
                 */
                getValueStateText(): string;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getWidth" href="api/sap.ui.unified.FileUploader#methods/getWidth">width</a>.</p><p>Specifies the displayed control width.</p><p>Default value is <code>empty string</code>.</p>
                 * @returns sap.ui.core.CSSSize <p>Value of property <code>width</code></p>
                 */
                getWidth(): sap.ui.core.CSSSize;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getXhrSettings" href="api/sap.ui.unified.FileUploader#methods/getXhrSettings">xhrSettings</a>.</p><p>Settings for the <code>XMLHttpRequest</code> object. <b>Note:</b> This aggregation is only used when the <code>sendXHR</code> property is set to <code>true</code>.</p>
                 * @returns sap.ui.unified.FileUploaderXHRSettings 
                 */
                getXhrSettings(): sap.ui.unified.FileUploaderXHRSettings;
                /**
                 * <p>Checks for the provided <code>sap.ui.unified.FileUploaderParameter</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeaderParameters" href="api/sap.ui.unified.FileUploader#methods/getHeaderParameters">headerParameters</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Checks for the provided <code>sap.ui.unified.FileUploaderParameter</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getParameters" href="api/sap.ui.unified.FileUploader#methods/getParameters">parameters</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Inserts a headerParameter into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeaderParameters" href="api/sap.ui.unified.FileUploader#methods/getHeaderParameters">headerParameters</a>.</p>
                ...
                /**
                 * <p>Inserts a parameter into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getParameters" href="api/sap.ui.unified.FileUploader#methods/getParameters">parameters</a>.</p>
                ...
                /**
                 * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaDescribedBy" href="api/sap.ui.unified.FileUploader#methods/getAriaDescribedBy">ariaDescribedBy</a>.</p>
                 * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllAriaDescribedBy(): sap.ui.core.ID[];
                /**
                 * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.FileUploader#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeaderParameters" href="api/sap.ui.unified.FileUploader#methods/getHeaderParameters">headerParameters</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getParameters" href="api/sap.ui.unified.FileUploader#methods/getParameters">parameters</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.unified.FileUploaderParameter[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllParameters(): sap.ui.unified.FileUploaderParameter[];
                /**
                 * <p>Removes an ariaDescribedBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaDescribedBy" href="api/sap.ui.unified.FileUploader#methods/getAriaDescribedBy">ariaDescribedBy</a>.</p>
                ...
                /**
                 * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.FileUploader#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {number | sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to be removed or its index or ID</p>
                 * @returns sap.ui.core.ID <p>The removed ariaLabelledBy or <code>null</code></p>
                 */
                removeAriaLabelledBy(vAriaLabelledBy: number | sap.ui.core.ID | sap.ui.core.Control): sap.ui.core.ID;
                /**
                 * <p>Removes a headerParameter from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeaderParameters" href="api/sap.ui.unified.FileUploader#methods/getHeaderParameters">headerParameters</a>.</p>
                ...
                /**
                 * <p>Removes a parameter from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getParameters" href="api/sap.ui.unified.FileUploader#methods/getParameters">parameters</a>.</p>
            ...
            export class FileUploaderParameter extends sap.ui.core.Element {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getName" href="api/sap.ui.unified.FileUploaderParameter#methods/getName">name</a>.</p><p>The name of the hidden inputfield.</p>
                 * @returns string <p>Value of property <code>name</code></p>
                 */
                getName(): string;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getValue" href="api/sap.ui.unified.FileUploaderParameter#methods/getValue">value</a>.</p><p>The value of the hidden inputfield.</p>
                 * @returns string <p>Value of property <code>value</code></p>
                 */
                getValue(): string;
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getName" href="api/sap.ui.unified.FileUploaderParameter#methods/getName">name</a>.</p><p>The name of the hidden inputfield.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                 * @param {string} sName <p>New value for property <code>name</code></p>
            ...
            export class FileUploaderXHRSettings extends sap.ui.core.Element {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getWithCredentials" href="api/sap.ui.unified.FileUploaderXHRSettings#methods/getWithCredentials">withCredentials</a>.</p><p>Determines the value of the <code>XMLHttpRequest.withCredentials</code> property</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>withCredentials</code></p>
                 */
                getWithCredentials(): boolean;
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getWithCredentials" href="api/sap.ui.unified.FileUploaderXHRSettings#methods/getWithCredentials">withCredentials</a>.</p><p>Determines the value of the <code>XMLHttpRequest.withCredentials</code> property</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
            ...
            export class Menu extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.Menu#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to add; if empty, nothing is inserted</p>
                ...
                /**
                 * <p>Adds some item to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getItems" href="api/sap.ui.unified.Menu#methods/getItems">items</a>.</p>
                ...
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="itemSelect" href="api/sap.ui.unified.Menu#events/itemSelect">itemSelect</a> event of this <code>sap.ui.unified.Menu</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.Menu</code> itself.</p><p>Fired on the root menu of a menu hierarchy whenever a user selects an item within the menu or within one of its direct or indirect submenus. <b>Note:</b> There is also a select event available for each single menu item. This event and the event of the menu items are redundant.</p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                ...
                close(): void;
                /**
                 * <p>Destroys all the items in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getItems" href="api/sap.ui.unified.Menu#methods/getItems">items</a>.</p>
                 * @returns sap.ui.unified.Menu <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyItems(): sap.ui.unified.Menu;
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="itemSelect" href="api/sap.ui.unified.Menu#events/itemSelect">itemSelect</a> event of this <code>sap.ui.unified.Menu</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.Menu <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="itemSelect" href="api/sap.ui.unified.Menu#events/itemSelect">itemSelect</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.Menu <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireItemSelect(mParameters?: any): sap.ui.unified.Menu;
                /**
                 * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.Menu#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] 
                 */
                getAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getEnabled" href="api/sap.ui.unified.Menu#methods/getEnabled">enabled</a>.</p><p>When a menu is disabled none of its items can be selected by the user. The enabled property of an item (@link sap.ui.unified.MenuItemBase#getEnabled) has no effect when the menu of the item is disabled.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>enabled</code></p>
                 */
                getEnabled(): boolean;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getItems" href="api/sap.ui.unified.Menu#methods/getItems">items</a>.</p><p>The available actions to be displayed as items of the menu.</p>
                 * @returns sap.ui.unified.MenuItemBase[] 
                 */
                getItems(): sap.ui.unified.MenuItemBase[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMaxVisibleItems" href="api/sap.ui.unified.Menu#methods/getMaxVisibleItems">maxVisibleItems</a>.</p><p>The maximum number of items which are displayed before an overflow mechanism takes effect. A value smaller than 1 means an infinite number of visible items. The overall height of the menu is limited by the height of the screen. If the maximum possible height is reached, an overflow takes effect, even if the maximum number of visible items is not yet reached.</p><p>Default value is <code>0</code>.</p>
                 * @returns number <p>Value of property <code>maxVisibleItems</code></p>
                 */
                getMaxVisibleItems(): number;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getPageSize" href="api/sap.ui.unified.Menu#methods/getPageSize">pageSize</a>.</p><p>The keyboard can be used to navigate through the items of a menu. Beside the arrow keys for single steps and the <i>Home</i> / <i>End</i> keys for jumping to the first / last item, the <i>Page Up</i> / <i>Page Down</i> keys can be used to jump an arbitrary number of items up or down. This number can be defined via the <code>pageSize</code> property. For values smaller than 1, paging behaves in a similar way to when using the <i>Home</i> / <i>End</i> keys. If the value equals 1, the paging behavior is similar to that of the arrow keys.</p><p>Default value is <code>5</code>.</p>
                 * @returns number <p>Value of property <code>pageSize</code></p>
                 */
                getPageSize(): number;
                /**
                 * <p>Checks for the provided <code>sap.ui.unified.MenuItemBase</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getItems" href="api/sap.ui.unified.Menu#methods/getItems">items</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Inserts a item into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getItems" href="api/sap.ui.unified.Menu#methods/getItems">items</a>.</p>
                ...
                /**
                 * <p>Opens the menu at the specified position.</p><p>The position of the menu is defined relative to an element in the visible DOM by specifying the docking location of the menu and of the related element.</p><p>See <a target="_self" class="jsdoclink" href="api/sap.ui.core.Popup#methods/open">Popup#open</a> for further details about popup positioning.</p>
                ...
                /**
                 * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.Menu#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getItems" href="api/sap.ui.unified.Menu#methods/getItems">items</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                ...
                /**
                 * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.Menu#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {number | sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to be removed or its index or ID</p>
                 * @returns sap.ui.core.ID <p>The removed ariaLabelledBy or <code>null</code></p>
                 */
                removeAriaLabelledBy(vAriaLabelledBy: number | sap.ui.core.ID | sap.ui.core.Control): sap.ui.core.ID;
                /**
                 * <p>Removes a item from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getItems" href="api/sap.ui.unified.Menu#methods/getItems">items</a>.</p>
            ...
            export class MenuItem extends sap.ui.unified.MenuItemBase {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.MenuItem#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to add; if empty, nothing is inserted</p>
                ...
                /**
                 * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.MenuItem#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] 
                 */
                getAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIcon" href="api/sap.ui.unified.MenuItem#methods/getIcon">icon</a>.</p><p>Defines the icon of the <a target="_self" class="jsdoclink" href="api/sap.ui.core.IconPool">sap.ui.core.IconPool</a> or an image which should be displayed on the item.</p><p>Default value is <code>empty string</code>.</p>
                 * @returns sap.ui.core.URI <p>Value of property <code>icon</code></p>
                 */
                getIcon(): sap.ui.core.URI;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getText" href="api/sap.ui.unified.MenuItem#methods/getText">text</a>.</p><p>Defines the text which should be displayed on the item.</p><p>Default value is <code>empty string</code>.</p>
                 * @returns string <p>Value of property <code>text</code></p>
                 */
                getText(): string;
                /**
                 * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.MenuItem#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.MenuItem#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {number | sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to be removed or its index or ID</p>
                 * @returns sap.ui.core.ID <p>The removed ariaLabelledBy or <code>null</code></p>
                 */
                removeAriaLabelledBy(vAriaLabelledBy: number | sap.ui.core.ID | sap.ui.core.Control): sap.ui.core.ID;
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIcon" href="api/sap.ui.unified.MenuItem#methods/getIcon">icon</a>.</p><p>Defines the icon of the <a target="_self" class="jsdoclink" href="api/sap.ui.core.IconPool">sap.ui.core.IconPool</a> or an image which should be displayed on the item.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>empty string</code>.</p>
                 * @param {sap.ui.core.URI} sIcon <p>New value for property <code>icon</code></p>
                 * @returns sap.ui.unified.MenuItem <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
            ...
            export abstract class MenuItemBase extends sap.ui.core.Element {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.MenuItemBase#events/select">select</a> event of this <code>sap.ui.unified.MenuItemBase</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.MenuItemBase</code> itself.</p><p>Fired when the item is selected by the user. <b>Note:</b> The event is also available for items which have a submenu. In general, applications must not handle event in this case because the user selection opens the sub menu.</p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                ...
                /**
                 * <p>Destroys the submenu in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSubmenu" href="api/sap.ui.unified.MenuItemBase#methods/getSubmenu">submenu</a>.</p>
                 * @returns sap.ui.unified.MenuItemBase <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroySubmenu(): sap.ui.unified.MenuItemBase;
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.MenuItemBase#events/select">select</a> event of this <code>sap.ui.unified.MenuItemBase</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.MenuItemBase <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.MenuItemBase#events/select">select</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.MenuItemBase <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireSelect(mParameters?: any): sap.ui.unified.MenuItemBase;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getEnabled" href="api/sap.ui.unified.MenuItemBase#methods/getEnabled">enabled</a>.</p><p>When an item is disabled the item can not be selected by the user. The enabled property of the item has no effect when the menu of the item is disabled (<a target="_self" class="jsdoclink" href="api/sap.ui.unified.Menu#methods/getEnabled">Menu#getEnabled</a>).</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>enabled</code></p>
                 */
                getEnabled(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getStartsSection" href="api/sap.ui.unified.MenuItemBase#methods/getStartsSection">startsSection</a>.</p><p>Defines whether a visual separator should be rendered before the item. <b>Note:</b> If an item is invisible also the separator of this item is not shown.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>startsSection</code></p>
                 */
                getStartsSection(): boolean;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSubmenu" href="api/sap.ui.unified.MenuItemBase#methods/getSubmenu">submenu</a>.</p><p>An optional submenu of the item which is opened when the item is selected by the user.</p>
                 * @returns sap.ui.unified.Menu 
                 */
                getSubmenu(): sap.ui.unified.Menu;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getVisible" href="api/sap.ui.unified.MenuItemBase#methods/getVisible">visible</a>.</p><p>Invisible items do not appear in the menu.</p><p>Default value is <code>true</code>.</p>
                ...
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getEnabled" href="api/sap.ui.unified.MenuItemBase#methods/getEnabled">enabled</a>.</p><p>When an item is disabled the item can not be selected by the user. The enabled property of the item has no effect when the menu of the item is disabled (<a target="_self" class="jsdoclink" href="api/sap.ui.unified.Menu#methods/getEnabled">Menu#getEnabled</a>).</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>true</code>.</p>
                 * @param {boolean} bEnabled <p>New value for property <code>enabled</code></p>
                 * @returns sap.ui.unified.MenuItemBase <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
            ...
            export class MenuTextFieldItem extends sap.ui.unified.MenuItemBase {
                ...
                destroySubmenu(): sap.ui.unified.MenuItemBase;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIcon" href="api/sap.ui.unified.MenuTextFieldItem#methods/getIcon">icon</a>.</p><p>Defines the icon of the <a target="_self" class="jsdoclink" href="api/sap.ui.core.IconPool">sap.ui.core.IconPool</a> or an image which should be displayed on the item.</p>
                 * @returns sap.ui.core.URI <p>Value of property <code>icon</code></p>
                 */
                getIcon(): sap.ui.core.URI;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getLabel" href="api/sap.ui.unified.MenuTextFieldItem#methods/getLabel">label</a>.</p><p>Defines the label of the text field of the item.</p>
                ...
                getSubmenu(): sap.ui.unified.Menu;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getValue" href="api/sap.ui.unified.MenuTextFieldItem#methods/getValue">value</a>.</p><p>Defines the value of the text field of the item.</p>
                 * @returns string <p>Value of property <code>value</code></p>
                 */
                getValue(): string;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getValueState" href="api/sap.ui.unified.MenuTextFieldItem#methods/getValueState">valueState</a>.</p><p>Defines the value state of the text field of the item. This allows you to visualize e.g. warnings or errors.</p><p>Default value is <code>None</code>.</p>
                 * @returns sap.ui.core.ValueState <p>Value of property <code>valueState</code></p>
                 */
                getValueState(): sap.ui.core.ValueState;
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIcon" href="api/sap.ui.unified.MenuTextFieldItem#methods/getIcon">icon</a>.</p><p>Defines the icon of the <a target="_self" class="jsdoclink" href="api/sap.ui.core.IconPool">sap.ui.core.IconPool</a> or an image which should be displayed on the item.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                 * @param {sap.ui.core.URI} sIcon <p>New value for property <code>icon</code></p>
                ...
                setSubmenu(oSubmenu: sap.ui.unified.Menu): sap.ui.unified.MenuItemBase;
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getValue" href="api/sap.ui.unified.MenuTextFieldItem#methods/getValue">value</a>.</p><p>Defines the value of the text field of the item.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                 * @param {string} sValue <p>New value for property <code>value</code></p>
                 * @returns sap.ui.unified.MenuTextFieldItem <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
            ...
            export class Shell extends sap.ui.unified.ShellLayout {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some curtainContent to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getCurtainContent" href="api/sap.ui.unified.Shell#methods/getCurtainContent">curtainContent</a>.</p>
                ...
                /**
                 * <p>Adds some curtainPaneContent to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getCurtainPaneContent" href="api/sap.ui.unified.Shell#methods/getCurtainPaneContent">curtainPaneContent</a>.</p>
                ...
                /**
                 * <p>Adds some headEndItem to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeadEndItems" href="api/sap.ui.unified.Shell#methods/getHeadEndItems">headEndItems</a>.</p>
                ...
                /**
                 * <p>Adds some headItem to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeadItems" href="api/sap.ui.unified.Shell#methods/getHeadItems">headItems</a>.</p>
                ...
                /**
                 * <p>Destroys all the curtainContent in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getCurtainContent" href="api/sap.ui.unified.Shell#methods/getCurtainContent">curtainContent</a>.</p>
                 * @returns sap.ui.unified.Shell <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyCurtainContent(): sap.ui.unified.Shell;
                /**
                 * <p>Destroys all the curtainPaneContent in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getCurtainPaneContent" href="api/sap.ui.unified.Shell#methods/getCurtainPaneContent">curtainPaneContent</a>.</p>
                 * @returns sap.ui.unified.Shell <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyCurtainPaneContent(): sap.ui.unified.Shell;
                /**
                 * <p>Destroys all the headEndItems in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeadEndItems" href="api/sap.ui.unified.Shell#methods/getHeadEndItems">headEndItems</a>.</p>
                 * @returns sap.ui.unified.Shell <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyHeadEndItems(): sap.ui.unified.Shell;
                /**
                 * <p>Destroys the header in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeader" href="api/sap.ui.unified.ShellLayout#methods/getHeader">header</a>.</p>
                ...
                /**
                 * <p>Destroys all the headItems in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeadItems" href="api/sap.ui.unified.Shell#methods/getHeadItems">headItems</a>.</p>
                 * @returns sap.ui.unified.Shell <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyHeadItems(): sap.ui.unified.Shell;
                /**
                 * <p>Destroys the search in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSearch" href="api/sap.ui.unified.Shell#methods/getSearch">search</a>.</p>
                 * @returns sap.ui.unified.Shell <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroySearch(): sap.ui.unified.Shell;
                /**
                 * <p>Destroys the user in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getUser" href="api/sap.ui.unified.Shell#methods/getUser">user</a>.</p>
                 * @returns sap.ui.unified.Shell <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyUser(): sap.ui.unified.Shell;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getCurtainContent" href="api/sap.ui.unified.Shell#methods/getCurtainContent">curtainContent</a>.</p><p>The content to appear in the curtain area.</p>
                 * @returns sap.ui.core.Control[] 
                 */
                getCurtainContent(): sap.ui.core.Control[];
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getCurtainPaneContent" href="api/sap.ui.unified.Shell#methods/getCurtainPaneContent">curtainPaneContent</a>.</p><p>The content to appear in the pane area of the curtain.</p>
                 * @returns sap.ui.core.Control[] 
                 */
                getCurtainPaneContent(): sap.ui.core.Control[];
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeadEndItems" href="api/sap.ui.unified.Shell#methods/getHeadEndItems">headEndItems</a>.</p><p>The buttons shown in the end (right in left-to-right case) of the Shell header. Currently max. 3 visible buttons are supported (when user is set only 1). If a custom header is set this aggregation has no effect.</p>
                 * @returns sap.ui.unified.ShellHeadItem[] 
                 */
                getHeadEndItems(): sap.ui.unified.ShellHeadItem[];
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeadItems" href="api/sap.ui.unified.Shell#methods/getHeadItems">headItems</a>.</p><p>The buttons shown in the begin (left in left-to-right case) of the Shell header. Currently max. 3 visible buttons are supported. If a custom header is set this aggregation has no effect.</p>
                 * @returns sap.ui.unified.ShellHeadItem[] 
                 */
                getHeadItems(): sap.ui.unified.ShellHeadItem[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIcon" href="api/sap.ui.unified.Shell#methods/getIcon">icon</a>.</p><p>The application icon. If a custom header is set this property has no effect.</p>
                 * @returns sap.ui.core.URI <p>Value of property <code>icon</code></p>
                 */
                getIcon(): sap.ui.core.URI;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSearch" href="api/sap.ui.unified.Shell#methods/getSearch">search</a>.</p><p>Experimental (This aggregation might change in future!): The search control which should be displayed in the shell header. If a custom header is set this aggregation has no effect.</p>
                 * @returns sap.ui.core.Control 
                 */
                getSearch(): sap.ui.core.Control;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSearchVisible" href="api/sap.ui.unified.Shell#methods/getSearchVisible">searchVisible</a>.</p><p>If set to false, the search area (aggregation 'search') is hidden. If a custom header is set this property has no effect.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>searchVisible</code></p>
                 */
                getSearchVisible(): boolean;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getUser" href="api/sap.ui.unified.Shell#methods/getUser">user</a>.</p><p>The user item which is rendered in the shell header beside the items. If a custom header is set this aggregation has no effect.</p>
                 * @returns sap.ui.unified.ShellHeadUserItem 
                 */
                getUser(): sap.ui.unified.ShellHeadUserItem;
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getCurtainContent" href="api/sap.ui.unified.Shell#methods/getCurtainContent">curtainContent</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getCurtainPaneContent" href="api/sap.ui.unified.Shell#methods/getCurtainPaneContent">curtainPaneContent</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Checks for the provided <code>sap.ui.unified.ShellHeadItem</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeadEndItems" href="api/sap.ui.unified.Shell#methods/getHeadEndItems">headEndItems</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Checks for the provided <code>sap.ui.unified.ShellHeadItem</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeadItems" href="api/sap.ui.unified.Shell#methods/getHeadItems">headItems</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Inserts a curtainContent into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getCurtainContent" href="api/sap.ui.unified.Shell#methods/getCurtainContent">curtainContent</a>.</p>
                ...
                /**
                 * <p>Inserts a curtainPaneContent into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getCurtainPaneContent" href="api/sap.ui.unified.Shell#methods/getCurtainPaneContent">curtainPaneContent</a>.</p>
                ...
                /**
                 * <p>Inserts a headEndItem into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeadEndItems" href="api/sap.ui.unified.Shell#methods/getHeadEndItems">headEndItems</a>.</p>
                ...
                /**
                 * <p>Inserts a headItem into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeadItems" href="api/sap.ui.unified.Shell#methods/getHeadItems">headItems</a>.</p>
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getCurtainContent" href="api/sap.ui.unified.Shell#methods/getCurtainContent">curtainContent</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllCurtainContent(): sap.ui.core.Control[];
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getCurtainPaneContent" href="api/sap.ui.unified.Shell#methods/getCurtainPaneContent">curtainPaneContent</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllCurtainPaneContent(): sap.ui.core.Control[];
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeadEndItems" href="api/sap.ui.unified.Shell#methods/getHeadEndItems">headEndItems</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeadItems" href="api/sap.ui.unified.Shell#methods/getHeadItems">headItems</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.unified.ShellHeadItem[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllHeadItems(): sap.ui.unified.ShellHeadItem[];
                /**
                 * <p>Removes a curtainContent from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getCurtainContent" href="api/sap.ui.unified.Shell#methods/getCurtainContent">curtainContent</a>.</p>
                ...
                /**
                 * <p>Removes a curtainPaneContent from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getCurtainPaneContent" href="api/sap.ui.unified.Shell#methods/getCurtainPaneContent">curtainPaneContent</a>.</p>
                ...
                /**
                 * <p>Removes a headEndItem from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeadEndItems" href="api/sap.ui.unified.Shell#methods/getHeadEndItems">headEndItems</a>.</p>
                ...
                /**
                 * <p>Removes a headItem from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeadItems" href="api/sap.ui.unified.Shell#methods/getHeadItems">headItems</a>.</p>
                ...
                /**
                 * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeader" href="api/sap.ui.unified.ShellLayout#methods/getHeader">header</a>.</p>
                ...
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIcon" href="api/sap.ui.unified.Shell#methods/getIcon">icon</a>.</p><p>The application icon. If a custom header is set this property has no effect.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                 * @param {sap.ui.core.URI} sIcon <p>New value for property <code>icon</code></p>
                 * @returns sap.ui.unified.Shell <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSearchVisible" href="api/sap.ui.unified.Shell#methods/getSearchVisible">searchVisible</a>.</p><p>If set to false, the search area (aggregation 'search') is hidden. If a custom header is set this property has no effect.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>true</code>.</p>
            ...
            export class ShellHeadItem extends sap.ui.core.Element {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.ShellHeadItem#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to add; if empty, nothing is inserted</p>
                ...
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="press" href="api/sap.ui.unified.ShellHeadItem#events/press">press</a> event of this <code>sap.ui.unified.ShellHeadItem</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.ShellHeadItem</code> itself.</p><p>Event is fired when the user presses the item.</p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="press" href="api/sap.ui.unified.ShellHeadItem#events/press">press</a> event of this <code>sap.ui.unified.ShellHeadItem</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.ShellHeadItem <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="press" href="api/sap.ui.unified.ShellHeadItem#events/press">press</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.ShellHeadItem <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected firePress(mParameters?: any): sap.ui.unified.ShellHeadItem;
                /**
                 * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.ShellHeadItem#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] 
                 */
                getAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIcon" href="api/sap.ui.unified.ShellHeadItem#methods/getIcon">icon</a>.</p><p>The icon of the item, either defined in the sap.ui.core.IconPool or a URI to a custom image. An icon must be set.</p>
                 * @returns sap.ui.core.URI <p>Value of property <code>icon</code></p>
                 */
                getIcon(): sap.ui.core.URI;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelected" href="api/sap.ui.unified.ShellHeadItem#methods/getSelected">selected</a>.</p><p>Defines the toggle state in case the item represents a toggle button (see also property <code>toggleEnabled</code>).</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>selected</code></p>
                 */
                getSelected(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowSeparator" href="api/sap.ui.unified.ShellHeadItem#methods/getShowSeparator">showSeparator</a>.</p><p>If set to true, a separator is displayed after the item.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>showSeparator</code></p>
                 */
                getShowSeparator(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getToggleEnabled" href="api/sap.ui.unified.ShellHeadItem#methods/getToggleEnabled">toggleEnabled</a>.</p><p>If set to true, the item represents a toggle button. The <code>selected</code> property can the be used to define the toggle state. Otherwise the item is displayed as action button. In this case the <code>selected</code> property is ignored.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>toggleEnabled</code></p>
                 */
                getToggleEnabled(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getVisible" href="api/sap.ui.unified.ShellHeadItem#methods/getVisible">visible</a>.</p><p>Invisible items are not shown on the UI.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>visible</code></p>
                 */
                getVisible(): boolean;
                /**
                 * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.ShellHeadItem#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.ShellHeadItem#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {number | sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to be removed or its index or ID</p>
                 * @returns sap.ui.core.ID <p>The removed ariaLabelledBy or <code>null</code></p>
                 */
                removeAriaLabelledBy(vAriaLabelledBy: number | sap.ui.core.ID | sap.ui.core.Control): sap.ui.core.ID;
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIcon" href="api/sap.ui.unified.ShellHeadItem#methods/getIcon">icon</a>.</p><p>The icon of the item, either defined in the sap.ui.core.IconPool or a URI to a custom image. An icon must be set.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                 * @param {sap.ui.core.URI} sIcon <p>New value for property <code>icon</code></p>
                 * @returns sap.ui.unified.ShellHeadItem <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
            ...
            export class ShellHeadUserItem extends sap.ui.core.Element {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.ShellHeadUserItem#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to add; if empty, nothing is inserted</p>
                ...
                /**
                 * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="press" href="api/sap.ui.unified.ShellHeadUserItem#events/press">press</a> event of this <code>sap.ui.unified.ShellHeadUserItem</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.ShellHeadUserItem</code> itself.</p><p>Event is fired when the user presses the button.</p>
                 * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                 * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                ...
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="press" href="api/sap.ui.unified.ShellHeadUserItem#events/press">press</a> event of this <code>sap.ui.unified.ShellHeadUserItem</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.ShellHeadUserItem <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="press" href="api/sap.ui.unified.ShellHeadUserItem#events/press">press</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.ShellHeadUserItem <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected firePress(mParameters?: any): sap.ui.unified.ShellHeadUserItem;
                /**
                 * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.ShellHeadUserItem#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] 
                 */
                getAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getImage" href="api/sap.ui.unified.ShellHeadUserItem#methods/getImage">image</a>.</p><p>An image of the user, normally a URI to an image but also an icon from the sap.ui.core.IconPool is possible.</p>
                 * @returns sap.ui.core.URI <p>Value of property <code>image</code></p>
                 */
                getImage(): sap.ui.core.URI;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowPopupIndicator" href="api/sap.ui.unified.ShellHeadUserItem#methods/getShowPopupIndicator">showPopupIndicator</a>.</p><p>The user item is intended to be used for user settings. Normally these settings are done via a Menu or Dialog. If this property is set to true an indicator for such a popup mechanismn is shown in the item.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>showPopupIndicator</code></p>
                 */
                getShowPopupIndicator(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getUsername" href="api/sap.ui.unified.ShellHeadUserItem#methods/getUsername">username</a>.</p><p>The name of the user.</p><p>Default value is <code>empty string</code>.</p>
                 * @returns string <p>Value of property <code>username</code></p>
                 */
                getUsername(): string;
                /**
                 * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.ShellHeadUserItem#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.ShellHeadUserItem#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {number | sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to be removed or its index or ID</p>
                 * @returns sap.ui.core.ID <p>The removed ariaLabelledBy or <code>null</code></p>
                 */
                removeAriaLabelledBy(vAriaLabelledBy: number | sap.ui.core.ID | sap.ui.core.Control): sap.ui.core.ID;
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getImage" href="api/sap.ui.unified.ShellHeadUserItem#methods/getImage">image</a>.</p><p>An image of the user, normally a URI to an image but also an icon from the sap.ui.core.IconPool is possible.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
            ...
            export class ShellLayout extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some content to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.unified.ShellLayout#methods/getContent">content</a>.</p>
                ...
                /**
                 * <p>Adds some paneContent to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getPaneContent" href="api/sap.ui.unified.ShellLayout#methods/getPaneContent">paneContent</a>.</p>
                ...
                /**
                 * <p>Destroys all the content in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.unified.ShellLayout#methods/getContent">content</a>.</p>
                 * @returns sap.ui.unified.ShellLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                destroyHeader(): sap.ui.unified.ShellLayout;
                /**
                 * <p>Destroys all the paneContent in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getPaneContent" href="api/sap.ui.unified.ShellLayout#methods/getPaneContent">paneContent</a>.</p>
                 * @returns sap.ui.unified.ShellLayout <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyPaneContent(): sap.ui.unified.ShellLayout;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.unified.ShellLayout#methods/getContent">content</a>.</p><p>The content to appear in the main canvas.</p>
                 * @returns sap.ui.core.Control[] 
                 */
                getContent(): sap.ui.core.Control[];
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeader" href="api/sap.ui.unified.ShellLayout#methods/getHeader">header</a>.</p><p>The control to appear in the header area.</p>
                 * @returns sap.ui.core.Control 
                 */
                getHeader(): sap.ui.core.Control;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeaderHiding" href="api/sap.ui.unified.ShellLayout#methods/getHeaderHiding">headerHiding</a>.</p><p>Whether the header can be hidden (manually or automatically). This feature is only available when touch events are supported.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>headerHiding</code></p>
                 */
                getHeaderHiding(): boolean;
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeaderVisible" href="api/sap.ui.unified.ShellLayout#methods/getHeaderVisible">headerVisible</a>.</p><p>If set to false, no header (and no items, search, ...) is shown.</p><p>Default value is <code>true</code>.</p>
                 * @returns boolean <p>Value of property <code>headerVisible</code></p>
                 */
                getHeaderVisible(): boolean;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getPaneContent" href="api/sap.ui.unified.ShellLayout#methods/getPaneContent">paneContent</a>.</p><p>The content to appear in the pane area.</p>
                 * @returns sap.ui.core.Control[] 
                 */
                getPaneContent(): sap.ui.core.Control[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowPane" href="api/sap.ui.unified.ShellLayout#methods/getShowPane">showPane</a>.</p><p>Shows / Hides the side pane.</p><p>Default value is <code>false</code>.</p>
                 * @returns boolean <p>Value of property <code>showPane</code></p>
                 */
                getShowPane(): boolean;
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.unified.ShellLayout#methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getPaneContent" href="api/sap.ui.unified.ShellLayout#methods/getPaneContent">paneContent</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Inserts a content into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.unified.ShellLayout#methods/getContent">content</a>.</p>
                ...
                /**
                 * <p>Inserts a paneContent into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getPaneContent" href="api/sap.ui.unified.ShellLayout#methods/getPaneContent">paneContent</a>.</p>
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.unified.ShellLayout#methods/getContent">content</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllContent(): sap.ui.core.Control[];
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getPaneContent" href="api/sap.ui.unified.ShellLayout#methods/getPaneContent">paneContent</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllPaneContent(): sap.ui.core.Control[];
                /**
                 * <p>Removes a content from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.unified.ShellLayout#methods/getContent">content</a>.</p>
                ...
                /**
                 * <p>Removes a paneContent from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getPaneContent" href="api/sap.ui.unified.ShellLayout#methods/getPaneContent">paneContent</a>.</p>
                ...
                setHeader(oHeader: sap.ui.core.Control): sap.ui.unified.ShellLayout;
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getHeaderHiding" href="api/sap.ui.unified.ShellLayout#methods/getHeaderHiding">headerHiding</a>.</p><p>Whether the header can be hidden (manually or automatically). This feature is only available when touch events are supported.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
            ...
            export class ShellOverlay extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.ShellOverlay#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to add; if empty, nothing is inserted</p>
                ...
                close(): void;
                /**
                 * <p>Destroys all the content in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.unified.ShellOverlay#methods/getContent">content</a>.</p>
                 * @returns sap.ui.unified.ShellOverlay <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyContent(): sap.ui.unified.ShellOverlay;
                /**
                 * <p>Destroys the search in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSearch" href="api/sap.ui.unified.ShellOverlay#methods/getSearch">search</a>.</p>
                 * @returns sap.ui.unified.ShellOverlay <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroySearch(): sap.ui.unified.ShellOverlay;
                /**
                 * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="closed" href="api/sap.ui.unified.ShellOverlay#events/closed">closed</a> event of this <code>sap.ui.unified.ShellOverlay</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                 * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                 * @param {any} oListener <p>Context object on which the given function had to be called</p>
                 * @returns sap.ui.unified.ShellOverlay <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="closed" href="api/sap.ui.unified.ShellOverlay#events/closed">closed</a> to attached listeners.</p>
                 * @param {any} mParameters <p>Parameters to pass along with the event</p>
                 * @returns sap.ui.unified.ShellOverlay <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                protected fireClosed(mParameters?: any): sap.ui.unified.ShellOverlay;
                /**
                 * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.ShellOverlay#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] 
                 */
                getAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.unified.ShellOverlay#methods/getContent">content</a>.</p><p>The content to appear in the overlay.</p>
                 * @returns sap.ui.core.Control[] 
                 */
                getContent(): sap.ui.core.Control[];
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSearch" href="api/sap.ui.unified.ShellOverlay#methods/getSearch">search</a>.</p><p>Experimental (This aggregation might change in future!): The search control which should be displayed in the overlay header.</p>
                 * @returns sap.ui.core.Control 
                 */
                getSearch(): sap.ui.core.Control;
                /**
                 * <p>ID of the element which is the current target of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getShell" href="api/sap.ui.unified.ShellOverlay#methods/getShell">shell</a>, or <code>null</code>.</p>
                 * @returns sap.ui.core.ID 
                 */
                getShell(): sap.ui.core.ID;
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.unified.ShellOverlay#methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content whose index is looked for</p>
                 * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                 */
                indexOfContent(oContent: sap.ui.core.Control): number;
                /**
                 * <p>Inserts a content into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.unified.ShellOverlay#methods/getContent">content</a>.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content to insert; if empty, nothing is inserted</p>
                 * @param {number} iIndex <p>The <code>0</code>-based index the content should be inserted at; for a negative value of <code>iIndex</code>, the content is inserted at position 0; for a value greater than the current size of the aggregation, the content is inserted at the last position</p>
                 * @returns sap.ui.unified.ShellOverlay <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                open(): void;
                /**
                 * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.ShellOverlay#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllAriaLabelledBy(): sap.ui.core.ID[];
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.unified.ShellOverlay#methods/getContent">content</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllContent(): sap.ui.core.Control[];
                /**
                 * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.ShellOverlay#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                 * @param {number | sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to be removed or its index or ID</p>
                 * @returns sap.ui.core.ID <p>The removed ariaLabelledBy or <code>null</code></p>
                 */
                removeAriaLabelledBy(vAriaLabelledBy: number | sap.ui.core.ID | sap.ui.core.Control): sap.ui.core.ID;
                /**
                 * <p>Removes a content from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.unified.ShellOverlay#methods/getContent">content</a>.</p>
                 * @param {number | string | sap.ui.core.Control} vContent <p>The content to remove or its index or id</p>
                 * @returns sap.ui.core.Control <p>The removed content or <code>null</code></p>
                 */
                removeContent(vContent: number | string | sap.ui.core.Control): sap.ui.core.Control;
                /**
                 * <p>Sets the aggregated <a target="_self" class="jsdoclink scrollToMethod" data-target="getSearch" href="api/sap.ui.unified.ShellOverlay#methods/getSearch">search</a>.</p>
                 * @param {sap.ui.core.Control} oSearch <p>The search to set</p>
                 * @returns sap.ui.unified.ShellOverlay <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                setSearch(oSearch: sap.ui.core.Control): sap.ui.unified.ShellOverlay;
                /**
                 * <p>Sets the associated <a target="_self" class="jsdoclink scrollToMethod" data-target="getShell" href="api/sap.ui.unified.ShellOverlay#methods/getShell">shell</a>.</p>
            ...
            export class SplitContainer extends sap.ui.core.Control {
                ...
                constructor(sId?: string, mSettings?: any);
                /**
                 * <p>Adds some content to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.unified.SplitContainer#methods/getContent">content</a>.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content to add; if empty, nothing is inserted</p>
                ...
                /**
                 * <p>Adds some secondaryContent to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSecondaryContent" href="api/sap.ui.unified.SplitContainer#methods/getSecondaryContent">secondaryContent</a>.</p>
                ...
                /**
                 * <p>Destroys all the content in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.unified.SplitContainer#methods/getContent">content</a>.</p>
                 * @returns sap.ui.unified.SplitContainer <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroyContent(): sap.ui.unified.SplitContainer;
                /**
                 * <p>Destroys all the secondaryContent in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSecondaryContent" href="api/sap.ui.unified.SplitContainer#methods/getSecondaryContent">secondaryContent</a>.</p>
                 * @returns sap.ui.unified.SplitContainer <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                destroySecondaryContent(): sap.ui.unified.SplitContainer;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.unified.SplitContainer#methods/getContent">content</a>.</p><p>The content to appear in the main area.</p>
                 * @returns sap.ui.core.Control[] 
                 */
                getContent(): sap.ui.core.Control[];
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getOrientation" href="api/sap.ui.unified.SplitContainer#methods/getOrientation">orientation</a>.</p><p>Whether to show the secondary content on the left ("Horizontal", default) or on the top ("Vertical").</p><p>Default value is <code>Horizontal</code>.</p>
                 * @returns sap.ui.core.Orientation <p>Value of property <code>orientation</code></p>
                 */
                getOrientation(): sap.ui.core.Orientation;
                /**
                 * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSecondaryContent" href="api/sap.ui.unified.SplitContainer#methods/getSecondaryContent">secondaryContent</a>.</p><p>The content to appear in the secondary area.</p>
                 * @returns sap.ui.core.Control[] 
                 */
                ...
                /**
                 * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowSecondaryContent" href="api/sap.ui.unified.SplitContainer#methods/getShowSecondaryContent">showSecondaryContent</a>.</p><p>Shows / Hides the secondary area.</p>
                 * @returns boolean <p>Value of property <code>showSecondaryContent</code></p>
                 */
                getShowSecondaryContent(): boolean;
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.unified.SplitContainer#methods/getContent">content</a>. and returns its index if found or -1 otherwise.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content whose index is looked for</p>
                 * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                 */
                indexOfContent(oContent: sap.ui.core.Control): number;
                /**
                 * <p>Checks for the provided <code>sap.ui.core.Control</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSecondaryContent" href="api/sap.ui.unified.SplitContainer#methods/getSecondaryContent">secondaryContent</a>. and returns its index if found or -1 otherwise.</p>
                ...
                /**
                 * <p>Inserts a content into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.unified.SplitContainer#methods/getContent">content</a>.</p>
                 * @param {sap.ui.core.Control} oContent <p>The content to insert; if empty, nothing is inserted</p>
                 * @param {number} iIndex <p>The <code>0</code>-based index the content should be inserted at; for a negative value of <code>iIndex</code>, the content is inserted at position 0; for a value greater than the current size of the aggregation, the content is inserted at the last position</p>
                 * @returns sap.ui.unified.SplitContainer <p>Reference to <code>this</code> in order to allow method chaining</p>
                 */
                ...
                /**
                 * <p>Inserts a secondaryContent into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSecondaryContent" href="api/sap.ui.unified.SplitContainer#methods/getSecondaryContent">secondaryContent</a>.</p>
                ...
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.unified.SplitContainer#methods/getContent">content</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllContent(): sap.ui.core.Control[];
                /**
                 * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSecondaryContent" href="api/sap.ui.unified.SplitContainer#methods/getSecondaryContent">secondaryContent</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                 * @returns sap.ui.core.Control[] <p>An array of the removed elements (might be empty)</p>
                 */
                removeAllSecondaryContent(): sap.ui.core.Control[];
                /**
                 * <p>Removes a content from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getContent" href="api/sap.ui.unified.SplitContainer#methods/getContent">content</a>.</p>
                 * @param {number | string | sap.ui.core.Control} vContent <p>The content to remove or its index or id</p>
                 * @returns sap.ui.core.Control <p>The removed content or <code>null</code></p>
                 */
                removeContent(vContent: number | string | sap.ui.core.Control): sap.ui.core.Control;
                /**
                 * <p>Removes a secondaryContent from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSecondaryContent" href="api/sap.ui.unified.SplitContainer#methods/getSecondaryContent">secondaryContent</a>.</p>
                ...
                /**
                 * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getOrientation" href="api/sap.ui.unified.SplitContainer#methods/getOrientation">orientation</a>.</p><p>Whether to show the secondary content on the left ("Horizontal", default) or on the top ("Vertical").</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>Horizontal</code>.</p>
        ...
        namespace unified {
            ...
            namespace calendar {
                ...
                export class DatesRow extends sap.ui.unified.calendar.Month {
                     ...
                     * @param {any} oDate <p>JavaScript date object for focused date.</p>
                     * @returns sap.ui.unified.calendar.DatesRow <p><code>this</code> to allow method chaining</p>
                     */
                    displayDate(oDate: any): sap.ui.unified.calendar.DatesRow;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getDays" href="api/sap.ui.unified.calendar.DatesRow#methods/getDays">days</a>.</p><p>number of days displayed</p><p>Default value is <code>7</code>.</p>
                     * @returns number <p>Value of property <code>days</code></p>
                     */
                    getDays(): number;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowDayNamesLine" href="api/sap.ui.unified.calendar.DatesRow#methods/getShowDayNamesLine">showDayNamesLine</a>.</p><p>If set the day names are shown in a separate line. If not set the day names are shown inside the single days.</p><p>Default value is <code>true</code>.</p>
                     * @returns boolean <p>Value of property <code>showDayNamesLine</code></p>
                     */
                    getShowDayNamesLine(): boolean;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getStartDate" href="api/sap.ui.unified.calendar.DatesRow#methods/getStartDate">startDate</a>.</p><p>Start date of the row If in rendering phase the date property is not in the range startDate + days, it is set to the start date So after setting the start date the date should be set to be in the range of the start date</p>
                     * @returns any <p>Value of property <code>startDate</code></p>
                     */
                    getStartDate(): any;
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getDate" href="api/sap.ui.unified.calendar.Month#methods/getDate">date</a>.</p><p>A date as JavaScript Date object. The month including this date is rendered and this date is focused initially (if no other focus is set).</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                    ...
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getDays" href="api/sap.ui.unified.calendar.DatesRow#methods/getDays">days</a>.</p><p>number of days displayed</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>7</code>.</p>
                     * @param {number} iDays <p>New value for property <code>days</code></p>
                ...
                export class Header extends sap.ui.core.Control {
                    ...
                    /**
                     * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="pressButton1" href="api/sap.ui.unified.calendar.Header#events/pressButton1">pressButton1</a> event of this <code>sap.ui.unified.calendar.Header</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.calendar.Header</code> itself.</p><p>Second button pressed (normally month)</p>
                     * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                     * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                     * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.calendar.Header</code> itself</p>
                     * @returns sap.ui.unified.calendar.Header <p>Reference to <code>this</code> in order to allow method chaining</p>
                    ...
                    /**
                     * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="pressButton2" href="api/sap.ui.unified.calendar.Header#events/pressButton2">pressButton2</a> event of this <code>sap.ui.unified.calendar.Header</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.calendar.Header</code> itself.</p><p>Third button pressed (normally year)</p>
                     * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                     * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                     * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.calendar.Header</code> itself</p>
                     * @returns sap.ui.unified.calendar.Header <p>Reference to <code>this</code> in order to allow method chaining</p>
                    ...
                    /**
                     * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="pressNext" href="api/sap.ui.unified.calendar.Header#events/pressNext">pressNext</a> event of this <code>sap.ui.unified.calendar.Header</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.calendar.Header</code> itself.</p><p>Next button pressed</p>
                     * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                     * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                     * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.calendar.Header</code> itself</p>
                     * @returns sap.ui.unified.calendar.Header <p>Reference to <code>this</code> in order to allow method chaining</p>
                    ...
                    /**
                     * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="pressPrevious" href="api/sap.ui.unified.calendar.Header#events/pressPrevious">pressPrevious</a> event of this <code>sap.ui.unified.calendar.Header</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.calendar.Header</code> itself.</p><p>Previous button pressed</p>
                     * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                     * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                     * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.calendar.Header</code> itself</p>
                     * @returns sap.ui.unified.calendar.Header <p>Reference to <code>this</code> in order to allow method chaining</p>
                    ...
                    /**
                     * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="pressButton0" href="api/sap.ui.unified.calendar.Header#events/pressButton0">pressButton0</a> event of this <code>sap.ui.unified.calendar.Header</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                     * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                     * @param {any} oListener <p>Context object on which the given function had to be called</p>
                     * @returns sap.ui.unified.calendar.Header <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="pressButton1" href="api/sap.ui.unified.calendar.Header#events/pressButton1">pressButton1</a> event of this <code>sap.ui.unified.calendar.Header</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                     * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                     * @param {any} oListener <p>Context object on which the given function had to be called</p>
                     * @returns sap.ui.unified.calendar.Header <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="pressButton2" href="api/sap.ui.unified.calendar.Header#events/pressButton2">pressButton2</a> event of this <code>sap.ui.unified.calendar.Header</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                     * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                     * @param {any} oListener <p>Context object on which the given function had to be called</p>
                     * @returns sap.ui.unified.calendar.Header <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="pressNext" href="api/sap.ui.unified.calendar.Header#events/pressNext">pressNext</a> event of this <code>sap.ui.unified.calendar.Header</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                     * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                     * @param {any} oListener <p>Context object on which the given function had to be called</p>
                     * @returns sap.ui.unified.calendar.Header <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="pressPrevious" href="api/sap.ui.unified.calendar.Header#events/pressPrevious">pressPrevious</a> event of this <code>sap.ui.unified.calendar.Header</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                     * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                     * @param {any} oListener <p>Context object on which the given function had to be called</p>
                     * @returns sap.ui.unified.calendar.Header <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="pressButton0" href="api/sap.ui.unified.calendar.Header#events/pressButton0">pressButton0</a> to attached listeners.</p>
                     * @param {any} mParameters <p>Parameters to pass along with the event</p>
                     * @returns sap.ui.unified.calendar.Header <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    protected firePressButton0(mParameters?: any): sap.ui.unified.calendar.Header;
                    /**
                     * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="pressButton1" href="api/sap.ui.unified.calendar.Header#events/pressButton1">pressButton1</a> to attached listeners.</p>
                     * @param {any} mParameters <p>Parameters to pass along with the event</p>
                     * @returns sap.ui.unified.calendar.Header <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    protected firePressButton1(mParameters?: any): sap.ui.unified.calendar.Header;
                    /**
                     * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="pressButton2" href="api/sap.ui.unified.calendar.Header#events/pressButton2">pressButton2</a> to attached listeners.</p>
                     * @param {any} mParameters <p>Parameters to pass along with the event</p>
                     * @returns sap.ui.unified.calendar.Header <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    protected firePressButton2(mParameters?: any): sap.ui.unified.calendar.Header;
                    /**
                     * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="pressNext" href="api/sap.ui.unified.calendar.Header#events/pressNext">pressNext</a> to attached listeners.</p>
                     * @param {any} mParameters <p>Parameters to pass along with the event</p>
                     * @returns sap.ui.unified.calendar.Header <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    protected firePressNext(mParameters?: any): sap.ui.unified.calendar.Header;
                    /**
                     * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="pressPrevious" href="api/sap.ui.unified.calendar.Header#events/pressPrevious">pressPrevious</a> to attached listeners.</p>
                     * @param {any} mParameters <p>Parameters to pass along with the event</p>
                     * @returns sap.ui.unified.calendar.Header <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    protected firePressPrevious(mParameters?: any): sap.ui.unified.calendar.Header;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getAdditionalTextButton0" href="api/sap.ui.unified.calendar.Header#methods/getAdditionalTextButton0">additionalTextButton0</a>.</p><p>Additional text of the first button (normally day)</p>
                     * @returns string <p>Value of property <code>additionalTextButton0</code></p>
                     */
                    getAdditionalTextButton0(): string;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getAdditionalTextButton1" href="api/sap.ui.unified.calendar.Header#methods/getAdditionalTextButton1">additionalTextButton1</a>.</p><p>Additional text of the second button (normally month)</p>
                     * @returns string <p>Value of property <code>additionalTextButton1</code></p>
                     */
                    getAdditionalTextButton1(): string;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getAdditionalTextButton2" href="api/sap.ui.unified.calendar.Header#methods/getAdditionalTextButton2">additionalTextButton2</a>.</p><p>Additional text of the third button (normally year)</p>
                     * @returns string <p>Value of property <code>additionalTextButton2</code></p>
                     */
                    getAdditionalTextButton2(): string;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelButton0" href="api/sap.ui.unified.calendar.Header#methods/getAriaLabelButton0">ariaLabelButton0</a>.</p><p>aria-label of the first button (normally day)</p>
                     * @returns string <p>Value of property <code>ariaLabelButton0</code></p>
                     */
                    getAriaLabelButton0(): string;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelButton1" href="api/sap.ui.unified.calendar.Header#methods/getAriaLabelButton1">ariaLabelButton1</a>.</p><p>aria-label of the second button (normally month)</p>
                     * @returns string <p>Value of property <code>ariaLabelButton1</code></p>
                     */
                    getAriaLabelButton1(): string;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelButton2" href="api/sap.ui.unified.calendar.Header#methods/getAriaLabelButton2">ariaLabelButton2</a>.</p><p>aria-label of the third button (normally year)</p>
                     * @returns string <p>Value of property <code>ariaLabelButton2</code></p>
                     */
                    getAriaLabelButton2(): string;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getEnabledNext" href="api/sap.ui.unified.calendar.Header#methods/getEnabledNext">enabledNext</a>.</p><p>Enables the Next button</p><p>Default value is <code>true</code>.</p>
                     * @returns boolean <p>Value of property <code>enabledNext</code></p>
                     */
                    getEnabledNext(): boolean;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getEnabledPrevious" href="api/sap.ui.unified.calendar.Header#methods/getEnabledPrevious">enabledPrevious</a>.</p><p>Enables the previous button</p><p>Default value is <code>true</code>.</p>
                     * @returns boolean <p>Value of property <code>enabledPrevious</code></p>
                     */
                    getEnabledPrevious(): boolean;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getTextButton0" href="api/sap.ui.unified.calendar.Header#methods/getTextButton0">textButton0</a>.</p><p>Text of the first button (normally day)</p>
                     * @returns string <p>Value of property <code>textButton0</code></p>
                     */
                    getTextButton0(): string;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getTextButton1" href="api/sap.ui.unified.calendar.Header#methods/getTextButton1">textButton1</a>.</p><p>Text of the second button (normally month)</p>
                     * @returns string <p>Value of property <code>textButton1</code></p>
                     */
                    getTextButton1(): string;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getTextButton2" href="api/sap.ui.unified.calendar.Header#methods/getTextButton2">textButton2</a>.</p><p>Text of the third button (normally year)</p>
                     * @returns string <p>Value of property <code>textButton2</code></p>
                     */
                    getTextButton2(): string;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getVisibleButton0" href="api/sap.ui.unified.calendar.Header#methods/getVisibleButton0">visibleButton0</a>.</p><p>If set, the first button will be displayed</p><p><b>Note:</b> The default is set to false to be compatible to older versions</p><p>Default value is <code>false</code>.</p>
                     * @returns boolean <p>Value of property <code>visibleButton0</code></p>
                     */
                    getVisibleButton0(): boolean;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getVisibleButton1" href="api/sap.ui.unified.calendar.Header#methods/getVisibleButton1">visibleButton1</a>.</p><p>If set, the second button will be displayed</p><p>Default value is <code>true</code>.</p>
                     * @returns boolean <p>Value of property <code>visibleButton1</code></p>
                     */
                    getVisibleButton1(): boolean;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getVisibleButton2" href="api/sap.ui.unified.calendar.Header#methods/getVisibleButton2">visibleButton2</a>.</p><p>If set, the third button will be displayed</p><p>Default value is <code>true</code>.</p>
                     * @returns boolean <p>Value of property <code>visibleButton2</code></p>
                     */
                    getVisibleButton2(): boolean;
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getAdditionalTextButton0" href="api/sap.ui.unified.calendar.Header#methods/getAdditionalTextButton0">additionalTextButton0</a>.</p><p>Additional text of the first button (normally day)</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                    ...
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getAdditionalTextButton2" href="api/sap.ui.unified.calendar.Header#methods/getAdditionalTextButton2">additionalTextButton2</a>.</p><p>Additional text of the third button (normally year)</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                    ...
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelButton0" href="api/sap.ui.unified.calendar.Header#methods/getAriaLabelButton0">ariaLabelButton0</a>.</p><p>aria-label of the first button (normally day)</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                    ...
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelButton1" href="api/sap.ui.unified.calendar.Header#methods/getAriaLabelButton1">ariaLabelButton1</a>.</p><p>aria-label of the second button (normally month)</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                    ...
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelButton2" href="api/sap.ui.unified.calendar.Header#methods/getAriaLabelButton2">ariaLabelButton2</a>.</p><p>aria-label of the third button (normally year)</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                    ...
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getTextButton1" href="api/sap.ui.unified.calendar.Header#methods/getTextButton1">textButton1</a>.</p><p>Text of the second button (normally month)</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                    ...
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getTextButton2" href="api/sap.ui.unified.calendar.Header#methods/getTextButton2">textButton2</a>.</p><p>Text of the third button (normally year)</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                ...
                export class Month extends sap.ui.core.Control {
                    ...
                    constructor(sId?: string, mSettings?: any);
                    /**
                     * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.calendar.Month#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @param {sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to add; if empty, nothing is inserted</p>
                     * @returns sap.ui.unified.calendar.Month <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    addAriaLabelledBy(vAriaLabelledBy: sap.ui.core.ID | sap.ui.core.Control): sap.ui.unified.calendar.Month;
                    /**
                     * <p>Adds some disabledDate to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getDisabledDates" href="api/sap.ui.unified.calendar.Month#methods/getDisabledDates">disabledDates</a>.</p>
                     * @param {sap.ui.unified.DateRange} oDisabledDate <p>The disabledDate to add; if empty, nothing is inserted</p>
                     * @returns sap.ui.unified.calendar.Month <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    addDisabledDate(oDisabledDate: sap.ui.unified.DateRange): sap.ui.unified.calendar.Month;
                    /**
                     * <p>Adds some selectedDate to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.Month#methods/getSelectedDates">selectedDates</a>.</p>
                     * @param {sap.ui.unified.DateRange} oSelectedDate <p>The selectedDate to add; if empty, nothing is inserted</p>
                     * @returns sap.ui.unified.calendar.Month <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    addSelectedDate(oSelectedDate: sap.ui.unified.DateRange): sap.ui.unified.calendar.Month;
                    /**
                     * <p>Adds some specialDate to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.calendar.Month#methods/getSpecialDates">specialDates</a>.</p>
                     * @param {sap.ui.unified.DateTypeRange} oSpecialDate <p>The specialDate to add; if empty, nothing is inserted</p>
                     * @returns sap.ui.unified.calendar.Month <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    addSpecialDate(oSpecialDate: sap.ui.unified.DateTypeRange): sap.ui.unified.calendar.Month;
                    /**
                     * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="focus" href="api/sap.ui.unified.calendar.Month#events/focus">focus</a> event of this <code>sap.ui.unified.calendar.Month</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.calendar.Month</code> itself.</p><p>Date focus changed</p>
                     * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                     * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                    ...
                    /**
                     * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.calendar.Month#events/select">select</a> event of this <code>sap.ui.unified.calendar.Month</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.calendar.Month</code> itself.</p><p>Date selection changed</p>
                     * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                     * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                     * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.calendar.Month</code> itself</p>
                     * @returns sap.ui.unified.calendar.Month <p>Reference to <code>this</code> in order to allow method chaining</p>
                    ...
                    /**
                     * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="weekNumberSelect" href="api/sap.ui.unified.calendar.Month#events/weekNumberSelect">weekNumberSelect</a> event of this <code>sap.ui.unified.calendar.Month</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.calendar.Month</code> itself.</p><p>Fired when a week number selection is changed. By default, choosing the week number will select the corresponding week. If the week has already been selected, choosing the week number will deselect it.</p><p>The default behavior can be prevented using the <code>preventDefault</code> method.</p><p><b>Note:</b> Works for Gregorian calendars only and when <code>intervalSelection</code> is set to <code>true</code>.</p>
                     * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                     * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                     * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.calendar.Month</code> itself</p>
                     * @returns sap.ui.unified.calendar.Month <p>Reference to <code>this</code> in order to allow method chaining</p>
                    ...
                    /**
                     * <p>Destroys all the disabledDates in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getDisabledDates" href="api/sap.ui.unified.calendar.Month#methods/getDisabledDates">disabledDates</a>.</p>
                     * @returns sap.ui.unified.calendar.Month <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroyDisabledDates(): sap.ui.unified.calendar.Month;
                    /**
                     * <p>Destroys all the selectedDates in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.Month#methods/getSelectedDates">selectedDates</a>.</p>
                     * @returns sap.ui.unified.calendar.Month <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroySelectedDates(): sap.ui.unified.calendar.Month;
                    /**
                     * <p>Destroys all the specialDates in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.calendar.Month#methods/getSpecialDates">specialDates</a>.</p>
                     * @returns sap.ui.unified.calendar.Month <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroySpecialDates(): sap.ui.unified.calendar.Month;
                    /**
                     * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="focus" href="api/sap.ui.unified.calendar.Month#events/focus">focus</a> event of this <code>sap.ui.unified.calendar.Month</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                     * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                     * @param {any} oListener <p>Context object on which the given function had to be called</p>
                     * @returns sap.ui.unified.calendar.Month <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.calendar.Month#events/select">select</a> event of this <code>sap.ui.unified.calendar.Month</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                     * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                     * @param {any} oListener <p>Context object on which the given function had to be called</p>
                     * @returns sap.ui.unified.calendar.Month <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="weekNumberSelect" href="api/sap.ui.unified.calendar.Month#events/weekNumberSelect">weekNumberSelect</a> event of this <code>sap.ui.unified.calendar.Month</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                     * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                     * @param {any} oListener <p>Context object on which the given function had to be called</p>
                     * @returns sap.ui.unified.calendar.Month <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    displayDate(oDate: any): sap.ui.unified.calendar.Month;
                    /**
                     * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="focus" href="api/sap.ui.unified.calendar.Month#events/focus">focus</a> to attached listeners.</p>
                     * @param {any} mParameters <p>Parameters to pass along with the event</p>
                     * @returns sap.ui.unified.calendar.Month <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    protected fireFocus(mParameters?: any): sap.ui.unified.calendar.Month;
                    /**
                     * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.calendar.Month#events/select">select</a> to attached listeners.</p>
                     * @param {any} mParameters <p>Parameters to pass along with the event</p>
                     * @returns sap.ui.unified.calendar.Month <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    protected fireWeekNumberSelect(mParameters?: any): boolean;
                    /**
                     * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.calendar.Month#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @returns sap.ui.core.ID[] 
                     */
                    getAriaLabelledBy(): sap.ui.core.ID[];
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getDate" href="api/sap.ui.unified.calendar.Month#methods/getDate">date</a>.</p><p>A date as JavaScript Date object. The month including this date is rendered and this date is focused initially (if no other focus is set).</p>
                     * @returns any <p>Value of property <code>date</code></p>
                     */
                    getDate(): any;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getDisabledDates" href="api/sap.ui.unified.calendar.Month#methods/getDisabledDates">disabledDates</a>.</p><p>Date Ranges for disabled dates</p>
                     * @returns sap.ui.unified.DateRange[] 
                     */
                    getDisabledDates(): sap.ui.unified.DateRange[];
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getFirstDayOfWeek" href="api/sap.ui.unified.calendar.Month#methods/getFirstDayOfWeek">firstDayOfWeek</a>.</p><p>If set, the first day of the displayed week is this day. Valid values are 0 to 6. If not a valid value is set, the default of the used locale is used.</p><p>Default value is <code>-1</code>.</p>
                     * @returns number <p>Value of property <code>firstDayOfWeek</code></p>
                     */
                    getFirstDayOfWeek(): number;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervalSelection" href="api/sap.ui.unified.calendar.Month#methods/getIntervalSelection">intervalSelection</a>.</p><p>If set, interval selection is allowed</p><p>Default value is <code>false</code>.</p>
                     * @returns boolean <p>Value of property <code>intervalSelection</code></p>
                     */
                    getIntervalSelection(): boolean;
                    /**
                     * <p>ID of the element which is the current target of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getLegend" href="api/sap.ui.unified.calendar.Month#methods/getLegend">legend</a>, or <code>null</code>.</p>
                     * @returns sap.ui.core.ID 
                     */
                    getLegend(): sap.ui.core.ID;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getNonWorkingDays" href="api/sap.ui.unified.calendar.Month#methods/getNonWorkingDays">nonWorkingDays</a>.</p><p>If set, the provided weekdays are displayed as non-working days. Valid values inside the array are 0 to 6. If not set, the weekend defined in the locale settings is displayed as non-working days.</p>
                     * @returns number[] <p>Value of property <code>nonWorkingDays</code></p>
                     */
                    getNonWorkingDays(): number[];
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getPrimaryCalendarType" href="api/sap.ui.unified.calendar.Month#methods/getPrimaryCalendarType">primaryCalendarType</a>.</p><p>If set, the calendar type is used for display. If not set, the calendar type of the global configuration is used.</p>
                     * @returns sap.ui.core.CalendarType <p>Value of property <code>primaryCalendarType</code></p>
                     */
                    getPrimaryCalendarType(): sap.ui.core.CalendarType;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSecondaryCalendarType" href="api/sap.ui.unified.calendar.Month#methods/getSecondaryCalendarType">secondaryCalendarType</a>.</p><p>If set, the days are also displayed in this calendar type If not set, the dates are only displayed in the primary calendar type</p>
                     * @returns sap.ui.core.CalendarType <p>Value of property <code>secondaryCalendarType</code></p>
                     */
                    getSecondaryCalendarType(): sap.ui.core.CalendarType;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.Month#methods/getSelectedDates">selectedDates</a>.</p><p>Date Ranges for selected dates of the DatePicker</p>
                     * @returns sap.ui.unified.DateRange[] 
                     */
                    getSelectedDates(): sap.ui.unified.DateRange[];
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowHeader" href="api/sap.ui.unified.calendar.Month#methods/getShowHeader">showHeader</a>.</p><p>If set, a header with the month name is shown</p><p>Default value is <code>false</code>.</p>
                     * @returns boolean <p>Value of property <code>showHeader</code></p>
                     */
                    getShowHeader(): boolean;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowWeekNumbers" href="api/sap.ui.unified.calendar.Month#methods/getShowWeekNumbers">showWeekNumbers</a>.</p><p>Determines whether the week numbers in the months are displayed.</p><p><b>Note:</b> For Islamic calendars, the week numbers are not displayed regardless of what is set to this property.</p><p>Default value is <code>true</code>.</p>
                     * @returns boolean <p>Value of property <code>showWeekNumbers</code></p>
                     */
                    getShowWeekNumbers(): boolean;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSingleSelection" href="api/sap.ui.unified.calendar.Month#methods/getSingleSelection">singleSelection</a>.</p><p>If set, only a single date or interval, if intervalSelection is enabled, can be selected</p><p>Default value is <code>true</code>.</p>
                     * @returns boolean <p>Value of property <code>singleSelection</code></p>
                     */
                    getSingleSelection(): boolean;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.calendar.Month#methods/getSpecialDates">specialDates</a>.</p><p><code>DateRange</code> with type to visualize special days in the Calendar.</p><p><b>Note:</b> If one day is assigned to more than one DateTypeRange, only the first one will be used. The only exception is when one of the types is <code>NonWorking</code>, then you can have both <code>NonWorking</code> and the other type. For example, you can have <code>NonWorking</code> + <code>Type01</code> but you can't have <code>Type01</code> + <code>Type02</code>.</p>
                     * @returns sap.ui.unified.DateTypeRange[] 
                     */
                    getSpecialDates(): sap.ui.unified.DateTypeRange[];
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getWidth" href="api/sap.ui.unified.calendar.Month#methods/getWidth">width</a>.</p><p>Width of Month</p>
                     * @returns sap.ui.core.CSSSize <p>Value of property <code>width</code></p>
                     */
                    getWidth(): sap.ui.core.CSSSize;
                    /**
                     * <p>Checks for the provided <code>sap.ui.unified.DateRange</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getDisabledDates" href="api/sap.ui.unified.calendar.Month#methods/getDisabledDates">disabledDates</a>. and returns its index if found or -1 otherwise.</p>
                     * @param {sap.ui.unified.DateRange} oDisabledDate <p>The disabledDate whose index is looked for</p>
                     * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                     */
                    indexOfDisabledDate(oDisabledDate: sap.ui.unified.DateRange): number;
                    /**
                     * <p>Checks for the provided <code>sap.ui.unified.DateRange</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.Month#methods/getSelectedDates">selectedDates</a>. and returns its index if found or -1 otherwise.</p>
                     * @param {sap.ui.unified.DateRange} oSelectedDate <p>The selectedDate whose index is looked for</p>
                     * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                     */
                    indexOfSelectedDate(oSelectedDate: sap.ui.unified.DateRange): number;
                    /**
                     * <p>Checks for the provided <code>sap.ui.unified.DateTypeRange</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.calendar.Month#methods/getSpecialDates">specialDates</a>. and returns its index if found or -1 otherwise.</p>
                     * @param {sap.ui.unified.DateTypeRange} oSpecialDate <p>The specialDate whose index is looked for</p>
                     * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                     */
                    indexOfSpecialDate(oSpecialDate: sap.ui.unified.DateTypeRange): number;
                    /**
                     * <p>Inserts a disabledDate into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getDisabledDates" href="api/sap.ui.unified.calendar.Month#methods/getDisabledDates">disabledDates</a>.</p>
                     * @param {sap.ui.unified.DateRange} oDisabledDate <p>The disabledDate to insert; if empty, nothing is inserted</p>
                     * @param {number} iIndex <p>The <code>0</code>-based index the disabledDate should be inserted at; for a negative value of <code>iIndex</code>, the disabledDate is inserted at position 0; for a value greater than the current size of the aggregation, the disabledDate is inserted at the last position</p>
                     * @returns sap.ui.unified.calendar.Month <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Inserts a selectedDate into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.Month#methods/getSelectedDates">selectedDates</a>.</p>
                     * @param {sap.ui.unified.DateRange} oSelectedDate <p>The selectedDate to insert; if empty, nothing is inserted</p>
                     * @param {number} iIndex <p>The <code>0</code>-based index the selectedDate should be inserted at; for a negative value of <code>iIndex</code>, the selectedDate is inserted at position 0; for a value greater than the current size of the aggregation, the selectedDate is inserted at the last position</p>
                     * @returns sap.ui.unified.calendar.Month <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Inserts a specialDate into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.calendar.Month#methods/getSpecialDates">specialDates</a>.</p>
                     * @param {sap.ui.unified.DateTypeRange} oSpecialDate <p>The specialDate to insert; if empty, nothing is inserted</p>
                     * @param {number} iIndex <p>The <code>0</code>-based index the specialDate should be inserted at; for a negative value of <code>iIndex</code>, the specialDate is inserted at position 0; for a value greater than the current size of the aggregation, the specialDate is inserted at the last position</p>
                     * @returns sap.ui.unified.calendar.Month <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.calendar.Month#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllAriaLabelledBy(): sap.ui.core.ID[];
                    /**
                     * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getDisabledDates" href="api/sap.ui.unified.calendar.Month#methods/getDisabledDates">disabledDates</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                     * @returns sap.ui.unified.DateRange[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllDisabledDates(): sap.ui.unified.DateRange[];
                    /**
                     * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.Month#methods/getSelectedDates">selectedDates</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                     * @returns sap.ui.unified.DateRange[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllSelectedDates(): sap.ui.unified.DateRange[];
                    /**
                     * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.calendar.Month#methods/getSpecialDates">specialDates</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                     * @returns sap.ui.unified.DateTypeRange[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllSpecialDates(): sap.ui.unified.DateTypeRange[];
                    /**
                     * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.calendar.Month#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @param {number | sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to be removed or its index or ID</p>
                     * @returns sap.ui.core.ID <p>The removed ariaLabelledBy or <code>null</code></p>
                     */
                    removeAriaLabelledBy(vAriaLabelledBy: number | sap.ui.core.ID | sap.ui.core.Control): sap.ui.core.ID;
                    /**
                     * <p>Removes a disabledDate from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getDisabledDates" href="api/sap.ui.unified.calendar.Month#methods/getDisabledDates">disabledDates</a>.</p>
                     * @param {number | string | sap.ui.unified.DateRange} vDisabledDate <p>The disabledDate to remove or its index or id</p>
                     * @returns sap.ui.unified.DateRange <p>The removed disabledDate or <code>null</code></p>
                     */
                    removeDisabledDate(vDisabledDate: number | string | sap.ui.unified.DateRange): sap.ui.unified.DateRange;
                    /**
                     * <p>Removes a selectedDate from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.Month#methods/getSelectedDates">selectedDates</a>.</p>
                     * @param {number | string | sap.ui.unified.DateRange} vSelectedDate <p>The selectedDate to remove or its index or id</p>
                     * @returns sap.ui.unified.DateRange <p>The removed selectedDate or <code>null</code></p>
                     */
                    removeSelectedDate(vSelectedDate: number | string | sap.ui.unified.DateRange): sap.ui.unified.DateRange;
                    /**
                     * <p>Removes a specialDate from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.calendar.Month#methods/getSpecialDates">specialDates</a>.</p>
                     * @param {number | string | sap.ui.unified.DateTypeRange} vSpecialDate <p>The specialDate to remove or its index or id</p>
                     * @returns sap.ui.unified.DateTypeRange <p>The removed specialDate or <code>null</code></p>
                     */
                    removeSpecialDate(vSpecialDate: number | string | sap.ui.unified.DateTypeRange): sap.ui.unified.DateTypeRange;
                    ...
                    setDate(oDate: any): sap.ui.unified.calendar.Month;
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getFirstDayOfWeek" href="api/sap.ui.unified.calendar.Month#methods/getFirstDayOfWeek">firstDayOfWeek</a>.</p><p>If set, the first day of the displayed week is this day. Valid values are 0 to 6. If not a valid value is set, the default of the used locale is used.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>-1</code>.</p>
                     * @param {number} iFirstDayOfWeek <p>New value for property <code>firstDayOfWeek</code></p>
                     * @returns sap.ui.unified.calendar.Month <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getNonWorkingDays" href="api/sap.ui.unified.calendar.Month#methods/getNonWorkingDays">nonWorkingDays</a>.</p><p>If set, the provided weekdays are displayed as non-working days. Valid values inside the array are 0 to 6. If not set, the weekend defined in the locale settings is displayed as non-working days.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                     * @param {number[]} sNonWorkingDays <p>New value for property <code>nonWorkingDays</code></p>
                     * @returns sap.ui.unified.calendar.Month <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSecondaryCalendarType" href="api/sap.ui.unified.calendar.Month#methods/getSecondaryCalendarType">secondaryCalendarType</a>.</p><p>If set, the days are also displayed in this calendar type If not set, the dates are only displayed in the primary calendar type</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                     * @param {sap.ui.core.CalendarType} sSecondaryCalendarType <p>New value for property <code>secondaryCalendarType</code></p>
                     * @returns sap.ui.unified.calendar.Month <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    setSecondaryCalendarType(sSecondaryCalendarType: sap.ui.core.CalendarType): sap.ui.unified.calendar.Month;
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowHeader" href="api/sap.ui.unified.calendar.Month#methods/getShowHeader">showHeader</a>.</p><p>If set, a header with the month name is shown</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
                ...
                export class MonthPicker extends sap.ui.core.Control {
                    ...
                    constructor(sId?: string, mSettings?: any);
                    /**
                     * <p>Adds some selectedDate to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.MonthPicker#methods/getSelectedDates">selectedDates</a>.</p>
                     * @param {sap.ui.unified.DateRange} oSelectedDate <p>The selectedDate to add; if empty, nothing is inserted</p>
                     * @returns sap.ui.unified.calendar.MonthPicker <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    addSelectedDate(oSelectedDate: sap.ui.unified.DateRange): sap.ui.unified.calendar.MonthPicker;
                    /**
                     * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="pageChange" href="api/sap.ui.unified.calendar.MonthPicker#events/pageChange">pageChange</a> event of this <code>sap.ui.unified.calendar.MonthPicker</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.calendar.MonthPicker</code> itself.</p><p>If less than 12 months are displayed the <code>pageChange</code> event is fired if the displayed months are changed by user navigation.</p>
                     * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                     * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                    ...
                    /**
                     * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.calendar.MonthPicker#events/select">select</a> event of this <code>sap.ui.unified.calendar.MonthPicker</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.calendar.MonthPicker</code> itself.</p><p>Month selection changed</p>
                     * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                     * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                     * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.calendar.MonthPicker</code> itself</p>
                     * @returns sap.ui.unified.calendar.MonthPicker <p>Reference to <code>this</code> in order to allow method chaining</p>
                    ...
                    /**
                     * <p>Destroys all the selectedDates in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.MonthPicker#methods/getSelectedDates">selectedDates</a>.</p>
                     * @returns sap.ui.unified.calendar.MonthPicker <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroySelectedDates(): sap.ui.unified.calendar.MonthPicker;
                    /**
                     * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="pageChange" href="api/sap.ui.unified.calendar.MonthPicker#events/pageChange">pageChange</a> event of this <code>sap.ui.unified.calendar.MonthPicker</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                     * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                     * @param {any} oListener <p>Context object on which the given function had to be called</p>
                     * @returns sap.ui.unified.calendar.MonthPicker <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.calendar.MonthPicker#events/select">select</a> event of this <code>sap.ui.unified.calendar.MonthPicker</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                     * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                     * @param {any} oListener <p>Context object on which the given function had to be called</p>
                     * @returns sap.ui.unified.calendar.MonthPicker <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="pageChange" href="api/sap.ui.unified.calendar.MonthPicker#events/pageChange">pageChange</a> to attached listeners.</p>
                     * @param {any} mParameters <p>Parameters to pass along with the event</p>
                     * @returns sap.ui.unified.calendar.MonthPicker <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    protected firePageChange(mParameters?: any): sap.ui.unified.calendar.MonthPicker;
                    /**
                     * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.calendar.MonthPicker#events/select">select</a> to attached listeners.</p>
                     * @param {any} mParameters <p>Parameters to pass along with the event</p>
                     * @returns sap.ui.unified.calendar.MonthPicker <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    protected fireSelect(mParameters?: any): sap.ui.unified.calendar.MonthPicker;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getColumns" href="api/sap.ui.unified.calendar.MonthPicker#methods/getColumns">columns</a>.</p><p>number of months in each row The value must be between 0 and 12 (0 means just to have all months in one row, independent of the number)</p><p>Default value is <code>3</code>.</p>
                     * @returns number <p>Value of property <code>columns</code></p>
                     */
                    getColumns(): number;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervalSelection" href="api/sap.ui.unified.calendar.MonthPicker#methods/getIntervalSelection">intervalSelection</a>.</p><p>If set, interval selection is allowed</p><p>Default value is <code>false</code>.</p>
                     * @returns boolean <p>Value of property <code>intervalSelection</code></p>
                     */
                    getIntervalSelection(): boolean;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMonth" href="api/sap.ui.unified.calendar.MonthPicker#methods/getMonth">month</a>.</p><p>The month is initial focused and selected The value must be between 0 and 11</p><p>Default value is <code>0</code>.</p>
                     * @returns number <p>Value of property <code>month</code></p>
                     */
                    getMonth(): number;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMonths" href="api/sap.ui.unified.calendar.MonthPicker#methods/getMonths">months</a>.</p><p>number of displayed months The value must be between 1 and 12</p><p>Default value is <code>12</code>.</p>
                     * @returns number <p>Value of property <code>months</code></p>
                     */
                    getMonths(): number;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getPrimaryCalendarType" href="api/sap.ui.unified.calendar.MonthPicker#methods/getPrimaryCalendarType">primaryCalendarType</a>.</p><p>If set, the calendar type is used for display. If not set, the calendar type of the global configuration is used.</p>
                     * @returns sap.ui.core.CalendarType <p>Value of property <code>primaryCalendarType</code></p>
                     */
                    getPrimaryCalendarType(): sap.ui.core.CalendarType;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.MonthPicker#methods/getSelectedDates">selectedDates</a>.</p><p>Date Ranges for selected dates of the MonthPicker</p>
                     * @returns sap.ui.unified.DateRange[] 
                     */
                    getSelectedDates(): sap.ui.unified.DateRange[];
                    /**
                     * <p>Checks for the provided <code>sap.ui.unified.DateRange</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.MonthPicker#methods/getSelectedDates">selectedDates</a>. and returns its index if found or -1 otherwise.</p>
                     * @param {sap.ui.unified.DateRange} oSelectedDate <p>The selectedDate whose index is looked for</p>
                     * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                     */
                    indexOfSelectedDate(oSelectedDate: sap.ui.unified.DateRange): number;
                    /**
                     * <p>Inserts a selectedDate into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.MonthPicker#methods/getSelectedDates">selectedDates</a>.</p>
                     * @param {sap.ui.unified.DateRange} oSelectedDate <p>The selectedDate to insert; if empty, nothing is inserted</p>
                     * @param {number} iIndex <p>The <code>0</code>-based index the selectedDate should be inserted at; for a negative value of <code>iIndex</code>, the selectedDate is inserted at position 0; for a value greater than the current size of the aggregation, the selectedDate is inserted at the last position</p>
                     * @returns sap.ui.unified.calendar.MonthPicker <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    insertSelectedDate(oSelectedDate: sap.ui.unified.DateRange, iIndex: number): sap.ui.unified.calendar.MonthPicker;
                    /**
                    ...
                    /**
                     * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.MonthPicker#methods/getSelectedDates">selectedDates</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                     * @returns sap.ui.unified.DateRange[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllSelectedDates(): sap.ui.unified.DateRange[];
                    /**
                     * <p>Removes a selectedDate from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.MonthPicker#methods/getSelectedDates">selectedDates</a>.</p>
                     * @param {number | string | sap.ui.unified.DateRange} vSelectedDate <p>The selectedDate to remove or its index or id</p>
                     * @returns sap.ui.unified.DateRange <p>The removed selectedDate or <code>null</code></p>
                     */
                    removeSelectedDate(vSelectedDate: number | string | sap.ui.unified.DateRange): sap.ui.unified.DateRange;
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getColumns" href="api/sap.ui.unified.calendar.MonthPicker#methods/getColumns">columns</a>.</p><p>number of months in each row The value must be between 0 and 12 (0 means just to have all months in one row, independent of the number)</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>3</code>.</p>
                ...
                export class MonthsRow extends sap.ui.core.Control {
                    ...
                    constructor(sId?: string, mSettings?: any);
                    /**
                     * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.calendar.MonthsRow#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @param {sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to add; if empty, nothing is inserted</p>
                    ...
                    /**
                     * <p>Adds some selectedDate to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.MonthsRow#methods/getSelectedDates">selectedDates</a>.</p>
                     * @param {sap.ui.unified.DateRange} oSelectedDate <p>The selectedDate to add; if empty, nothing is inserted</p>
                     * @returns sap.ui.unified.calendar.MonthsRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    addSelectedDate(oSelectedDate: sap.ui.unified.DateRange): sap.ui.unified.calendar.MonthsRow;
                    /**
                     * <p>Adds some specialDate to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.calendar.MonthsRow#methods/getSpecialDates">specialDates</a>.</p>
                     * @param {sap.ui.unified.DateTypeRange} oSpecialDate <p>The specialDate to add; if empty, nothing is inserted</p>
                     * @returns sap.ui.unified.calendar.MonthsRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    addSpecialDate(oSpecialDate: sap.ui.unified.DateTypeRange): sap.ui.unified.calendar.MonthsRow;
                    /**
                     * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="focus" href="api/sap.ui.unified.calendar.MonthsRow#events/focus">focus</a> event of this <code>sap.ui.unified.calendar.MonthsRow</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.calendar.MonthsRow</code> itself.</p><p>Month focus changed</p>
                     * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                     * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                    ...
                    /**
                     * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.calendar.MonthsRow#events/select">select</a> event of this <code>sap.ui.unified.calendar.MonthsRow</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.calendar.MonthsRow</code> itself.</p><p>Month selection changed</p>
                     * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                     * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                     * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.calendar.MonthsRow</code> itself</p>
                     * @returns sap.ui.unified.calendar.MonthsRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                    ...
                    /**
                     * <p>Destroys all the selectedDates in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.MonthsRow#methods/getSelectedDates">selectedDates</a>.</p>
                     * @returns sap.ui.unified.calendar.MonthsRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroySelectedDates(): sap.ui.unified.calendar.MonthsRow;
                    /**
                     * <p>Destroys all the specialDates in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.calendar.MonthsRow#methods/getSpecialDates">specialDates</a>.</p>
                     * @returns sap.ui.unified.calendar.MonthsRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroySpecialDates(): sap.ui.unified.calendar.MonthsRow;
                    /**
                     * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="focus" href="api/sap.ui.unified.calendar.MonthsRow#events/focus">focus</a> event of this <code>sap.ui.unified.calendar.MonthsRow</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                     * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                     * @param {any} oListener <p>Context object on which the given function had to be called</p>
                     * @returns sap.ui.unified.calendar.MonthsRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.calendar.MonthsRow#events/select">select</a> event of this <code>sap.ui.unified.calendar.MonthsRow</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                     * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                     * @param {any} oListener <p>Context object on which the given function had to be called</p>
                     * @returns sap.ui.unified.calendar.MonthsRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="focus" href="api/sap.ui.unified.calendar.MonthsRow#events/focus">focus</a> to attached listeners.</p>
                     * @param {any} mParameters <p>Parameters to pass along with the event</p>
                     * @returns sap.ui.unified.calendar.MonthsRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    protected fireFocus(mParameters?: any): sap.ui.unified.calendar.MonthsRow;
                    /**
                     * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.calendar.MonthsRow#events/select">select</a> to attached listeners.</p>
                     * @param {any} mParameters <p>Parameters to pass along with the event</p>
                     * @returns sap.ui.unified.calendar.MonthsRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    protected fireSelect(mParameters?: any): sap.ui.unified.calendar.MonthsRow;
                    /**
                     * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.calendar.MonthsRow#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @returns sap.ui.core.ID[] 
                     */
                    getAriaLabelledBy(): sap.ui.core.ID[];
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getDate" href="api/sap.ui.unified.calendar.MonthsRow#methods/getDate">date</a>.</p><p>A date as JavaScript Date object. The month including this date is rendered and this date is focused initially (if no other focus is set). If the date property is not in the range <code>startDate</code> + <code>months</code> in the rendering phase, it is set to the <code>startDate</code>. So after setting the <code>startDate</code> the date should be set to be in the visible range.</p>
                     * @returns any <p>Value of property <code>date</code></p>
                     */
                    getDate(): any;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervalSelection" href="api/sap.ui.unified.calendar.MonthsRow#methods/getIntervalSelection">intervalSelection</a>.</p><p>If set, interval selection is allowed</p><p>Default value is <code>false</code>.</p>
                     * @returns boolean <p>Value of property <code>intervalSelection</code></p>
                     */
                    getIntervalSelection(): boolean;
                    /**
                     * <p>ID of the element which is the current target of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getLegend" href="api/sap.ui.unified.calendar.MonthsRow#methods/getLegend">legend</a>, or <code>null</code>.</p>
                     * @returns sap.ui.core.ID 
                     */
                    getLegend(): sap.ui.core.ID;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMonths" href="api/sap.ui.unified.calendar.MonthsRow#methods/getMonths">months</a>.</p><p>Number of months displayed</p><p>Default value is <code>12</code>.</p>
                     * @returns number <p>Value of property <code>months</code></p>
                     */
                    getMonths(): number;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.MonthsRow#methods/getSelectedDates">selectedDates</a>.</p><p>Date ranges for selected dates. If <code>singleSelection</code> is set, only the first entry is used.</p><p><b>Note:</b> Even if only one day is selected, the whole corresponding month is selected.</p>
                     * @returns sap.ui.unified.DateRange[] 
                     */
                    getSelectedDates(): sap.ui.unified.DateRange[];
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowHeader" href="api/sap.ui.unified.calendar.MonthsRow#methods/getShowHeader">showHeader</a>.</p><p>If set, a header with the years is shown to visualize what month belongs to what year.</p><p>Default value is <code>false</code>.</p>
                     * @returns boolean <p>Value of property <code>showHeader</code></p>
                     */
                    getShowHeader(): boolean;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSingleSelection" href="api/sap.ui.unified.calendar.MonthsRow#methods/getSingleSelection">singleSelection</a>.</p><p>If set, only a single month or interval, if intervalSelection is enabled, can be selected</p><p><b>Note:</b> Selection of multiple intervals is not supported in the current version.</p><p>Default value is <code>true</code>.</p>
                     * @returns boolean <p>Value of property <code>singleSelection</code></p>
                     */
                    getSingleSelection(): boolean;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.calendar.MonthsRow#methods/getSpecialDates">specialDates</a>.</p><p>Date ranges with type to visualize special months in the row. If one day is assigned to more than one type, only the first one will be used.</p><p><b>Note:</b> Even if only one day is set as a special day, the whole corresponding month is displayed in this way.</p>
                     * @returns sap.ui.unified.DateTypeRange[] 
                     */
                    getSpecialDates(): sap.ui.unified.DateTypeRange[];
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getStartDate" href="api/sap.ui.unified.calendar.MonthsRow#methods/getStartDate">startDate</a>.</p><p>Start date, as JavaScript Date object, of the row. The month of this date is the first month of the displayed row.</p>
                     * @returns any <p>Value of property <code>startDate</code></p>
                     */
                    getStartDate(): any;
                    /**
                     * <p>Checks for the provided <code>sap.ui.unified.DateRange</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.MonthsRow#methods/getSelectedDates">selectedDates</a>. and returns its index if found or -1 otherwise.</p>
                     * @param {sap.ui.unified.DateRange} oSelectedDate <p>The selectedDate whose index is looked for</p>
                     * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                     */
                    indexOfSelectedDate(oSelectedDate: sap.ui.unified.DateRange): number;
                    /**
                     * <p>Checks for the provided <code>sap.ui.unified.DateTypeRange</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.calendar.MonthsRow#methods/getSpecialDates">specialDates</a>. and returns its index if found or -1 otherwise.</p>
                     * @param {sap.ui.unified.DateTypeRange} oSpecialDate <p>The specialDate whose index is looked for</p>
                     * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                     */
                    indexOfSpecialDate(oSpecialDate: sap.ui.unified.DateTypeRange): number;
                    /**
                     * <p>Inserts a selectedDate into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.MonthsRow#methods/getSelectedDates">selectedDates</a>.</p>
                     * @param {sap.ui.unified.DateRange} oSelectedDate <p>The selectedDate to insert; if empty, nothing is inserted</p>
                     * @param {number} iIndex <p>The <code>0</code>-based index the selectedDate should be inserted at; for a negative value of <code>iIndex</code>, the selectedDate is inserted at position 0; for a value greater than the current size of the aggregation, the selectedDate is inserted at the last position</p>
                     * @returns sap.ui.unified.calendar.MonthsRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Inserts a specialDate into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.calendar.MonthsRow#methods/getSpecialDates">specialDates</a>.</p>
                     * @param {sap.ui.unified.DateTypeRange} oSpecialDate <p>The specialDate to insert; if empty, nothing is inserted</p>
                     * @param {number} iIndex <p>The <code>0</code>-based index the specialDate should be inserted at; for a negative value of <code>iIndex</code>, the specialDate is inserted at position 0; for a value greater than the current size of the aggregation, the specialDate is inserted at the last position</p>
                     * @returns sap.ui.unified.calendar.MonthsRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.calendar.MonthsRow#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllAriaLabelledBy(): sap.ui.core.ID[];
                    /**
                     * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.MonthsRow#methods/getSelectedDates">selectedDates</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                     * @returns sap.ui.unified.DateRange[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllSelectedDates(): sap.ui.unified.DateRange[];
                    /**
                     * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.calendar.MonthsRow#methods/getSpecialDates">specialDates</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                     * @returns sap.ui.unified.DateTypeRange[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllSpecialDates(): sap.ui.unified.DateTypeRange[];
                    /**
                     * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.calendar.MonthsRow#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @param {number | sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to be removed or its index or ID</p>
                     * @returns sap.ui.core.ID <p>The removed ariaLabelledBy or <code>null</code></p>
                     */
                    removeAriaLabelledBy(vAriaLabelledBy: number | sap.ui.core.ID | sap.ui.core.Control): sap.ui.core.ID;
                    /**
                     * <p>Removes a selectedDate from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.MonthsRow#methods/getSelectedDates">selectedDates</a>.</p>
                     * @param {number | string | sap.ui.unified.DateRange} vSelectedDate <p>The selectedDate to remove or its index or id</p>
                     * @returns sap.ui.unified.DateRange <p>The removed selectedDate or <code>null</code></p>
                     */
                    removeSelectedDate(vSelectedDate: number | string | sap.ui.unified.DateRange): sap.ui.unified.DateRange;
                    /**
                     * <p>Removes a specialDate from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.calendar.MonthsRow#methods/getSpecialDates">specialDates</a>.</p>
                     * @param {number | string | sap.ui.unified.DateTypeRange} vSpecialDate <p>The specialDate to remove or its index or id</p>
                     * @returns sap.ui.unified.DateTypeRange <p>The removed specialDate or <code>null</code></p>
                     */
                    removeSpecialDate(vSpecialDate: number | string | sap.ui.unified.DateTypeRange): sap.ui.unified.DateTypeRange;
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getDate" href="api/sap.ui.unified.calendar.MonthsRow#methods/getDate">date</a>.</p><p>A date as JavaScript Date object. The month including this date is rendered and this date is focused initially (if no other focus is set). If the date property is not in the range <code>startDate</code> + <code>months</code> in the rendering phase, it is set to the <code>startDate</code>. So after setting the <code>startDate</code> the date should be set to be in the visible range.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                     * @param {any} oDate <p>New value for property <code>date</code></p>
                     * @returns sap.ui.unified.calendar.MonthsRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    setDate(oDate: any): sap.ui.unified.calendar.MonthsRow;
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervalSelection" href="api/sap.ui.unified.calendar.MonthsRow#methods/getIntervalSelection">intervalSelection</a>.</p><p>If set, interval selection is allowed</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
                     * @param {boolean} bIntervalSelection <p>New value for property <code>intervalSelection</code></p>
                     * @returns sap.ui.unified.calendar.MonthsRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getMonths" href="api/sap.ui.unified.calendar.MonthsRow#methods/getMonths">months</a>.</p><p>Number of months displayed</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>12</code>.</p>
                     * @param {number} iMonths <p>New value for property <code>months</code></p>
                     * @returns sap.ui.unified.calendar.MonthsRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                ...
                export class TimesRow extends sap.ui.core.Control {
                    ...
                    constructor(sId?: string, mSettings?: any);
                    /**
                     * <p>Adds some ariaLabelledBy into the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.calendar.TimesRow#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @param {sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to add; if empty, nothing is inserted</p>
                    ...
                    /**
                     * <p>Adds some selectedDate to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.TimesRow#methods/getSelectedDates">selectedDates</a>.</p>
                     * @param {sap.ui.unified.DateRange} oSelectedDate <p>The selectedDate to add; if empty, nothing is inserted</p>
                     * @returns sap.ui.unified.calendar.TimesRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    addSelectedDate(oSelectedDate: sap.ui.unified.DateRange): sap.ui.unified.calendar.TimesRow;
                    /**
                     * <p>Adds some specialDate to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.calendar.TimesRow#methods/getSpecialDates">specialDates</a>.</p>
                     * @param {sap.ui.unified.DateTypeRange} oSpecialDate <p>The specialDate to add; if empty, nothing is inserted</p>
                     * @returns sap.ui.unified.calendar.TimesRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    addSpecialDate(oSpecialDate: sap.ui.unified.DateTypeRange): sap.ui.unified.calendar.TimesRow;
                    /**
                     * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="focus" href="api/sap.ui.unified.calendar.TimesRow#events/focus">focus</a> event of this <code>sap.ui.unified.calendar.TimesRow</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.calendar.TimesRow</code> itself.</p><p>Time focus changed</p>
                     * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                     * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                    ...
                    /**
                     * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.calendar.TimesRow#events/select">select</a> event of this <code>sap.ui.unified.calendar.TimesRow</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.calendar.TimesRow</code> itself.</p><p>Time selection changed</p>
                     * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                     * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                     * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.calendar.TimesRow</code> itself</p>
                     * @returns sap.ui.unified.calendar.TimesRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                    ...
                    checkDateFocusable(oDate: any): boolean;
                    /**
                     * <p>Destroys all the selectedDates in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.TimesRow#methods/getSelectedDates">selectedDates</a>.</p>
                     * @returns sap.ui.unified.calendar.TimesRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroySelectedDates(): sap.ui.unified.calendar.TimesRow;
                    /**
                     * <p>Destroys all the specialDates in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.calendar.TimesRow#methods/getSpecialDates">specialDates</a>.</p>
                     * @returns sap.ui.unified.calendar.TimesRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroySpecialDates(): sap.ui.unified.calendar.TimesRow;
                    /**
                     * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="focus" href="api/sap.ui.unified.calendar.TimesRow#events/focus">focus</a> event of this <code>sap.ui.unified.calendar.TimesRow</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                     * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                     * @param {any} oListener <p>Context object on which the given function had to be called</p>
                     * @returns sap.ui.unified.calendar.TimesRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.calendar.TimesRow#events/select">select</a> event of this <code>sap.ui.unified.calendar.TimesRow</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                     * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                     * @param {any} oListener <p>Context object on which the given function had to be called</p>
                     * @returns sap.ui.unified.calendar.TimesRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="focus" href="api/sap.ui.unified.calendar.TimesRow#events/focus">focus</a> to attached listeners.</p>
                     * @param {any} mParameters <p>Parameters to pass along with the event</p>
                     * @returns sap.ui.unified.calendar.TimesRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    protected fireFocus(mParameters?: any): sap.ui.unified.calendar.TimesRow;
                    /**
                     * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.calendar.TimesRow#events/select">select</a> to attached listeners.</p>
                     * @param {any} mParameters <p>Parameters to pass along with the event</p>
                     * @returns sap.ui.unified.calendar.TimesRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    protected fireSelect(mParameters?: any): sap.ui.unified.calendar.TimesRow;
                    /**
                     * <p>Returns array of IDs of the elements which are the current targets of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.calendar.TimesRow#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @returns sap.ui.core.ID[] 
                     */
                    getAriaLabelledBy(): sap.ui.core.ID[];
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getDate" href="api/sap.ui.unified.calendar.TimesRow#methods/getDate">date</a>.</p><p>A date as JavaScript Date object. The month including this date is rendered and this date is focused initially (if no other focus is set). If the date property is not in the range <code>startDate</code> + <code>items</code> in the rendering phase, it is set to the <code>startDate</code>. So after setting the <code>startDate</code> the date should be set to be in the visible range.</p>
                     * @returns any <p>Value of property <code>date</code></p>
                     */
                    getDate(): any;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervalMinutes" href="api/sap.ui.unified.calendar.TimesRow#methods/getIntervalMinutes">intervalMinutes</a>.</p><p>Size of on time interval in minutes, default is 60 minutes.</p><p><b>Note:</b> the start of the interval calculation is always <code>startDat</code> at 00:00.</p><p>An interval longer than 720 minutes is not allowed. Please use the <code>DatesRow</code> instead.</p><p>A day must be divisible by this interval size. One interval must not include more than one day.</p><p>Default value is <code>60</code>.</p>
                     * @returns number <p>Value of property <code>intervalMinutes</code></p>
                     */
                    getIntervalMinutes(): number;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervalSelection" href="api/sap.ui.unified.calendar.TimesRow#methods/getIntervalSelection">intervalSelection</a>.</p><p>If set, interval selection is allowed</p><p>Default value is <code>false</code>.</p>
                     * @returns boolean <p>Value of property <code>intervalSelection</code></p>
                     */
                    getIntervalSelection(): boolean;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getItems" href="api/sap.ui.unified.calendar.TimesRow#methods/getItems">items</a>.</p><p>Number of time items displayed</p><p>Default value is <code>12</code>.</p>
                     * @returns number <p>Value of property <code>items</code></p>
                     */
                    getItems(): number;
                    /**
                     * <p>ID of the element which is the current target of the association <a target="_self" class="jsdoclink scrollToMethod" data-target="getLegend" href="api/sap.ui.unified.calendar.TimesRow#methods/getLegend">legend</a>, or <code>null</code>.</p>
                     * @returns sap.ui.core.ID 
                     */
                    getLegend(): sap.ui.core.ID;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.TimesRow#methods/getSelectedDates">selectedDates</a>.</p><p>Date ranges for selected dates. If <code>singleSelection</code> is set, only the first entry is used.</p>
                     * @returns sap.ui.unified.DateRange[] 
                     */
                    getSelectedDates(): sap.ui.unified.DateRange[];
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowHeader" href="api/sap.ui.unified.calendar.TimesRow#methods/getShowHeader">showHeader</a>.</p><p>If set, a header with the years is shown to visualize what month belongs to what year.</p><p>Default value is <code>false</code>.</p>
                     * @returns boolean <p>Value of property <code>showHeader</code></p>
                     */
                    getShowHeader(): boolean;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getSingleSelection" href="api/sap.ui.unified.calendar.TimesRow#methods/getSingleSelection">singleSelection</a>.</p><p>If set, only a single month or interval, if intervalSelection is enabled, can be selected</p><p><b>Note:</b> Selection of multiple intervals is not supported in the current version.</p><p>Default value is <code>true</code>.</p>
                     * @returns boolean <p>Value of property <code>singleSelection</code></p>
                     */
                    getSingleSelection(): boolean;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.calendar.TimesRow#methods/getSpecialDates">specialDates</a>.</p><p>Date ranges with type to visualize special item in the row. If one day is assigned to more than one type, only the first one will be used.</p>
                     * @returns sap.ui.unified.DateTypeRange[] 
                     */
                    getSpecialDates(): sap.ui.unified.DateTypeRange[];
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getStartDate" href="api/sap.ui.unified.calendar.TimesRow#methods/getStartDate">startDate</a>.</p><p>Start date, as JavaScript Date object, of the row.</p>
                     * @returns any <p>Value of property <code>startDate</code></p>
                     */
                    getStartDate(): any;
                    /**
                     * <p>Checks for the provided <code>sap.ui.unified.DateRange</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.TimesRow#methods/getSelectedDates">selectedDates</a>. and returns its index if found or -1 otherwise.</p>
                     * @param {sap.ui.unified.DateRange} oSelectedDate <p>The selectedDate whose index is looked for</p>
                     * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                     */
                    indexOfSelectedDate(oSelectedDate: sap.ui.unified.DateRange): number;
                    /**
                     * <p>Checks for the provided <code>sap.ui.unified.DateTypeRange</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.calendar.TimesRow#methods/getSpecialDates">specialDates</a>. and returns its index if found or -1 otherwise.</p>
                     * @param {sap.ui.unified.DateTypeRange} oSpecialDate <p>The specialDate whose index is looked for</p>
                     * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                     */
                    indexOfSpecialDate(oSpecialDate: sap.ui.unified.DateTypeRange): number;
                    /**
                     * <p>Inserts a selectedDate into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.TimesRow#methods/getSelectedDates">selectedDates</a>.</p>
                     * @param {sap.ui.unified.DateRange} oSelectedDate <p>The selectedDate to insert; if empty, nothing is inserted</p>
                     * @param {number} iIndex <p>The <code>0</code>-based index the selectedDate should be inserted at; for a negative value of <code>iIndex</code>, the selectedDate is inserted at position 0; for a value greater than the current size of the aggregation, the selectedDate is inserted at the last position</p>
                     * @returns sap.ui.unified.calendar.TimesRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Inserts a specialDate into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.calendar.TimesRow#methods/getSpecialDates">specialDates</a>.</p>
                     * @param {sap.ui.unified.DateTypeRange} oSpecialDate <p>The specialDate to insert; if empty, nothing is inserted</p>
                     * @param {number} iIndex <p>The <code>0</code>-based index the specialDate should be inserted at; for a negative value of <code>iIndex</code>, the specialDate is inserted at position 0; for a value greater than the current size of the aggregation, the specialDate is inserted at the last position</p>
                     * @returns sap.ui.unified.calendar.TimesRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Removes all the controls in the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.calendar.TimesRow#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @returns sap.ui.core.ID[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllAriaLabelledBy(): sap.ui.core.ID[];
                    /**
                     * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.TimesRow#methods/getSelectedDates">selectedDates</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                     * @returns sap.ui.unified.DateRange[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllSelectedDates(): sap.ui.unified.DateRange[];
                    /**
                     * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.calendar.TimesRow#methods/getSpecialDates">specialDates</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                     * @returns sap.ui.unified.DateTypeRange[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllSpecialDates(): sap.ui.unified.DateTypeRange[];
                    /**
                     * <p>Removes an ariaLabelledBy from the association named <a target="_self" class="jsdoclink scrollToMethod" data-target="getAriaLabelledBy" href="api/sap.ui.unified.calendar.TimesRow#methods/getAriaLabelledBy">ariaLabelledBy</a>.</p>
                     * @param {number | sap.ui.core.ID | sap.ui.core.Control} vAriaLabelledBy <p>The ariaLabelledBy to be removed or its index or ID</p>
                     * @returns sap.ui.core.ID <p>The removed ariaLabelledBy or <code>null</code></p>
                     */
                    removeAriaLabelledBy(vAriaLabelledBy: number | sap.ui.core.ID | sap.ui.core.Control): sap.ui.core.ID;
                    /**
                     * <p>Removes a selectedDate from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.TimesRow#methods/getSelectedDates">selectedDates</a>.</p>
                     * @param {number | string | sap.ui.unified.DateRange} vSelectedDate <p>The selectedDate to remove or its index or id</p>
                     * @returns sap.ui.unified.DateRange <p>The removed selectedDate or <code>null</code></p>
                     */
                    removeSelectedDate(vSelectedDate: number | string | sap.ui.unified.DateRange): sap.ui.unified.DateRange;
                    /**
                     * <p>Removes a specialDate from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSpecialDates" href="api/sap.ui.unified.calendar.TimesRow#methods/getSpecialDates">specialDates</a>.</p>
                     * @param {number | string | sap.ui.unified.DateTypeRange} vSpecialDate <p>The specialDate to remove or its index or id</p>
                     * @returns sap.ui.unified.DateTypeRange <p>The removed specialDate or <code>null</code></p>
                     */
                    removeSpecialDate(vSpecialDate: number | string | sap.ui.unified.DateTypeRange): sap.ui.unified.DateTypeRange;
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getDate" href="api/sap.ui.unified.calendar.TimesRow#methods/getDate">date</a>.</p><p>A date as JavaScript Date object. The month including this date is rendered and this date is focused initially (if no other focus is set). If the date property is not in the range <code>startDate</code> + <code>items</code> in the rendering phase, it is set to the <code>startDate</code>. So after setting the <code>startDate</code> the date should be set to be in the visible range.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p>
                     * @param {any} oDate <p>New value for property <code>date</code></p>
                     * @returns sap.ui.unified.calendar.TimesRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    setDate(oDate: any): sap.ui.unified.calendar.TimesRow;
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervalMinutes" href="api/sap.ui.unified.calendar.TimesRow#methods/getIntervalMinutes">intervalMinutes</a>.</p><p>Size of on time interval in minutes, default is 60 minutes.</p><p><b>Note:</b> the start of the interval calculation is always <code>startDat</code> at 00:00.</p><p>An interval longer than 720 minutes is not allowed. Please use the <code>DatesRow</code> instead.</p><p>A day must be divisible by this interval size. One interval must not include more than one day.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>60</code>.</p>
                     * @param {number} iIntervalMinutes <p>New value for property <code>intervalMinutes</code></p>
                     * @returns sap.ui.unified.calendar.TimesRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getShowHeader" href="api/sap.ui.unified.calendar.TimesRow#methods/getShowHeader">showHeader</a>.</p><p>If set, a header with the years is shown to visualize what month belongs to what year.</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
                     * @param {boolean} bShowHeader <p>New value for property <code>showHeader</code></p>
                     * @returns sap.ui.unified.calendar.TimesRow <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                ...
                export class YearPicker extends sap.ui.core.Control {
                    ...
                    constructor(sId?: string, mSettings?: any);
                    /**
                     * <p>Adds some selectedDate to the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.YearPicker#methods/getSelectedDates">selectedDates</a>.</p>
                     * @param {sap.ui.unified.DateRange} oSelectedDate <p>The selectedDate to add; if empty, nothing is inserted</p>
                     * @returns sap.ui.unified.calendar.YearPicker <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    addSelectedDate(oSelectedDate: sap.ui.unified.DateRange): sap.ui.unified.calendar.YearPicker;
                    /**
                     * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="pageChange" href="api/sap.ui.unified.calendar.YearPicker#events/pageChange">pageChange</a> event of this <code>sap.ui.unified.calendar.YearPicker</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.calendar.YearPicker</code> itself.</p><p>The <code>pageChange</code> event is fired if the displayed years are changed by user navigation.</p>
                     * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                     * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                    ...
                    /**
                     * <p>Attaches event handler <code>fnFunction</code> to the <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.calendar.YearPicker#events/select">select</a> event of this <code>sap.ui.unified.calendar.YearPicker</code>.</p><p>When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.unified.calendar.YearPicker</code> itself.</p><p>Year selection changed</p>
                     * @param {any} oData <p>An application-specific payload object that will be passed to the event handler along with the event object when firing the event</p>
                     * @param {Function} fnFunction <p>The function to be called when the event occurs</p>
                     * @param {any} oListener <p>Context object to call the event handler with. Defaults to this <code>sap.ui.unified.calendar.YearPicker</code> itself</p>
                     * @returns sap.ui.unified.calendar.YearPicker <p>Reference to <code>this</code> in order to allow method chaining</p>
                    ...
                    /**
                     * <p>Destroys all the selectedDates in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.YearPicker#methods/getSelectedDates">selectedDates</a>.</p>
                     * @returns sap.ui.unified.calendar.YearPicker <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    destroySelectedDates(): sap.ui.unified.calendar.YearPicker;
                    /**
                     * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="pageChange" href="api/sap.ui.unified.calendar.YearPicker#events/pageChange">pageChange</a> event of this <code>sap.ui.unified.calendar.YearPicker</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                     * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                     * @param {any} oListener <p>Context object on which the given function had to be called</p>
                     * @returns sap.ui.unified.calendar.YearPicker <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Detaches event handler <code>fnFunction</code> from the <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.calendar.YearPicker#events/select">select</a> event of this <code>sap.ui.unified.calendar.YearPicker</code>.</p><p>The passed function and listener object must match the ones used for event registration.</p>
                     * @param {Function} fnFunction <p>The function to be called, when the event occurs</p>
                     * @param {any} oListener <p>Context object on which the given function had to be called</p>
                     * @returns sap.ui.unified.calendar.YearPicker <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="pageChange" href="api/sap.ui.unified.calendar.YearPicker#events/pageChange">pageChange</a> to attached listeners.</p>
                     * @param {any} mParameters <p>Parameters to pass along with the event</p>
                     * @returns sap.ui.unified.calendar.YearPicker <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    protected firePageChange(mParameters?: any): sap.ui.unified.calendar.YearPicker;
                    /**
                     * <p>Fires event <a target="_self" class="jsdoclink scrollToEvent" data-target="select" href="api/sap.ui.unified.calendar.YearPicker#events/select">select</a> to attached listeners.</p>
                     * @param {any} mParameters <p>Parameters to pass along with the event</p>
                     * @returns sap.ui.unified.calendar.YearPicker <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    protected fireSelect(mParameters?: any): sap.ui.unified.calendar.YearPicker;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getColumns" href="api/sap.ui.unified.calendar.YearPicker#methods/getColumns">columns</a>.</p><p>number of years in each row 0 means just to have all years in one row, independent of the number</p><p>Default value is <code>4</code>.</p>
                     * @returns number <p>Value of property <code>columns</code></p>
                     */
                    getColumns(): number;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getDate" href="api/sap.ui.unified.calendar.YearPicker#methods/getDate">date</a>.</p><p>Date as JavaScript Date object. For this date a <code>YearPicker</code> is rendered. If a Year is selected the date is updated with the start date of the selected year (depending on the calendar type).</p>
                     * @returns any <p>Value of property <code>date</code></p>
                     */
                    getDate(): any;
                    /**
                    ...
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervalSelection" href="api/sap.ui.unified.calendar.YearPicker#methods/getIntervalSelection">intervalSelection</a>.</p><p>If set, interval selection is allowed</p><p>Default value is <code>false</code>.</p>
                     * @returns boolean <p>Value of property <code>intervalSelection</code></p>
                     */
                    getIntervalSelection(): boolean;
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getPrimaryCalendarType" href="api/sap.ui.unified.calendar.YearPicker#methods/getPrimaryCalendarType">primaryCalendarType</a>.</p><p>If set, the calendar type is used for display. If not set, the calendar type of the global configuration is used.</p>
                     * @returns sap.ui.core.CalendarType <p>Value of property <code>primaryCalendarType</code></p>
                     */
                    getPrimaryCalendarType(): sap.ui.core.CalendarType;
                    /**
                     * <p>Gets content of aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.YearPicker#methods/getSelectedDates">selectedDates</a>.</p><p>Date Ranges for selected dates of the YearPicker</p>
                     * @returns sap.ui.unified.DateRange[] 
                     */
                    getSelectedDates(): sap.ui.unified.DateRange[];
                    /**
                     * <p>Gets current value of property <a target="_self" class="jsdoclink scrollToMethod" data-target="getYears" href="api/sap.ui.unified.calendar.YearPicker#methods/getYears">years</a>.</p><p>number of displayed years</p><p>Default value is <code>20</code>.</p>
                     * @returns number <p>Value of property <code>years</code></p>
                     */
                    getYears(): number;
                    /**
                     * <p>Checks for the provided <code>sap.ui.unified.DateRange</code> in the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.YearPicker#methods/getSelectedDates">selectedDates</a>. and returns its index if found or -1 otherwise.</p>
                     * @param {sap.ui.unified.DateRange} oSelectedDate <p>The selectedDate whose index is looked for</p>
                     * @returns number <p>The index of the provided control in the aggregation if found, or -1 otherwise</p>
                     */
                    indexOfSelectedDate(oSelectedDate: sap.ui.unified.DateRange): number;
                    /**
                     * <p>Inserts a selectedDate into the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.YearPicker#methods/getSelectedDates">selectedDates</a>.</p>
                     * @param {sap.ui.unified.DateRange} oSelectedDate <p>The selectedDate to insert; if empty, nothing is inserted</p>
                     * @param {number} iIndex <p>The <code>0</code>-based index the selectedDate should be inserted at; for a negative value of <code>iIndex</code>, the selectedDate is inserted at position 0; for a value greater than the current size of the aggregation, the selectedDate is inserted at the last position</p>
                     * @returns sap.ui.unified.calendar.YearPicker <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    insertSelectedDate(oSelectedDate: sap.ui.unified.DateRange, iIndex: number): sap.ui.unified.calendar.YearPicker;
                    /**
                     * <p>displays the next page</p>
                    ...
                    /**
                     * <p>Removes all the controls from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.YearPicker#methods/getSelectedDates">selectedDates</a>.</p><p>Additionally, it unregisters them from the hosting UIArea.</p>
                     * @returns sap.ui.unified.DateRange[] <p>An array of the removed elements (might be empty)</p>
                     */
                    removeAllSelectedDates(): sap.ui.unified.DateRange[];
                    /**
                     * <p>Removes a selectedDate from the aggregation <a target="_self" class="jsdoclink scrollToMethod" data-target="getSelectedDates" href="api/sap.ui.unified.calendar.YearPicker#methods/getSelectedDates">selectedDates</a>.</p>
                     * @param {number | string | sap.ui.unified.DateRange} vSelectedDate <p>The selectedDate to remove or its index or id</p>
                     * @returns sap.ui.unified.DateRange <p>The removed selectedDate or <code>null</code></p>
                     */
                    removeSelectedDate(vSelectedDate: number | string | sap.ui.unified.DateRange): sap.ui.unified.DateRange;
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getColumns" href="api/sap.ui.unified.calendar.YearPicker#methods/getColumns">columns</a>.</p><p>number of years in each row 0 means just to have all years in one row, independent of the number</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>4</code>.</p>
                     * @param {number} iColumns <p>New value for property <code>columns</code></p>
                     * @returns sap.ui.unified.calendar.YearPicker <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getIntervalSelection" href="api/sap.ui.unified.calendar.YearPicker#methods/getIntervalSelection">intervalSelection</a>.</p><p>If set, interval selection is allowed</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>false</code>.</p>
                     * @param {boolean} bIntervalSelection <p>New value for property <code>intervalSelection</code></p>
                     * @returns sap.ui.unified.calendar.YearPicker <p>Reference to <code>this</code> in order to allow method chaining</p>
                     */
                    ...
                    /**
                     * <p>Sets a new value for property <a target="_self" class="jsdoclink scrollToMethod" data-target="getYears" href="api/sap.ui.unified.calendar.YearPicker#methods/getYears">years</a>.</p><p>number of displayed years</p><p>When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.</p><p>Default value is <code>20</code>.</p>
