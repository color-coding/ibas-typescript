    ...
    export namespace extension {
        export namespace layout {
            ...
            SimpleForm.extend("sap.extension.layout.DataSimpleForm", {
                ...
                updatePropertyControls(this: DataSimpleForm, boInfo: shell.bo.IBizObjectInfo): void {
            ...
            function propertyControls(this: DataSimpleForm, boInfo: shell.bo.IBizObjectInfo): void {
                ...
                if (this.getUserFieldsMode() === "input") {
                    for (let property of properties.filter(c => !ibas.objects.isNull(c)).sort((a, b) => a.position - b.position)) {
                        ...
                        this.addContent(factories.newComponent(property, "Input", !ibas.strings.isEmpty(property.linkedObject) ? (event) => {
                            ...
                            if (source instanceof sap.m.Input && event.getId() === "changed") {
                                ...
                                let boData: any = this.getBindingContext()?.getObject();
