...
declare namespace sap {
    namespace extension {
        namespace m {
             ...
             * 日期选择框
             */
            class DatePicker extends sap.m.DatePicker {
                /**
                 * 构造
                 ...
                 * @param value 值
                 */
                setBindingValue(value: any): this;
            }
            /**
             * 时间选择框
             */
            class TimePicker extends sap.m.TimePicker {
                /**
                 * 构造
                 * @param {string} sId 唯一标记，不要赋值
                 * @param {any} mSettings 绑定值属性：bindingValue
             ...
             * 日期时间选择框
             */
            class DateTimePicker extends sap.m.DateTimePicker {
                /**
                 * 构造
                 * @param {string} sId 唯一标记，不要赋值
                 * @param {any} mSettings 绑定值属性：日期：dateValue；时间：timeValue
                 */
                constructor(sId?: string, mSettings?: any);
                /**
                 * 设置属性值
