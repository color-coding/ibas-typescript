    ...
    export abstract class DataConverter4j implements IDataConverter {
        ...
        parsing(data: any, sign: string): any {
            if (data.type === "string") {
                ...
                newData.bracketClose = objects.isNull(remote.BracketClose) ? 0 : remote.BracketClose;
                newData.bracketOpen = objects.isNull(remote.BracketOpen) ? 0 : remote.BracketOpen;
